...
CREATE OR REPLACE FUNCTION "public"."admin_cleanup_ticket_images"("p_days_old" integer DEFAULT 7) RETURNS "jsonb"
...
ALTER FUNCTION "public"."admin_cleanup_ticket_images"("p_days_old" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."admin_review_refund"("p_request_id" "uuid", "p_approved" boolean, "p_refund_amount" numeric DEFAULT NULL::numeric, "p_admin_note" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."admin_review_refund"("p_request_id" "uuid", "p_approved" boolean, "p_refund_amount" numeric, "p_admin_note" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."cancel_user_refund_request"("p_order_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."cancel_user_refund_request"("p_order_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."cleanup_expired_order_fulfillments"() RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."cleanup_expired_order_fulfillments"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."cleanup_old_expired_preorders"() RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."cleanup_old_expired_preorders"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."cleanup_unverified_users"() RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."create_refund_request"("p_order_id" "uuid", "p_reason" "text", "p_reason_detail" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_refund_request"("p_order_id" "uuid", "p_reason" "text", "p_reason_detail" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_renewal_pre_order"("p_sku_id" "uuid", "p_old_order_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_renewal_pre_order"("p_sku_id" "uuid", "p_old_order_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_ticket"("p_order_id" "uuid", "p_title" "text", "p_content" "text", "p_priority" "text", "p_attachments" "text"[] DEFAULT NULL::"text"[]) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_ticket"("p_order_id" "uuid", "p_title" "text", "p_content" "text", "p_priority" "text", "p_attachments" "text"[]) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."expire_active_orders"() RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."expire_active_orders"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_order_refund_info"("p_order_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_order_refund_info"("p_order_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_refund_request"("p_order_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_refund_request"("p_order_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_renewal_skus"("p_order_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_renewal_skus"("p_order_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."is_notification_enabled"("config_key" "text") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."is_notification_enabled"("config_key" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."resolve_ticket"("p_ticket_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE 
...
ALTER FUNCTION "public"."resolve_ticket"("p_ticket_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."send_auto_message"("p_user_id" "uuid", "p_title" "text", "p_content" "text", "p_type" "text" DEFAULT 'system'::"text", "p_link" "text" DEFAULT NULL::"text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."send_auto_message"("p_user_id" "uuid", "p_title" "text", "p_content" "text", "p_type" "text", "p_link" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."send_ticket_message"("p_ticket_id" "uuid", "p_content" "text", "p_attachments" "text"[] DEFAULT NULL::"text"[]) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."send_ticket_message"("p_ticket_id" "uuid", "p_content" "text", "p_attachments" "text"[]) OWNER TO "postgres";
...
ALTER FUNCTION "public"."set_ticket_no"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."trigger_notify_balance_change"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."trigger_notify_balance_change"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."trigger_notify_coupon_insert"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."trigger_notify_coupon_insert"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."trigger_notify_fulfillment_update"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."trigger_notify_fulfillment_update"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."trigger_notify_order_created"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."trigger_notify_order_created"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."trigger_notify_order_status"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."trigger_notify_order_status"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."trigger_notify_ticket_reply"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."trigger_notify_ticket_reply"() OWNER TO "postgres";
...
ALTER TABLE "public"."channel_recognitions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."faq_categories" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "is_checkout_visible" boolean DEFAULT false
);
...
CREATE TABLE IF NOT EXISTS "public"."pre_orders" (
    ...
    CONSTRAINT "pre_orders_source_check" CHECK (("source" = ANY (ARRAY['buy_now'::"text", 'cart'::"text", 'renew'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."recharge_orders" (
    ...
    "payer_openid" character varying(128),
...
COMMENT ON COLUMN "public"."recharge_orders"."bonus" IS '赠送金额';
...
CREATE TABLE IF NOT EXISTS "public"."ticket_messages" (
    ...
    "attachments" "text"[],
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "ticket_messages_message_type_check" CHECK (("message_type" = ANY (ARRAY['text'::"text", 'image'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."tickets" (
    ...
    CONSTRAINT "tickets_status_check" CHECK (("status" = ANY (ARRAY['processing'::"text", 'resolved'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."wechat_login_sessions" (
    ...
    CONSTRAINT "wechat_login_sessions_status_check" CHECK (("status" = ANY (ARRAY['waiting'::"text", 'scanned'::"text", 'bound'::"text", 'expired'::"text"])))
);


ALTER TABLE "public"."wechat_login_sessions" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."channel_recognitions"
    ADD CONSTRAINT "channel_recognitions_channel_key_key" UNIQUE ("channel_key");



ALTER TABLE ONLY "public"."channel_recognitions"
    ADD CONSTRAINT "channel_recognitions_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."wechat_login_sessions"
    ADD CONSTRAINT "wechat_login_sessions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."wechat_login_sessions"
    ADD CONSTRAINT "wechat_login_sessions_scene_str_key" UNIQUE ("scene_str");
...
CREATE INDEX "idx_banners_image_id" ON "public"."banners" USING "btree" ("image_id");
...
CREATE INDEX "idx_channel_recognitions_product_id" ON "public"."channel_recognitions" USING "btree" ("product_id");
...
CREATE INDEX "idx_pre_orders_coupon_id" ON "public"."pre_orders" USING "btree" ("coupon_id");
...
CREATE INDEX "idx_pre_orders_related_order_id" ON "public"."pre_orders" USING "btree" ("related_order_id");
...
CREATE INDEX "idx_pre_orders_user_id" ON "public"."pre_orders" USING "btree" ("user_id");
...
CREATE INDEX "idx_profiles_wechat_openid" ON "public"."profiles" USING "btree" ("wechat_openid") WHERE ("wechat_openid" IS NOT NULL);
...
CREATE INDEX "idx_recharge_orders_created_at" ON "public"."recharge_orders" USING "btree" ("created_at" DESC);
...
CREATE INDEX "idx_refund_requests_admin_id" ON "public"."refund_requests" USING "btree" ("admin_id");
...
CREATE INDEX "idx_slot_occupancies_pre_order_id" ON "public"."slot_occupancies" USING "btree" ("pre_order_id");
...
CREATE INDEX "idx_slot_occupancies_user_id" ON "public"."slot_occupancies" USING "btree" ("user_id");
...
CREATE INDEX "idx_user_favorites_sku_id" ON "public"."user_favorites" USING "btree" ("sku_id");
...
CREATE INDEX "idx_wechat_login_sessions_expires" ON "public"."wechat_login_sessions" USING "btree" ("expires_at");



CREATE INDEX "idx_wechat_login_sessions_scene" ON "public"."wechat_login_sessions" USING "btree" ("scene_str");



CREATE OR REPLACE TRIGGER "on_balance_change" AFTER UPDATE ON "public"."profiles" FOR EACH ROW WHEN (("old"."balance" IS DISTINCT FROM "new"."balance")) EXECUTE FUNCTION "public"."trigger_notify_balance_change"();



CREATE OR REPLACE TRIGGER "on_coupon_received" AFTER INSERT ON "public"."user_coupons" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_notify_coupon_insert"();



CREATE OR REPLACE TRIGGER "on_fulfillment_update" AFTER UPDATE ON "public"."order_fulfillments" FOR EACH ROW WHEN (("old"."status" IS DISTINCT FROM "new"."status")) EXECUTE FUNCTION "public"."trigger_notify_fulfillment_update"();



CREATE OR REPLACE TRIGGER "on_order_created" AFTER INSERT ON "public"."orders" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_notify_order_created"();



CREATE OR REPLACE TRIGGER "on_order_status_change" AFTER UPDATE ON "public"."orders" FOR EACH ROW WHEN (("old"."status" IS DISTINCT FROM "new"."status")) EXECUTE FUNCTION "public"."trigger_notify_order_status"();



CREATE OR REPLACE TRIGGER "on_ticket_reply" AFTER INSERT ON "public"."ticket_messages" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_notify_ticket_reply"();



CREATE OR REPLACE TRIGGER "trigger_set_ticket_no" BEFORE INSERT ON "public"."tickets" FOR EACH ROW EXECUTE FUNCTION "public"."set_ticket_no"();
...
ALTER TABLE ONLY "public"."channel_recognitions"
    ADD CONSTRAINT "channel_recognitions_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."coupon_codes"
    ADD CONSTRAINT "coupon_codes_user_uid_fkey" FOREIGN KEY ("user_uid") REFERENCES "public"."profiles"("id");
...
ALTER TABLE ONLY "public"."pre_orders"
    ADD CONSTRAINT "pre_orders_related_order_id_fkey" FOREIGN KEY ("related_order_id") REFERENCES "public"."orders"("id");



ALTER TABLE ONLY "public"."pre_orders"
    ADD CONSTRAINT "pre_orders_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id");
...
ALTER TABLE ONLY "public"."recharge_orders"
    ADD CONSTRAINT "recharge_orders_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."refund_requests"
    ADD CONSTRAINT "refund_requests_admin_id_fkey" FOREIGN KEY ("admin_id") REFERENCES "public"."profiles"("id");
...
ALTER TABLE ONLY "public"."slot_occupancies"
    ADD CONSTRAINT "slot_occupancies_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id");
...
ALTER TABLE ONLY "public"."user_coupons"
    ADD CONSTRAINT "user_coupons_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
CREATE POLICY "Service role can manage recharge orders" ON "public"."recharge_orders" USING (("auth"."role"() = 'service_role'::"text"));
...
CREATE POLICY "Service role has full access to scan sessions" ON "public"."wechat_login_sessions" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "admin_manage_shared_sku_groups" ON "public"."shared_sku_groups" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "admin_only_task_logs" ON "public"."scheduled_task_logs" USING ("public"."is_admin"());
...
CREATE POLICY "admin_users_select_combined" ON "public"."admin_users" FOR SELECT USING (("public"."is_admin"() OR ("auth_user_id" = "auth"."uid"())));
...
CREATE POLICY "banners_admin_write" ON "public"."banners" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "cart_items_user_delete" ON "public"."cart_items" FOR DELETE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "cart_items_user_insert" ON "public"."cart_items" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "cart_items_user_select" ON "public"."cart_items" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "cart_items_user_update" ON "public"."cart_items" FOR UPDATE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "cdks_admin_all" ON "public"."cdks" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "cdks_user_view_own" ON "public"."cdks" FOR SELECT TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."orders" "o"
  WHERE (("o"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ((("o"."cdk_snapshot" -> 'locked_cdk_ids'::"text") @> "to_jsonb"("cdks"."id")) OR ("o"."cdk_snapshot" @> "to_jsonb"("cdks"."id")))))) OR (EXISTS ( SELECT 1
   FROM "public"."pre_orders" "po"
  WHERE (("po"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("cdks"."id" = ANY ("po"."locked_cdk_ids")))))));
...
CREATE POLICY "channel_recognitions_admin_all" ON "public"."channel_recognitions" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "channel_recognitions_public_read" ON "public"."channel_recognitions" FOR SELECT USING (true);
...
CREATE POLICY "community_articles_admin_all" ON "public"."community_articles" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "community_categories_admin_all" ON "public"."community_categories" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "coupon_codes_admin_all" ON "public"."coupon_codes" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "coupon_codes_public_select" ON "public"."coupon_codes" FOR SELECT USING (true);
...
CREATE POLICY "coupons_admin_all" ON "public"."coupons" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "faq_categories_admin_all" ON "public"."faq_categories" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "image_categories_admin_write" ON "public"."image_categories" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "image_categories_public_read" ON "public"."image_categories" FOR SELECT USING (true);
...
CREATE POLICY "images_admin_write" ON "public"."images" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "messages_user_select" ON "public"."messages" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "messages_user_update" ON "public"."messages" FOR UPDATE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid"))) WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "order_fulfillments_admin" ON "public"."order_fulfillments" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "order_fulfillments_user" ON "public"."order_fulfillments" TO "authenticated" USING (("order_id" IN ( SELECT "orders"."id"
   FROM "public"."orders"
  WHERE ("orders"."user_id" = ( SELECT "auth"."uid"() AS "uid"))))) WITH CHECK (("order_id" IN ( SELECT "orders"."id"
   FROM "public"."orders"
...
CREATE POLICY "orders_admin_select" ON "public"."orders" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));



CREATE POLICY "orders_user_select" ON "public"."orders" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "orders_user_update" ON "public"."orders" FOR UPDATE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "pre_orders_admin_select" ON "public"."pre_orders" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));



CREATE POLICY "pre_orders_user_insert" ON "public"."pre_orders" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "pre_orders_user_select" ON "public"."pre_orders" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "pre_orders_user_update" ON "public"."pre_orders" FOR UPDATE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "product_categories_admin_write" ON "public"."product_categories" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "product_sku_map_admin_all" ON "public"."product_sku_map" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "product_sku_map_public_select" ON "public"."product_sku_map" FOR SELECT USING (true);
...
CREATE POLICY "product_skus_admin_all" ON "public"."product_skus" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "product_skus_public_select" ON "public"."product_skus" FOR SELECT USING (true);
...
CREATE POLICY "products_admin_all" ON "public"."products" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "profiles_user_select" ON "public"."profiles" FOR SELECT TO "authenticated" USING (("id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "profiles_user_update" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (("id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "recharge_orders_user_insert" ON "public"."recharge_orders" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "recharge_orders_user_select" ON "public"."recharge_orders" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "recharge_tiers_admin_all" ON "public"."recharge_tiers" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "recharge_tiers_public_select" ON "public"."recharge_tiers" FOR SELECT USING (true);
...
CREATE POLICY "refund_requests_user_insert" ON "public"."refund_requests" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "refund_requests_user_select" ON "public"."refund_requests" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "slot_occupancies_admin_all" ON "public"."slot_occupancies" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."admin_users"
  WHERE (("admin_users"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("admin_users"."status" = 'enabled'::"text")))));
...
CREATE POLICY "slot_occupancies_user_insert" ON "public"."slot_occupancies" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "slot_occupancies_user_select" ON "public"."slot_occupancies" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "slot_occupancies_user_update" ON "public"."slot_occupancies" FOR UPDATE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "ticket_messages_user_insert" ON "public"."ticket_messages" FOR INSERT TO "authenticated" WITH CHECK (("ticket_id" IN ( SELECT "tickets"."id"
   FROM "public"."tickets"
  WHERE ("tickets"."user_id" = ( SELECT "auth"."uid"() AS "uid")))));



CREATE POLICY "ticket_messages_user_select" ON "public"."ticket_messages" FOR SELECT TO "authenticated" USING (("ticket_id" IN ( SELECT "tickets"."id"
   FROM "public"."tickets"
  WHERE ("tickets"."user_id" = ( SELECT "auth"."uid"() AS "uid")))));
...
CREATE POLICY "tickets_user_insert" ON "public"."tickets" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "tickets_user_select" ON "public"."tickets" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "tickets_user_update" ON "public"."tickets" FOR UPDATE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "user_coupons_user_delete" ON "public"."user_coupons" FOR DELETE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "user_coupons_user_insert" ON "public"."user_coupons" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "user_coupons_user_select" ON "public"."user_coupons" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "user_coupons_user_update" ON "public"."user_coupons" FOR UPDATE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "user_favorites_user_delete" ON "public"."user_favorites" FOR DELETE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "user_favorites_user_insert" ON "public"."user_favorites" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "user_favorites_user_select" ON "public"."user_favorites" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "wallet_transactions_user_select" ON "public"."wallet_transactions" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "wechat_sessions_anon" ON "public"."wechat_login_sessions" TO "anon" USING (true) WITH CHECK (true);



CREATE POLICY "wechat_sessions_authenticated" ON "public"."wechat_login_sessions" TO "authenticated" USING (true) WITH CHECK (true);
...
GRANT ALL ON FUNCTION "public"."admin_cleanup_ticket_images"("p_days_old" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."admin_cleanup_ticket_images"("p_days_old" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_cleanup_ticket_images"("p_days_old" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."admin_review_refund"("p_request_id" "uuid", "p_approved" boolean, "p_refund_amount" numeric, "p_admin_note" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."admin_review_refund"("p_request_id" "uuid", "p_approved" boolean, "p_refund_amount" numeric, "p_admin_note" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_review_refund"("p_request_id" "uuid", "p_approved" boolean, "p_refund_amount" numeric, "p_admin_note" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."cancel_user_refund_request"("p_order_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."cancel_user_refund_request"("p_order_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."cancel_user_refund_request"("p_order_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."cleanup_expired_order_fulfillments"() TO "anon";
GRANT ALL ON FUNCTION "public"."cleanup_expired_order_fulfillments"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."cleanup_expired_order_fulfillments"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."cleanup_old_expired_preorders"() TO "anon";
GRANT ALL ON FUNCTION "public"."cleanup_old_expired_preorders"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."cleanup_old_expired_preorders"() TO "service_role";



GRANT ALL ON FUNCTION "public"."cleanup_unverified_users"() TO "anon";
GRANT ALL ON FUNCTION "public"."cleanup_unverified_users"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."create_refund_request"("p_order_id" "uuid", "p_reason" "text", "p_reason_detail" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_refund_request"("p_order_id" "uuid", "p_reason" "text", "p_reason_detail" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_refund_request"("p_order_id" "uuid", "p_reason" "text", "p_reason_detail" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_renewal_pre_order"("p_sku_id" "uuid", "p_old_order_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."create_renewal_pre_order"("p_sku_id" "uuid", "p_old_order_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_renewal_pre_order"("p_sku_id" "uuid", "p_old_order_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_ticket"("p_order_id" "uuid", "p_title" "text", "p_content" "text", "p_priority" "text", "p_attachments" "text"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."create_ticket"("p_order_id" "uuid", "p_title" "text", "p_content" "text", "p_priority" "text", "p_attachments" "text"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_ticket"("p_order_id" "uuid", "p_title" "text", "p_content" "text", "p_priority" "text", "p_attachments" "text"[]) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."expire_active_orders"() TO "anon";
GRANT ALL ON FUNCTION "public"."expire_active_orders"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."expire_active_orders"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_order_refund_info"("p_order_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_order_refund_info"("p_order_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_order_refund_info"("p_order_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_refund_request"("p_order_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_refund_request"("p_order_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_refund_request"("p_order_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_renewal_skus"("p_order_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_renewal_skus"("p_order_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_renewal_skus"("p_order_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_notification_enabled"("config_key" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."is_notification_enabled"("config_key" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_notification_enabled"("config_key" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."resolve_channel_key"("p_channel_key" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."resolve_channel_key"("p_channel_key" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."resolve_channel_key"("p_channel_key" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."resolve_ticket"("p_ticket_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."resolve_ticket"("p_ticket_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."resolve_ticket"("p_ticket_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."send_auto_message"("p_user_id" "uuid", "p_title" "text", "p_content" "text", "p_type" "text", "p_link" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."send_auto_message"("p_user_id" "uuid", "p_title" "text", "p_content" "text", "p_type" "text", "p_link" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."send_auto_message"("p_user_id" "uuid", "p_title" "text", "p_content" "text", "p_type" "text", "p_link" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."send_ticket_message"("p_ticket_id" "uuid", "p_content" "text", "p_attachments" "text"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."send_ticket_message"("p_ticket_id" "uuid", "p_content" "text", "p_attachments" "text"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."send_ticket_message"("p_ticket_id" "uuid", "p_content" "text", "p_attachments" "text"[]) TO "service_role";



GRANT ALL ON FUNCTION "public"."set_ticket_no"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_ticket_no"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_ticket_no"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."trigger_notify_balance_change"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_notify_balance_change"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trigger_notify_balance_change"() TO "service_role";



GRANT ALL ON FUNCTION "public"."trigger_notify_coupon_insert"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_notify_coupon_insert"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trigger_notify_coupon_insert"() TO "service_role";



GRANT ALL ON FUNCTION "public"."trigger_notify_fulfillment_update"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_notify_fulfillment_update"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trigger_notify_fulfillment_update"() TO "service_role";



GRANT ALL ON FUNCTION "public"."trigger_notify_order_created"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_notify_order_created"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trigger_notify_order_created"() TO "service_role";



GRANT ALL ON FUNCTION "public"."trigger_notify_order_status"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_notify_order_status"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trigger_notify_order_status"() TO "service_role";



GRANT ALL ON FUNCTION "public"."trigger_notify_ticket_reply"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_notify_ticket_reply"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trigger_notify_ticket_reply"() TO "service_role";
...
GRANT ALL ON TABLE "public"."channel_recognitions" TO "anon";
GRANT ALL ON TABLE "public"."channel_recognitions" TO "authenticated";
GRANT ALL ON TABLE "public"."channel_recognitions" TO "service_role";
...
GRANT ALL ON TABLE "public"."recharge_orders" TO "anon";
GRANT ALL ON TABLE "public"."recharge_orders" TO "authenticated";
...
GRANT ALL ON TABLE "public"."wechat_login_sessions" TO "anon";
GRANT ALL ON TABLE "public"."wechat_login_sessions" TO "authenticated";
GRANT ALL ON TABLE "public"."wechat_login_sessions" TO "service_role";
