...
/* Pending */
.order-card.status-pending .status-line { background: var(--color-accent); box-shadow: 0 0 10px rgba(249, 115, 22, 0.4); }
.status-pill.pending { color: var(--color-accent); background: rgba(249, 115, 22, 0.1); border: 1px solid rgba(249, 115, 22, 0.2); }
