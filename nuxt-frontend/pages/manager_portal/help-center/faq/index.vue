<template>
  <div class="admin-page">
    ...
    <AdminActionCard>
      <el-button type="primary" :icon="Plus" @click="$router.push('/manager_portal/help-center/faq/post')">添加问题</el-button>
    </AdminActionCard>
    ...
    >
        ...
        <el-table-column label="操作" width="180" align="center" fixed="right">
          <template #default="{ row }">
            <el-button type="primary" link size="small" @click="$router.push(`/manager_portal/help-center/faq/post?id=${row.id}`)">
              编辑
            </el-button>
