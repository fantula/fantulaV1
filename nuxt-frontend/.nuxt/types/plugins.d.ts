...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../plugins/auth.listener.client")> &
  InjectionType<typeof import("../../plugins/axios")> &
  InjectionType<typeof import("../../plugins/directives")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt-site-config:init' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'pinia' | 'nuxt:global-components' | 'nuxt:prefetch'
  }
}
