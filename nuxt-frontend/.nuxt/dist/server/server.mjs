import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, ref, markRaw, isRef, isReactive, toRaw, nextTick, onScopeDispose, watch, toRefs, computed, readonly, shallowRef, isReadonly, isShallow, defineComponent, createElementBlock, provide, cloneVNode, h, resolveComponent, unref, Suspense, Fragment, warn, openBlock, mergeProps, renderSlot, useSSRContext, createElementVNode, normalizeClass, createVNode, Transition, withCtx, withDirectives, normalizeStyle, createTextVNode, toDisplayString, vShow, createBlock, createCommentVNode, resolveDynamicComponent, withModifiers, isVNode, render, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
import { $fetch } from "/Users/dalin/fantula/nuxt-frontend/node_modules/ofetch/dist/node.mjs";
...
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie } from "/Users/dalin/fantula/nuxt-frontend/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "/Users/dalin/fantula/nuxt-frontend/node_modules/radix3/dist/index.mjs";
import { defu } from "/Users/dalin/fantula/nuxt-frontend/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "/Users/dalin/fantula/nuxt-frontend/node_modules/ufo/dist/index.mjs";
import { createClient } from "@supabase/supabase-js";
import { klona } from "/Users/dalin/fantula/nuxt-frontend/node_modules/klona/dist/index.mjs";
import { isClient, computedEager, useEventListener, useResizeObserver, useTimeoutFn } from "@vueuse/core";
import { isString as isString$1, isArray as isArray$1, isObject as isObject$1, hasOwn, camelize, NOOP, isFunction as isFunction$2 } from "@vue/shared";
import { isNil, fromPairs, set as set$1, get, isEqual as isEqual$1 } from "lodash-unified";
...
import { parse } from "/Users/dalin/fantula/nuxt-frontend/node_modules/cookie-es/dist/index.mjs";
...
import { ssrRenderAttrs, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderComponent, ssrLooseContain, ssrRenderStyle, ssrRenderTeleport, ssrRenderSlot, ssrRenderVNode, ssrRenderSuspense } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "faq",
    path: "/faq",
    component: () => import("./_nuxt/faq-B1d3CfEx.js")
  },
  {
    name: "id",
    path: "/:id()",
    component: () => import("./_nuxt/_id_-BQGZIfw_.js")
  },
  {
    name: "cart",
    path: "/cart",
    component: () => import("./_nuxt/cart-B3bx4XpX.js")
  },
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-Dafc6TM9.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CdB734IG.js")
  },
  {
    name: "policy",
    path: "/policy",
    component: () => import("./_nuxt/policy-D0w2fO4v.js")
  },
  {
    name: "refund",
    path: "/refund",
    component: () => import("./_nuxt/refund-DI7b9Vv6.js")
  },
  {
    name: "company",
    path: "/company",
    component: () => import("./_nuxt/company-C5shCCox.js")
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-Ce8LSQLB.js")
  },
  {
    name: "privacy",
    path: "/privacy",
    component: () => import("./_nuxt/privacy-CqmYoMoT.js")
  },
  {
    name: __nuxt_page_meta$A?.name,
    path: "/profile",
    component: () => import("./_nuxt/profile-B9UKXqIB.js"),
    children: [
      {
        name: "profile",
        path: "",
        component: () => import("./_nuxt/index-Bw0sIbIb.js")
      },
      {
        name: "profile-wallet",
        path: "wallet",
        component: () => import("./_nuxt/wallet-B2ooliuK.js")
      },
      {
        name: "profile-tickets",
        path: "tickets",
        component: () => import("./_nuxt/tickets-VcvNI0l7.js")
      },
      {
        name: "profile-exchange",
        path: "exchange",
        component: () => import("./_nuxt/exchange-KPAOmvua.js")
      },
      {
        name: "profile-messages",
        path: "messages",
        component: () => import("./_nuxt/messages-H5pbhYcv.js")
      },
      {
        name: "profile-referral",
        path: "referral",
        component: () => import("./_nuxt/referral-CXlLgOio.js")
      },
      {
        name: "profile-favorites",
        path: "favorites",
        component: () => import("./_nuxt/favorites-CPIQFUaX.js")
      },
      {
        name: "profile-order-id",
        path: "order/:id()",
        meta: __nuxt_page_meta$C || {},
        component: () => import("./_nuxt/_id_-BmMX4F2y.js")
      },
      {
        name: "profile-order",
        path: "order",
        meta: __nuxt_page_meta$B || {},
        component: () => import("./_nuxt/index-BZhUBU5A.js")
      }
    ]
  },
  {
    name: "service",
    path: "/service",
    component: () => import("./_nuxt/service-CW-Bx9iI.js")
  },
  {
    name: "about-us",
    path: "/about-us",
    component: () => import("./_nuxt/about-us-CapKEiF5.js")
  },
  {
    name: "community",
    path: "/community",
    component: () => import("./_nuxt/community-CyTjc0rg.js")
  },
  {
    name: "disclaimer",
    path: "/disclaimer",
    component: () => import("./_nuxt/disclaimer-CCcKpb_T.js")
  },
  {
    name: "goods-id",
    path: "/goods/:id()",
    component: () => import("./_nuxt/_id_-DeMxHHiA.js")
  },
  {
    name: __nuxt_page_meta$1?.name,
    path: "/_mgmt_9Xfa3",
    component: () => import("./_nuxt/_mgmt_9Xfa3--kAluYQM.js"),
    children: [
      {
        name: __nuxt_page_meta$v?.name,
        path: "cdk",
        component: () => import("./_nuxt/cdk-EnZN4ieC.js"),
        children: [
          {
            name: "_mgmt_9Xfa3-cdk-cdks",
            path: "cdks",
            component: () => import("./_nuxt/cdks-DYwHvdnx.js")
          },
          {
            name: "_mgmt_9Xfa3-cdk-keys",
            path: "keys",
            meta: __nuxt_page_meta$z || {},
            component: () => import("./_nuxt/keys-B_fXYAmV.js")
          },
          {
            name: "_mgmt_9Xfa3-cdk-post",
            path: "post",
            component: () => import("./_nuxt/post-CqqH5X0N.js")
          },
          {
            name: "_mgmt_9Xfa3-cdk-debug",
            path: "debug",
            component: () => import("./_nuxt/debug-DZf9t1eR.js")
          },
          {
            name: "_mgmt_9Xfa3-cdk",
            path: "",
            meta: __nuxt_page_meta$y || {},
            component: () => import("./_nuxt/index-Qnq5wXns.js")
          },
          {
            name: "_mgmt_9Xfa3-cdk-virtual",
            path: "virtual",
            meta: __nuxt_page_meta$x || {},
            component: () => import("./_nuxt/virtual-B_nYnTsU.js")
          },
          {
            name: "_mgmt_9Xfa3-cdk-accounts",
            path: "accounts",
            meta: __nuxt_page_meta$w || {},
            component: () => import("./_nuxt/accounts-DaZYCU5I.js")
          },
          {
            name: "_mgmt_9Xfa3-cdk-edit-id",
            path: "edit/:id()",
            component: () => import("./_nuxt/_id_-CGIXBHjC.js")
          }
        ]
      },
      {
        ...
        component: () => import("./_nuxt/index-6S3h3Htr.js")
      },
      {
        name: "_mgmt_9Xfa3-login",
        path: "login",
        meta: __nuxt_page_meta$t || {},
        component: () => import("./_nuxt/login-DHYdf6uF.js")
      },
      {
        name: __nuxt_page_meta$r?.name,
        path: "media",
        component: () => import("./_nuxt/media-DDcD1UDt.js"),
        children: [
          {
            name: "_mgmt_9Xfa3-media",
            path: "",
            component: () => import("./_nuxt/index-D8dffWAm.js")
          },
          {
            name: "_mgmt_9Xfa3-media-images",
            path: "images",
            component: () => import("./_nuxt/images-DWx0AUSH.js")
          },
          {
            name: "_mgmt_9Xfa3-media-banners",
            path: "banners",
            meta: __nuxt_page_meta$s || {},
            component: () => import("./_nuxt/banners-BWnBdaKR.js")
          }
        ]
      },
      {
        ...
        path: "users",
        component: () => import("./_nuxt/users-D7dUk3Aa.js"),
        children: [
          {
            name: "_mgmt_9Xfa3-users",
            path: "",
            meta: __nuxt_page_meta$q || {},
            component: () => import("./_nuxt/index-C-Ea41kP.js")
          },
          {
            name: "_mgmt_9Xfa3-users-accounts",
            path: "accounts",
            meta: __nuxt_page_meta$p || {},
            component: () => import("./_nuxt/index-BeyraRO8.js")
          },
          {
            name: "_mgmt_9Xfa3-users-departments",
            path: "departments",
            meta: __nuxt_page_meta$o || {},
            component: () => import("./_nuxt/index-UBUsDtHS.js")
          }
        ]
      },
      {
        ...
        path: "orders",
        component: () => import("./_nuxt/orders-Dipj1ssh.js"),
        children: [
          {
            name: "_mgmt_9Xfa3-orders-cdkey",
            path: "cdkey",
            meta: __nuxt_page_meta$m || {},
            component: () => import("./_nuxt/index-BBPNw4s_.js")
          },
          {
            name: "_mgmt_9Xfa3-orders-share",
            path: "share",
            meta: __nuxt_page_meta$l || {},
            component: () => import("./_nuxt/index-CE_ce1UJ.js")
          },
          {
            name: "_mgmt_9Xfa3-orders-cdkey-detail",
            path: "cdkey/detail",
            component: () => import("./_nuxt/detail-eWJCKUr7.js")
          },
          {
            name: "_mgmt_9Xfa3-orders-refund",
            path: "refund",
            meta: __nuxt_page_meta$k || {},
            component: () => import("./_nuxt/index-BZTIVZRx.js")
          },
          {
            name: "_mgmt_9Xfa3-orders-share-detail",
            path: "share/detail",
            component: () => import("./_nuxt/detail-Cw_aGZrF.js")
          },
          {
            name: "_mgmt_9Xfa3-orders-recharge",
            path: "recharge",
            meta: __nuxt_page_meta$j || {},
            component: () => import("./_nuxt/index-Cbxj_iPe.js")
          },
          {
            name: "_mgmt_9Xfa3-orders-preorders",
            path: "preorders",
            meta: __nuxt_page_meta$i || {},
            component: () => import("./_nuxt/index-CD7ZDQ0f.js")
          },
          {
            name: "_mgmt_9Xfa3-orders-recharge-detail",
            path: "recharge/detail",
            component: () => import("./_nuxt/detail-BR1d1RBF.js")
          },
          {
            name: "_mgmt_9Xfa3-orders-cancelled-refunds",
            path: "cancelled-refunds",
            meta: __nuxt_page_meta$h || {},
            component: () => import("./_nuxt/index-DPzIHOE-.js")
          }
        ]
      },
      {
        ...
        path: "coupons",
        component: () => import("./_nuxt/coupons-1rxxPizg.js"),
        children: [
          {
            name: "_mgmt_9Xfa3-coupons",
            path: "",
            component: () => import("./_nuxt/index-DkaRZdkg.js")
          },
          {
            name: "_mgmt_9Xfa3-coupons-flat-post",
            path: "flat/post",
            component: () => import("./_nuxt/post-IXg0RdqS.js")
          },
          {
            name: "_mgmt_9Xfa3-coupons-flat",
            path: "flat",
            component: () => import("./_nuxt/index-BcDD6Dtx.js")
          },
          {
            name: "_mgmt_9Xfa3-coupons-stats",
            path: "stats",
            component: () => import("./_nuxt/index-BOPc54D6.js")
          },
          {
            name: "_mgmt_9Xfa3-coupons-balance-post",
            path: "balance/post",
            component: () => import("./_nuxt/post-C86zZuxa.js")
          },
          {
            name: "_mgmt_9Xfa3-coupons-product-post",
            path: "product/post",
            component: () => import("./_nuxt/post-DWLyqUjF.js")
          },
          {
            name: "_mgmt_9Xfa3-coupons-balance",
            path: "balance",
            component: () => import("./_nuxt/index-Se-b_hRa.js")
          },
          {
            name: "_mgmt_9Xfa3-coupons-product",
            path: "product",
            component: () => import("./_nuxt/index-fzi4nC9r.js")
          }
        ]
      },
      {
        ...
        path: "faq/post",
        component: () => import("./_nuxt/post-CCI39wE9.js")
      },
      {
        name: __nuxt_page_meta$b?.name,
        path: "products",
        component: () => import("./_nuxt/products-Bcl54yLS.js"),
        children: [
          {
            name: "_mgmt_9Xfa3-products-post",
            path: "post",
            meta: __nuxt_page_meta$f || {},
            component: () => import("./_nuxt/post-BPTaom9z.js")
          },
          {
            name: "_mgmt_9Xfa3-products-skus",
            path: "skus",
            component: () => import("./_nuxt/skus-DXFjVCex.js")
          },
          {
            name: "_mgmt_9Xfa3-products",
            path: "",
            meta: __nuxt_page_meta$e || {},
            component: () => import("./_nuxt/index-tnRVnrFX.js")
          },
          {
            name: "_mgmt_9Xfa3-products-sku-id",
            path: "sku/:id()",
            component: () => import("./_nuxt/_id_-1CGK7MJb.js")
          },
          {
            name: "_mgmt_9Xfa3-products-categories",
            path: "categories",
            meta: __nuxt_page_meta$d || {},
            component: () => import("./_nuxt/categories-BJoiUj_8.js")
          },
          {
            name: "_mgmt_9Xfa3-products-shared-sku",
            path: "shared-sku",
            meta: __nuxt_page_meta$c || {},
            component: () => import("./_nuxt/shared-sku-DY5SD9Sr.js")
          }
        ]
      },
      {
        ...
        path: "recharge",
        component: () => import("./_nuxt/recharge-DWE4vCcH.js"),
        children: [
          {
            name: "_mgmt_9Xfa3-recharge",
            path: "",
            meta: __nuxt_page_meta$a || {},
            component: () => import("./_nuxt/index-CBAYSvu3.js")
          },
          {
            name: "_mgmt_9Xfa3-recharge-tiers",
            path: "tiers",
            component: () => import("./_nuxt/tiers-DTyqpu_x.js")
          },
          {
            name: "_mgmt_9Xfa3-recharge-orders",
            path: "orders",
            component: () => import("./_nuxt/orders-6oQDuOQH.js")
          }
        ]
      },
      {
        ...
        path: "faq",
        component: () => import("./_nuxt/index-BSQEsBJC.js")
      },
      {
        name: __nuxt_page_meta$8?.name,
        path: "help-center",
        component: () => import("./_nuxt/help-center-CFV5svYP.js"),
        children: [
          {
            name: "_mgmt_9Xfa3-help-center-faq",
            path: "faq",
            component: () => import("./_nuxt/faq-BJ7RB-iQ.js"),
            children: [
              {
                name: "_mgmt_9Xfa3-help-center-faq-post",
                path: "post",
                component: () => import("./_nuxt/post-CxB1OAdi.js")
              }
            ]
          },
          {
            ...
            path: "",
            component: () => import("./_nuxt/index-COdo_xnW.js")
          },
          {
            name: "_mgmt_9Xfa3-help-center-articles",
            path: "articles",
            component: () => import("./_nuxt/articles-CUzQDGRf.js"),
            children: [
              {
                name: "_mgmt_9Xfa3-help-center-articles-post",
                path: "post",
                component: () => import("./_nuxt/post-BQ21BMZ_.js")
              }
            ]
          },
          {
            ...
            path: "faq-categories",
            component: () => import("./_nuxt/faq-categories-CxKTEnwZ.js")
          },
          {
            name: "_mgmt_9Xfa3-help-center-article-categories",
            path: "article-categories",
            component: () => import("./_nuxt/article-categories-2WXsiF2z.js")
          }
        ]
      },
      {
        ...
        path: "article/post",
        component: () => import("./_nuxt/post-DIGtBYuJ.js")
      },
      {
        name: "_mgmt_9Xfa3-faq-category",
        path: "faq/category",
        component: () => import("./_nuxt/category-DH7p9iRI.js")
      },
      {
        name: "_mgmt_9Xfa3-images",
        path: "images",
        meta: __nuxt_page_meta$7 || {},
        component: () => import("./_nuxt/index-BJ-NxF7C.js")
      },
      {
        name: "_mgmt_9Xfa3-article",
        path: "article",
        component: () => import("./_nuxt/index-BQIj21bO.js")
      },
      {
        name: "_mgmt_9Xfa3-banners",
        path: "banners",
        meta: __nuxt_page_meta$6 || {},
        component: () => import("./_nuxt/index-CjnNa-q7.js")
      },
      {
        name: "_mgmt_9Xfa3-refunds",
        path: "refunds",
        meta: __nuxt_page_meta$5 || {},
        component: () => import("./_nuxt/index-BVik5JWj.js")
      },
      {
        name: "_mgmt_9Xfa3-tickets",
        path: "tickets",
        component: () => import("./_nuxt/index-6L1kOSdi.js")
      },
      {
        name: "_mgmt_9Xfa3-messages",
        path: "messages",
        meta: __nuxt_page_meta$4 || {},
        component: () => import("./_nuxt/index-Dct6vo3M.js")
      },
      {
        name: __nuxt_page_meta$2?.name,
        path: "backend-settings",
        component: () => import("./_nuxt/backend-settings-DHK8a8YI.js"),
        children: [
          {
            name: "_mgmt_9Xfa3-backend-settings",
            path: "",
            meta: __nuxt_page_meta$3 || {},
            component: () => import("./_nuxt/index-BbbO9_Bi.js")
          },
          {
            name: "_mgmt_9Xfa3-backend-settings-storage",
            path: "storage",
            component: () => import("./_nuxt/storage-DgFfIUZf.js")
          },
          {
            name: "_mgmt_9Xfa3-backend-settings-scheduler",
            path: "scheduler",
            component: () => import("./_nuxt/scheduler-BuB-Aqri.js")
          }
        ]
      },
      {
        ...
        path: "article/categories",
        component: () => import("./_nuxt/categories-DGTxmuNE.js")
      },
      {
        name: "_mgmt_9Xfa3-tickets-components-TicketChatModal",
        path: "tickets/components/TicketChatModal",
        component: () => import("./_nuxt/TicketChatModal-B0_FVH8D.js").then((n) => n.b)
      }
    ]
  },
  {
    name: "article-id",
    path: "/article/:id()",
    component: () => import("./_nuxt/_id_-iC7TssmB.js")
  },
  {
    name: "checkout-id",
    path: "/checkout/:id()",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/_id_-DLoHkiHq.js")
  },
  {
    name: "support-refund-create",
    path: "/support/refund/create",
    component: () => import("./_nuxt/create-Bbz2fR_0.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BxdnpjH4.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Dq_z2JLl.js"));
...
export {
  ...
  isUndefined$1 as A,
  withInstall as B,
  withNoopInstall as C,
  definePropType as D,
  ElIcon as E,
  mutable as F,
  scale_to_original_default as G,
  full_screen_default as H,
  useZIndex as I,
  close_default as J,
  zoom_out_default as K,
  zoom_in_default as L,
  refresh_left_default as M,
  refresh_right_default as N,
  keysOf as O,
  isElement as P,
  isWindow as Q,
  picture_filled_default as R,
  useId as S,
  addUnit as T,
  getStyle as U,
  getEventCode as V,
  ...
  money_default as a0,
  guide_default as a1,
  warning_default as a2,
  info_filled_default as a3,
  user_default as a4,
  wallet_default as a5,
  list_default as a6,
  ticket_default as a7,
  star_default as a8,
  bell_default as a9,
  select_default as aA,
  _imports_1 as aB,
  lightning_default as aC,
  top_default as aD,
  bottom_default as aE,
  buildProp as aF,
  isBoolean$1 as aG,
  composeEventHandlers as aH,
  useGetDerivedNamespace as aI,
  useIdInjection as aJ,
  view_default as aK,
  useGlobalComponentSettings as aL,
  removeClass as aM,
  clock_default as aN,
  right_default as aO,
  chat_dot_round_default as aP,
  shopping_cart_default as aQ,
  componentSizes as aR,
  d_arrow_left_default as aS,
  more_filled_default as aT,
  d_arrow_right_default as aU,
  useEmptyValues as aV,
  ValidateComponentsMap as aW,
  isEmpty as aX,
  useEmptyValuesProps as aY,
  arrow_down_default as aZ,
  circle_close_default as a_,
  switch_button_default as aa,
  __nuxt_component_0 as ab,
  authApi as ac,
  BaseModal as ad,
  user_filled_default as ae,
  upload_default as af,
  check_default as ag,
  ElMessage as ah,
  SendCodeButton as ai,
  EmailInput as aj,
  setInterval as ak,
  camera_default as al,
  circle_check_default as am,
  edit_default as an,
  credit_card_default as ao,
  copy_document_default as ap,
  message_default as aq,
  edit_pen_default as ar,
  lock_default as as,
  key_default as at,
  connection_default as au,
  useGlobalConfig as av,
  iconPropType as aw,
  useSizeProp as ax,
  useGlobalSize as ay,
  present_default as az,
  useRoute as b,
  iconProps as b$,
  hide_default as b0,
  star_filled_default as b1,
  operation_default as b2,
  files_default as b3,
  document_add_default as b4,
  box_default as b5,
  timer_default as b6,
  headset_default as b7,
  tickets_default as b8,
  refresh_default as b9,
  cpu_default as bA,
  circle_check_filled_default as bB,
  getEventKey as bC,
  CloseComponents as bD,
  defaultNamespace as bE,
  warning_filled_default as bF,
  entriesOf as bG,
  folder_remove_default as bH,
  folder_default as bI,
  search_default as bJ,
  calendar_default as bK,
  magic_stick_default as bL,
  document_copy_default as bM,
  rank_default as bN,
  video_pause_default as bO,
  caret_right_default as bP,
  back_default as bQ,
  withInstallDirective as bR,
  circle_close_filled_default as bS,
  sort_up_default as bT,
  sort_down_default as bU,
  badgeProps as bV,
  ElBadge as bW,
  messageConfig as bX,
  configProviderProps as bY,
  configProviderContextKey as bZ,
  provideGlobalConfig as b_,
  picture_default as ba,
  delete_default as bb,
  video_play_default as bc,
  useNuxtApp as bd,
  asyncDataDefaults as be,
  createError as bf,
  useAdminStore as bg,
  setting_default as bh,
  collection_default as bi,
  question_filled_default as bj,
  goods_default as bk,
  odometer_default as bl,
  expand_default as bm,
  fold_default as bn,
  sunny_default as bo,
  moon_default as bp,
  whenMouse as bq,
  more_default as br,
  isPropAbsent as bs,
  __nuxt_component_0$2 as bt,
  TypeComponentsMap as bu,
  TypeComponents as bv,
  getProp as bw,
  arrow_up_default as bx,
  getAdminSupabaseClient as by,
  minus_default as bz,
  __nuxt_component_2$1 as c,
  MESSAGE_DEFAULT_PLACEMENT as c0,
  messageDefaults as c1,
  messageEmits as c2,
  messagePlacement as c3,
  messageProps as c4,
  messageTypes as c5,
  buildLocaleContext as c6,
  buildTranslator as c7,
  localeContextKey as c8,
  translate as c9,
  ID_INJECTION_KEY as ca,
  namespaceContextKey as cb,
  ZINDEX_INJECTION_KEY as cc,
  defaultInitialZIndex as cd,
  zIndexContextKey as ce,
  SIZE_INJECTION_KEY as cf,
  DEFAULT_EMPTY_VALUES as cg,
  DEFAULT_VALUE_ON_CLEAR as ch,
  SCOPE as ci,
  emptyValuesContextKey as cj,
  getAuthToken as ck,
  EDGE_FUNCTIONS_URL as cl,
  supabaseAdmin as cm,
  supabase as cn,
  useUserStore as d,
  ...
  callEdgeFunction as k,
  loading_default as l,
  monitor_default as m,
  navigateTo as n,
  getSupabaseClient as o,
  plus_default as p,
  buildProps as q,
  isNumber$1 as r,
  service_default as s,
  tryUseNuxtApp as t,
  useModalStore as u,
  debugWarn as v,
  _export_sfc$1 as w,
