import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, nextTick, onScopeDispose, watch, toRefs, computed, defineComponent, createElementBlock, provide, cloneVNode, h, unref, mergeProps, useSSRContext, defineAsyncComponent, Suspense, Fragment, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/dalin/fantula/nuxt-frontend/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/dalin/fantula/nuxt-frontend/node_modules/hookable/dist/index.mjs";
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import("./_nuxt/policy-cfPGrPtA.js")
  },
  {
    name: "pc-refund",
    path: "/pc/refund",
    meta: __nuxt_page_meta$1E || {},
    component: () => import("./_nuxt/refund-DmpKrYYP.js")
  },
  {
    name: "pc-company",
    path: "/pc/company",
    meta: __nuxt_page_meta$1D || {},
    component: () => import("./_nuxt/company-CfwD8NuR.js")
  },
  {
    name: "pc-contact",
    path: "/pc/contact",
    meta: __nuxt_page_meta$1C || {},
    component: () => import("./_nuxt/contact-A7OtRbSU.js")
  },
  {
    name: "pc-join-us",
    path: "/pc/join-us",
    meta: __nuxt_page_meta$1B || {},
    component: () => import("./_nuxt/join-us-BWOnZuFu.js")
  },
  {
    name: "pc-privacy",
    path: "/pc/privacy",
    meta: __nuxt_page_meta$1A || {},
    component: () => import("./_nuxt/privacy-BX8WOKcW.js")
  },
  {
    name: __nuxt_page_meta$1r?.name,
    path: "/pc/profile",
    meta: __nuxt_page_meta$1r || {},
    component: () => import("./_nuxt/profile-l8Jk7fEa.js"),
    children: [
      {
        name: "pc-profile",
        path: "",
        meta: __nuxt_page_meta$1z || {},
        component: () => import("./_nuxt/index-CD_maZea.js")
      },
      {
        name: "pc-profile-wallet",
        path: "wallet",
        meta: __nuxt_page_meta$1y || {},
        component: () => import("./_nuxt/wallet-G1wXQXy1.js")
      },
      {
        name: "pc-profile-tickets",
        path: "tickets",
        meta: __nuxt_page_meta$1x || {},
        component: () => import("./_nuxt/tickets-B7ourJ6x.js")
      },
      {
        name: "pc-profile-exchange",
        path: "exchange",
        meta: __nuxt_page_meta$1w || {},
        component: () => import("./_nuxt/exchange-jFDJhYXe.js")
      },
      {
        name: "pc-profile-messages",
        path: "messages",
        meta: __nuxt_page_meta$1v || {},
        component: () => import("./_nuxt/messages-D58gtHUK.js")
      },
      {
        name: "pc-profile-favorites",
        path: "favorites",
        meta: __nuxt_page_meta$1u || {},
        component: () => import("./_nuxt/favorites-DRFQ3ncr.js")
      },
      {
        name: "pc-profile-order-id",
        path: "order/:id()",
        meta: __nuxt_page_meta$1t || {},
        component: () => import("./_nuxt/_id_-BqlERYJL.js")
      },
      {
        name: "pc-profile-order",
        path: "order",
        meta: __nuxt_page_meta$1s || {},
        component: () => import("./_nuxt/index-DngAreEh.js")
      }
    ]
  },
  {
    ...
    path: "/pc/service",
    meta: __nuxt_page_meta$1q || {},
    component: () => import("./_nuxt/service-CCx0IqB6.js")
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta$1p || {}, ...{ "middleware": ["mgmt-auth"] } },
    component: () => import("./_nuxt/index-DAvimfin.js")
  },
  {
    name: "admin-login",
    path: "/admin/login",
    meta: { ...__nuxt_page_meta$1o || {}, ...{ "middleware": ["mgmt-auth"] } },
    component: () => import("./_nuxt/login-CkFNVQJL.js")
  },
  {
    name: __nuxt_page_meta$1k?.name,
    path: "/admin/media",
    meta: { ...__nuxt_page_meta$1k || {}, ...{ "middleware": ["mgmt-auth"] } },
    component: () => import("./_nuxt/media-BlBu2ck6.js"),
    children: [
      {
        name: "admin-media",
        path: "",
        meta: { ...__nuxt_page_meta$1n || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/index-C-5mrMpe.js")
      },
      {
        name: "admin-media-images",
        path: "images",
        meta: { ...__nuxt_page_meta$1m || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/images-Blo_eDN5.js")
      },
      {
        name: "admin-media-banners",
        path: "banners",
        meta: { ...__nuxt_page_meta$1l || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/banners-B3vhvpRi.js")
      }
    ]
  },
  {
    ...
    path: "/admin/users",
    meta: { ...__nuxt_page_meta$1g || {}, ...{ "middleware": ["mgmt-auth"] } },
    component: () => import("./_nuxt/users-CzguXf6s.js"),
    children: [
      {
        name: "admin-users",
        path: "",
        meta: { ...__nuxt_page_meta$1j || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/index-Cip-YTEX.js")
      },
      {
        name: "admin-users-accounts",
        path: "accounts",
        meta: { ...__nuxt_page_meta$1i || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/index-B5yRM0rP.js")
      },
      {
        name: "admin-users-departments",
        path: "departments",
        meta: { ...__nuxt_page_meta$1h || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/index-6ZEZsLf9.js")
      }
    ]
  },
  {
  ...
  },
  {
    ...
    component: () => import("./_nuxt/advantages-DUdSfelR.js")
  },
  {
    name: "pc-disclaimer",
    path: "/pc/disclaimer",
    meta: __nuxt_page_meta$S || {},
    component: () => import("./_nuxt/disclaimer-DByisfso.js")
  },
  {
    name: "pc-goods-id",
    path: "/pc/goods/:id()",
    meta: __nuxt_page_meta$R || {},
    component: () => import("./_nuxt/_id_-CJKx-3Lg.js")
  },
  {
    name: __nuxt_page_meta$N?.name,
    path: "/admin/messages",
    meta: { ...__nuxt_page_meta$N || {}, ...{ "middleware": ["mgmt-auth"] } },
    component: () => import("./_nuxt/messages-D_T2_DRc.js"),
    children: [
      {
        name: "admin-messages",
        path: "",
        meta: __nuxt_page_meta$Q || {},
        component: () => import("./_nuxt/index-e3kmf1HS.js")
      },
      {
        name: "admin-messages-settings",
        path: "settings",
        meta: { ...__nuxt_page_meta$P || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/settings-DqaKVuYn.js")
      },
      {
        name: "admin-messages-batch-send",
        path: "batch-send",
        meta: { ...__nuxt_page_meta$O || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/batch-send-Bi7G0kjm.js")
      }
    ]
  },
  {
  ...
  },
  {
    ...
    component: () => import("./_nuxt/recharge-BIc3u5QJ.js"),
    children: [
      {
        name: "admin-recharge",
        path: "",
        meta: __nuxt_page_meta$F || {},
        component: () => import("./_nuxt/index-CNowTfjV.js")
      },
      {
        name: "admin-recharge-tiers",
        path: "tiers",
        meta: { ...__nuxt_page_meta$E || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/tiers-dwaX70V3.js")
      },
      {
        name: "admin-recharge-orders",
        path: "orders",
        meta: { ...__nuxt_page_meta$D || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/orders-DrlLg_Cw.js")
      }
    ]
  },
  {
  ...
  },
  {
    ...
    component: () => import("./_nuxt/_id_-DxDyGq4F.js")
  },
  {
    name: "pc-checkout-id",
    path: "/pc/checkout/:id()",
    meta: __nuxt_page_meta$o || {},
    component: () => import("./_nuxt/_id_-DyErbQHh.js")
  },
  {
    name: __nuxt_page_meta$g?.name,
    path: "/admin/help-center",
    meta: { ...__nuxt_page_meta$g || {}, ...{ "middleware": ["mgmt-auth"] } },
    component: () => import("./_nuxt/help-center-GU7SAv7d.js"),
    children: [
      {
        name: "admin-help-center",
        path: "",
        meta: { ...__nuxt_page_meta$n || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/index-B24dVYp6.js")
      },
      {
        name: "admin-help-center-articles",
        path: "articles",
        meta: { ...__nuxt_page_meta$l || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/articles-DqUc9NSV.js"),
        children: [
          {
            name: "admin-help-center-articles-post",
            path: "post",
            meta: { ...__nuxt_page_meta$m || {}, ...{ "middleware": ["mgmt-auth"] } },
            component: () => import("./_nuxt/post-Cwigwkg5.js")
          }
        ]
      },
      {
        ...
        path: "faq/post",
        meta: { ...__nuxt_page_meta$k || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/post-B2oV0AML.js")
      },
      {
        name: "admin-help-center-faq",
        path: "faq",
        meta: { ...__nuxt_page_meta$j || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/index-B4uPvHRA.js")
      },
      {
        name: "admin-help-center-faq-categories",
        path: "faq-categories",
        meta: { ...__nuxt_page_meta$i || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/faq-categories-D75cTO0f.js")
      },
      {
        name: "admin-help-center-article-categories",
        path: "article-categories",
        meta: { ...__nuxt_page_meta$h || {}, ...{ "middleware": ["mgmt-auth"] } },
        component: () => import("./_nuxt/article-categories-YswBTopx.js")
      }
    ]
  },
  {
...
const namedMiddleware = {
  "client-auth": () => import("./_nuxt/client-auth-BV6mv_Rm.js"),
  "mgmt-auth": () => import("./_nuxt/mgmt-auth-CBd0K1at.js")
};
...
const layouts = {
  mgmt: defineAsyncComponent(() => import("./_nuxt/mgmt-B96LS5zP.js").then((m) => m.default || m)),
  mobile: defineAsyncComponent(() => import("./_nuxt/mobile-BAQALBbM.js").then((m) => m.default || m)),
  pc: defineAsyncComponent(() => import("./_nuxt/pc-DuI4ndAE.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CaFiwFvH.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DTq_Nb_1.js"));
...
export {
  ...
  isElement as m,
  navigateTo as n,
  namespaceContextKey as o,
  defaultNamespace as p,
  useZIndex as q,
  resolveRouteObject as r,
  defaultInitialZIndex as s,
  tryUseNuxtApp as t,
  useRouter as u,
  useId as v,
  isUndefined$1 as w,
