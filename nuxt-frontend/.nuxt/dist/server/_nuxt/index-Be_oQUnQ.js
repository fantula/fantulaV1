import { defineComponent, ref, computed, watch, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, createTextVNode, Fragment, renderList, createCommentVNode, useSSRContext, withDirectives, withKeys, vModelText, reactive, toDisplayString, vModelCheckbox } from "vue";
import { ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrIncludeBooleanAttr, ssrInterpolate, ssrLooseContain, ssrRenderAttrs, ssrRenderStyle } from "vue/server-renderer";
...
import { R as user_filled_default, Z as upload_default, J as check_default, _ as chat_dot_round_default, $ as connection_default, a0 as select_default, v as refresh_default, a1 as camera_default, a as circle_check_default, a2 as edit_default, a3 as credit_card_default, a4 as copy_document_default, a5 as message_default, a6 as edit_pen_default, a7 as lock_default, a8 as key_default, f as arrow_right_default, P as warning_default } from "./index-4qszPKX4.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.currentEmail && step.value === 1) {
              _push2(`<!--[--><div class="alert-box" data-v-a57fc57b${_scopeId}> 为了您的账号安全，请先验证当前邮箱。 </div><div class="form-group" data-v-a57fc57b${_scopeId}><label class="form-label" data-v-a57fc57b${_scopeId}>当前邮箱</label><input${ssrRenderAttr("value", __props.currentEmail)} class="form-input" disabled data-v-a57fc57b${_scopeId}></div><div class="form-group" data-v-a57fc57b${_scopeId}><label class="form-label" data-v-a57fc57b${_scopeId}>验证码</label><div class="input-with-action" data-v-a57fc57b${_scopeId}><input${ssrRenderAttr("value", oldCode.value)} class="form-input" placeholder="请输入验证码" maxlength="6" data-v-a57fc57b${_scopeId}><button class="send-code-btn"${ssrIncludeBooleanAttr(countdown.value > 0 || loading.value) ? " disabled" : ""} data-v-a57fc57b${_scopeId}>${ssrInterpolate(countdown.value > 0 ? `${countdown.value}s` : "获取验证码")}</button></div></div><div class="step-actions" data-v-a57fc57b${_scopeId}><button class="primary-btn full-width"${ssrIncludeBooleanAttr(loading.value || oldCode.value.length < 4) ? " disabled" : ""} data-v-a57fc57b${_scopeId}> 下一步 </button></div><!--]-->`);
            } else {
              _push2(`<!--[--><div class="form-group" data-v-a57fc57b${_scopeId}><label class="form-label" data-v-a57fc57b${_scopeId}>新邮箱地址</label><input${ssrRenderAttr("value", form.email)} class="form-input" placeholder="请输入新邮箱" type="email" data-v-a57fc57b${_scopeId}></div><div class="form-group" data-v-a57fc57b${_scopeId}><label class="form-label" data-v-a57fc57b${_scopeId}>验证码</label><div class="input-with-action" data-v-a57fc57b${_scopeId}><input${ssrRenderAttr("value", form.code)} class="form-input" placeholder="新邮箱验证码" maxlength="6" data-v-a57fc57b${_scopeId}><button class="send-code-btn"${ssrIncludeBooleanAttr(countdown.value > 0 || loading.value || !isEmailValid.value) ? " disabled" : ""} data-v-a57fc57b${_scopeId}>${ssrInterpolate(countdown.value > 0 ? `${countdown.value}s` : "获取验证码")}</button></div></div><!--]-->`);
            }
          } else {
            return [
              __props.currentEmail && step.value === 1 ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                ...
                createVNode("div", { class: "form-group" }, [
                  ...
                  createVNode("div", { class: "input-with-action" }, [
                    withDirectives(createVNode("input", {
                    ...
                    createVNode("button", {
                      ...
                      onClick: sendOldCode
                    }, toDisplayString(countdown.value > 0 ? `${countdown.value}s` : "获取验证码"), 9, ["disabled"])
                  ])
                ]),
                ...
                createVNode("div", { class: "form-group" }, [
                  ...
                  createVNode("div", { class: "input-with-action" }, [
                    ...
                    createVNode("button", {
                      class: "send-code-btn",
                      disabled: countdown.value > 0 || loading.value || !isEmailValid.value,
                      onClick: sendNewCode
                    }, toDisplayString(countdown.value > 0 ? `${countdown.value}s` : "获取验证码"), 9, ["disabled"])
                  ])
                ])
...
const BindEmailModal = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-a57fc57b"]]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(BaseFormModal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!__props.email) {
              _push2(`<div class="alert-box" data-v-54058262${_scopeId}> 请先绑定邮箱，修改密码需要邮箱验证。 </div>`);
            } else {
              _push2(`<!--[--><div class="form-group" data-v-54058262${_scopeId}><label class="form-label" data-v-54058262${_scopeId}>验证码</label><div class="input-with-action" data-v-54058262${_scopeId}><input${ssrRenderAttr("value", form.code)} class="form-input" placeholder="邮箱验证码" maxlength="6" data-v-54058262${_scopeId}><button class="send-code-btn"${ssrIncludeBooleanAttr(countdown.value > 0 || loading.value) ? " disabled" : ""} data-v-54058262${_scopeId}>${ssrInterpolate(countdown.value > 0 ? `${countdown.value}s` : "发送验证码")}</button></div></div><div class="form-group" data-v-54058262${_scopeId}><label class="form-label" data-v-54058262${_scopeId}>新密码</label><input${ssrRenderAttr("value", form.newPassword)} class="form-input" type="password" placeholder="6-20位字符" data-v-54058262${_scopeId}></div><div class="form-group" data-v-54058262${_scopeId}><label class="form-label" data-v-54058262${_scopeId}>确认密码</label><input${ssrRenderAttr("value", form.confirmPassword)} class="form-input" type="password" placeholder="再次输入新密码" data-v-54058262${_scopeId}></div><!--]-->`);
            }
          } else {
            return [
                ...
                createVNode("div", { class: "form-group" }, [
                  ...
                  createVNode("div", { class: "input-with-action" }, [
                    ...
                    createVNode("button", {
                      ...
                      disabled: countdown.value > 0 || loading.value,
                      onClick: sendCode
                    }, toDisplayString(countdown.value > 0 ? `${countdown.value}s` : "发送验证码"), 9, ["disabled"])
                  ])
                ]),
                createVNode("div", { class: "form-group" }, [
...
const ChangePasswordModal = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-54058262"]]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BaseModal, mergeProps({
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="base-modal-cancel" data-v-52693750${_scopeId}>取消</button><button class="delete-btn"${ssrIncludeBooleanAttr(!isConfirmed.value || !otpCode.value || loading.value) ? " disabled" : ""} data-v-52693750${_scopeId}>${ssrInterpolate(loading.value ? "处理中..." : "确认注销")}</button>`);
          } else {
            return [
              createVNode("button", {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="warning-box" data-v-52693750${_scopeId}><span class="warning-icon" data-v-52693750${_scopeId}>⚠️</span><div class="warning-content" data-v-52693750${_scopeId}> 警告：账号注销是不可恢复的操作。所有个人数据、订单记录和资产将被永久删除。 </div></div><div class="form-group" data-v-52693750${_scopeId}><label class="form-label" data-v-52693750${_scopeId}>邮箱验证</label><div class="captcha-row" data-v-52693750${_scopeId}><input${ssrRenderAttr("value", otpCode.value)} type="text" class="form-input" placeholder="请输入验证码" maxlength="6" inputmode="numeric" autocomplete="off" data-v-52693750${_scopeId}><button class="send-code-btn"${ssrIncludeBooleanAttr(countdown.value > 0 || loading.value) ? " disabled" : ""} data-v-52693750${_scopeId}>${ssrInterpolate(countdown.value > 0 ? `${countdown.value}s后重发` : "获取验证码")}</button></div><p class="form-tip" data-v-52693750${_scopeId}>为了您的资产安全，请验证邮箱: ${ssrInterpolate(__props.email)}</p></div><div class="confirmation-area" data-v-52693750${_scopeId}><label class="checkbox-label" data-v-52693750${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(isConfirmed.value) ? ssrLooseContain(isConfirmed.value, null) : isConfirmed.value) ? " checked" : ""} data-v-52693750${_scopeId}><span data-v-52693750${_scopeId}>我已了解风险，确认注销当前账号</span></label></div>`);
          } else {
            return [
...
const DeleteAccountModal = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-52693750"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    const handleDeleteAccount = async () => {
      try {
        ...
        if (res.success) {
          const { ElMessageBox: ElMessageBox2 } = await import("./index-D7e-Xw6M.js");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="action-card-lg" data-v-b8de3711><div class="card-bg-icon" data-v-b8de3711>🔗</div><div class="card-content" data-v-b8de3711><div class="card-icon-frame purple-frame" data-v-b8de3711>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</div><div class="action-card-lg" data-v-b8de3711><div class="card-bg-icon" data-v-b8de3711>🔗</div><div class="card-content" data-v-b8de3711><div class="card-icon-frame green-frame" data-v-b8de3711>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(connection_default), null, null, _parent2, _scopeId));
...
//# sourceMappingURL=index-Be_oQUnQ.js.map
