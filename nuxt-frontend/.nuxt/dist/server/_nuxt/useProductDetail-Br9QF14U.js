...
import { supabaseProductApi, supabaseFaqApi } from "./supabase-D4dCvdwD.js";
...
import { u as useAsyncData } from "./asyncData-Ca_2pe3n.js";
...
const useProductDetail = (overrideId) => {
  ...
  const checkFavoriteStatus = async () => {
    ...
    const { favoriteApi } = await import("./common-CeIxTI3I.js").then((n) => n.b);
  ...
  const buyNow = async () => {
    ...
    try {
      const { supabasePreOrderApi } = await import("./supabase-D4dCvdwD.js");
...
//# sourceMappingURL=useProductDetail-Br9QF14U.js.map
