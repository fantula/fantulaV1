  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(allSlots.value, (slot) => {
        ...
        _push(`</div><div class="roommate-name" data-v-3cb53c4e>${ssrInterpolate(slot.isMe ? "我" : slot.user?.nickname || "空")}</div><div class="slot-num" data-v-3cb53c4e>${ssrInterpolate(slot.index)}号</div></div>`);
      });
...
//# sourceMappingURL=_id_-CZLXtPpZ.js.map
