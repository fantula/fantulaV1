...
import { t as delete_default, aa as shopping_cart_default, U as star_default, Q as user_default } from "./index-DlETah8a.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.visible) {
        ...
        if (cartItem.value) {
          ...
          _push(`<div class="mc-empty" data-v-b8a6f9bb><div class="empty-icon" data-v-b8a6f9bb>🛒</div><p data-v-b8a6f9bb>空空如也</p></div>`);
        }
        _push(`</div>`);
        if (hasItems.value) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(userStore).isLoggedIn) {
        ...
        if (unref(userStore).loading) {
          ...
          _push(`<!--[--><img${ssrRenderAttr("src", unref(userStore).user?.avatar || "/images/client/pc/avatars/avatar-cat.png")} data-v-ac5558d9><div class="avatar-ring" data-v-ac5558d9></div><!--]-->`);
        }
        _push(`</div>`);
      }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ProductDetailSheet = defineAsyncComponent(() => import("./ProductDetailSheet-BXqgptIL.js"));
    const MobileLoginSheet = defineAsyncComponent(() => import("./MobileLoginSheet-DO0eXnQ-.js"));
    useRouter();
    useRoute();
    useUserStore();
    usePageLoading();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mobile-home-page" }, _attrs))} data-v-8152ba4d>`);
      _push(ssrRenderComponent(HomeHeader, {
        "is-scrolled": isScrolled.value,
        onOpenLogin: ($event) => showLoginSheet.value = true
      }, null, _parent));
      _push(`<div class="content-scroll no-scrollbar" data-v-8152ba4d>`);
      ...
      _push(`<div class="goods-list-section" data-v-8152ba4d>`);
      if (goodsLoading.value && currentGoods.value.length === 0) {
        _push(`<div class="loading-state" data-v-8152ba4d><!--[-->`);
        ssrRenderList(6, (i) => {
          _push(ssrRenderComponent(ProductCardSkeleton, { key: i }, null, _parent));
        });
        _push(`<!--]--></div>`);
      } else if (currentGoods.value.length === 0) {
        _push(`<div class="empty-state bg-glass-card" data-v-8152ba4d><div class="empty-icon" data-v-8152ba4d>📦</div><p class="text-muted text-sm" data-v-8152ba4d>暂无相关商品</p></div>`);
      } else {
        _push(`<div class="goods-list" data-v-8152ba4d><!--[-->`);
      ...
      if (hasMore.value && currentGoods.value.length > 0) {
        _push(`<div class="load-more-trigger" data-v-8152ba4d>`);
        if (isLoadingMore.value) {
          _push(`<div class="loading-more" data-v-8152ba4d><div class="spinner-mini" data-v-8152ba4d></div> 加载更多... </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (!hasMore.value && currentGoods.value.length > 0) {
        _push(`<div class="no-more-data" data-v-8152ba4d> - 到底了 - </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="tab-bar-spacer" data-v-8152ba4d></div></div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8152ba4d"]]);
export {
  index as default
};
//# sourceMappingURL=index-C5aFedzU.js.map
