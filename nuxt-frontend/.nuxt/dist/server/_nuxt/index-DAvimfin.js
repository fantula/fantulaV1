...
import { a8 as top_default, K as money_default, an as goods_default, Q as user_default } from "./index-DlETah8a.js";
import { _ as __nuxt_component_3 } from "./AdminPageSkeleton-DR3UMKim.js";
                    ...
                    _push3(ssrRenderComponent(_component_el_card, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(`<div class="metric-sub" data-v-a62c2c91${_scopeId3}>昨日: ¥${ssrInterpolate(Number(stats.value.yesterday_sales).toFixed(2))}</div></div>`);
                        } else {
                          return [
                            createVNode("div", { class: "metric-content" }, [
                              createVNode(_component_el_statistic, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          ssrRenderList(stats.value.sales_trend, (item, index2) => {
                            _push4(`<div class="bar-group" data-v-a62c2c91${_scopeId3}><div class="bar-col" data-v-a62c2c91${_scopeId3}><div class="bar-val" data-v-a62c2c91${_scopeId3}>¥${ssrInterpolate(item.amount)}</div><div class="bar-fill" style="${ssrRenderStyle({ height: `${calculatePercent(item.amount, maxSalesAmount.value)}%` })}" data-v-a62c2c91${_scopeId3}></div></div><div class="bar-label" data-v-a62c2c91${_scopeId3}>${ssrInterpolate(formatDate(item.date))}</div></div>`);
                          });
                          _push4(`<!--]--></div></div></div>`);
                        } else {
                          return [
...
//# sourceMappingURL=index-DAvimfin.js.map
