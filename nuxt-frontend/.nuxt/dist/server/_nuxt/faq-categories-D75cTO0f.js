...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-page" }, _attrs))} data-v-5db83f18>`);
                  ...
                  _push3(ssrRenderComponent(_component_el_form_item, { label: "结算页显示" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="form-tip text-gray-400 text-xs mt-1" data-v-5db83f18${_scopeId3}>开启后，该分类下的问题将显示在结算界面。</div>`);
                      } else {
                        return [
                          createVNode(_component_el_switch, {
                            modelValue: unref(dialog).form.is_checkout_visible,
...
const faqCategories = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5db83f18"]]);
export {
  faqCategories as default
};
//# sourceMappingURL=faq-categories-D75cTO0f.js.map
