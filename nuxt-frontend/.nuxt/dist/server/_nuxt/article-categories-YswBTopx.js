...
import { u as useAdminDialog, c as confirmDelete } from "./useAdminDialog-CsbKStaI.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-page" }, _attrs))} data-v-a68f5f35>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span style="${ssrRenderStyle({ "font-size": "20px" })}" data-v-a68f5f35${_scopeId2}>${ssrInterpolate(row.icon)}</span>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span style="${ssrRenderStyle({ color: row.color, fontWeight: "bold" })}" data-v-a68f5f35${_scopeId2}>${ssrInterpolate(row.name)}</span>`);
                } else {
                  return [
                    createVNode("span", {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center" data-v-a68f5f35${_scopeId2}><div style="${ssrRenderStyle({ background: row.color, width: "16px", height: "16px", borderRadius: "4px", marginRight: "8px", border: "1px solid #ddd" })}" data-v-a68f5f35${_scopeId2}></div><span data-v-a68f5f35${_scopeId2}>${ssrInterpolate(row.color)}</span></div>`);
                } else {
                  return [
                  ...
                  _push3(ssrRenderComponent(_component_el_form_item, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                          ...
                          append: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              if (unref(dialog).form.icon) {
                                _push5(`<span data-v-a68f5f35${_scopeId4}>${ssrInterpolate(unref(dialog).form.icon)}</span>`);
                              } else {
                                _push5(`<!---->`);
                              }
                            } else {
                        ...
                        _push4(`<span class="text-gray-400 text-xs ml-2" data-v-a68f5f35${_scopeId3}>推荐使用 Emoji，如 📝</span>`);
                      } else {
                        return [
                          createVNode(_component_el_input, {
                            modelValue: unref(dialog).form.icon,
                  ...
                  _push3(ssrRenderComponent(_component_el_form_item, { label: "排序" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span class="text-gray-400 text-xs ml-2" data-v-a68f5f35${_scopeId3}>数字越小越靠前</span>`);
                      } else {
                        return [
...
const articleCategories = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a68f5f35"]]);
export {
  articleCategories as default
};
//# sourceMappingURL=article-categories-YswBTopx.js.map
