...
import { ac as present_default, a0 as select_default, f as arrow_right_default, a7 as lock_default, a as circle_check_default } from "./index-CmsdIFY8.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!showQrCode.value) {
              ...
              _push2(`<span class="btn-text" data-v-0f06b8d3${_scopeId}>${ssrInterpolate(loading.value ? "正在发起支付..." : `立即支付 ¥${payAmount.value.toFixed(2)}`)}</span>`);
              if (!loading.value) {
              ...
              _push2(`</div><div class="qrcode-info" data-v-0f06b8d3${_scopeId}><div class="amount-display" data-v-0f06b8d3${_scopeId}><span class="label" data-v-0f06b8d3${_scopeId}>支付金额</span><span class="amount" data-v-0f06b8d3${_scopeId}>¥${ssrInterpolate(payAmount.value.toFixed(2))}</span></div><div class="order-no" data-v-0f06b8d3${_scopeId}> 订单号: ${ssrInterpolate(currentOrderNo.value)}</div></div><div class="qrcode-tips" data-v-0f06b8d3${_scopeId}><p data-v-0f06b8d3${_scopeId}>请使用微信扫一扫</p><p data-v-0f06b8d3${_scopeId}>扫描二维码完成支付</p></div><div class="qrcode-actions" data-v-0f06b8d3${_scopeId}><button class="btn-back"${ssrIncludeBooleanAttr(paymentStatus.value === "checking") ? " disabled" : ""} data-v-0f06b8d3${_scopeId}> 返回重新选择 </button></div></div>`);
            }
            _push2(`</div>`);
          } else {
            return [
                      ...
                      createVNode("div", { class: "modal-footer" }, [
                        ...
                        createVNode("div", { class: "action-row" }, [
                          createVNode("button", {
                            ...
                            createVNode("span", { class: "btn-text" }, toDisplayString(loading.value ? "正在发起支付..." : `立即支付 ¥${payAmount.value.toFixed(2)}`), 1),
...
//# sourceMappingURL=WalletRechargeModal-ClHnmzJa.js.map
