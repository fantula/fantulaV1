...
import { A as AdminModuleLayout } from "./AdminModuleLayout-CO8X8t6n.js";
...
/* empty css                  */
/* empty css                    */
import { a as adminTicketApi, T as TicketChatModal } from "./TicketChatModal-JtoCWjjH.js";
...
import { B as delete_default } from "./index-DuV_oMrC.js";
...
import "./AdminDataDialog-DdPeAUNy.js";
import "./index-CcOBk9kW.js";
import "./refs-CxYYXu5Q.js";
/* empty css                   */
import "./useSupabaseSession-D0X5WUcm.js";
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_el_table_column, {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="font-medium truncate mb-1 cursor-pointer hover:text-blue-500" data-v-25e7fae7${_scopeId3}>${ssrInterpolate(row.title)}</div><div class="sub-text truncate" data-v-25e7fae7${_scopeId3}>${ssrInterpolate(row.ticket_messages?.[0]?.content || "暂无消息")}</div>`);
                      } else {
                        return [
                          createVNode("div", {
                  ...
                  _push3(ssrRenderComponent(_component_el_table_column, {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="user-cell" data-v-25e7fae7${_scopeId3}><div class="w-8 h-8 rounded bg-gray-100 flex items-center justify-center text-xs font-mono text-gray-500" data-v-25e7fae7${_scopeId3}>${ssrInterpolate(row.user_id.substring(0, 2).toUpperCase())}</div><div class="flex flex-col min-w-0" data-v-25e7fae7${_scopeId3}><span class="mono-text text-xs" data-v-25e7fae7${_scopeId3}>UID: ${ssrInterpolate(row.user_id.substring(0, 8).toUpperCase())}</span><span class="sub-text truncate"${ssrRenderAttr("title", row.profiles?.email)} data-v-25e7fae7${_scopeId3}>${ssrInterpolate(row.profiles?.email || "未知用户")}</span></div></div>`);
                      } else {
                        return [
...
//# sourceMappingURL=index-CCiZoVnr.js.map
