...
import { E as ElAvatar } from "./index-Dvr6SB4P.js";
...
import { q as refresh_right_default, b as close_default, I as picture_default, J as check_default, j as circle_check_filled_default } from "./index-CmsdIFY8.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (error.value) {
              ...
              _push2(`<div class="user-details" data-v-ab3ee77a${_scopeId}><div class="uid" data-v-ab3ee77a${_scopeId}>UID: ${ssrInterpolate(ticket.value?.user_id?.substring(0, 8).toUpperCase())}</div>`);
              ...
              if (ticket.value?.orders) {
                ...
                _push2(`<div class="detail-row" data-v-ab3ee77a${_scopeId}><span class="row-label" data-v-ab3ee77a${_scopeId}>金额</span><span class="row-value price" data-v-ab3ee77a${_scopeId}>¥${ssrInterpolate(ticket.value.orders.total_amount?.toFixed(2))}</span></div>`);
                if (timeLeft.value) {
              ...
              if (ticket.value?.status !== "processing" && ticket.value?.status !== "resolved") {
                _push2(`<div class="text-xs text-red-400 text-center mb-2" data-v-ab3ee77a${_scopeId}> 当前状态异常: ${ssrInterpolate(ticket.value?.status)}</div>`);
              } else {
                _push2(`<!---->`);
              }
...
//# sourceMappingURL=TicketChatModal-DU7Pt2Iv.js.map
