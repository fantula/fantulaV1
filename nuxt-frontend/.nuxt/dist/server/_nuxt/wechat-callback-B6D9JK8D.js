  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (state.value === "loading") {
        ...
        _push(`<div class="callback-bind" data-v-6e5bfa26><div class="bind-header" data-v-6e5bfa26><div class="success-icon" data-v-6e5bfa26>🎉</div><h2 data-v-6e5bfa26>微信授权成功</h2><p data-v-6e5bfa26>请绑定邮箱以完成登录</p></div><form class="bind-form" data-v-6e5bfa26><div class="input-group" data-v-6e5bfa26>`);
...
//# sourceMappingURL=wechat-callback-B6D9JK8D.js.map
