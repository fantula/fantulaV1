...
import { an as headset_default } from "./index-CRs4T-Jf.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="info-card-glass ticket-status-card" data-v-75624bbe><div class="card-head" data-v-75624bbe><div class="${ssrRenderClass([ticketInfo.value?.status, "status-badge"])}" data-v-75624bbe><div class="dot" data-v-75624bbe></div> ${ssrInterpolate(getStatusText(ticketInfo.value?.status))}</div><div class="ticket-no" data-v-75624bbe>NO. ${ssrInterpolate(ticketInfo.value?.ticket_no || ticketInfo.value?.id)}</div></div><div class="card-body" data-v-75624bbe><div class="desc-row" data-v-75624bbe><span class="label" data-v-75624bbe>问题:</span><span class="val text-highlight" data-v-75624bbe>${ssrInterpolate(ticketInfo.value?.title)}</span></div><div class="time-row" data-v-75624bbe>${ssrInterpolate(formatTime(ticketInfo.value?.created_at))}</div></div></div><div class="divider" data-v-75624bbe><span data-v-75624bbe>沟通记录</span></div><div class="messages-list" data-v-75624bbe><!--[-->`);
        ssrRenderList(messages.value, (msg) => {
          ...
          if (msg.sender === "user") {
            _push(`<img${ssrRenderAttr("src", unref(userStore).user?.avatar || unref(DEFAULT_AVATAR))} data-v-75624bbe>`);
          } else {
...
//# sourceMappingURL=_id_-D_MRRS3n.js.map
