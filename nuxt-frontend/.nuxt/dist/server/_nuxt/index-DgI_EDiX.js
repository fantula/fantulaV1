...
/* empty css              */
import { defineComponent, ref, computed, mergeProps, withCtx, unref, createVNode, useSSRContext, watch, nextTick, defineAsyncComponent } from "vue";
...
import { B as delete_default, ag as shopping_cart_default, _ as star_default, W as user_default, ax as arrow_up_bold_default } from "./index-DuV_oMrC.js";
import "/Users/dalin/fantula/nuxt-frontend/node_modules/hookable/dist/index.mjs";
import { _ as _export_sfc, H as usePageLoading } from "../server.mjs";
import { u as useUserStore } from "./user-C1i1UnhA.js";
import { u as useHomeData } from "./useHomeData-BAU-FNGf.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(userStore).isLoggedIn) {
        ...
        if (unref(userStore).loading) {
          ...
          _push(`<!--[--><img${ssrRenderAttr("src", unref(userStore).user?.avatar || "/images/client/pc/avatars/avatar-cat.png")} data-v-34d495b9><div class="avatar-ring" data-v-34d495b9></div><!--]-->`);
        }
        _push(`</div>`);
      }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ProductDetailSheet = defineAsyncComponent(() => import("./ProductDetailSheet-eRLQDIjq.js"));
    const MobileLoginSheet = defineAsyncComponent(() => import("./MobileLoginSheet-DPgXXBiL.js"));
    useRouter();
    useRoute();
    useUserStore();
    usePageLoading();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(goodsLoading) && unref(currentGoods).length === 0) {
        ...
        _push(`<div class="empty-state bg-glass-card" data-v-2a1d1f33><div class="empty-icon" data-v-2a1d1f33>📦</div><p class="text-muted text-sm" data-v-2a1d1f33>暂无相关商品</p></div>`);
      } else {
...
//# sourceMappingURL=index-DgI_EDiX.js.map
