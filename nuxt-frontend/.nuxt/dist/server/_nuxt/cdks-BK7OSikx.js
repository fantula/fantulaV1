...
import { E as ElRadioGroup, a as ElRadioButton } from "./index-gpqNf9xE.js";
...
import { M as refresh_default, Y as delete_default } from "./index-CbQ9NNm4.js";
...
import { u as useAdminList } from "./useAdminList-8OVTPqBj.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span class="product-name" data-v-00d4909c${_scopeId2}>${ssrInterpolate(row.product_snapshot?.product_name || "未知商品")}</span></div>`);
                } else {
                  return [
                    createVNode("div", {
                      class: "product-cell",
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span data-v-00d4909c${_scopeId2}>${ssrInterpolate(row.stock ?? 1)}</span>`);
                } else {
                  return [
...
//# sourceMappingURL=cdks-BK7OSikx.js.map
