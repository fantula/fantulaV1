...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "coupon-product-list" }, _attrs))} data-v-12736228>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="code-info" data-v-12736228${_scopeId2}><div class="code-name" data-v-12736228${_scopeId2}>${ssrInterpolate(row.name)}</div></div>`);
                } else {
                  return [
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row.sku_ids && row.sku_ids.length) {
                    _push3(`<div class="product-tags" data-v-12736228${_scopeId2}><!--[-->`);
                    ...
                    _push3(`<span class="text-secondary" data-v-12736228${_scopeId2}>无关联商品</span>`);
                  }
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="amount" data-v-12736228${_scopeId2}>${ssrInterpolate(unref(formatPrice)(row.value))}</span>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (!row.end_date) {
                    _push3(`<div class="validity-tag" data-v-12736228${_scopeId2}>永久有效</div>`);
                  } else {
                    _push3(`<div class="validity-range" data-v-12736228${_scopeId2}><div data-v-12736228${_scopeId2}>${ssrInterpolate(unref(formatDate)(row.end_date))} 到期</div></div>`);
                  }
                } else {
                  return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-12736228"]]);
export {
  index as default
};
//# sourceMappingURL=index-B-TXoeoP.js.map
