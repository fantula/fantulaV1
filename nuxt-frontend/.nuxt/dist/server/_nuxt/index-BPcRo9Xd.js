import { defineComponent, inject, ref, computed, watch, nextTick, openBlock, createElementBlock, normalizeStyle, normalizeClass, unref, createCommentVNode, shallowRef, triggerRef, createVNode, getCurrentInstance, provide, renderSlot, useSlots, reactive, withDirectives, vShow } from "vue";
import { clamp, omit } from "lodash-unified";
import { E as ElIcon } from "./index-CsSUb8pm.js";
import { b as buildProps, d as definePropType, n as arrow_left_default, m as arrow_right_default, f as close_default, p as plus_default, w as withInstall, o as withNoopInstall } from "./index-DuV_oMrC.js";
import { useResizeObserver, useDocumentVisibility, useWindowFocus, useElementSize } from "@vueuse/core";
import { c as cAF, r as rAF } from "./raf-CQRaPAjg.js";
import { i as isFirefox, g as getEventCode, E as EVENT_CODE } from "./event-D3FEo2C5.js";
import { m as mutable } from "./typescript-D6L75muK.js";
import { c as capitalize } from "./strings-D1uxkXhq.js";
import { y as throwError, g as useNamespace, w as isUndefined, i as isNumber } from "../server.mjs";
...
export {
  AUTO_ALIGNMENT as A,
  BACKWARD as B,
  CENTERED_ALIGNMENT as C,
  DEFAULT_DYNAMIC_LIST_ITEM_SIZE as D,
  ElTabs as E,
  FORWARD as F,
  HORIZONTAL as H,
  ITEM_RENDER_EVT as I,
  LTR as L,
  RTL as R,
  ScrollbarDirKey as S,
  VERTICAL as V,
  ElTabPane as a,
  RTL_OFFSET_POS_DESC as b,
  RTL_OFFSET_NAG as c,
  RTL_OFFSET_POS_ASC as d,
  SCROLLBAR_MIN_SIZE as e,
  SCROLL_EVT as f,
  END_ALIGNMENT as g,
  START_ALIGNMENT as h,
  SMART_ALIGNMENT as i,
  tabNavEmits as j,
  tabNavProps as k,
  tabPaneProps as l,
  tabsEmits as m,
  tabsProps as n,
  tabsRootContextKey as o,
  tabBarProps as t,
  useWheel as u
};
//# sourceMappingURL=index-BPcRo9Xd.js.map
