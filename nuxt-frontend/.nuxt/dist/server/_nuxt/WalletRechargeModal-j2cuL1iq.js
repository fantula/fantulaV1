...
import { a$ as present_default, a3 as select_default, m as arrow_right_default, aa as lock_default, e as circle_check_default } from "./index-CRs4T-Jf.js";
            ...
            if (!showQrCode.value) {
              ...
              _push2(ssrRenderComponent(BaseButton, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (!loading.value) {
                      _push3(`<!--[--><span class="btn-text" data-v-3b6d4525${_scopeId2}>立即支付 ¥${ssrInterpolate(payAmount.value.toFixed(2))}</span>`);
              ...
              _push2(`</div><div class="qrcode-info" data-v-3b6d4525${_scopeId}><div class="amount-display" data-v-3b6d4525${_scopeId}><span class="label" data-v-3b6d4525${_scopeId}>支付金额</span><span class="amount" data-v-3b6d4525${_scopeId}>¥${ssrInterpolate(payAmount.value.toFixed(2))}</span></div><div class="order-no" data-v-3b6d4525${_scopeId}> 订单号: ${ssrInterpolate(currentOrderNo.value)}</div></div><div class="qrcode-tips" data-v-3b6d4525${_scopeId}><p data-v-3b6d4525${_scopeId}>请使用微信扫一扫</p><p data-v-3b6d4525${_scopeId}>扫描二维码完成支付</p></div><div class="qrcode-actions" data-v-3b6d4525${_scopeId}>`);
              _push2(ssrRenderComponent(BaseButton, {
                themeId: "secondary",
...
//# sourceMappingURL=WalletRechargeModal-j2cuL1iq.js.map
