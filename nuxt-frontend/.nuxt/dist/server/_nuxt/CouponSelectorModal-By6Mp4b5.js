...
/* empty css                   */
/* empty css                  */
import { defineComponent, mergeProps, useSSRContext, computed, ref, watch, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode } from "vue";
...
import { B as BaseCouponTicket } from "./BaseCouponTicket-CKW8RMPT.js";
import { c as couponApi } from "./coupon-D1so52Ot.js";
import { i as info_filled_default, v as refresh_default, c as circle_close_default } from "./index-4qszPKX4.js";
        ...
        "footer-left": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (tempSelected.value) {
              _push2(`<div class="selected-info" data-v-b63d824f${_scopeId}> 已选择: <span class="highlight" data-v-b63d824f${_scopeId}>${ssrInterpolate(tempSelected.value.coupon.name)}</span><span class="discount-preview" data-v-b63d824f${_scopeId}>-¥${ssrInterpolate(tempSelected.value.coupon.value)}</span></div>`);
            } else {
              ...
              ssrRenderList(sortedCoupons.value, (coupon) => {
                ...
                _push2(ssrRenderComponent(BaseCouponTicket, {
                  ...
                  action: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="${ssrRenderClass([{ checked: tempSelected.value?.id === coupon.id }, "radio-check"])}" data-v-b63d824f${_scopeId2}></div>`);
                    } else {
                      return [
                        createVNode("div", {
...
//# sourceMappingURL=CouponSelectorModal-By6Mp4b5.js.map
