  ...
  setup(__props, { emit: __emit }) {
    ...
    const handleDeleteAccount = async () => {
      try {
        ...
        if (res.success) {
          const { ElMessageBox: ElMessageBox2 } = await import("./index-BxfJN5os.js");
...
//# sourceMappingURL=index-CGy18w3F.js.map
