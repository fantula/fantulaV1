        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (error.value) {
              ...
              _push2(`<div class="user-details" data-v-18c81dd7${_scopeId}><div class="uid" data-v-18c81dd7${_scopeId}>UID: ${ssrInterpolate(ticket.value?.user_id?.substring(0, 8).toUpperCase())}</div>`);
              ...
              if (ticket.value?.orders) {
                _push2(`<div class="info-block" data-v-18c81dd7${_scopeId}><div class="label" data-v-18c81dd7${_scopeId}>关联订单快照</div><div class="order-card-large" data-v-18c81dd7${_scopeId}><img${ssrRenderAttr("src", ticket.value.orders.product_snapshot?.image)} class="order-img-large" data-v-18c81dd7${_scopeId}><div class="order-details-rows" data-v-18c81dd7${_scopeId}><div class="detail-row" data-v-18c81dd7${_scopeId}><span class="row-label" data-v-18c81dd7${_scopeId}>订单号</span><span class="row-value font-mono copyable" data-v-18c81dd7${_scopeId}>${ssrInterpolate(ticket.value.orders.order_no)}</span></div><div class="detail-row" data-v-18c81dd7${_scopeId}><span class="row-label" data-v-18c81dd7${_scopeId}>商品</span><span class="row-value"${ssrRenderAttr("title", ticket.value.orders.product_snapshot?.product_name)} data-v-18c81dd7${_scopeId}>${ssrInterpolate(ticket.value.orders.product_snapshot?.product_name)}</span></div>`);
                ...
                _push2(`<div class="detail-row" data-v-18c81dd7${_scopeId}><span class="row-label" data-v-18c81dd7${_scopeId}>金额</span><span class="row-value price" data-v-18c81dd7${_scopeId}>¥${ssrInterpolate(ticket.value.orders.total_amount?.toFixed(2))}</span></div>`);
                if (timeLeft.value) {
              ...
              if (ticket.value?.status !== "processing" && ticket.value?.status !== "resolved") {
                _push2(`<div class="text-xs text-red-400 text-center mb-2" data-v-18c81dd7${_scopeId}> 当前状态异常: ${ssrInterpolate(ticket.value?.status)}</div>`);
              } else {
                _push2(`<!---->`);
              }
...
//# sourceMappingURL=TicketChatModal-QPvzvpwS.js.map
