...
import { u as useAdminDialog, c as confirmDelete } from "./useAdminDialog-LVLqZ-7L.js";
                  ...
                  _push3(ssrRenderComponent(_component_el_form_item, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span class="text-gray-400 text-xs ml-2" data-v-f824594e${_scopeId3}>推荐使用 Emoji，如 📝</span>`);
                      } else {
                        return [
                          createVNode(_component_el_input, {
                            modelValue: unref(dialog).form.icon,
...
//# sourceMappingURL=article-categories-Bhe64EmB.js.map
