...
/* empty css                    */
import { defineComponent, mergeProps, withCtx, unref, createVNode, useSSRContext, ref, computed, watch, reactive, openBlock, createBlock, toDisplayString, Fragment, renderList, createCommentVNode, createTextVNode, withDirectives, vModelText } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderStyle, ssrRenderTeleport } from "vue/server-renderer";
import { useRouter, useRoute } from "vue-router";
import { Q as copy_document_default, a3 as files_default, B as user_default, p as plus_default, l as loading_default, a as circle_check_default, c as circle_close_default, S as edit_pen_default, O as edit_default, n as refresh_right_default, a4 as document_add_default, a5 as arrow_down_default, v as warning_default, g as arrow_left_default, a6 as box_default, r as refresh_left_default, i as info_filled_default, a7 as timer_default, a8 as headset_default, a9 as tickets_default, M as refresh_default, t as money_default, f as arrow_right_default, b as close_default, w as warning_filled_default, u as guide_default, m as zoom_in_default } from "./index-DNnPa_Q9.js";
import "/Users/dalin/fantula/nuxt-frontend/node_modules/nuxt/node_modules/hookable/dist/index.mjs";
import { u as useOrderDetail } from "./useOrderDetail-BuiDZ7Fj.js";
...
import CouponSelectorModal from "./CouponSelectorModal-DmVmOOeQ.js";
...
import { S as ServiceModal } from "./ServiceModal-B93nNyX-.js";
import "@vueuse/core";
import "@vue/shared";
...
/* empty css                   */
/* empty css                  */
import "./BaseCouponTicket-CoNCTgZN.js";
import "./useCouponList-BXgjq8MB.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(allSlots.value, (slot) => {
        ...
        _push(`</div><span class="profile-name" data-v-43d0c29f>${ssrInterpolate(slot.isMe ? "我" : slot.user?.nickname || "待加入")}</span><span class="slot-number-tag" data-v-43d0c29f>${ssrInterpolate(slot.index)}号</span></div>`);
      });
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (records.value.length > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fulfillment-history glass-panel" }, _attrs))} data-v-6229d37d><div class="history-header" data-v-6229d37d><div class="header-left" data-v-6229d37d><span class="icon" data-v-6229d37d>📋</span><span class="title" data-v-6229d37d>回执记录</span><span class="count-badge flex-center" data-v-6229d37d>${ssrInterpolate(records.value.length)}</span></div>`);
...
//# sourceMappingURL=_id_-DXyqbHs5.js.map
