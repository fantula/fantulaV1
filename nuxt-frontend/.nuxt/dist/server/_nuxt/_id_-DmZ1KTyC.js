  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (hasSkus.value) {
        ...
        _push(`<div class="no-sku-notice" data-v-7e779d38><div class="notice-emoji" data-v-7e779d38>📦✨</div><h3 data-v-7e779d38>我正在疑狂补货中！</h3><p data-v-7e779d38>商品正在准备中，请稍后再来或联系客服了解更多~</p></div>`);
      }
      ...
      if (!stockLoading.value && hasStock.value && hasSkus.value) {
        _push(`<span class="btn-subtext" data-v-7e779d38>安全合规·秒速发货</span>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=_id_-DmZ1KTyC.js.map
