...
import { g as goodsApi } from "./goods-BEbxfX07.js";
import { supabaseProductApi, supabaseFaqApi } from "./supabase-DLV6up8l.js";
...
const useProductDetail = (overrideId) => {
  ...
  const checkFavoriteStatus = async () => {
    ...
    const { favoriteApi } = await import("./common-Bgv_wRgd.js").then((n) => n.b);
  ...
  const buyNow = async () => {
    ...
    try {
      const { supabasePreOrderApi } = await import("./supabase-DLV6up8l.js");
...
//# sourceMappingURL=useProductDetail-DLP8HdIq.js.map
