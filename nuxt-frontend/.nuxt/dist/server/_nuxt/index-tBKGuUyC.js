...
/* empty css                  */
/* empty css                    */
import { a as authApi, u as useUserStore } from "./user-C1i1UnhA.js";
import { V as user_filled_default, a1 as upload_default, M as check_default, a2 as chat_dot_round_default, a3 as connection_default, a4 as select_default, A as refresh_default, a5 as camera_default, e as circle_check_default, a6 as edit_default, a7 as credit_card_default, a8 as copy_document_default, a9 as message_default, aa as edit_pen_default, ab as lock_default, ac as key_default, m as arrow_right_default, S as warning_default } from "./index-DuV_oMrC.js";
...
import { w as wechatLoginApi } from "./wechat-login-WH-GLTWF.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(BaseFormModal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="avatar-preview-section" data-v-89c3ae12${_scopeId}><div class="preview-wrapper" data-v-89c3ae12${_scopeId}>`);
            if (previewLoading.value) {
              _push2(`<div class="preview-skeleton" data-v-89c3ae12${_scopeId}></div>`);
            } else if (displayAvatar.value) {
              _push2(`<img${ssrRenderAttr("src", displayAvatar.value)} class="preview-avatar" data-v-89c3ae12${_scopeId}>`);
            } else {
              _push2(`<div class="preview-avatar-placeholder" data-v-89c3ae12${_scopeId}>`);
            ...
            _push2(`</div><div class="upload-btn-wrapper" data-v-89c3ae12${_scopeId}><button class="btn-upload" data-v-89c3ae12${_scopeId}>`);
            ...
            _push2(` 上传新头像 </button><input type="file" hidden accept="image/png,image/jpeg,image/webp" data-v-89c3ae12${_scopeId}><div class="upload-tip" data-v-89c3ae12${_scopeId}>支持 JPG, PNG, WebP 格式，上传后自动裁剪压缩</div><div class="upload-limit" data-v-89c3ae12${_scopeId}>最大 5MB，将压缩为 200x200px</div></div></div><div class="system-avatars-section" data-v-89c3ae12${_scopeId}><div class="section-title" data-v-89c3ae12${_scopeId}>系统推荐头像</div><div class="avatar-grid" data-v-89c3ae12${_scopeId}><!--[-->`);
            ssrRenderList(presetAvatars, (url, index) => {
              _push2(`<div class="${ssrRenderClass([{ active: selectedAvatar.value === url }, "avatar-item"])}" data-v-89c3ae12${_scopeId}><img${ssrRenderAttr("src", url)} class="system-avatar-img" loading="lazy" data-v-89c3ae12${_scopeId}>`);
              if (selectedAvatar.value === url) {
                _push2(`<div class="active-overlay" data-v-89c3ae12${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_icon, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
...
const ChangeAvatarModal = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-89c3ae12"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    const handleDeleteAccount = async () => {
      try {
        ...
        if (res.success) {
          const { ElMessageBox: ElMessageBox2 } = await import("./index-Cfl21XIg.js");
...
//# sourceMappingURL=index-tBKGuUyC.js.map
