...
import { af as search_default, B as user_default, M as refresh_default } from "./index-CCIZH4aC.js";
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_el_table_column, {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span data-v-dd63bc87${_scopeId3}>${ssrInterpolate(row.user_nickname || row.user_id?.slice(0, 8))}</span>`);
                      } else {
                        return [
...
//# sourceMappingURL=index-cF3I89PT.js.map
