...
import { v as refresh_default, x as delete_default, p as plus_default } from "./index-CmsdIFY8.js";
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span class="product-name" data-v-3e5a6af5${_scopeId2}>${ssrInterpolate(row.product_snapshot?.product_name || "未知商品")}</span></div>`);
                } else {
                  return [
            ...
            if (props.type === "shared") {
              ...
              _push2(ssrRenderComponent(_component_el_table_column, {
                ...
                default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<span data-v-3e5a6af5${_scopeId2}>${ssrInterpolate(row.stock ?? 1)}</span>`);
                  } else {
                    return [
...
//# sourceMappingURL=CdkListByType-C3ec4c7d.js.map
