  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (goodsLoading.value && currentGoods.value.length === 0) {
        ...
        _push(`<div class="empty-state bg-glass-card" data-v-a8206558><div class="empty-icon" data-v-a8206558>📦</div><p class="text-muted text-sm" data-v-a8206558>暂无相关商品</p></div>`);
      } else {
...
//# sourceMappingURL=index-C-fNtowd.js.map
