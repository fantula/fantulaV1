...
import { a as confirmAction } from "./useAdminDialog-CsbKStaI.js";
import { n as refresh_right_default, b as close_default, F as picture_default, G as check_default, h as circle_check_filled_default } from "./index-DlETah8a.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (error.value) {
              ...
              _push2(`<div class="user-details" data-v-c05214ee${_scopeId}><div class="uid" data-v-c05214ee${_scopeId}>UID: ${ssrInterpolate(ticket.value?.user_id?.substring(0, 8).toUpperCase())}</div>`);
              ...
              if (ticket.value?.orders) {
                ...
                _push2(`<div class="detail-row" data-v-c05214ee${_scopeId}><span class="row-label" data-v-c05214ee${_scopeId}>金额</span><span class="row-value price" data-v-c05214ee${_scopeId}>¥${ssrInterpolate(ticket.value.orders.total_amount?.toFixed(2))}</span></div>`);
                if (timeLeft.value) {
              ...
              if (ticket.value?.status !== "processing" && ticket.value?.status !== "resolved") {
                _push2(`<div class="text-xs text-red-400 text-center mb-2" data-v-c05214ee${_scopeId}> 当前状态异常: ${ssrInterpolate(ticket.value?.status)}</div>`);
              } else {
                _push2(`<!---->`);
              }
...
//# sourceMappingURL=TicketChatModal-DR5KY0WD.js.map
