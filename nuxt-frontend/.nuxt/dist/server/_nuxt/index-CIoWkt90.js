import { defineComponent, ref, computed, provide, renderSlot, inject, createElementBlock, openBlock, normalizeStyle, normalizeClass, unref, withDirectives, cloneVNode, Comment, Fragment, Text, createVNode, createBlock, createCommentVNode, mergeProps, withCtx, shallowRef, watch, getCurrentInstance, toRef, nextTick, Transition, vShow, readonly, toDisplayString } from "vue";
import { q as buildProps, w as _export_sfc, x as useNamespace, D as definePropType, v as debugWarn, I as useZIndex, r as isNumber, B as withInstall, W as EVENT_CODE, aC as buildProp, aD as isBoolean, aE as composeEventHandlers, V as getEventCode, aF as useGetDerivedNamespace, aG as useIdInjection, S as useId } from "../server.mjs";
import { isClient, unrefElement, tryOnScopeDispose, computedEager, onClickOutside } from "@vueuse/core";
import { placements, createPopper } from "@popperjs/core";
import { u as useAriaProps } from "./index-Dxw_X3Hq.js";
import { a as ElFocusTrap, t as teleportProps, E as ElTeleport } from "./focus-trap-D_6Xxduc.js";
...
export {
  usePopperContainerId as A,
  useDelayedToggle as B,
  useDelayedToggleProps as C,
  useForwardRef as D,
  ElTooltip as E,
  FORWARD_REF_INJECTION_KEY as F,
  useForwardRefDirective as G,
  OnlyChild as O,
  ...
  unique as b,
  castArray as c,
  popperTriggerProps as d,
  extractFirst as e,
  popperContentEmits as f,
  popperContentProps as g,
  popperCoreConfigProps as h,
  popperArrowProps as i,
  POPPER_INJECTION_KEY as j,
  ElPopperArrow as k,
  ElPopperTrigger as l,
  ElPopperContent as m,
  ElPopper as n,
  useTooltipModelToggle as o,
  popperProps as p,
  useTooltipModelToggleEmits as q,
  roleTypes as r,
  useTooltipModelToggleProps as s,
  tooltipEmits as t,
  useTooltipContentProps as u,
  useTooltipProps as v,
  createModelToggleComposable as w,
  usePopper as x,
  useTimeout as y,
  usePopperContainer as z
};
//# sourceMappingURL=index-CIoWkt90.js.map
