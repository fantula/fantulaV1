        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span class="uid-text" data-v-a21846e5${_scopeId2}>${ssrInterpolate(row._profile?.uid || "无UID")}</span></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-a21846e5${_scopeId2}>${ssrInterpolate(row.product_snapshot?.product_name || "未知商品")}</span></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="spec-text" data-v-a21846e5${_scopeId2}>${ssrInterpolate(unref(formatSpec)(row.sku_snapshot?.spec_combination))}</span>`);
                } else {
                  return [
...
//# sourceMappingURL=index-C3ns_wU0.js.map
