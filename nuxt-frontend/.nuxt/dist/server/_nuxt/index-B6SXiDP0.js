...
import { v as refresh_default, l as loading_default, J as check_default } from "./index-CmsdIFY8.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span class="uid-text" data-v-476cf353${_scopeId2}>${ssrInterpolate(row._profile?.uid || "无UID")}</span></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-476cf353${_scopeId2}>${ssrInterpolate(row.product_snapshot?.product_name || "未知商品")}</span></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="spec-text" data-v-476cf353${_scopeId2}>${ssrInterpolate(formatSpec(row.sku_snapshot?.spec_combination))}</span>`);
                } else {
                  return [
          ...
          if (_push2) {
            if (refundLoading.value) {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_el_descriptions_item, { label: "订单金额" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="amount" data-v-476cf353${_scopeId3}>¥${ssrInterpolate(currentOrder.value?.total_amount)}</span>`);
                        } else {
                          return [
                    ...
                    if (_push3) {
                      if (currentRequest.value.refund_amount) {
                        _push3(ssrRenderComponent(_component_el_descriptions_item, { label: "退款金额" }, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`<span class="amount" data-v-476cf353${_scopeId3}>¥${ssrInterpolate(currentRequest.value.refund_amount)}</span>`);
                            } else {
                              return [
              ...
              if (currentRequest.value.status === "pending") {
                ...
                _push2(`<span class="hint" data-v-476cf353${_scopeId}>（订单金额: ¥${ssrInterpolate(currentOrder.value?.total_amount)}）</span></div><div class="form-row" data-v-476cf353${_scopeId}><label data-v-476cf353${_scopeId}>管理员备注：</label>`);
...
//# sourceMappingURL=index-B6SXiDP0.js.map
