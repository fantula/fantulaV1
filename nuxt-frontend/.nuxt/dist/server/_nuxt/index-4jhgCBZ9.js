...
import { u as useUserStore, a as authApi } from "./user-0iCypJz1.js";
...
import { E as EditNicknameModal, C as ChangePasswordModal, a as ChangeEmailModal, D as DeleteAccountModal } from "./DeleteAccountModal-e3oYETKL.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="divider" data-v-48c4330b></div><div class="setting-item" data-v-48c4330b><div class="left" data-v-48c4330b><span class="label" data-v-48c4330b>昵称</span></div><div class="right" data-v-48c4330b><span class="value" data-v-48c4330b>${ssrInterpolate(unref(userStore).user?.nickName || "未设置")}</span>`);
      _push(ssrRenderComponent(_component_el_icon, { class: "arrow" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(arrow_right_default), null, null, _parent2, _scopeId));
      ...
      _push(`</div></div><div class="setting-item" data-v-48c4330b><span class="label" data-v-48c4330b>邮箱</span><div class="value-wrap" data-v-48c4330b><span class="text-val" data-v-48c4330b>${ssrInterpolate(unref(userStore).user?.email)}</span>`);
      _push(ssrRenderComponent(_component_el_icon, { class: "arrow" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(arrow_right_default), null, null, _parent2, _scopeId));
...
//# sourceMappingURL=index-4jhgCBZ9.js.map
