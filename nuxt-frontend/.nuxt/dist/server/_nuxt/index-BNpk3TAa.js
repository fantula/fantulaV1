...
import { B as delete_default, af as shopping_cart_default, _ as star_default, W as user_default, ax as arrow_up_bold_default } from "./index-CRs4T-Jf.js";
import "/Users/dalin/fantula/nuxt-frontend/node_modules/nuxt/node_modules/hookable/dist/index.mjs";
import { u as useUserStore } from "./user-0iCypJz1.js";
import { u as useHomeData } from "./useHomeData-qfeuHVBN.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(userStore).isLoggedIn) {
        ...
        if (unref(userStore).loading) {
          ...
          _push(`<!--[--><img${ssrRenderAttr("src", unref(userStore).user?.avatar || unref(DEFAULT_AVATAR))} data-v-f86b1a21><div class="avatar-ring" data-v-f86b1a21></div><!--]-->`);
        }
        _push(`</div>`);
      }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const MobileLoginSheet = defineAsyncComponent(() => import("./MobileLoginSheet--SOPXnjZ.js"));
    useRouter();
    useRoute();
    useUserStore();
    const {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(goodsLoading) && unref(currentGoods).length === 0) {
        ...
        _push(`<div class="empty-state bg-glass-card" data-v-093685d5><div class="empty-icon" data-v-093685d5>📦</div><p class="text-muted text-sm" data-v-093685d5>暂无相关商品</p></div>`);
      } else {
...
//# sourceMappingURL=index-BNpk3TAa.js.map
