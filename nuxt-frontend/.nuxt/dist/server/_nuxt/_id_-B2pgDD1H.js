...
import { Q as user_default, a2 as copy_document_default, p as plus_default, i as info_filled_default, l as loading_default, a as circle_check_default, c as circle_close_default, v as arrow_down_default, M as warning_default, b as close_default, _ as select_default, w as warning_filled_default, ag as box_default, r as refresh_left_default, ai as headset_default, aj as tickets_default, m as zoom_in_default } from "./index-DlETah8a.js";
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (visible.value) {
          ...
          if (loading.value) {
            ...
            if (availableCoupons.value.length > 0) {
              ...
              ssrRenderList(availableCoupons.value, (coupon) => {
                _push2(`<div class="${ssrRenderClass([{ active: selectedCoupon.value?.id === coupon.id }, "coupon-item-glass"])}" data-v-cd53d542><div class="c-left" data-v-cd53d542><span class="c-name" data-v-cd53d542>${ssrInterpolate(coupon.coupon.name)}</span></div><div class="c-right" data-v-cd53d542>`);
                if (coupon.coupon.type === "flat") {
                  _push2(`<span class="c-val" data-v-cd53d542>-¥${ssrInterpolate(coupon.coupon.value)}</span>`);
          ...
          if (discountAmount.value > 0) {
            _push2(`<div class="discount-tag" data-v-cd53d542>已省 ¥${ssrInterpolate(discountAmount.value)}</div>`);
          } else {
            _push2(`<!---->`);
          }
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (visible.value) {
          ...
          ssrRenderList(form.attachments, (url, idx) => {
            _push2(`<div class="img-preview" data-v-893d04b0><img${ssrRenderAttr("src", url)} data-v-893d04b0><div class="del-btn" data-v-893d04b0>×</div></div>`);
          });
          _push2(`<!--]-->`);
...
//# sourceMappingURL=_id_-B2pgDD1H.js.map
