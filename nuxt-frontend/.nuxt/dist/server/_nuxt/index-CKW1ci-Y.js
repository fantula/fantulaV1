...
import { u as useUserStore } from "./user-B9FaDvHc.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ProductDetailSheet = defineAsyncComponent(() => import("./ProductDetailSheet-GnnFiDMI.js"));
    const MobileLoginSheet = defineAsyncComponent(() => import("./MobileLoginSheet-eVcTsj0N.js"));
    useRouter();
    useRoute();
    useUserStore();
    const {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(goodsLoading) && unref(currentGoods).length === 0) {
        ...
        _push(`<div class="empty-state bg-glass-card" data-v-17ef5014><div class="empty-icon" data-v-17ef5014>📦</div><p class="text-muted text-sm" data-v-17ef5014>暂无相关商品</p></div>`);
      } else {
...
//# sourceMappingURL=index-CKW1ci-Y.js.map
