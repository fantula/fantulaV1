import { o as getSupabaseClient, d as useUserStore, ah as ElMessage, ak as setInterval, _ as _export_sfc, E as ElIcon, z as arrow_left_default, b6 as timer_default, a3 as info_filled_default, f as arrow_right_default, a5 as wallet_default, b9 as refresh_default, aA as select_default } from "../server.mjs";
...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr } from "vue/server-renderer";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(preOrders), (order) => {
          _push(`<div class="order-card glass-card" data-v-b245c8d1><div class="order-header-row" data-v-b245c8d1><span class="order-no" data-v-b245c8d1>订单号: ${ssrInterpolate(order.order_no)}</span><span class="order-status" data-v-b245c8d1>待支付</span></div><div class="order-body" data-v-b245c8d1><div class="product-thumb" data-v-b245c8d1><div class="sq-cover-img-container" data-v-b245c8d1><img${ssrRenderAttr("src", order.product_snapshot?.image || "/images/shared/logo.png")} class="sq-cover-img" data-v-b245c8d1></div></div><div class="product-info" data-v-b245c8d1><div class="product-name" data-v-b245c8d1>${ssrInterpolate(order.product_snapshot?.product_name)}</div><div class="product-meta-row" data-v-b245c8d1>`);
...
//# sourceMappingURL=_id_-CQyFWmRt.js.map
