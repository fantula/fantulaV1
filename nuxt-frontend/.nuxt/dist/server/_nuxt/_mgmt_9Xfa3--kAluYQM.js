import { bg as useAdminStore, ab as __nuxt_component_0, E as ElIcon, ae as user_filled_default, m as monitor_default, b6 as timer_default, bh as setting_default, aq as message_default, bi as collection_default, $ as document_default, bj as question_filled_default, R as picture_filled_default, ba as picture_default, a0 as money_default, s as service_default, a4 as user_default, a7 as ticket_default, at as key_default, b3 as files_default, bk as goods_default, M as refresh_left_default, a6 as list_default, bl as odometer_default, bm as expand_default, bn as fold_default, bo as sunny_default, bp as moon_default, aZ as arrow_down_default, aa as switch_button_default, ah as ElMessage, _ as _export_sfc } from "../server.mjs";
import { E as ElContainer, a as ElAside, b as ElMenu, c as ElSubMenu, d as ElMenuItem, e as ElHeader, f as ElDropdown, g as ElDropdownMenu, h as ElDropdownItem, i as ElMain } from "./index-D8rtC56F.js";
import { E as ElScrollbar } from "./index-D_b573Qt.js";
import { E as ElAvatar } from "./index-Blg-R14R.js";
/* empty css                      */
/* empty css                    */
/* empty css                   */
/* empty css                   */
/* empty css                   */
import { defineComponent, computed, ref, mergeProps, withCtx, unref, createVNode, resolveDynamicComponent, createBlock, openBlock, createCommentVNode, toDisplayString, Fragment, renderList, withDirectives, vShow, createTextVNode, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderClass, ssrRenderStyle, ssrRenderList, ssrRenderVNode, ssrInterpolate, ssrRenderAttr } from "vue/server-renderer";
import { useRoute, useRouter } from "vue-router";
import draggable from "vuedraggable";
import { A as ADMIN_MENU_ITEMS } from "./admin-menu-DXx4fNJV.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isLoginPage.value) {
        ...
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-loading-screen" }, _attrs))} data-v-7c98c01c><div class="loading-content" data-v-7c98c01c><div class="loading-logo" data-v-7c98c01c>F</div><p class="loading-text" data-v-7c98c01c>正在验证身份...</p></div></div>`);
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_component_el_aside, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="${ssrRenderClass([{ "collapsed": isCollapse.value }, "logo"])}" data-v-7c98c01c${_scopeId2}><div class="logo-icon" data-v-7c98c01c${_scopeId2}>F</div><div class="logo-text" style="${ssrRenderStyle(!isCollapse.value ? null : { display: "none" })}" data-v-7c98c01c${_scopeId2}><h2 data-v-7c98c01c${_scopeId2}>FANTULA</h2><span class="logo-sub" data-v-7c98c01c${_scopeId2}>ADMINISTRATOR</span></div></div>`);
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(unref(draggable), {
                                  modelValue: filteredMenuList.value,
                                  "onUpdate:modelValue": ($event) => filteredMenuList.value = $event,
                                  "item-key": "index",
                                  animation: 200,
                                  ...
                                  item: withCtx(({ element }, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="menu-wrapper" data-v-7c98c01c${_scopeId5}>`);
                                        ...
                                        _push6(ssrRenderComponent(_component_el_sub_menu, {
                                          ...
                                          title: withCtx((_5, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              ...
                                              _push7(`<span data-v-7c98c01c${_scopeId6}>${ssrInterpolate(element.title)}</span>`);
                                            } else {
                                              return [
                                              ...
                                              ssrRenderList(element.children, (child) => {
                                                _push7(ssrRenderComponent(_component_el_menu_item, {
                                                  ...
                                                  title: withCtx((_6, _push8, _parent8, _scopeId7) => {
                                                    if (_push8) {
                                                      _push8(`<span data-v-7c98c01c${_scopeId7}>${ssrInterpolate(child.title)}</span>`);
                                                    } else {
                                                      return [
                    ...
                    _push3(`<div class="sidebar-toggle" data-v-7c98c01c${_scopeId2}>`);
                    if (isCollapse.value) {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_el_header, { class: "admin-header" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="header-content" data-v-7c98c01c${_scopeId3}><div id="header-portal" class="header-portal" data-v-7c98c01c${_scopeId3}></div><div class="header-right-actions" data-v-7c98c01c${_scopeId3}><button class="theme-toggle"${ssrRenderAttr("title", isDark.value ? "Switch to Light" : "Switch to Dark")} data-v-7c98c01c${_scopeId3}>`);
                          if (isDark.value) {
                          ...
                          if (currentUser.value) {
                            _push4(`<div class="user-info" data-v-7c98c01c${_scopeId3}>`);
                            _push4(ssrRenderComponent(_component_el_dropdown, { trigger: "click" }, {
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<div class="el-dropdown-link" data-v-7c98c01c${_scopeId4}>`);
                                  _push5(ssrRenderComponent(_component_el_avatar, {
                                    size: 36,
                                    src: "https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png",
                                    class: "user-avatar"
                                  }, null, _parent5, _scopeId4));
                                  _push5(`<div class="user-details" data-v-7c98c01c${_scopeId4}><span class="username" data-v-7c98c01c${_scopeId4}>${ssrInterpolate(currentUser.value.name)}</span><span class="user-role" data-v-7c98c01c${_scopeId4}>${ssrInterpolate(currentUser.value.email)}</span></div>`);
                    ...
                    _push3(ssrRenderComponent(_component_el_main, { class: "admin-main" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="main-content-wrapper" data-v-7c98c01c${_scopeId3}>`);
...
const _mgmt_9Xfa3 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7c98c01c"]]);
export {
  _mgmt_9Xfa3 as default
};
//# sourceMappingURL=_mgmt_9Xfa3--kAluYQM.js.map
