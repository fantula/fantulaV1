...
import { n as arrow_left_default, W as user_default, X as wallet_default, Y as list_default, Z as ticket_default, _ as star_default, s as service_default, $ as bell_default, a0 as switch_button_default } from "./index-CRs4T-Jf.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(userStore).loading) {
        ...
        _push(`<div class="user-hero-content" data-v-c12b69ee><div class="avatar-wrapper" data-v-c12b69ee><img${ssrRenderAttr("src", unref(userStore).user?.avatar || unref(DEFAULT_AVATAR))} class="user-avatar" data-v-c12b69ee><div class="status-dot" data-v-c12b69ee></div></div><div class="user-info" data-v-c12b69ee><h3 class="user-nickname" data-v-c12b69ee>${ssrInterpolate(unref(userStore).user?.nickname || "FANTULA User")}</h3><div class="user-id-badge" data-v-c12b69ee><span data-v-c12b69ee>UID: ${ssrInterpolate(unref(userStore).user?.uid || "---")}</span></div></div></div>`);
      }
      ...
      ssrRenderList(menuGroups, (group) => {
        ...
        ssrRenderList(group.items, (item) => {
          ...
          _push(`</div><span class="menu-text" data-v-c12b69ee>${ssrInterpolate(item?.label)}</span>`);
...
//# sourceMappingURL=profile-BQQoVYTX.js.map
