...
import { W as user_default, a7 as copy_document_default, p as plus_default, i as info_filled_default, l as loading_default, e as circle_check_default, c as circle_close_default, D as arrow_down_default, S as warning_default, f as close_default, a3 as select_default, h as warning_filled_default, al as box_default, v as refresh_left_default, an as headset_default, ao as tickets_default, u as zoom_in_default } from "./index-CRs4T-Jf.js";
import { M as MobileSubPageHeader } from "./MobileSubPageHeader-BBaO6M-A.js";
import { M as MobileOrderProductInfo } from "./MobileOrderProductInfo-CZ_RBPft.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(allSlots.value, (slot) => {
        ...
        _push(`</div><div class="roommate-name" data-v-58ab82d2>${ssrInterpolate(slot.isMe ? "我" : slot.user?.nickname || "空")}</div><div class="slot-num" data-v-58ab82d2>${ssrInterpolate(slot.index)}号</div></div>`);
      });
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (visible.value) {
          ...
          if (loading.value) {
            ...
            if (availableCoupons.value.length > 0) {
              ...
              ssrRenderList(availableCoupons.value, (coupon) => {
                _push2(`<div class="${ssrRenderClass([{ active: selectedCoupon.value?.id === coupon.id }, "coupon-item-glass aurora-option-card"])}" data-v-520a0ed8><div class="c-left" data-v-520a0ed8><span class="c-name" data-v-520a0ed8>${ssrInterpolate(coupon.coupon.name)}</span></div><div class="c-right" data-v-520a0ed8>`);
                if (coupon.coupon.type === "flat") {
                  _push2(`<span class="c-val" data-v-520a0ed8>-¥${ssrInterpolate(coupon.coupon.value)}</span>`);
          ...
          if (discountAmount.value > 0) {
            _push2(`<div class="discount-tag" data-v-520a0ed8>已省 ¥${ssrInterpolate(discountAmount.value)}</div>`);
          } else {
            _push2(`<!---->`);
          }
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (visible.value) {
          ...
          ssrRenderList(form.attachments, (url, idx) => {
            _push2(`<div class="img-preview" data-v-c68ea6df><img${ssrRenderAttr("src", url)} data-v-c68ea6df><div class="del-btn" data-v-c68ea6df>×</div></div>`);
          });
          _push2(`<!--]-->`);
...
//# sourceMappingURL=_id_-B6i29kLO.js.map
