...
import { E as ElAvatar } from "./index-CGm1hG-X.js";
...
import { a as confirmAction } from "./useAdminDialog-DLYHZIYu.js";
import { n as refresh_right_default, b as close_default, ad as picture_default, I as check_default, h as circle_check_filled_default } from "./index-CCIZH4aC.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const handleFileSelect = async (event) => {
      ...
      try {
        const { getAuthToken } = await import("./supabase-Ds8OQlZJ.js");
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (error.value) {
              ...
              _push2(`<div class="user-details" data-v-4b48c80b${_scopeId}><div class="uid" data-v-4b48c80b${_scopeId}>UID: ${ssrInterpolate(ticket.value?.user_id?.substring(0, 8).toUpperCase())}</div>`);
              ...
              if (ticket.value?.orders) {
                _push2(`<div class="info-block" data-v-4b48c80b${_scopeId}><div class="label" data-v-4b48c80b${_scopeId}>关联订单快照</div><div class="order-card-large" data-v-4b48c80b${_scopeId}><img${ssrRenderAttr("src", ticket.value.orders.product_snapshot?.image)} class="order-img-large" data-v-4b48c80b${_scopeId}><div class="order-details-rows" data-v-4b48c80b${_scopeId}><div class="detail-row" data-v-4b48c80b${_scopeId}><span class="row-label" data-v-4b48c80b${_scopeId}>订单号</span><span class="row-value font-mono copyable" data-v-4b48c80b${_scopeId}>${ssrInterpolate(ticket.value.orders.order_no)}</span></div><div class="detail-row" data-v-4b48c80b${_scopeId}><span class="row-label" data-v-4b48c80b${_scopeId}>商品</span><span class="row-value"${ssrRenderAttr("title", ticket.value.orders.product_snapshot?.product_name)} data-v-4b48c80b${_scopeId}>${ssrInterpolate(ticket.value.orders.product_snapshot?.product_name)}</span></div>`);
                ...
                _push2(`<div class="detail-row" data-v-4b48c80b${_scopeId}><span class="row-label" data-v-4b48c80b${_scopeId}>金额</span><span class="row-value price" data-v-4b48c80b${_scopeId}>¥${ssrInterpolate(ticket.value.orders.total_amount?.toFixed(2))}</span></div>`);
                if (timeLeft.value) {
              ...
              if (ticket.value?.status !== "processing" && ticket.value?.status !== "resolved") {
                _push2(`<div class="text-xs text-red-400 text-center mb-2" data-v-4b48c80b${_scopeId}> 当前状态异常: ${ssrInterpolate(ticket.value?.status)}</div>`);
              } else {
                _push2(`<!---->`);
              }
...
//# sourceMappingURL=TicketChatModal-B00mgvo3.js.map
