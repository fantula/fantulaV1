...
import { ag as box_default, w as warning_filled_default } from "./index-DlETah8a.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-e1ad5eac><div class="card-header" data-v-e1ad5eac><div class="order-no-group" data-v-e1ad5eac><span class="label" data-v-e1ad5eac>NO.</span><span class="value" data-v-e1ad5eac>${ssrInterpolate(__props.order.order_no?.slice(-8) || "---")}</span></div><div class="${ssrRenderClass([__props.order.isPending ? "pending" : __props.order.status, "status-pill"])}" data-v-e1ad5eac><div class="dot" data-v-e1ad5eac></div><span data-v-e1ad5eac>${ssrInterpolate(__props.order.isPending ? "待支付" : unref(getOrderStatusLabel)(__props.order.status))}</span></div></div><div class="card-body" data-v-e1ad5eac><div class="thumb" data-v-e1ad5eac><img${ssrRenderAttr("src", __props.order.product_image || "/images/placeholder.png")} class="product-img" loading="lazy" decoding="async" data-v-e1ad5eac></div><div class="info" data-v-e1ad5eac><div class="name-row" data-v-e1ad5eac><span class="name-text" data-v-e1ad5eac>${ssrInterpolate(__props.order.product_name)}</span><span class="spec-inline" data-v-e1ad5eac>${ssrInterpolate(__props.order.spec_text || "标准规格")}</span></div><div class="price-row" data-v-e1ad5eac><div class="price" data-v-e1ad5eac><span class="unit" data-v-e1ad5eac>¥</span><span class="amount" data-v-e1ad5eac>${ssrInterpolate(Number(__props.order.total_amount).toFixed(2))}</span></div><div class="qty" data-v-e1ad5eac>x${ssrInterpolate(__props.order.quantity)}</div></div></div></div><div class="card-footer" data-v-e1ad5eac><div class="time" data-v-e1ad5eac>${ssrInterpolate(unref(formatDate)(__props.order.created_at))}</div><div class="actions" data-v-e1ad5eac>`);
...
//# sourceMappingURL=index-tJqaWiP3.js.map
