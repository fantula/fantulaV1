import { _ as __nuxt_component_0$2 } from "./nuxt-link-R7CyI21u.js";
/* empty css              */
/* empty css                    */
import { defineComponent, ref, watch, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, createVNode, createCommentVNode, withModifiers, withDirectives, vModelText, vModelCheckbox, nextTick, useSSRContext } from "vue";
...
import { _ as __nuxt_component_0$1 } from "./BaseModal-CiVpglQ1.js";
      ...
      _push(ssrRenderComponent(__nuxt_component_0$1, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><button class="modal-close" data-v-eedf9434${_scopeId}>×</button></div></div><div class="modal-body" data-v-eedf9434${_scopeId}><div class="modal-form-area" data-v-eedf9434${_scopeId}>`);
            if (mode.value === "login") {
            ...
            if (mode.value === "login" && loginType.value === "password") {
              ...
              if (wechatState.value === "loading") {
                ...
                _push2(`<div class="wechat-bind-form" data-v-eedf9434${_scopeId}><p class="bind-tip" data-v-eedf9434${_scopeId}>🎉 扫码成功！请绑定邮箱以完成登录</p><form data-v-eedf9434${_scopeId}><div class="form-group" data-v-eedf9434${_scopeId}><label data-v-eedf9434${_scopeId}>邮箱地址</label>`);
                _push2(ssrRenderComponent(EmailInput, {
...
//# sourceMappingURL=LoginRegisterModal-yj-0Rq6I.js.map
