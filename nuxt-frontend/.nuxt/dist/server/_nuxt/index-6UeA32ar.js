...
import { _ as delete_default, $ as shopping_cart_default, F as star_default, B as user_default, ag as arrow_up_bold_default } from "./index-DNnPa_Q9.js";
import { u as useUserStore } from "./user-CctDsbAN.js";
import { u as useHomeData } from "./useHomeData-C-v1sZSb.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const ProductDetailSheet = defineAsyncComponent(() => import("./ProductDetailSheet-By4Tig38.js"));
    const MobileLoginSheet = defineAsyncComponent(() => import("./MobileLoginSheet-BHKowgcb.js"));
    useRouter();
    useRoute();
    useUserStore();
    const {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((unref(pending) || unref(goodsLoading)) && unref(currentGoods).length === 0) {
        ...
        _push(`<div class="empty-state bg-glass-card" data-v-a7bf7e9f><div class="empty-icon" data-v-a7bf7e9f>📦</div><p class="text-muted text-sm" data-v-a7bf7e9f>暂无相关商品</p></div>`);
      } else {
...
//# sourceMappingURL=index-6UeA32ar.js.map
