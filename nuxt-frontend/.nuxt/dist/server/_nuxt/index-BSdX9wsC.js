...
/* empty css              */
/* empty css                    */
import { defineComponent, ref, computed, watch, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, Fragment, renderList, withModifiers, toDisplayString, createCommentVNode, createTextVNode, useSSRContext } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr } from "vue/server-renderer";
import { useRouter } from "vue-router";
import { h as arrow_left_default, W as star_default, x as delete_default } from "./index-4qszPKX4.js";
          ...
          if (_push2) {
            if (unref(displayList).length === 0 && !unref(loading)) {
              ...
              ssrRenderList(unref(displayList), (item) => {
                ...
                _push2(`<div class="product-price" data-v-d1c9baad${_scopeId}><span class="symbol" data-v-d1c9baad${_scopeId}>¥</span>${ssrInterpolate(item.price)}</div></div></div>`);
              });
              _push2(`<!--]--></div>`);
            }
          } else {
...
//# sourceMappingURL=index-BSdX9wsC.js.map
