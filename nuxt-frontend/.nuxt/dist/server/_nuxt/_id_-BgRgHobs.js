...
import { W as user_default, a8 as copy_document_default, p as plus_default, i as info_filled_default, l as loading_default, e as circle_check_default, c as circle_close_default, D as arrow_down_default, S as warning_default, f as close_default, a4 as select_default, h as warning_filled_default, am as box_default, v as refresh_left_default, ao as headset_default, ap as tickets_default, u as zoom_in_default } from "./index-DuV_oMrC.js";
import { M as MobileSubPageHeader } from "./MobileSubPageHeader-iRi1Uk9z.js";
import { M as MobileOrderProductInfo } from "./MobileOrderProductInfo-Dz-10UcG.js";
...
import { M as MobileContactModal } from "./MobileContactModal-D2_Mlz7X.js";
import "@vueuse/core";
import "@vue/shared";
import "./objects-Bz74KHmq.js";
import "lodash-unified";
import "./ticket-C7sv4DHi.js";
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (visible.value) {
          ...
          if (loading.value) {
            ...
            if (availableCoupons.value.length > 0) {
              ...
              ssrRenderList(availableCoupons.value, (coupon) => {
                _push2(`<div class="${ssrRenderClass([{ active: selectedCoupon.value?.id === coupon.id }, "coupon-item-glass aurora-option-card"])}" data-v-5f7944b0><div class="c-left" data-v-5f7944b0><span class="c-name" data-v-5f7944b0>${ssrInterpolate(coupon.coupon.name)}</span></div><div class="c-right" data-v-5f7944b0>`);
                if (coupon.coupon.type === "flat") {
                  _push2(`<span class="c-val" data-v-5f7944b0>-¥${ssrInterpolate(coupon.coupon.value)}</span>`);
          ...
          if (discountAmount.value > 0) {
            _push2(`<div class="discount-tag" data-v-5f7944b0>已省 ¥${ssrInterpolate(discountAmount.value)}</div>`);
          } else {
            _push2(`<!---->`);
          }
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (visible.value) {
          ...
          ssrRenderList(form.attachments, (url, idx) => {
            _push2(`<div class="img-preview" data-v-35e09935><img${ssrRenderAttr("src", url)} data-v-35e09935><div class="del-btn" data-v-35e09935>×</div></div>`);
          });
          _push2(`<!--]-->`);
...
//# sourceMappingURL=_id_-BgRgHobs.js.map
