...
import { am as box_default, L as picture_default, B as delete_default, m as arrow_right_default, S as warning_default } from "./index-DuV_oMrC.js";
import { u as useOrderList } from "./useOrderList-Ddg3MhcK.js";
import { u as useInfiniteScroll } from "./useInfiniteScroll-Cg7MWwox.js";
import { B as BaseInfiniteList } from "./BaseInfiniteList-D4mXnhlO.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "orders-page" }, _attrs))} data-v-8ef70167><div class="section-header" data-v-8ef70167><h2 class="section-title" data-v-8ef70167>我的订单</h2><div class="section-subtitle" data-v-8ef70167>Order History</div></div><div class="order-tabs" data-v-8ef70167><!--[-->`);
      ssrRenderList(unref(tabs), (tab) => {
        _push(`<div class="${ssrRenderClass(["tab-item", { active: unref(currentTab) === tab.value }])}" data-v-8ef70167><span data-v-8ef70167>${ssrInterpolate(tab.label)}</span>`);
        if (unref(currentTab) === tab.value) {
          _push(`<div class="active-glow" data-v-8ef70167></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      });
      _push(`<!--]--></div><div class="orders-scroll-area" data-v-8ef70167><div class="orders-container" data-v-8ef70167>`);
      _push(ssrRenderComponent(BaseInfiniteList, {
        ...
        loading: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(displayList).length === 0 && unref(loading)) {
              _push2(`<div class="loading-state" data-v-8ef70167${_scopeId}><div class="glass-loader" data-v-8ef70167${_scopeId}></div><p data-v-8ef70167${_scopeId}>正在加载订单...</p></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(displayList).length === 0 && !unref(loading)) {
              _push2(`<div class="empty-state" data-v-8ef70167${_scopeId}><div class="empty-icon-wrapper" data-v-8ef70167${_scopeId}>`);
              ...
              _push2(`</div><div class="empty-text" data-v-8ef70167${_scopeId}>暂无${ssrInterpolate(unref(getCurrentTabLabel)())}记录</div><button class="go-shopping-btn" data-v-8ef70167${_scopeId}>前往选购</button></div>`);
            } else {
              _push2(`<div class="order-list" data-v-8ef70167${_scopeId}><!--[-->`);
              ssrRenderList(unref(displayList), (item) => {
                _push2(`<div class="${ssrRenderClass([["status-" + (item.isPending ? "pending" : item.status)], "order-card"])}" data-v-8ef70167${_scopeId}><div class="status-line" data-v-8ef70167${_scopeId}></div><div class="card-inner" data-v-8ef70167${_scopeId}><div class="card-header" data-v-8ef70167${_scopeId}><div class="order-no-group" data-v-8ef70167${_scopeId}><span class="label" data-v-8ef70167${_scopeId}>NO.</span><span class="value" data-v-8ef70167${_scopeId}>${ssrInterpolate(item.order_no)}</span></div><div class="${ssrRenderClass([item.isPending ? "pending" : item.status, "status-pill"])}" data-v-8ef70167${_scopeId}><div class="dot" data-v-8ef70167${_scopeId}></div><span data-v-8ef70167${_scopeId}>${ssrInterpolate(item.isPending ? "待支付" : getStatusText(item.status))}</span></div></div><div class="card-body" data-v-8ef70167${_scopeId}><div class="product-thumb" data-v-8ef70167${_scopeId}>`);
                if (item.product_image) {
                  _push2(`<img${ssrRenderAttr("src", item.product_image)} class="thumb-img" loading="lazy" data-v-8ef70167${_scopeId}>`);
                } else {
                  _push2(`<div class="placeholder-img" data-v-8ef70167${_scopeId}>`);
                ...
                _push2(`</div><div class="product-info" data-v-8ef70167${_scopeId}><div class="name-row" data-v-8ef70167${_scopeId}><h3 class="product-name" data-v-8ef70167${_scopeId}>${ssrInterpolate(item.product_name)}</h3><span class="spec-tag" data-v-8ef70167${_scopeId}>${ssrInterpolate(item.spec_text || "标准规格")}</span></div><div class="price-row" data-v-8ef70167${_scopeId}><div class="price" data-v-8ef70167${_scopeId}><span class="amount" data-v-8ef70167${_scopeId}>${ssrInterpolate(Number(item.total_amount).toFixed(2))}</span><span class="unit" data-v-8ef70167${_scopeId}>点</span></div><div class="qty" data-v-8ef70167${_scopeId}>x${ssrInterpolate(item.quantity)}</div></div></div></div><div class="card-footer" data-v-8ef70167${_scopeId}><div class="order-time" data-v-8ef70167${_scopeId}>${ssrInterpolate(unref(formatTime)(item.created_at))}</div><div class="card-actions" data-v-8ef70167${_scopeId}>`);
                if (item.isPending || item.status === "pending") {
                  _push2(`<!--[--><button class="action-btn delete" data-v-8ef70167${_scopeId}>`);
                  _push2(ssrRenderComponent(_component_el_icon, null, {
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                  ...
                  _push2(`</button><button class="action-btn pay" data-v-8ef70167${_scopeId}>去支付</button><!--]-->`);
                } else if (["expired", "refunded", "cancelled"].includes(item.status)) {
                  _push2(`<button class="action-btn cleanup" data-v-8ef70167${_scopeId}>`);
                  _push2(ssrRenderComponent(_component_el_icon, null, {
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(ssrRenderComponent(unref(delete_default), null, null, _parent3, _scopeId2));
                  ...
                  _push2(`<button class="action-btn view" data-v-8ef70167${_scopeId}>查看详情 `);
                  _push2(ssrRenderComponent(_component_el_icon, null, {
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
      ...
      _push(ssrRenderComponent(__nuxt_component_0, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="confirm-content" data-v-8ef70167${_scopeId}><div class="confirm-icon" data-v-8ef70167${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_icon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`</div><p class="confirm-text" data-v-8ef70167${_scopeId}>${ssrInterpolate(confirmModalMessage.value)}</p></div>`);
          } else {
            return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8ef70167"]]);
export {
  index as default
};
//# sourceMappingURL=index-DS-ZJs0d.js.map
