...
import { ae as arrow_up_bold_default, Z as shopping_cart_default, F as star_default, B as user_default, Y as delete_default } from './index-CbQ9NNm4.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const MobileLoginSheet = defineAsyncComponent(() => import('./MobileLoginSheet-WIOZ1cel.mjs'));
    useRouter();
    useRoute();
    useUserStore();
    const {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((unref(pending) || unref(goodsLoading)) && unref(currentGoods).length === 0) {
        ...
        _push(`<div class="empty-state bg-glass-card" data-v-28eac39f><div class="empty-icon" data-v-28eac39f>\u{1F4E6}</div><p class="text-muted text-sm" data-v-28eac39f>\u6682\u65E0\u76F8\u5173\u5546\u54C1</p></div>`);
      } else {
...
//# sourceMappingURL=index-BwBTUztx.mjs.map
