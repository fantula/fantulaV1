...
import { a as ElSkeletonItem } from './index-Buprbscf.mjs';
...
import { g as circle_check_filled_default, X as lightning_default, am as umbrella_default, al as question_filled_default, f as arrow_right_default, i as info_filled_default, a0 as star_filled_default, F as star_default, b as close_default } from './index-DNnPa_Q9.mjs';
...
import { u as useProductDetail } from './useProductDetail-DLP8HdIq.mjs';
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (showDetailViewer.value) {
          ...
          if (unref(detailModules).length === 0) {
            _push2(`<div class="empty-detail" data-v-96760cd5><div class="empty-icon" data-v-96760cd5>\u{1F4E6}</div><span data-v-96760cd5>\u6682\u65E0\u8BE6\u60C5</span></div>`);
          } else {
            _push2(`<!--[-->`);
...
//# sourceMappingURL=ProductDetailSheet-By4Tig38.mjs.map
