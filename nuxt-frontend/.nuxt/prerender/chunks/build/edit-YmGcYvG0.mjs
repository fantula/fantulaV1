...
import { defineComponent, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode, createTextVNode, toDisplayString, isRef, ref, computed, reactive, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { o as picture_filled_default, al as arrow_up_default, a7 as arrow_down_default, Y as delete_default, ab as picture_default, q as document_default } from './index-CbQ9NNm4.mjs';
import { A as AdminImageSelector } from './AdminImageSelector-Df4rVl5Q.mjs';
import { S as StickyFormHeader } from './StickyFormHeader-BZCvzXYo.mjs';
import { T as TagInputGroup } from './TagInputGroup-DmN54XOf.mjs';
...
import './AdminDataDialog-DgjGDqf6.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "product-post-page" }, _attrs))} data-v-d810f851>`);
      ...
      _push(`<div class="main-body" data-v-d810f851><div class="content-wrapper" data-v-d810f851>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_card, {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card-header" data-v-d810f851${_scopeId2}>\u57FA\u672C\u4FE1\u606F</div>`);
                } else {
                  return [
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_el_form_item, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="image-gallery-trigger" data-v-d810f851${_scopeId5}>`);
                                    if (unref(form).image) {
                                      ...
                                      _push6(`<div class="trigger-content" data-v-d810f851${_scopeId5}>`);
                                      ...
                                      _push6(`<span data-v-d810f851${_scopeId5}>\u5C01\u9762\u56FE</span></div>`);
                                    }
                                    if (unref(form).image) {
                                      _push6(`<div class="trigger-overlay" data-v-d810f851${_scopeId5}>\u66F4\u6362\u56FE\u7247</div>`);
                                    } else {
                                      _push6(`<!---->`);
                                    }
                                    _push6(`</div><div class="form-tip" data-v-d810f851${_scopeId5}>\u5EFA\u8BAE\u5C3A\u5BF8 800x800</div>`);
                                  } else {
                                    return [
                                      createVNode("div", {
            ...
            _push2(ssrRenderComponent(_component_el_card, {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card-header" data-v-d810f851${_scopeId2}>\u8425\u9500\u4E0E\u5C55\u793A</div>`);
                } else {
                  return [
                              ...
                              _push5(ssrRenderComponent(_component_el_form_item, { label: "\u5C55\u793A\u4EF7\u683C" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(`<div class="form-tip" data-v-d810f851${_scopeId5}>\u5217\u8868\u9875\u8D77\u6B65\u4EF7</div>`);
                                  } else {
                                    return [
                                      createVNode(_component_el_input_number, {
                                        modelValue: unref(form).displayPrice,
            ...
            _push2(ssrRenderComponent(_component_el_card, {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card-header" data-v-d810f851${_scopeId2}><span data-v-d810f851${_scopeId2}>\u5546\u54C1\u8BE6\u60C5</span><div class="header-actions" data-v-d810f851${_scopeId2}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="detail-module-list" data-v-d810f851${_scopeId2}><!--[-->`);
                  ssrRenderList(unref(form).detailModules, (mod, idx) => {
                    _push3(`<div class="detail-module-item" data-v-d810f851${_scopeId2}><div class="module-actions" data-v-d810f851${_scopeId2}>`);
                    ...
                    _push3(`<div class="action-btns" data-v-d810f851${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_el_button, {
                      link: "",
                      disabled: idx === 0,
                    ...
                    _push3(`</div></div><div class="module-display" data-v-d810f851${_scopeId2}>`);
                    if (mod.type === "image") {
                      _push3(`<div class="module-image-trigger" data-v-d810f851${_scopeId2}>`);
                      if (mod.content) {
                        ...
                        _push3(`<div class="image-placeholder" data-v-d810f851${_scopeId2}>`);
                        ...
                        _push3(`<span data-v-d810f851${_scopeId2}>\u70B9\u51FB\u9009\u62E9\u56FE\u7247</span></div>`);
                      }
                      _push3(`</div>`);
                    } else {
                  ...
                  if (unref(form).detailModules.length === 0) {
                    _push3(`<div class="empty-detail-tip" data-v-d810f851${_scopeId2}> \u6682\u65E0\u8BE6\u60C5\u5185\u5BB9\uFF0C\u8BF7\u70B9\u51FB\u4E0A\u65B9\u6309\u94AE\u6DFB\u52A0 </div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/products/edit.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const edit = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d810f851"]]);

export { edit as default };
//# sourceMappingURL=edit-YmGcYvG0.mjs.map
