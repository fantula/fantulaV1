import { _ as _export_sfc, C as __nuxt_component_0$2, H as useState, f as useRouter$1 } from './server.mjs';
import { defineComponent, mergeProps, unref, ref, watch, withCtx, createVNode, createTextVNode, openBlock, createBlock, toDisplayString, resolveDynamicComponent, computed, nextTick, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { af as shopping_cart_default, ag as star_filled_default, _ as star_default, aa as chat_dot_round_default, aU as platform_default, $ as bell_default, ay as video_play_default, B as delete_default, O as search_default, l as loading_default, n as circle_check_filled_default, ah as right_default, e as warning_filled_default } from './index-CRs4T-Jf.mjs';
import getSupabaseClient from './supabase-Ds8OQlZJ.mjs';
import { supabasePreOrderApi } from './supabase-D4dCvdwD.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(userStore).isLoggedIn) {
        ...
        if (unref(userStore).loading) {
          ...
          _push(`<div class="user-info" title="\u8FDB\u5165\u4E2A\u4EBA\u4E2D\u5FC3" data-v-604fe7d5><img${ssrRenderAttr("src", ((_a = unref(userStore).user) == null ? void 0 : _a.avatar) || unref(DEFAULT_AVATAR))}${ssrRenderAttr("alt", ((_b = unref(userStore).user) == null ? void 0 : _b.nickName) || ((_c = unref(userStore).user) == null ? void 0 : _c.nickname) || "\u7528\u6237\u5934\u50CF")} class="user-avatar" data-v-604fe7d5><span class="user-name" data-v-604fe7d5>${ssrInterpolate(((_d = unref(userStore).user) == null ? void 0 : _d.nickName) || ((_e = unref(userStore).user) == null ? void 0 : _e.nickname) || "\u7528\u6237")}</span></div>`);
        }
        _push(`</div></div>`);
      }
...
//# sourceMappingURL=pc-D-Xp3T-9.mjs.map
