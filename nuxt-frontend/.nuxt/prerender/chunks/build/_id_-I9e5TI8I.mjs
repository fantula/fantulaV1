import { _ as _export_sfc, E as ElIcon, z as arrow_left_default, b6 as timer_default, bj as question_filled_default, aZ as arrow_down_default, a3 as info_filled_default, f as arrow_right_default, a5 as wallet_default, b9 as refresh_default, aI as select_default, d as useUserStore, ah as ElMessage, o as getSupabaseClient, ak as setInterval } from './server.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrRenderStyle, ssrIncludeBooleanAttr } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(preOrders), (order) => {
          var _a2, _b;
          _push(`<div class="order-card glass-card" data-v-7e7f7ac5><div class="order-header-row" data-v-7e7f7ac5><span class="order-no" data-v-7e7f7ac5>\u8BA2\u5355\u53F7: ${ssrInterpolate(order.order_no)}</span><span class="order-status" data-v-7e7f7ac5>\u5F85\u652F\u4ED8</span></div><div class="order-body" data-v-7e7f7ac5><div class="product-thumb" data-v-7e7f7ac5><div class="sq-cover-img-container" data-v-7e7f7ac5><img${ssrRenderAttr("src", ((_a2 = order.product_snapshot) == null ? void 0 : _a2.image) || "/images/shared/logo.png")} class="sq-cover-img" data-v-7e7f7ac5></div></div><div class="product-info" data-v-7e7f7ac5><div class="product-name" data-v-7e7f7ac5>${ssrInterpolate((_b = order.product_snapshot) == null ? void 0 : _b.product_name)}</div><div class="product-meta-row" data-v-7e7f7ac5>`);
...
//# sourceMappingURL=_id_-I9e5TI8I.mjs.map
