...
import { h as arrow_left_default, $ as shopping_cart_default, F as star_default, a0 as star_filled_default, i as info_filled_default, e as circle_check_default } from './index-DNnPa_Q9.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const FaqTicker = defineAsyncComponent(() => import('./FaqTicker-zv4QXmzP.mjs'));
    ...
    const handleAddToCartWrapper = async (event) => {
      const { useCartStore: useCartStore2 } = await import('./cart-CDhPH3qi.mjs');
...
//# sourceMappingURL=_id_-Bi_CsUQj.mjs.map
