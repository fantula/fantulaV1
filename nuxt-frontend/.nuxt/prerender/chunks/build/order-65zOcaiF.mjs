...
const adminOrderApi = {
  ...
  async getVirtualRechargeDetail(id) {
    return this.getOrderDetail(id);
  },
  async getShareOrderDetail(id) {
    return this.getOrderDetail(id);
  },
  async getCdkeyOrderDetail(id) {
    return this.getOrderDetail(id);
  },
  /**
   * 更新订单状态
...
export { adminOrderApi as a };
//# sourceMappingURL=order-65zOcaiF.mjs.map
