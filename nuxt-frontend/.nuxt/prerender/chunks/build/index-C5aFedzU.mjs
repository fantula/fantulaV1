import { defineComponent, defineAsyncComponent, ref, mergeProps, unref, withCtx, createVNode, watch, computed, nextTick, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (goodsLoading.value && currentGoods.value.length === 0) {
        ...
        _push(`<div class="empty-state bg-glass-card" data-v-8152ba4d><div class="empty-icon" data-v-8152ba4d>\u{1F4E6}</div><p class="text-muted text-sm" data-v-8152ba4d>\u6682\u65E0\u76F8\u5173\u5546\u54C1</p></div>`);
      } else {
...
//# sourceMappingURL=index-C5aFedzU.mjs.map
