...
import { _ as _export_sfc, z as arrow_left_default, an as edit_default } from './server.mjs';
...
import { O as OrderItemCell } from './OrderItemCell-BDl1NDlB.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function openEdit() {
      router.push(`/_mgmt_9Xfa3/orders/recharge/post?id=${order.value.id}`);
    }
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="detail-wrapper" data-v-b231b180>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/_mgmt_9Xfa3/orders/recharge/detail.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const detail = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b231b180"]]);

export { detail as default };
//# sourceMappingURL=detail-7WTksD_H.mjs.map
