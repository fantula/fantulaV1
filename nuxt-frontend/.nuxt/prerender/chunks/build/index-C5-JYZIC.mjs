...
import { defineComponent, ref, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, Fragment, renderList, watch, nextTick, createTextVNode, resolveDynamicComponent, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrGetDirectiveProps, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrRenderAttr, ssrRenderVNode } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { l as loading_default, a as arrow_right_default, m as monitor_default, s as service_default, t as trophy_default, b as share_default } from './index-4qszPKX4.mjs';
import { _ as _export_sfc, g as useRoute, u as useRouter, b as useRuntimeConfig, n as navigateTo } from './server.mjs';
...
import { _ as __nuxt_component_2$1 } from './LoginRegisterModal-CQuqnDUY.mjs';
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-71d9cac5"]]);
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "category-nav" }, _attrs))} data-v-cb1a976c><div class="category-outer" data-v-cb1a976c><div class="category-scroll" data-v-cb1a976c><!--[-->`);
      ssrRenderList(props.categories, (cat) => {
        _push(`<div class="${ssrRenderClass([{ active: props.activeId === cat.id }, "category-item"])}" data-v-cb1a976c><span class="cat-label" data-v-cb1a976c>${ssrInterpolate(cat.name)}</span></div>`);
      });
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-cb1a976c"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "goods-section" }, _attrs))} data-v-4affc949><div class="container" data-v-4affc949>`);
      if (__props.loading) {
        _push(`<div class="goods-grid" data-v-4affc949><!--[-->`);
        ssrRenderList(8, (i) => {
          _push(`<div class="goods-card" data-v-4affc949><div style="${ssrRenderStyle({ "padding": "24px" })}" data-v-4affc949>`);
          _push(ssrRenderComponent(_component_el_skeleton, { animated: "" }, {
            template: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(`<div style="${ssrRenderStyle({ "display": "flex", "justify-content": "space-between", "margin-bottom": "20px" })}" data-v-4affc949${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_skeleton_item, {
                  variant: "text",
                  style: { "width": "30%" }
                }, null, _parent2, _scopeId));
        ...
        ssrRenderList(__props.goodsList, (item) => {
          _push(`<div class="goods-card" data-v-4affc949>`);
          if (item.badge_label && item.badge_label !== "\u4E0D\u5C55\u793A") {
            _push(`<div class="${ssrRenderClass([getBadgeClass(item.badge_label), "badge-label"])}" data-v-4affc949>${ssrInterpolate(item.badge_label)}</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="goods-image-container" data-v-4affc949>`);
          _push(ssrRenderComponent(_component_el_image, {
            ...
            placeholder: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="image-placeholder" data-v-4affc949${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_skeleton_item, {
                  variant: "image",
          ...
          _push(`</div><div class="goods-card-content" data-v-4affc949><h3 class="goods-title"${ssrRenderAttr("title", item.product_name)} data-v-4affc949>${ssrInterpolate(item.product_name)}</h3><div class="goods-price-row" data-v-4affc949><span class="price-val" data-v-4affc949>${ssrInterpolate(formatPrice(item.display_price))}</span><span class="price-unit" data-v-4affc949>/\u8D77</span></div>`);
          if (parseTags(item.tags).length) {
            _push(`<div class="selling-tags" data-v-4affc949><!--[-->`);
            ssrRenderList(parseTags(item.tags).slice(0, 3), (tag, tIdx) => {
              _push(`<span class="sell-tag" data-v-4affc949>${ssrInterpolate(tag)}</span>`);
            });
            _push(`<!--]--></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="goods-stats" data-v-4affc949><div class="stat-item" data-v-4affc949><span class="stat-label" data-v-4affc949>\u9500\u91CF</span> <span class="stat-value" data-v-4affc949>${ssrInterpolate(formatSales(item.initial_sales || 0))}</span></div><div class="stat-item rating" data-v-4affc949><span class="stat-label" data-v-4affc949>\u597D\u8BC4\u5EA6</span> <span class="stat-value" data-v-4affc949>${ssrInterpolate(item.rating)}%</span></div></div><div class="action-btn-wrap" data-v-4affc949>`);
        ...
        _push(`<div class="error-state" data-v-4affc949>`);
        ...
        _push(`<div class="empty-state" data-v-4affc949>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-4affc949"]]);
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-443c8716"]]);
const PAGE_SIZE = 10;
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-page" }, _attrs))} data-v-60c4051a>`);
      ...
      _push(`<div class="goods-container" data-v-60c4051a>`);
      ...
      if (!goodsLoading.value && currentGoods.value.length === 0) {
        _push(`<div class="empty-state" data-v-60c4051a>`);
      ...
      if (hasMore.value && currentGoods.value.length > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "load-more-trigger" }, ssrGetDirectiveProps(_ctx, vIntersectionObserver, loadMore)))} data-v-60c4051a>`);
        if (isLoadingMore.value) {
          _push(`<div class="loading-more-spinner" data-v-60c4051a>`);
      ...
      if (!hasMore.value && currentGoods.value.length > 0) {
        _push(`<div class="no-more-data" data-v-60c4051a> - \u5230\u5E95\u4E86 - </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-60c4051a"]]);

export { index as default };
//# sourceMappingURL=index-C5-JYZIC.mjs.map
