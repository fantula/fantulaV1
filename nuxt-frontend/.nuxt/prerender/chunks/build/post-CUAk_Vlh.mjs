...
import { E as ElUpload } from './index-B-lUxOPb.mjs';
import { E as ElImage } from './index-CEmMQsAU.mjs';
import { E as ElEmpty } from './index-bbvp9z3V.mjs';
import { v as vLoading } from './directive-DYMvUrfr.mjs';
...
import { h as arrow_left_default, Y as delete_default, p as plus_default, ac as minus_default, ar as cpu_default, ab as picture_default, g as circle_check_filled_default } from './index-CbQ9NNm4.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "cdk-post-page" }, _attrs))} data-v-07db5a3b><div class="wizard-header" data-v-07db5a3b><div class="header-left" data-v-07db5a3b>`);
      ...
      _push(`<div class="header-titles" data-v-07db5a3b><div class="main-title" data-v-07db5a3b>\u6DFB\u52A0\u8D44\u6E90</div><div class="sub-title" data-v-07db5a3b>ADD RESOURCES</div></div></div><div class="header-center" data-v-07db5a3b>`);
      ...
      _push(`</div><div class="header-right" data-v-07db5a3b></div></div><div class="wizard-body" data-v-07db5a3b><div class="centered-container" data-v-07db5a3b><div class="step-content" style="${ssrRenderStyle(activeStep.value === 0 ? null : { display: "none" })}" data-v-07db5a3b><div class="form-card" data-v-07db5a3b><h3 class="card-title" data-v-07db5a3b>\u57FA\u7840\u4FE1\u606F</h3>`);
                        ...
                        ssrRenderList(filteredProducts.value, (prod) => {
                          _push4(ssrRenderComponent(_component_el_option, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<span style="${ssrRenderStyle({ "float": "left" })}" data-v-07db5a3b${_scopeId4}>${ssrInterpolate(prod.product_name)}</span><span style="${ssrRenderStyle({ "float": "right", "color": "#8492a6", "font-size": "13px" })}" data-v-07db5a3b${_scopeId4}>${ssrInterpolate(getTypeText(prod.product_type))}</span>`);
                              } else {
                                return [
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (currentCdkType.value === "virtual") {
                      _push3(`<div data-v-07db5a3b${_scopeId2}>\u7CFB\u7EDF\u5C06\u5F15\u5BFC\u60A8\u914D\u7F6E\u5E93\u5B58\u6570\u91CF\u4E0E\u8BA2\u5355\u586B\u5199\u5B57\u6BB5\u3002</div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (currentCdkType.value === "shared_account") {
                      _push3(`<div data-v-07db5a3b${_scopeId2}>\u7CFB\u7EDF\u5C06\u5F15\u5BFC\u60A8\u8F93\u5165\u8D26\u53F7\u5BC6\u7801\u53CA\u6700\u5927\u5E76\u53D1\u6570\u3002</div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (currentCdkType.value === "one_time_cdk") {
                      _push3(`<div data-v-07db5a3b${_scopeId2}>\u7CFB\u7EDF\u5C06\u5F15\u5BFC\u60A8\u6279\u91CF\u5BFC\u5165\u6FC0\u6D3B\u7801\u5185\u5BB9\u3002</div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                  } else {
      ...
      _push(`</div></div><div class="step-content" style="${ssrRenderStyle(activeStep.value === 1 ? null : { display: "none" })}" data-v-07db5a3b><div class="form-card" data-v-07db5a3b><h3 class="card-title" data-v-07db5a3b>\u8D44\u6E90\u914D\u7F6E: ${ssrInterpolate(getTypeText(currentCdkType.value))}</h3>`);
      if (currentCdkType.value === "virtual") {
        _push(`<div data-v-07db5a3b>`);
        _push(ssrRenderComponent(_component_el_form, {
          model: formVirtual,
          "label-position": "top"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_el_form_item, { label: "\u53EF\u7528\u5E93\u5B58\u6570" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<div class="form-tip" data-v-07db5a3b${_scopeId2}>\u8BBE\u7F6E\u8BE5\u8D44\u6E90\u7684\u53EF\u7528\u670D\u52A1\u4F4D\u6570\u91CF (\u5982 GPT KEY \u7684\u5E76\u53D1\u4E0A\u9650)</div>`);
                  } else {
                    return [
              ...
              _push2(`<div class="dynamic-fields" data-v-07db5a3b${_scopeId}><!--[-->`);
              ssrRenderList(formVirtual.fields, (field, idx) => {
                _push2(`<div class="field-row" data-v-07db5a3b${_scopeId}>`);
              ...
              _push2(`<div class="form-tip" data-v-07db5a3b${_scopeId}>\u7528\u6237\u4E0B\u5355\u65F6\u9700\u8981\u586B\u5199\u7684\u8F85\u52A9\u4FE1\u606F\u5B57\u6BB5\u3002</div></div>`);
            } else {
              return [
        ...
        _push(ssrRenderComponent(_component_el_form, { "label-position": "top" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_el_form_item, { label: "\u6700\u5927\u8F66\u4F4D\u6570" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<div class="form-tip" data-v-07db5a3b${_scopeId2}>\u51B3\u5B9A\u8BE5\u8D44\u6E90\u53EF\u540C\u65F6\u670D\u52A1\u7684\u7528\u6237\u6570</div>`);
                  } else {
                    return [
                      createVNode(_component_el_input_number, {
                        modelValue: formShared.maxSlots,
              ...
              _push2(`<div class="kv-list" data-v-07db5a3b${_scopeId}><!--[-->`);
              ssrRenderList(formShared.attributes, (attr, idx) => {
                _push2(`<div class="kv-row" data-v-07db5a3b${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_input, {
                  modelValue: attr.key,
                ...
                _push2(`<span class="separator" data-v-07db5a3b${_scopeId}>:</span>`);
                _push2(ssrRenderComponent(_component_el_input, {
        ...
        _push(ssrRenderComponent(_component_el_form, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<div class="card-actions" data-v-07db5a3b${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_button, {
                type: "primary",
                onClick: parseCards,
              ...
              if (!cardParsedResult.value) {
                _push2(`<span class="parse-tip" data-v-07db5a3b${_scopeId}>\u672A\u89E3\u6790\uFF0C\u8BF7\u5148\u70B9\u51FB\u89E3\u6790\u6309\u94AE</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
              if (cardParsedResult.value) {
                _push2(`<div class="parse-dashboard" data-v-07db5a3b${_scopeId}><div class="stat-item success" data-v-07db5a3b${_scopeId}><span class="num" data-v-07db5a3b${_scopeId}>${ssrInterpolate(cardParsedResult.value.valid.length)}</span><span class="label" data-v-07db5a3b${_scopeId}>\u53EF\u7528\u6570\u91CF</span></div><div class="stat-item warning" data-v-07db5a3b${_scopeId}><span class="num" data-v-07db5a3b${_scopeId}>${ssrInterpolate(cardParsedResult.value.duplicates.length)}</span><span class="label" data-v-07db5a3b${_scopeId}>\u91CD\u590D/\u5E93\u5B58\u5DF2\u5B58</span></div><div class="stat-item danger" data-v-07db5a3b${_scopeId}><span class="num" data-v-07db5a3b${_scopeId}>${ssrInterpolate(cardParsedResult.value.invalid.length)}</span><span class="label" data-v-07db5a3b${_scopeId}>\u683C\u5F0F\u65E0\u6548</span></div></div>`);
              } else {
                _push2(`<!---->`);
              }
      ...
      _push(`<div class="common-section" data-v-07db5a3b><span class="section-label" data-v-07db5a3b>\u8BE6\u60C5\u9875\u5E2E\u52A9\u56FE\u7247 (\u53EF\u9009)</span><div class="image-selector" data-v-07db5a3b>`);
      if (commonImage.value) {
        _push(`<img${ssrRenderAttr("src", commonImage.value)} class="preview-img" data-v-07db5a3b>`);
      } else {
        _push(`<div class="placeholder" data-v-07db5a3b>`);
        ...
        _push(`<span data-v-07db5a3b>\u9009\u62E9\u56FE\u7247</span></div>`);
      }
      _push(`</div></div></div></div><div class="step-content" style="${ssrRenderStyle(activeStep.value === 2 ? null : { display: "none" })}" data-v-07db5a3b><div class="form-card confirmation-card" data-v-07db5a3b><div class="success-icon" data-v-07db5a3b>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</div><h2 data-v-07db5a3b>\u51C6\u5907\u5C31\u7EEA</h2><p data-v-07db5a3b>\u8BF7\u786E\u8BA4\u4EE5\u4E0B\u4FE1\u606F\u65E0\u8BEF\u540E\u63D0\u4EA4</p><div class="summary-box" data-v-07db5a3b><div class="summary-item" data-v-07db5a3b><span class="label" data-v-07db5a3b>\u5546\u54C1:</span><span class="value" data-v-07db5a3b>${ssrInterpolate((_a = currentProduct.value) == null ? void 0 : _a.product_name)}</span></div><div class="summary-item" data-v-07db5a3b><span class="label" data-v-07db5a3b>SKU:</span><span class="value" data-v-07db5a3b>${ssrInterpolate(skuOptions.value.filter((s) => formStep1.skuIds.includes(s.id)).map((s) => s.label).join(", ") || "\u901A\u7528")}</span></div><div class="summary-item" data-v-07db5a3b><span class="label" data-v-07db5a3b>\u7C7B\u578B:</span><span class="value" data-v-07db5a3b>${ssrInterpolate(getTypeText(currentCdkType.value))}</span></div>`);
      _push(ssrRenderComponent(_component_el_divider, null, null, _parent));
      if (currentCdkType.value === "virtual") {
        _push(`<div data-v-07db5a3b><div class="summary-item" data-v-07db5a3b><span class="label" data-v-07db5a3b>\u65B0\u589E\u5E93\u5B58:</span> <span class="value" data-v-07db5a3b>${ssrInterpolate(formVirtual.stock)}</span></div><div class="summary-item" data-v-07db5a3b><span class="label" data-v-07db5a3b>\u914D\u7F6E\u5B57\u6BB5:</span> <span class="value" data-v-07db5a3b>${ssrInterpolate(formVirtual.fields.join(", ") || "\u65E0")}</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (currentCdkType.value === "shared_account") {
        _push(`<div data-v-07db5a3b><div class="summary-item" data-v-07db5a3b><span class="label" data-v-07db5a3b>\u6700\u5927\u8F66\u4F4D\u6570:</span> <span class="value" data-v-07db5a3b>${ssrInterpolate(formShared.maxSlots)}</span></div><div class="summary-item" data-v-07db5a3b><span class="label" data-v-07db5a3b>\u5C5E\u6027\u5B57\u6BB5:</span> <span class="value" data-v-07db5a3b>${ssrInterpolate(formShared.attributes.map((a) => a.key).join("/"))}</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (currentCdkType.value === "one_time_cdk") {
        _push(`<div data-v-07db5a3b><div class="summary-item" data-v-07db5a3b><span class="label" data-v-07db5a3b>\u6709\u6548\u6FC0\u6D3B\u7801:</span> <span class="value highlight" data-v-07db5a3b>${ssrInterpolate(((_c = (_b = cardParsedResult.value) == null ? void 0 : _b.valid) == null ? void 0 : _c.length) || 0)}</span> \u6761</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div></div></div><div class="wizard-footer" data-v-07db5a3b>`);
      _push(ssrRenderComponent(_component_el_button, {
        size: "large",
        onClick: prevStep,
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="picker-container" data-v-07db5a3b${_scopeId}><div class="picker-sidebar" data-v-07db5a3b${_scopeId}><div class="${ssrRenderClass([{ active: pickerActiveCatId.value === "" }, "picker-cat-item"])}" data-v-07db5a3b${_scopeId}>\u5168\u90E8\u56FE\u7247</div><!--[-->`);
            ssrRenderList(pickerCategories.value, (cat) => {
              _push2(`<div class="${ssrRenderClass([{ active: pickerActiveCatId.value === cat.id }, "picker-cat-item"])}" data-v-07db5a3b${_scopeId}>${ssrInterpolate(cat.name)}</div>`);
            });
            _push2(`<!--]--></div><div${ssrRenderAttrs(mergeProps({ class: "picker-main" }, ssrGetDirectiveProps(_ctx, _directive_loading, pickerLoading.value)))} data-v-07db5a3b${_scopeId}><div class="picker-toolbar" data-v-07db5a3b${_scopeId}>`);
            ...
            _push2(`</div><div class="picker-grid" data-v-07db5a3b${_scopeId}><!--[-->`);
            ssrRenderList(galleryImages.value, (img) => {
              _push2(`<div class="picker-img-card" data-v-07db5a3b${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_image, {
                src: img.url,
                fit: "cover"
              }, null, _parent2, _scopeId));
              _push2(`<div class="picker-img-name" data-v-07db5a3b${_scopeId}>${ssrInterpolate(img.name)}</div></div>`);
            });
            _push2(`<!--]--></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/cdk/post.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const post = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-07db5a3b"]]);

export { post as default };
//# sourceMappingURL=post-CUAk_Vlh.mjs.map
