...
import { aB as data_line_default, a5 as files_default, s as service_default, x as monitor_default } from './index-CbQ9NNm4.mjs';
import { P as PageTipHeader } from './PageTipHeader-BwP3Y8-M.mjs';
import { _ as _export_sfc, j as useRuntimeConfig } from './server.mjs';
import { getEdgeFunctionsUrl, getAuthToken } from './supabase-Ds8OQlZJ.mjs';
import { u as useSupabaseSession } from './useSupabaseSession-2l1XDO7-.mjs';
import { u as useFetch } from './fetch-Dk_hX_ae.mjs';
  ...
  const checkAll = async () => {
    ...
    try {
      ...
      if (!result || !result.success) {
        throw new Error((result == null ? void 0 : result.error) || "Check Failed");
      }
      const probe = result.results;
      const dbCheck = (_a = probe.checks) == null ? void 0 : _a.database;
      if ((dbCheck == null ? void 0 : dbCheck.status) === "ok") {
        dbStatus.value = { type: "success", text: `Connected (${dbCheck.latency})` };
      } else {
        dbStatus.value = { type: "danger", text: (dbCheck == null ? void 0 : dbCheck.error) || "Failed" };
      }
      const r2Check = (_b = probe.checks) == null ? void 0 : _b.r2_connectivity;
      if ((r2Check == null ? void 0 : r2Check.status) === "ok") {
        r2Status.value = { type: "success", text: `Connected (${r2Check.latency})` };
      } else {
        r2Status.value = { type: "danger", text: (r2Check == null ? void 0 : r2Check.error) || "Failed" };
      }
      const netCheck = (_c = probe.checks) == null ? void 0 : _c.internal_network;
      if ((netCheck == null ? void 0 : netCheck.status) === "ok") {
        networkStatus.value = { type: "success", text: `OK (${netCheck.latency})` };
      } else {
        networkStatus.value = { type: "danger", text: (netCheck == null ? void 0 : netCheck.error) || "Failed" };
      }
      const webCheck = (_d = probe.checks) == null ? void 0 : _d.external_internet;
      if ((webCheck == null ? void 0 : webCheck.status) === "ok") {
        internetStatus.value = { type: "success", text: `Online (${webCheck.latency})` };
      } else {
        internetStatus.value = { type: "danger", text: (webCheck == null ? void 0 : webCheck.error) || "Offline" };
      }
    } catch (e) {
...
//# sourceMappingURL=index-DKFeTmnW.mjs.map
