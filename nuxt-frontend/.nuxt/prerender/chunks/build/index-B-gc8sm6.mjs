  ...
  setup(__props, { emit: __emit }) {
    ...
    const handleDeleteAccount = async () => {
      try {
        ...
        if (res.success) {
          const { ElMessageBox: ElMessageBox2 } = await import('./index-Bnqwh5bC.mjs');
...
//# sourceMappingURL=index-B-gc8sm6.mjs.map
