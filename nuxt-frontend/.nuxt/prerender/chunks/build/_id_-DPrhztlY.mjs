...
import { a5 as headset_default } from './index-CCIZH4aC.mjs';
import { u as useUserStore } from './user-DLDq0pTF.mjs';
import { M as MobileSubPageHeader } from './MobileSubPageHeader-D74TXOlf.mjs';
import { M as MobileOrderProductInfo } from './MobileOrderProductInfo-Y9j6-WWG.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="info-card-glass ticket-status-card" data-v-930c18cd><div class="card-head" data-v-930c18cd><div class="${ssrRenderClass([(_a = ticketInfo.value) == null ? void 0 : _a.status, "status-badge"])}" data-v-930c18cd><div class="dot" data-v-930c18cd></div> ${ssrInterpolate(getStatusText((_b = ticketInfo.value) == null ? void 0 : _b.status))}</div><div class="ticket-no" data-v-930c18cd>NO. ${ssrInterpolate(((_c = ticketInfo.value) == null ? void 0 : _c.ticket_no) || ((_d = ticketInfo.value) == null ? void 0 : _d.id))}</div></div><div class="card-body" data-v-930c18cd><div class="desc-row" data-v-930c18cd><span class="label" data-v-930c18cd>\u95EE\u9898:</span><span class="val text-highlight" data-v-930c18cd>${ssrInterpolate((_e = ticketInfo.value) == null ? void 0 : _e.title)}</span></div><div class="time-row" data-v-930c18cd>${ssrInterpolate(formatTime((_f = ticketInfo.value) == null ? void 0 : _f.created_at))}</div></div></div><div class="divider" data-v-930c18cd><span data-v-930c18cd>\u6C9F\u901A\u8BB0\u5F55</span></div><div class="messages-list" data-v-930c18cd><!--[-->`);
        ssrRenderList(messages.value, (msg) => {
          ...
          if (msg.sender === "user") {
            _push(`<img${ssrRenderAttr("src", ((_a2 = unref(userStore).user) == null ? void 0 : _a2.avatar) || unref(DEFAULT_AVATAR))} data-v-930c18cd>`);
          } else {
...
//# sourceMappingURL=_id_-DPrhztlY.mjs.map
