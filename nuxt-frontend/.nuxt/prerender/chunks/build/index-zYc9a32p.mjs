...
import { A as AdminModuleLayout } from './AdminModuleLayout-V9a1Gk3f.mjs';
...
import { B as delete_default } from './index-CRs4T-Jf.mjs';
import TicketChatModal from './TicketChatModal-CmvecED6.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AdminModuleLayout, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-6" data-v-25e7fae7${_scopeId}>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_table_column, {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="mono-text cursor-pointer hover:text-blue-600" data-v-25e7fae7${_scopeId3}>${ssrInterpolate(row.ticket_no || `T-${row.id.substring(0, 8).toUpperCase()}`)}</span><div class="sub-text mt-1" data-v-25e7fae7${_scopeId3}>${ssrInterpolate(unref(formatDate)(row.created_at).split(" ")[0])}</div>`);
                      } else {
                        return [
                          createVNode("span", {
                  ...
                  _push3(ssrRenderComponent(_component_el_table_column, {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        if (row.orders) {
                          _push4(`<div data-v-25e7fae7${_scopeId3}><div class="mono-text cursor-pointer hover:text-blue-600" data-v-25e7fae7${_scopeId3}>${ssrInterpolate(row.orders.order_no)}</div><div class="sub-text truncate"${ssrRenderAttr("title", (_a = row.orders.product_snapshot) == null ? void 0 : _a.product_name)} data-v-25e7fae7${_scopeId3}>${ssrInterpolate((_b = row.orders.product_snapshot) == null ? void 0 : _b.product_name)}</div></div>`);
                        } else {
                          _push4(`<div class="sub-text text-gray-400" data-v-25e7fae7${_scopeId3}>-</div>`);
                        }
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_el_table_column, {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      var _a, _b, _c, _d;
                      if (_push4) {
                        _push4(`<div class="font-medium truncate mb-1 cursor-pointer hover:text-blue-500" data-v-25e7fae7${_scopeId3}>${ssrInterpolate(row.title)}</div><div class="sub-text truncate" data-v-25e7fae7${_scopeId3}>${ssrInterpolate(((_b = (_a = row.ticket_messages) == null ? void 0 : _a[0]) == null ? void 0 : _b.content) || "\u6682\u65E0\u6D88\u606F")}</div>`);
                      } else {
                        return [
                          createVNode("div", {
                  ...
                  _push3(ssrRenderComponent(_component_el_table_column, {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      var _a, _b, _c, _d;
                      if (_push4) {
                        _push4(`<div class="user-cell" data-v-25e7fae7${_scopeId3}><div class="w-8 h-8 rounded bg-gray-100 flex items-center justify-center text-xs font-mono text-gray-500" data-v-25e7fae7${_scopeId3}>${ssrInterpolate(row.user_id.substring(0, 2).toUpperCase())}</div><div class="flex flex-col min-w-0" data-v-25e7fae7${_scopeId3}><span class="mono-text text-xs" data-v-25e7fae7${_scopeId3}>UID: ${ssrInterpolate(row.user_id.substring(0, 8).toUpperCase())}</span><span class="sub-text truncate"${ssrRenderAttr("title", (_a = row.profiles) == null ? void 0 : _a.email)} data-v-25e7fae7${_scopeId3}>${ssrInterpolate(((_b = row.profiles) == null ? void 0 : _b.email) || "\u672A\u77E5\u7528\u6237")}</span></div></div>`);
                      } else {
                        return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/tickets/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-25e7fae7"]]);

export { index as default };
//# sourceMappingURL=index-zYc9a32p.mjs.map
