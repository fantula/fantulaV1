...
import { l as loading_default, av as video_play_default, K as document_default } from './index-CmsdIFY8.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(categoryTags.value, (tag) => {
        ...
        if (activeTag.value === tag.key && activeTag.value !== "all") {
          _push(`<span class="reset-hint" data-v-a36853c4>\xD7</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</button>`);
...
//# sourceMappingURL=community-DPdyd822.mjs.map
