...
import { defineComponent, defineAsyncComponent, withAsyncContext, ref, computed, mergeProps, unref, withCtx, createVNode, watch, nextTick, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { ag as arrow_up_bold_default, $ as shopping_cart_default, F as star_default, B as user_default, _ as delete_default } from './index-DNnPa_Q9.mjs';
import { u as useUserStore } from './user-CctDsbAN.mjs';
import { u as useHomeData } from './useHomeData-C-v1sZSb.mjs';
import { _ as _export_sfc, w as __nuxt_component_0$2 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const ProductDetailSheet = defineAsyncComponent(() => import('./ProductDetailSheet-By4Tig38.mjs'));
    const MobileLoginSheet = defineAsyncComponent(() => import('./MobileLoginSheet-BHKowgcb.mjs'));
    useRouter();
    useRoute();
    useUserStore();
    const {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_el_icon = ElIcon;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mobile-home-page" }, _attrs))} data-v-a7bf7e9f>`);
      _push(ssrRenderComponent(HomeHeader, {
        "is-scrolled": isScrolled.value,
        onOpenLogin: ($event) => showLoginSheet.value = true
      }, null, _parent));
      _push(`<div class="content-scroll no-scrollbar" data-v-a7bf7e9f>`);
      ...
      _push(`<div class="pull-refresh-indicator" style="${ssrRenderStyle({ height: `${pullDistance.value}px`, opacity: pullDistance.value > 0 ? 1 : 0 })}" data-v-a7bf7e9f>`);
      if (isRefreshing.value) {
        _push(`<div class="spinner-mini" data-v-a7bf7e9f></div>`);
      } else {
        _push(`<span class="text-xs text-muted" data-v-a7bf7e9f>${ssrInterpolate(pullText.value)}</span>`);
      }
      _push(`</div><div class="goods-list-section" data-v-a7bf7e9f>`);
      if ((unref(pending) || unref(goodsLoading)) && unref(currentGoods).length === 0) {
        _push(`<div class="loading-state" data-v-a7bf7e9f><!--[-->`);
        ssrRenderList(6, (i) => {
          _push(ssrRenderComponent(MobileProductCardSkeleton, { key: i }, null, _parent));
        });
        _push(`<!--]--></div>`);
      } else if (unref(currentGoods).length === 0) {
        _push(`<div class="empty-state bg-glass-card" data-v-a7bf7e9f><div class="empty-icon" data-v-a7bf7e9f>\u{1F4E6}</div><p class="text-muted text-sm" data-v-a7bf7e9f>\u6682\u65E0\u76F8\u5173\u5546\u54C1</p></div>`);
      } else {
        _push(`<div class="goods-list" data-v-a7bf7e9f><!--[-->`);
      ...
      if (unref(hasMore) && unref(currentGoods).length > 0) {
        _push(`<div class="load-more-trigger" data-v-a7bf7e9f>`);
        if (unref(isLoadingMore)) {
          _push(`<div class="loading-more" data-v-a7bf7e9f><div class="spinner-mini" data-v-a7bf7e9f></div> \u52A0\u8F7D\u66F4\u591A... </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (!unref(hasMore) && unref(currentGoods).length > 0) {
        _push(`<div class="no-more-data" data-v-a7bf7e9f> - \u5230\u5E95\u4E86 - </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="tab-bar-spacer" data-v-a7bf7e9f></div></div><button class="back-to-top-btn" style="${ssrRenderStyle(showBackToTop.value ? null : { display: "none" })}" data-v-a7bf7e9f>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a7bf7e9f"]]);

export { index as default };
//# sourceMappingURL=index-6UeA32ar.mjs.map
