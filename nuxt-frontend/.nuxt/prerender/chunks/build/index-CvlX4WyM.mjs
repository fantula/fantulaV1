...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "root-loading" }, _attrs))} data-v-34cad796></div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-34cad796"]]);

export { index as default };
//# sourceMappingURL=index-CvlX4WyM.mjs.map
