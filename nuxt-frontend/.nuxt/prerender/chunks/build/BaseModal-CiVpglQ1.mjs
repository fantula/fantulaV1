import { defineComponent, computed, ref, withCtx, createTextVNode, toDisplayString, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderTeleport, ssrRenderClass, ssrRenderStyle, ssrInterpolate, ssrRenderSlot, ssrRenderComponent, ssrRenderAttr } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        var _a;
        if (__props.visible) {
          _push2(`<div class="base-modal-overlay" data-v-1e4cbe85><div class="${ssrRenderClass([__props.customClass, "base-modal-container"])}" style="${ssrRenderStyle({ width: containerWidth.value })}" data-v-1e4cbe85>`);
          if (__props.showHeader) {
            _push2(`<div class="base-modal-header" data-v-1e4cbe85><h3 class="base-modal-title" data-v-1e4cbe85>${ssrInterpolate(__props.title)}</h3>`);
            if (__props.showClose) {
              _push2(`<button class="base-modal-close" data-v-1e4cbe85>\xD7</button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
          ...
          _push2(`<div class="base-modal-body" style="${ssrRenderStyle({ padding: __props.contentPadding })}" data-v-1e4cbe85>`);
          ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent);
          _push2(`</div>`);
          if (__props.showFooter) {
            _push2(`<div class="base-modal-actions" data-v-1e4cbe85>`);
          ...
          if (currentTheme.value.mascotImg) {
            _push2(`<img${ssrRenderAttr("src", currentTheme.value.mascotImg)} class="${ssrRenderClass([[`phantom-${currentTheme.value.mascotPosition}`, currentTheme.value.variantClass], "modal-mascot-phantom"])}" style="${ssrRenderStyle({
              ...
              "--mascot-final-opacity": (_a = currentTheme.value.opacity) != null ? _a : 1
            })}" data-v-1e4cbe85>`);
          } else {
            _push2(`<!---->`);
          }
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1e4cbe85"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=BaseModal-CiVpglQ1.mjs.map
