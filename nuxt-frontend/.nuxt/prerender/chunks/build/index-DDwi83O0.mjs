...
import { u as useHomeData } from './useHomeData-BGtmFa-M.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const ProductDetailSheet = defineAsyncComponent(() => import('./ProductDetailSheet-DlI7QI1D.mjs'));
    const MobileLoginSheet = defineAsyncComponent(() => import('./MobileLoginSheet-FEVXLXBZ.mjs'));
    useRouter();
    useRoute();
    useUserStore();
    const {
...
//# sourceMappingURL=index-DDwi83O0.mjs.map
