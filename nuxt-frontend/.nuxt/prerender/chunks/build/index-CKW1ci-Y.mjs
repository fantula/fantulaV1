...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ProductDetailSheet = defineAsyncComponent(() => import('./ProductDetailSheet-GnnFiDMI.mjs'));
    const MobileLoginSheet = defineAsyncComponent(() => import('./MobileLoginSheet-eVcTsj0N.mjs'));
    useRouter();
    useRoute();
    useUserStore();
    const {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_el_icon = ElIcon;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mobile-home-page" }, _attrs))} data-v-17ef5014>`);
      _push(ssrRenderComponent(HomeHeader, {
        "is-scrolled": isScrolled.value,
        onOpenLogin: ($event) => showLoginSheet.value = true
      }, null, _parent));
      _push(`<div class="content-scroll no-scrollbar" data-v-17ef5014>`);
      ...
      _push(`<div class="pull-refresh-indicator" style="${ssrRenderStyle({ height: `${pullDistance.value}px`, opacity: pullDistance.value > 0 ? 1 : 0 })}" data-v-17ef5014>`);
      if (isRefreshing.value) {
        _push(`<div class="spinner-mini" data-v-17ef5014></div>`);
      } else {
        _push(`<span class="text-xs text-muted" data-v-17ef5014>${ssrInterpolate(unref(pullText))}</span>`);
      }
      _push(`</div><div class="goods-list-section" data-v-17ef5014>`);
      if (unref(goodsLoading) && unref(currentGoods).length === 0) {
        _push(`<div class="loading-state" data-v-17ef5014><!--[-->`);
        ssrRenderList(6, (i) => {
          _push(ssrRenderComponent(MobileProductCardSkeleton, { key: i }, null, _parent));
        });
        _push(`<!--]--></div>`);
      } else if (unref(currentGoods).length === 0) {
        _push(`<div class="empty-state bg-glass-card" data-v-17ef5014><div class="empty-icon" data-v-17ef5014>\u{1F4E6}</div><p class="text-muted text-sm" data-v-17ef5014>\u6682\u65E0\u76F8\u5173\u5546\u54C1</p></div>`);
      } else {
        _push(`<div class="goods-list" data-v-17ef5014><!--[-->`);
      ...
      if (unref(hasMore) && unref(currentGoods).length > 0) {
        _push(`<div class="load-more-trigger" data-v-17ef5014>`);
        if (unref(isLoadingMore)) {
          _push(`<div class="loading-more" data-v-17ef5014><div class="spinner-mini" data-v-17ef5014></div> \u52A0\u8F7D\u66F4\u591A... </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (!unref(hasMore) && unref(currentGoods).length > 0) {
        _push(`<div class="no-more-data" data-v-17ef5014> - \u5230\u5E95\u4E86 - </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="tab-bar-spacer" data-v-17ef5014></div></div><button class="back-to-top-btn" style="${ssrRenderStyle(showBackToTop.value ? null : { display: "none" })}" data-v-17ef5014>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-17ef5014"]]);

export { index as default };
//# sourceMappingURL=index-CKW1ci-Y.mjs.map
