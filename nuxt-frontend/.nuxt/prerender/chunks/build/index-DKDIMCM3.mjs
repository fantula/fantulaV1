...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "loading-container" }, _attrs))} data-v-8a9448df>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8a9448df"]]);

export { index as default };
//# sourceMappingURL=index-DKDIMCM3.mjs.map
