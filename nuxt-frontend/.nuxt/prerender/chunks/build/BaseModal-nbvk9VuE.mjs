  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        var _a;
        if (__props.visible) {
          _push2(`<div class="base-modal-overlay" data-v-cb5ecbd9><div class="${ssrRenderClass([__props.customClass, "base-modal-container"])}" style="${ssrRenderStyle({ width: containerWidth.value, padding: __props.contentPadding })}" data-v-cb5ecbd9>`);
          if (__props.showHeader) {
            _push2(`<div class="base-modal-header" data-v-cb5ecbd9><h3 class="base-modal-title" data-v-cb5ecbd9>${ssrInterpolate(__props.title)}</h3>`);
            if (__props.showClose) {
              _push2(`<button class="base-modal-close" data-v-cb5ecbd9>\xD7</button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
          ...
          _push2(`<div class="base-modal-body" data-v-cb5ecbd9>`);
          ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent);
          _push2(`</div>`);
          if (__props.showFooter) {
            _push2(`<div class="base-modal-actions" data-v-cb5ecbd9>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cb5ecbd9"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=BaseModal-nbvk9VuE.mjs.map
