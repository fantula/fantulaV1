...
import { defineComponent, ref, mergeProps, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, toDisplayString, createCommentVNode, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "faq-category-page" }, _attrs))} data-v-653f6e6b><div class="page-actions" data-v-653f6e6b>`);
      ...
      _push(`</div><div${ssrRenderAttrs(mergeProps({ class: "content-card" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-653f6e6b>`);
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dialog-footer" data-v-653f6e6b${_scopeId}>`);
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_el_form_item, { label: "\u7ED3\u7B97\u9875\u663E\u793A" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_el_switch, {
                          modelValue: form.value.is_checkout_visible,
                          "onUpdate:modelValue": ($event) => form.value.is_checkout_visible = $event
                        }, null, _parent4, _scopeId3));
                        _push4(`<div class="form-tip" data-v-653f6e6b${_scopeId3}>\u5F00\u542F\u540E\uFF0C\u8BE5\u5206\u7C7B\u4E0B\u7684\u95EE\u9898\u5C06\u663E\u793A\u5728\u7ED3\u7B97\u754C\u9762\u3002</div>`);
                      } else {
                        return [
                          createVNode(_component_el_switch, {
                            modelValue: form.value.is_checkout_visible,
                          ...
                          createVNode("div", { class: "form-tip" }, "\u5F00\u542F\u540E\uFF0C\u8BE5\u5206\u7C7B\u4E0B\u7684\u95EE\u9898\u5C06\u663E\u793A\u5728\u7ED3\u7B97\u754C\u9762\u3002")
                        ];
                      }
                    }),
                    _: 1
...
const faqCategories = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-653f6e6b"]]);

export { faqCategories as default };
//# sourceMappingURL=faq-categories-DAMmG-fa.mjs.map
