...
import { defineComponent, ref, computed, reactive, watch, mergeProps, withCtx, createVNode, createTextVNode, openBlock, createBlock, toDisplayString, createCommentVNode, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
        ...
        if (valid) {
          ...
          try {
            ...
            if (res.success) {
              ...
              router.push(adminRoute("coupons/flat"));
            } else {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "coupon-post-page" }, _attrs))} data-v-039327b7>`);
      ...
      _push(`<div class="form-content" data-v-039327b7>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_card, {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card-header" data-v-039327b7${_scopeId2}><span data-v-039327b7${_scopeId2}>\u57FA\u7840\u4FE1\u606F</span></div>`);
                } else {
                  return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                              ...
                              _push5(ssrRenderComponent(_component_el_form_item, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(`<div class="form-tip" data-v-039327b7${_scopeId5}>\u8BA2\u5355\u6EE1\u591A\u5C11\u5143\u53EF\u7528\uFF080\u8868\u793A\u65E0\u95E8\u69DB\uFF09</div>`);
                                  } else {
                                    return [
                                      createVNode(_component_el_input_number, {
                                        modelValue: form.minUsage,
                  ...
                  _push3(ssrRenderComponent(_component_el_form_item, { label: "\u6709\u6548\u671F" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="date-picker-wrapper" data-v-039327b7${_scopeId3}>`);
                        if (!isUnlimitedDate.value) {
                          _push4(`<div class="date-text" data-v-039327b7${_scopeId3}><span class="label" data-v-039327b7${_scopeId3}>\u5F00\u59CB\uFF1A</span><span class="value" data-v-039327b7${_scopeId3}>${ssrInterpolate(formatDate(form.startDate))}</span></div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        if (!isUnlimitedDate.value) {
                        ...
                        _push4(`</div>`);
                        if (!isUnlimitedDate.value) {
                          _push4(`<div class="form-tip" data-v-039327b7${_scopeId3}>\u9ED8\u8BA4\u4ECE\u4ECA\u65E5\u5F00\u59CB\u751F\u6548\uFF0C\u8BF7\u9009\u62E9\u622A\u6B62\u65E5\u671F</div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
            ...
            _push2(ssrRenderComponent(_component_el_card, {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card-header" data-v-039327b7${_scopeId2}><span data-v-039327b7${_scopeId2}>\u6548\u679C\u9884\u89C8</span></div>`);
                } else {
                  return [
                    createVNode("div", { class: "card-header" }, [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="preview-container" data-v-039327b7${_scopeId2}><div class="coupon-ticket flat-ticket" data-v-039327b7${_scopeId2}><div class="ticket-left" data-v-039327b7${_scopeId2}><div class="ticket-amount" data-v-039327b7${_scopeId2}><small data-v-039327b7${_scopeId2}>\xA5</small>${ssrInterpolate(form.value || "0")}</div><div class="ticket-cond" data-v-039327b7${_scopeId2}>\u6EE1 ${ssrInterpolate(form.minUsage)} \u53EF\u7528</div></div><div class="ticket-right" data-v-039327b7${_scopeId2}><div class="ticket-name" data-v-039327b7${_scopeId2}>${ssrInterpolate(form.name || "\u4F18\u60E0\u5238\u540D\u79F0")}</div><div class="ticket-date" data-v-039327b7${_scopeId2}>${ssrInterpolate(isUnlimitedDate.value ? "\u6C38\u4E45\u6709\u6548" : `${formatDate(form.startDate)} \u81F3 ${form.endDate || "?"}`)}</div><div class="ticket-btn" data-v-039327b7${_scopeId2}>\u7ACB\u5373\u9886\u53D6</div></div></div></div>`);
                } else {
                  return [
...
const post = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-039327b7"]]);

export { post as default };
//# sourceMappingURL=post-B6pS0Av8.mjs.map
