...
import { defineComponent, mergeProps, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, createTextVNode, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "sticky-form-header" }, _attrs))} data-v-785b4f95><div class="header-left" data-v-785b4f95>`);
      _push(ssrRenderComponent(_component_el_button, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="header-titles" data-v-785b4f95${_scopeId}><div class="main-title" data-v-785b4f95${_scopeId}>${ssrInterpolate(__props.title)}</div>`);
            if (__props.subtitle) {
              _push2(`<div class="sub-title" data-v-785b4f95${_scopeId}>${ssrInterpolate(__props.subtitle)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
      ...
      _push(`</div><div class="header-right" data-v-785b4f95>`);
...
const StickyFormHeader = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-785b4f95"]]);

export { StickyFormHeader as S };
//# sourceMappingURL=StickyFormHeader-BEb9UJKB.mjs.map
