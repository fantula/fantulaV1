...
import { aS as home_filled_default, aT as grid_default, s as service_default, W as user_default } from './index-DuV_oMrC.mjs';
...
import MobileLoginSheet from './MobileLoginSheet-DPgXXBiL.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mobile-layout" }, _attrs))} data-v-eb514d28><div class="mobile-bg-layer" data-v-eb514d28></div><main class="mobile-content" data-v-eb514d28>`);
...
const mobile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-eb514d28"]]);

export { mobile as default };
//# sourceMappingURL=mobile-DoDwxsEC.mjs.map
