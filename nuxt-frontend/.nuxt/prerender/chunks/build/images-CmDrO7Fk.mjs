...
import { ad as picture_default, at as folder_remove_default, au as folder_default, av as setting_default, U as refresh_default, aw as upload_default, V as view_default, J as edit_default, _ as delete_default, R as check_default } from './index-DNnPa_Q9.mjs';
import { d as adminImageCategoryApi, a as adminImageApi } from './media-dze9BKD9.mjs';
import { c as confirmAction, a as confirmDelete } from './useAdminDialog-LVLqZ-7L.mjs';
...
import { getAuthToken } from './supabase-F2pQZHm6.mjs';
  ...
  setup(__props) {
    ...
    const syncFromR2 = async () => {
      ...
      try {
        ...
        const { getEdgeFunctionsUrl } = await import('./supabase-F2pQZHm6.mjs');
...
//# sourceMappingURL=images-CmDrO7Fk.mjs.map
