...
import { b as adminArticleApi } from './help-center-d-ts0aZv.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-page" }, _attrs))} data-v-c4752290>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_button, {
              ...
              onClick: ($event) => unref(router).push(unref(adminRoute)("help-center/articles/post"))
            }, {
...
const articles = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c4752290"]]);

export { articles as default };
//# sourceMappingURL=articles-D1tsgbKR.mjs.map
