...
import { h as arrow_left_default, J as edit_default } from './index-CbQ9NNm4.mjs';
...
import { O as OrderItemCell } from './OrderItemCell-fzJPELTG.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function openEdit() {
      router.push(`/manager_portal/orders/share/post?id=${order.value.id}`);
    }
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="detail-wrapper" data-v-e9a29098>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/orders/share/detail.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const detail = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e9a29098"]]);

export { detail as default };
//# sourceMappingURL=detail-BwqoZBG5.mjs.map
