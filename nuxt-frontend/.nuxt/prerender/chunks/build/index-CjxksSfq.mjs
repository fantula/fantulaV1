...
import { defineComponent, defineAsyncComponent, ref, resolveComponent, resolveDirective, mergeProps, withCtx, createVNode, unref, openBlock, createBlock, Fragment, renderList, watch, nextTick, createTextVNode, computed, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrGetDirectiveProps, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrRenderAttr } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { l as loading_default, a as arrow_right_default } from './index-DlETah8a.mjs';
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-cb1a976c"]]);
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_el_skeleton_item = ElSkeletonItem;
      const _component_el_icon = ElIcon;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "goods-card" }, _attrs))} data-v-f6c1a360>`);
      if (__props.goods.badge_label && __props.goods.badge_label !== "\u4E0D\u5C55\u793A") {
        _push(`<div class="${ssrRenderClass([getBadgeClass(__props.goods.badge_label), "badge-label"])}" data-v-f6c1a360>${ssrInterpolate(__props.goods.badge_label)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="goods-image-container" data-v-f6c1a360>`);
      _push(ssrRenderComponent(_component_el_image, {
        ...
        placeholder: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="image-placeholder" data-v-f6c1a360${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_skeleton_item, {
              variant: "image",
      ...
      _push(`</div><div class="goods-card-content" data-v-f6c1a360><h3 class="goods-title"${ssrRenderAttr("title", __props.goods.product_name)} data-v-f6c1a360>${ssrInterpolate(__props.goods.product_name)}</h3><div class="goods-price-row" data-v-f6c1a360><span class="price-val" data-v-f6c1a360>${ssrInterpolate(unref(formatPrice)(__props.goods.display_price))}</span><span class="price-unit" data-v-f6c1a360>/\u8D77</span></div>`);
      if (tagsList.value.length) {
        _push(`<div class="selling-tags" data-v-f6c1a360><!--[-->`);
        ssrRenderList(tagsList.value.slice(0, 3), (tag, tIdx) => {
          _push(`<span class="sell-tag" data-v-f6c1a360>${ssrInterpolate(tag)}</span>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="goods-stats" data-v-f6c1a360><div class="stat-item" data-v-f6c1a360><span class="stat-label" data-v-f6c1a360>\u9500\u91CF</span><span class="stat-value" data-v-f6c1a360>${ssrInterpolate(formatSales(__props.goods.initial_sales || 0))}</span></div><div class="stat-item rating" data-v-f6c1a360><span class="stat-label" data-v-f6c1a360>\u597D\u8BC4\u5EA6</span><span class="stat-value" data-v-f6c1a360>${ssrInterpolate(__props.goods.rating)}%</span></div></div><div class="action-btn-wrap" data-v-f6c1a360>`);
...
const ProductCard = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-f6c1a360"]]);
const _sfc_main$2 = {};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const AboutSection = defineAsyncComponent(() => import('./AboutSection-C31NmaWE.mjs'));
    const LoginRegisterModal = defineAsyncComponent(() => import('./LoginRegisterModal-Bk5ohhhl.mjs'));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-page" }, _attrs))} data-v-67341392>`);
      ...
      _push(`<div class="goods-container" data-v-67341392>`);
      ...
      if (!goodsLoading.value && currentGoods.value.length === 0) {
        _push(`<div class="empty-state" data-v-67341392>`);
      ...
      if (hasMore.value && currentGoods.value.length > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "load-more-trigger" }, ssrGetDirectiveProps(_ctx, _directive_intersection_observer, loadMore)))} data-v-67341392>`);
        if (isLoadingMore.value) {
          _push(`<div class="loading-more-spinner" data-v-67341392>`);
      ...
      if (!hasMore.value && currentGoods.value.length > 0) {
        _push(`<div class="no-more-data" data-v-67341392> - \u5230\u5E95\u4E86 - </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-67341392"]]);

export { index as default };
//# sourceMappingURL=index-CjxksSfq.mjs.map
