...
import { A as refresh_default, p as plus_default } from './index-CRs4T-Jf.mjs';
import { _ as _export_sfc } from './server.mjs';
import { u as useBizFormat } from './useBizFormat-CLwhy_Ih.mjs';
import { u as useAdminCouponList } from './useAdminCouponList-BD1AOB8t.mjs';
...
import { C as CouponCodeGenerator, a as CouponCodeDrawer, _ as _sfc_main$1 } from './CouponCodeEditor-0XP0o81J.mjs';
...
import './useAdminList-BaLXphr7.mjs';
...
import './index-DltvidSo.mjs';
import './index-DGk0tJv4.mjs';
import './index-uVJ2GEO7.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const {
      ...
      selectedIds,
      refresh: loadList,
      // Alias refresh to loadList for compatibility
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "coupon-balance-list" }, _attrs))} data-v-72c54226>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="code-info" data-v-72c54226${_scopeId2}><div class="code-name" data-v-72c54226${_scopeId2}>${ssrInterpolate(row.name)}</div></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="amount" data-v-72c54226${_scopeId2}>${ssrInterpolate(unref(formatPrice)(row.value))}</span>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (!row.end_date) {
                    _push3(`<div class="validity-tag" data-v-72c54226${_scopeId2}>\u6C38\u4E45\u6709\u6548</div>`);
                  } else {
                    _push3(`<div class="validity-range" data-v-72c54226${_scopeId2}><div data-v-72c54226${_scopeId2}>${ssrInterpolate(unref(formatDate)(row.start_date))}</div><div class="date-sep" data-v-72c54226${_scopeId2}>\u81F3</div><div data-v-72c54226${_scopeId2}>${ssrInterpolate(unref(formatDate)(row.end_date))}</div></div>`);
                  }
                } else {
                  return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-72c54226"]]);

export { index as default };
//# sourceMappingURL=index-DQfFoOBv.mjs.map
