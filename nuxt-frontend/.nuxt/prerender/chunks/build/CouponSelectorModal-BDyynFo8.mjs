...
import { defineComponent, computed, ref, toRef, watch, mergeProps, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderClass, ssrRenderList, ssrInterpolate, ssrRenderAttrs, ssrRenderStyle, ssrRenderSlot, ssrIncludeBooleanAttr } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { _ as _export_sfc } from './server.mjs';
import { B as BaseCouponTicket } from './BaseCouponTicket-bOGhbUT0.mjs';
import { i as info_filled_default, A as refresh_default, h as circle_close_default } from './index-CRs4T-Jf.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.visible) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "modal-mask" }, _attrs))} data-v-09f1bee1><div class="modal-business" style="${ssrRenderStyle({ width: __props.width })}" data-v-09f1bee1>`);
        if (__props.showHeader) {
          _push(`<div class="modal-header" data-v-09f1bee1><div class="header-content" data-v-09f1bee1><div class="modal-title" data-v-09f1bee1>${ssrInterpolate(__props.title)}</div>`);
          if (__props.subtitle) {
            _push(`<div class="modal-subtitle" data-v-09f1bee1>${ssrInterpolate(__props.subtitle)}</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div><button class="modal-close" data-v-09f1bee1>\xD7</button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="${ssrRenderClass([{ "no-header": !__props.showHeader }, "modal-body"])}" data-v-09f1bee1>`);
        ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
        _push(`</div>`);
        if (__props.showFooter) {
          _push(`<div class="modal-footer" data-v-09f1bee1><div class="footer-left" data-v-09f1bee1>`);
          ssrRenderSlot(_ctx.$slots, "footer-left", {}, null, _push, _parent);
          _push(`</div><div class="footer-right" data-v-09f1bee1>`);
          ssrRenderSlot(_ctx.$slots, "footer-right", {}, () => {
            if (__props.showCancel) {
              _push(`<button class="btn btn-secondary"${ssrIncludeBooleanAttr(__props.loading) ? " disabled" : ""} data-v-09f1bee1>${ssrInterpolate(__props.cancelText)}</button>`);
            } else {
              _push(`<!---->`);
            }
            if (__props.showConfirm) {
              _push(`<button class="btn btn-primary"${ssrIncludeBooleanAttr(__props.loading || __props.confirmDisabled) ? " disabled" : ""} data-v-09f1bee1>`);
              if (__props.loading) {
                _push(`<span class="btn-loading" data-v-09f1bee1></span>`);
              } else {
                _push(`<!---->`);
              }
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/pc/modal/base/BaseBusinessModal.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const BaseBusinessModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-09f1bee1"]]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(BaseBusinessModal, mergeProps({
        ...
        "footer-left": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (tempSelected.value) {
              _push2(`<div class="selected-info" data-v-e4c8b1f9${_scopeId}> \u5DF2\u9009\u62E9: <span class="highlight" data-v-e4c8b1f9${_scopeId}>${ssrInterpolate(tempSelected.value.coupon.name)}</span><span class="discount-preview" data-v-e4c8b1f9${_scopeId}>-\xA5${ssrInterpolate(tempSelected.value.coupon.value)}</span></div>`);
            } else {
              _push2(`<div class="selected-info" data-v-e4c8b1f9${_scopeId}> \u672A\u9009\u62E9\u4F18\u60E0\u5238 </div>`);
            }
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="coupon-selector-content" data-v-e4c8b1f9${_scopeId}><div class="action-header" data-v-e4c8b1f9${_scopeId}><div class="header-tip" data-v-e4c8b1f9${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_component_el_button, {
              ...
              size: "small",
              class: "refresh-btn",
              onClick: unref(loadCoupons),
              loading: unref(listLoading)
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="coupon-list-container" data-v-e4c8b1f9${_scopeId}>`);
            if (unref(listLoading)) {
              _push2(`<div class="loading-state" data-v-e4c8b1f9${_scopeId}><div class="spinner" data-v-e4c8b1f9${_scopeId}></div> \u6B63\u5728\u83B7\u53D6\u4F18\u60E0\u5238... </div>`);
            } else if (unref(coupons).length === 0) {
              _push2(`<div class="empty-state" data-v-e4c8b1f9${_scopeId}>`);
              ...
              _push2(`<div class="coupon-list" data-v-e4c8b1f9${_scopeId}><div class="${ssrRenderClass([{ active: tempSelected.value === null }, "coupon-item no-coupon glass-card"])}" data-v-e4c8b1f9${_scopeId}><div class="coupon-left" data-v-e4c8b1f9${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_icon, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
              ...
              _push2(`</div><div class="coupon-center" data-v-e4c8b1f9${_scopeId}><div class="coupon-title" data-v-e4c8b1f9${_scopeId}>\u4E0D\u4F7F\u7528\u4F18\u60E0\u5238</div><div class="coupon-desc" data-v-e4c8b1f9${_scopeId}>\u653E\u5F03\u5F53\u524D\u4F18\u60E0</div></div><div class="coupon-right" data-v-e4c8b1f9${_scopeId}><div class="radio-check" data-v-e4c8b1f9${_scopeId}></div></div></div><!--[-->`);
              ssrRenderList(unref(sortedCoupons), (coupon) => {
                ...
                }, "ticket-wrapper"])}" data-v-e4c8b1f9${_scopeId}>`);
                _push2(ssrRenderComponent(BaseCouponTicket, {
                  ...
                  action: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    var _a2, _b;
                    if (_push3) {
                      _push3(`<div class="${ssrRenderClass([{ checked: ((_a2 = tempSelected.value) == null ? void 0 : _a2.id) === coupon.id }, "radio-check"])}" data-v-e4c8b1f9${_scopeId2}></div>`);
                    } else {
                      return [
                        createVNode("div", {
                ...
                if (!unref(isApplicable)(coupon)) {
                  _push2(`<div class="inapplicable-reason" data-v-e4c8b1f9${_scopeId}>${ssrInterpolate(unref(getInapplicableReason)(coupon))}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
            ...
            return [
              createVNode("div", { class: "coupon-selector-content" }, [
                ...
                createVNode("div", { class: "coupon-list-container" }, [
                  unref(listLoading) ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "loading-state"
                  }, [
                    createVNode("div", { class: "spinner" }),
                    createTextVNode(" \u6B63\u5728\u83B7\u53D6\u4F18\u60E0\u5238... ")
                  ])) : unref(coupons).length === 0 ? (openBlock(), createBlock("div", {
                    key: 1,
                    class: "empty-state"
                  }, [
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(sortedCoupons), (coupon) => {
                      var _a;
                      return openBlock(), createBlock("div", {
                        ...
                        !unref(isApplicable)(coupon) ? (openBlock(), createBlock("div", {
                          key: 0,
                          class: "inapplicable-reason"
                        }, toDisplayString(unref(getInapplicableReason)(coupon)), 1)) : createCommentVNode("", true)
                      ], 10, ["onClick"]);
                    }), 128))
                  ]))
                ])
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/pc/modal/business/CouponSelectorModal.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const CouponSelectorModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e4c8b1f9"]]);

export { CouponSelectorModal as default };
//# sourceMappingURL=CouponSelectorModal-BDyynFo8.mjs.map
