...
import { aH as data_line_default, an as files_default, s as service_default } from './index-CRs4T-Jf.mjs';
...
function useAdminSystemStatus() {
  ...
  const checkAll = async () => {
    ...
    try {
      ...
      if (error.value) {
        throw new Error(error.value.statusMessage || "Network Error");
      }
      ...
      dbStatus.value = {
        type: res.db.status === "success" ? "success" : "danger",
        text: res.db.message
      };
      r2Status.value = {
        type: res.storage.status === "success" ? "success" : "danger",
        text: res.storage.message
      };
    } catch (e) {
...
//# sourceMappingURL=index-3sdcPpXL.mjs.map
