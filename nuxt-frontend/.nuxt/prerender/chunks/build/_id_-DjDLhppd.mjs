...
import { E as ElSkeleton } from './index-CjBk2Z9n.mjs';
import { E as ElForm, a as ElFormItem } from './index-C-iEkQSR.mjs';
import { E as ElRow, a as ElCol } from './index-9Sj60IxL.mjs';
...
import { h as arrow_left_default, Y as delete_default, p as plus_default, ac as minus_default, ab as picture_default } from './index-CbQ9NNm4.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "cdk-edit-page" }, _attrs))} data-v-d13461f4><div class="wizard-header" data-v-d13461f4><div class="header-left" data-v-d13461f4>`);
      ...
      _push(`<div class="header-titles" data-v-d13461f4><div class="main-title" data-v-d13461f4>\u7F16\u8F91\u8D44\u6E90</div><div class="sub-title" data-v-d13461f4>EDIT RESOURCE</div></div></div><div class="header-center" data-v-d13461f4></div><div class="header-right" data-v-d13461f4></div></div>`);
      if (loading.value) {
        _push(`<div class="loading-container" data-v-d13461f4>`);
        ...
        _push(`<div class="wizard-body" data-v-d13461f4><div class="centered-container" data-v-d13461f4><div class="form-card" data-v-d13461f4><h3 class="card-title" data-v-d13461f4>\u57FA\u7840\u4FE1\u606F</h3>`);
        ...
        _push(`</div><div class="form-card" data-v-d13461f4><h3 class="card-title" data-v-d13461f4>\u8D44\u6E90\u914D\u7F6E (\u53EF\u7F16\u8F91)</h3>`);
        if (((_a = cdkData.value) == null ? void 0 : _a.cdk_type) === "virtual") {
          _push(`<div data-v-d13461f4>`);
          _push(ssrRenderComponent(_component_el_form, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_el_form_item, { label: "\u53EF\u7528\u5E93\u5B58\u6570" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`<div class="form-tip" data-v-d13461f4${_scopeId2}> \u5DF2\u4F7F\u7528: ${ssrInterpolate(usedStock.value)} \u4E2A\uFF0C\u6700\u5C0F\u503C\u4E0D\u80FD\u4F4E\u4E8E\u5DF2\u4F7F\u7528\u6570\u91CF </div>`);
                    } else {
                      return [
                ...
                _push2(`<div class="dynamic-fields" data-v-d13461f4${_scopeId}><!--[-->`);
                ssrRenderList(formVirtual.fields, (field, idx) => {
                  _push2(`<div class="field-row" data-v-d13461f4${_scopeId}>`);
          ...
          _push(ssrRenderComponent(_component_el_form, { "label-position": "top" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_el_form_item, { label: "\u6700\u5927\u8F66\u4F4D\u6570" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`<div class="form-tip" data-v-d13461f4${_scopeId2}>\u51B3\u5B9A\u8BE5\u8D44\u6E90\u53EF\u540C\u65F6\u670D\u52A1\u7684\u7528\u6237\u6570</div>`);
                    } else {
                      return [
                        createVNode(_component_el_input_number, {
                          modelValue: formShared.maxSlots,
                ...
                _push2(`<div class="kv-list" data-v-d13461f4${_scopeId}><!--[-->`);
                ssrRenderList(formShared.attributes, (attr, idx) => {
                  _push2(`<div class="kv-row" data-v-d13461f4${_scopeId}>`);
                  _push2(ssrRenderComponent(_component_el_input, {
                    modelValue: attr.key,
                  ...
                  _push2(`<span class="separator" data-v-d13461f4${_scopeId}>:</span>`);
                  _push2(ssrRenderComponent(_component_el_input, {
                ...
                _push2(ssrRenderComponent(_component_el_form_item, { label: "\u6FC0\u6D3B\u7801\u5185\u5BB9" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`<div class="form-tip" data-v-d13461f4${_scopeId2}>\u6CE8\u610F\uFF1A\u66F4\u6539\u540E\u4F1A\u5F71\u54CD\u5DF2\u5173\u8054\u7684\u8BA2\u5355</div>`);
                    } else {
                      return [
                        createVNode(_component_el_input, {
                          modelValue: formOneTime.code,
        ...
        _push(`<div class="form-item" data-v-d13461f4><div class="image-selector" data-v-d13461f4>`);
        if (commonImage.value) {
          _push(`<img${ssrRenderAttr("src", commonImage.value)} class="preview-img" data-v-d13461f4>`);
        } else {
          _push(`<div class="placeholder" data-v-d13461f4>`);
          ...
          _push(`<span data-v-d13461f4>\u70B9\u51FB\u9009\u62E9\u56FE\u7247</span></div>`);
        }
        _push(`</div><div class="form-tip" style="${ssrRenderStyle({ "margin-top": "8px" })}" data-v-d13461f4> \u5C06\u5728\u5BA2\u6237\u7AEF\u8BA2\u5355\u8BE6\u60C5\u9875\u5C55\u793A\uFF0C\u7528\u4E8E\u5F15\u5BFC\u7528\u6237\u4F7F\u7528 </div></div></div><div class="form-actions" data-v-d13461f4>`);
        _push(ssrRenderComponent(_component_el_button, {
          onClick: ($event) => unref(router).back()
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="picker-container" data-v-d13461f4${_scopeId}><div class="picker-sidebar" data-v-d13461f4${_scopeId}><div class="${ssrRenderClass([{ active: pickerActiveCatId.value === "" }, "picker-cat-item"])}" data-v-d13461f4${_scopeId}>\u5168\u90E8\u56FE\u7247</div><!--[-->`);
            ssrRenderList(pickerCategories.value, (cat) => {
              _push2(`<div class="${ssrRenderClass([{ active: pickerActiveCatId.value === cat.id }, "picker-cat-item"])}" data-v-d13461f4${_scopeId}>${ssrInterpolate(cat.name)}</div>`);
            });
            _push2(`<!--]--></div><div${ssrRenderAttrs(mergeProps({ class: "picker-main" }, ssrGetDirectiveProps(_ctx, _directive_loading, pickerLoading.value)))} data-v-d13461f4${_scopeId}><div class="picker-toolbar" data-v-d13461f4${_scopeId}>`);
            ...
            _push2(`</div><div class="picker-grid" data-v-d13461f4${_scopeId}><!--[-->`);
            ssrRenderList(galleryImages.value, (img) => {
              _push2(`<div class="picker-img-card" data-v-d13461f4${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_image, {
                src: img.url,
                fit: "cover"
              }, null, _parent2, _scopeId));
              _push2(`<div class="picker-img-name" data-v-d13461f4${_scopeId}>${ssrInterpolate(img.name)}</div></div>`);
            });
            _push2(`<!--]--></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/cdk/edit/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d13461f4"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-DjDLhppd.mjs.map
