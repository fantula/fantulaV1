...
import { defineComponent, ref, computed, reactive, mergeProps, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, unref, createTextVNode, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrGetDirectiveProps, ssrRenderList, ssrRenderStyle, ssrInterpolate, ssrRenderAttr } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { useRouter, useRoute } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue-router/vue-router.node.mjs';
import { a2 as edit_default, p as plus_default } from './index-CRs4T-Jf.mjs';
import { a as adminCommunityApi } from './community-C9yysBwl.mjs';
import { A as AdminImagePicker } from './AdminImagePicker-Dpevamev.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-page-post" }, _attrs))} data-v-35fdcf5f>`);
      ...
      _push(`<div class="form-container" data-v-35fdcf5f>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                        ...
                        ssrRenderList(categories.value, (item) => {
                          _push4(ssrRenderComponent(_component_el_option, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<span style="${ssrRenderStyle({ "float": "left" })}" data-v-35fdcf5f${_scopeId4}>${ssrInterpolate(item.icon)} ${ssrInterpolate(item.name)}</span>`);
                                if (!item.is_active) {
                                  _push5(`<span style="${ssrRenderStyle({ "float": "right", "color": "var(--el-text-color-placeholder)", "font-size": "13px" })}" data-v-35fdcf5f${_scopeId4}>\u5DF2\u7981\u7528</span>`);
                                } else {
                                  _push5(`<!---->`);
                                }
                              } else {
            ...
            _push2(ssrRenderComponent(_component_el_form_item, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="image-select-container" data-v-35fdcf5f${_scopeId2}>`);
                  if (form.cover_image) {
                    _push3(`<div class="cover-preview" data-v-35fdcf5f${_scopeId2}><img${ssrRenderAttr("src", form.cover_image)} class="cover-image" data-v-35fdcf5f${_scopeId2}><div class="cover-mask" data-v-35fdcf5f${_scopeId2}>`);
                    ...
                    _push3(`<span data-v-35fdcf5f${_scopeId2}>\u66F4\u6362\u56FE\u7247</span></div></div>`);
                  } else {
                    _push3(`<div class="cover-uploader" data-v-35fdcf5f${_scopeId2}>`);
                    ...
                    _push3(`<span data-v-35fdcf5f${_scopeId2}>\u9009\u62E9\u5C01\u9762</span></div>`);
                  }
                  _push3(`<div class="tip-text" data-v-35fdcf5f${_scopeId2}>\u5EFA\u8BAE\u5C3A\u5BF8 800x450 (16:9)\uFF0C\u70B9\u51FB\u9009\u62E9\u6216\u4E0A\u4F20</div></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_form_item, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="tip-text" data-v-35fdcf5f${_scopeId2}>\u793A\u4F8B: https://www.bilibili.com/video/BVxxx \u6216 https://youtu.be/xxx</div>`);
                  if (videoPreviewUrl.value) {
                    _push3(`<div class="video-preview" data-v-35fdcf5f${_scopeId2}><iframe${ssrRenderAttr("src", videoPreviewUrl.value)} scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" data-v-35fdcf5f${_scopeId2}></iframe></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/help-center/articles/post.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const post = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-35fdcf5f"]]);

export { post as default };
//# sourceMappingURL=post-CT2UmpEj.mjs.map
