...
import { E as EditNicknameModal, C as ChangePasswordModal, a as ChangeEmailModal, D as DeleteAccountModal } from './DeleteAccountModal-e3oYETKL.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_el_icon = ElIcon;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mobile-page" }, _attrs))} data-v-48c4330b>`);
      _push(ssrRenderComponent(MobileSubPageHeader, { title: "\u8D26\u53F7\u8BBE\u7F6E" }, null, _parent));
      _push(`<div class="settings-content" data-v-48c4330b><div class="setting-container" data-v-48c4330b><div class="setting-item" data-v-48c4330b><div class="left" data-v-48c4330b><span class="label" data-v-48c4330b>\u5934\u50CF</span></div><div class="right" data-v-48c4330b><img${ssrRenderAttr("src", ((_a = unref(userStore).user) == null ? void 0 : _a.avatar) || unref(DEFAULT_AVATAR))} class="avatar-img" data-v-48c4330b>`);
      ...
      _push(`</div></div><div class="divider" data-v-48c4330b></div><div class="setting-item" data-v-48c4330b><div class="left" data-v-48c4330b><span class="label" data-v-48c4330b>\u6635\u79F0</span></div><div class="right" data-v-48c4330b><span class="value" data-v-48c4330b>${ssrInterpolate(((_b = unref(userStore).user) == null ? void 0 : _b.nickName) || "\u672A\u8BBE\u7F6E")}</span>`);
      _push(ssrRenderComponent(_component_el_icon, { class: "arrow" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(arrow_right_default), null, null, _parent2, _scopeId));
      ...
      _push(`</div></div><div class="divider" data-v-48c4330b></div><div class="setting-item" data-v-48c4330b><div class="left" data-v-48c4330b><span class="label" data-v-48c4330b>UID</span></div><div class="right" data-v-48c4330b><span class="value uid-text" data-v-48c4330b>${ssrInterpolate(((_c = unref(userStore).user) == null ? void 0 : _c.uid) || ((_d = unref(userStore).user) == null ? void 0 : _d.id))}</span>`);
      ...
      _push(`</div></div></div><h3 class="group-title" data-v-48c4330b>\u8D26\u53F7\u5B89\u5168</h3><div class="setting-container" data-v-48c4330b><div class="setting-item" data-v-48c4330b><div class="left" data-v-48c4330b><span class="label" data-v-48c4330b>\u5FAE\u4FE1\u7ED1\u5B9A</span></div><div class="right" data-v-48c4330b><span class="value" data-v-48c4330b>${ssrInterpolate(((_e = unref(userStore).user) == null ? void 0 : _e.openId) ? "\u5DF2\u7ED1\u5B9A" : "\u672A\u7ED1\u5B9A")}</span>`);
      _push(ssrRenderComponent(_component_el_icon, { class: "arrow" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(arrow_right_default), null, null, _parent2, _scopeId));
      ...
      _push(`</div></div><div class="setting-item" data-v-48c4330b><span class="label" data-v-48c4330b>\u90AE\u7BB1</span><div class="value-wrap" data-v-48c4330b><span class="text-val" data-v-48c4330b>${ssrInterpolate((_f = unref(userStore).user) == null ? void 0 : _f.email)}</span>`);
      _push(ssrRenderComponent(_component_el_icon, { class: "arrow" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(arrow_right_default), null, null, _parent2, _scopeId));
      ...
      _push(`</div></div><div class="setting-item" data-v-48c4330b><span class="label" data-v-48c4330b>\u767B\u5F55\u5BC6\u7801</span><div class="value-wrap" data-v-48c4330b><span class="text-val muted" data-v-48c4330b>\u4FEE\u6539</span>`);
      _push(ssrRenderComponent(_component_el_icon, { class: "arrow" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(arrow_right_default), null, null, _parent2, _scopeId));
      ...
      _push(`</div></div></div><div class="setting-container" data-v-48c4330b><div class="setting-item" data-v-48c4330b><span class="label text-danger" data-v-48c4330b>\u6CE8\u9500\u8D26\u53F7</span><div class="value-wrap" data-v-48c4330b>`);
      _push(ssrRenderComponent(_component_el_icon, { class: "arrow" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(arrow_right_default), null, null, _parent2, _scopeId));
      ...
      _push(`</div></div></div><div class="action-group" data-v-48c4330b><button class="logout-btn" data-v-48c4330b>\u9000\u51FA\u767B\u5F55</button></div></div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-48c4330b"]]);

export { index as default };
//# sourceMappingURL=index-4jhgCBZ9.mjs.map
