...
import { defineComponent, watch, mergeProps, ref, withCtx, unref, createVNode, resolveDynamicComponent, openBlock, createBlock, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { b as arrow_left_default, Q as user_default, R as wallet_default, S as list_default, T as ticket_default, U as star_default, s as service_default, V as bell_default, W as switch_button_default } from './index-DlETah8a.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(userStore).loading) {
        ...
        _push(`<div class="user-hero-content" data-v-44e7d899><div class="avatar-wrapper" data-v-44e7d899><img${ssrRenderAttr("src", ((_a = unref(userStore).user) == null ? void 0 : _a.avatar) || "/images/client/pc/avatars/avatar-cat.png")} class="user-avatar" data-v-44e7d899><div class="status-dot" data-v-44e7d899></div></div><div class="user-info" data-v-44e7d899><h3 class="user-nickname" data-v-44e7d899>${ssrInterpolate(((_b = unref(userStore).user) == null ? void 0 : _b.nickname) || "FANTULA User")}</h3><div class="user-id-badge" data-v-44e7d899><span data-v-44e7d899>UID: ${ssrInterpolate(((_c = unref(userStore).user) == null ? void 0 : _c.uid) || "---")}</span></div></div></div>`);
      }
      ...
      ssrRenderList(menuGroups, (group) => {
        ...
        ssrRenderList(group.items, (item) => {
          ...
          _push(`</div><span class="menu-text" data-v-44e7d899>${ssrInterpolate(item == null ? void 0 : item.label)}</span>`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "profile-page" }, _attrs))} data-v-bb55210f><div class="profile-container" data-v-bb55210f><h1 class="simple-welcome-text" data-v-bb55210f>\u6B22\u8FCE\u56DE\u6765</h1><div class="profile-layout" data-v-bb55210f>`);
      _push(ssrRenderComponent(SideNavigation, null, null, _parent));
      _push(`<main class="profile-main" data-v-bb55210f><div class="profile-content-frame" data-v-bb55210f><div class="phantom-ambassador" data-v-bb55210f></div><div class="page-content-wrapper" data-v-bb55210f>`);
...
const profile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bb55210f"]]);

export { profile as default };
//# sourceMappingURL=profile-l8Jk7fEa.mjs.map
