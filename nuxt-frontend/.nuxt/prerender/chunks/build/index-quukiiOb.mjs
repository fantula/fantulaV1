...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "redirect-loading" }, _attrs))} data-v-c58eea05>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c58eea05"]]);

export { index as default };
//# sourceMappingURL=index-quukiiOb.mjs.map
