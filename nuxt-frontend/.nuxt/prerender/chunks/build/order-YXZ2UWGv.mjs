...
const clientOrderApi = {
  ...
  async getOrderList(params) {
    ...
    if ((params == null ? void 0 : params.status) && params.status !== "all") {
  ...
  async getOrderDetail(orderId) {
    ...
    if (error || !data) {
      return { success: false, error: (error == null ? void 0 : error.message) || "\u8BA2\u5355\u4E0D\u5B58\u5728" };
    }
    let cdkList = [];
    const cdkIds = ((_a = data.cdk_snapshot) == null ? void 0 : _a.locked_cdk_ids) || data.cdk_snapshot || [];
  ...
  async getPreOrderDetail(preOrderId) {
    ...
    if (!(data == null ? void 0 : data.success)) {
      return { success: false, error: (data == null ? void 0 : data.error) || "\u9884\u8BA2\u5355\u4E0D\u5B58\u5728" };
    }
  ...
  async createPreOrder(skuId, quantity = 1, source = "buy_now") {
    ...
    if (!(data == null ? void 0 : data.success)) {
      return { success: false, error: (data == null ? void 0 : data.error) || "\u521B\u5EFA\u9884\u8BA2\u5355\u5931\u8D25" };
    }
    return {
      success: true,
  ...
  async confirmPreOrder(preOrderId, payMethod, couponId) {
    ...
    if (!(data == null ? void 0 : data.success)) {
      return { success: false, error: (data == null ? void 0 : data.error) || "\u652F\u4ED8\u5931\u8D25" };
    }
    return {
      success: true,
      orderNo: data.order_no,
  ...
  async cancelPreOrder(preOrderId) {
    ...
    if (!(data == null ? void 0 : data.success)) {
      return { success: false, error: (data == null ? void 0 : data.error) || "\u53D6\u6D88\u5931\u8D25" };
    }
    return { success: true };
  },
  /**
  ...
  async applyCoupon(preOrderId, couponId) {
    ...
    if (!(data == null ? void 0 : data.success)) {
      return { success: false, error: (data == null ? void 0 : data.error) || "\u5E94\u7528\u4F18\u60E0\u5238\u5931\u8D25" };
    }
    return {
      success: true,
      totalAmount: data.total_amount,
  ...
  async getRenewalSkus(orderId) {
    ...
    if (!(data == null ? void 0 : data.success)) {
      return { success: false, error: (data == null ? void 0 : data.error) || "\u83B7\u53D6\u7EED\u8D39SKU\u5931\u8D25" };
    }
    return {
      success: true,
      orderId: data.order_id,
  ...
  async createRenewalPreOrder(skuId, oldOrderId) {
    ...
    if (!(data == null ? void 0 : data.success)) {
      return { success: false, error: (data == null ? void 0 : data.error) || "\u521B\u5EFA\u7EED\u8D39\u8BA2\u5355\u5931\u8D25" };
    }
    return {
      success: true,
      preOrderId: data.pre_order_id,
  ...
  async createRefundRequest(orderId, reason, reasonDetail = "") {
    ...
    if (!(data == null ? void 0 : data.success)) return { success: false, error: (data == null ? void 0 : data.error) || "\u7533\u8BF7\u5931\u8D25" };
  ...
  async getRefundRequest(orderId) {
    ...
    if (error) return { success: false, error: error.message };
    if (!(data == null ? void 0 : data.success)) return { success: false, error: data == null ? void 0 : data.error };
  ...
  async cancelRefundRequest(orderId) {
    ...
    if (error) return { success: false, error: error.message };
    if (!(data == null ? void 0 : data.success)) return { success: false, error: (data == null ? void 0 : data.error) || "\u53D6\u6D88\u5931\u8D25" };
...
export { clientOrderApi as c };
//# sourceMappingURL=order-YXZ2UWGv.mjs.map
