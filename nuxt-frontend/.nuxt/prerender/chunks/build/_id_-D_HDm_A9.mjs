...
import { defineComponent, ref, computed, mergeProps, withCtx, unref, createVNode, watch, reactive, openBlock, createBlock, toDisplayString, Fragment, renderList, createCommentVNode, createTextVNode, withDirectives, vModelText, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderStyle } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { useRoute, useRouter } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue-router/vue-router.node.mjs';
import { c as arrow_left_default, a0 as copy_document_default, q as circle_check_default, ai as box_default, y as refresh_left_default, i as info_filled_default, aj as timer_default, ak as headset_default, al as tickets_default, r as refresh_default, o as circle_close_default, N as money_default, O as guide_default, x as zoom_in_default, S as user_default, p as plus_default, am as files_default, l as loading_default, a2 as edit_pen_default, _ as edit_default, A as refresh_right_default, an as document_add_default, D as arrow_down_default, P as warning_default, a as arrow_right_default } from './index-4qszPKX4.mjs';
...
import { C as CouponSelectorModal } from './CouponSelectorModal-By6Mp4b5.mjs';
...
import { C as ContactModal } from './ContactModal-Co07Pgk0.mjs';
...
import './BaseCouponTicket-CKW8RMPT.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(allSlots.value, (slot) => {
        ...
        _push(`</div><span class="profile-name" data-v-dc55ef36>${ssrInterpolate(slot.isMe ? "\u6211" : ((_a = slot.user) == null ? void 0 : _a.nickname) || "\u5F85\u52A0\u5165")}</span><span class="slot-number-tag" data-v-dc55ef36>${ssrInterpolate(slot.index)}\u53F7</span></div>`);
      });
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (records.value.length > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fulfillment-history glass-panel" }, _attrs))} data-v-4257991e><div class="history-header" data-v-4257991e><div class="header-left" data-v-4257991e><span class="icon" data-v-4257991e>\u{1F4CB}</span><span class="title" data-v-4257991e>\u56DE\u6267\u8BB0\u5F55</span><span class="count-badge flex-center" data-v-4257991e>${ssrInterpolate(records.value.length)}</span></div>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (orderDetail.value) {
              ...
              _push2(`<div class="price-row" data-v-da51f9e6${_scopeId}><span class="price" data-v-da51f9e6${_scopeId}>\xA5${ssrInterpolate((_c = orderDetail.value.total_amount) == null ? void 0 : _c.toFixed(2))}</span><span class="quantity" data-v-da51f9e6${_scopeId}>x${ssrInterpolate(orderDetail.value.quantity)}</span></div></div></div>`);
            ...
            ssrRenderList(form.attachments, (url, idx) => {
              _push2(`<div class="img-preview" data-v-da51f9e6${_scopeId}><img${ssrRenderAttr("src", url)} data-v-da51f9e6${_scopeId}><div class="remove-btn" data-v-da51f9e6${_scopeId}>\xD7</div></div>`);
            });
            _push2(`<!--]-->`);
...
//# sourceMappingURL=_id_-D_HDm_A9.mjs.map
