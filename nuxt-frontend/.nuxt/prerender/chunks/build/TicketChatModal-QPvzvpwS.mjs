...
import { E as ElTag } from './index-RGUM47gz.mjs';
import { E as ElAvatar } from './index-C1n9agP9.mjs';
...
import { c as confirmAction } from './useAdminDialog-B2Mn_Lor.mjs';
import { x as refresh_right_default, g as close_default, L as picture_default, M as check_default, n as circle_check_filled_default } from './index-CRs4T-Jf.mjs';
import { uploadImageToStorage } from './uploadImage-84nFn-7l.mjs';
import { A as AdminDataDialog } from './AdminDataDialog-CdRAbjlt.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AdminDataDialog, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div${ssrRenderAttrs(mergeProps({ class: "modal-layout" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-18c81dd7${_scopeId}>`);
            if (error.value) {
              _push2(`<div class="flex flex-col items-center justify-center w-full h-full text-center" data-v-18c81dd7${_scopeId}>`);
              ...
              _push2(`<div class="text-gray-600 mb-4" data-v-18c81dd7${_scopeId}>${ssrInterpolate(error.value)}</div>`);
              ...
              _push2(`<!--[--><div class="layout-sidebar" data-v-18c81dd7${_scopeId}><div class="info-block" data-v-18c81dd7${_scopeId}><div class="label" data-v-18c81dd7${_scopeId}>\u5DE5\u5355\u72B6\u6001</div><div class="value" data-v-18c81dd7${_scopeId}>`);
              ...
              _push2(`</div></div><div class="info-block" data-v-18c81dd7${_scopeId}><div class="label" data-v-18c81dd7${_scopeId}>\u63D0\u4EA4\u7528\u6237</div><div class="user-card" data-v-18c81dd7${_scopeId}>`);
              ...
              _push2(`<div class="user-details" data-v-18c81dd7${_scopeId}><div class="uid" data-v-18c81dd7${_scopeId}>UID: ${ssrInterpolate((_c = (_b = ticket.value) == null ? void 0 : _b.user_id) == null ? void 0 : _c.substring(0, 8).toUpperCase())}</div>`);
              if ((_e = (_d = ticket.value) == null ? void 0 : _d.profiles) == null ? void 0 : _e.email) {
                _push2(`<div class="email" data-v-18c81dd7${_scopeId}>${ssrInterpolate(ticket.value.profiles.email)}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div></div>`);
              if ((_f = ticket.value) == null ? void 0 : _f.orders) {
                _push2(`<div class="info-block" data-v-18c81dd7${_scopeId}><div class="label" data-v-18c81dd7${_scopeId}>\u5173\u8054\u8BA2\u5355\u5FEB\u7167</div><div class="order-card-large" data-v-18c81dd7${_scopeId}><img${ssrRenderAttr("src", (_g = ticket.value.orders.product_snapshot) == null ? void 0 : _g.image)} class="order-img-large" data-v-18c81dd7${_scopeId}><div class="order-details-rows" data-v-18c81dd7${_scopeId}><div class="detail-row" data-v-18c81dd7${_scopeId}><span class="row-label" data-v-18c81dd7${_scopeId}>\u8BA2\u5355\u53F7</span><span class="row-value font-mono copyable" data-v-18c81dd7${_scopeId}>${ssrInterpolate(ticket.value.orders.order_no)}</span></div><div class="detail-row" data-v-18c81dd7${_scopeId}><span class="row-label" data-v-18c81dd7${_scopeId}>\u5546\u54C1</span><span class="row-value"${ssrRenderAttr("title", (_h = ticket.value.orders.product_snapshot) == null ? void 0 : _h.product_name)} data-v-18c81dd7${_scopeId}>${ssrInterpolate((_i = ticket.value.orders.product_snapshot) == null ? void 0 : _i.product_name)}</span></div>`);
                if ((_j = ticket.value.orders.sku_snapshot) == null ? void 0 : _j.spec_combination) {
                  _push2(`<div class="detail-row" data-v-18c81dd7${_scopeId}><span class="row-label" data-v-18c81dd7${_scopeId}>\u89C4\u683C</span><span class="row-value spec-tag" data-v-18c81dd7${_scopeId}>${ssrInterpolate(Object.values(ticket.value.orders.sku_snapshot.spec_combination).join(" / "))}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<div class="detail-row" data-v-18c81dd7${_scopeId}><span class="row-label" data-v-18c81dd7${_scopeId}>\u91D1\u989D</span><span class="row-value price" data-v-18c81dd7${_scopeId}>\xA5${ssrInterpolate((_k = ticket.value.orders.total_amount) == null ? void 0 : _k.toFixed(2))}</span></div>`);
                if (timeLeft.value) {
                  _push2(`<div class="detail-row bg-blue-50 p-2 rounded mt-2 border border-blue-100" data-v-18c81dd7${_scopeId}><span class="row-label text-blue-600" data-v-18c81dd7${_scopeId}>\u5269\u4F59\u65F6\u95F4</span><span class="row-value font-bold text-blue-700" data-v-18c81dd7${_scopeId}>${ssrInterpolate(timeLeft.value)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div></div>`);
              ...
              _push2(`<div class="info-block" data-v-18c81dd7${_scopeId}><div class="label" data-v-18c81dd7${_scopeId}>\u521B\u5EFA\u65F6\u95F4</div><div class="value text-gray-500 text-sm" data-v-18c81dd7${_scopeId}>${ssrInterpolate(ticket.value ? new Date(ticket.value.created_at).toLocaleString() : "-")}</div></div></div><div class="layout-main" data-v-18c81dd7${_scopeId}><div class="chat-container custom-scrollbar" data-v-18c81dd7${_scopeId}>`);
              if (messages.value.length === 0) {
                _push2(`<div class="empty-chat" data-v-18c81dd7${_scopeId}>`);
              ...
              ssrRenderList(groupedMessages.value, (group, date) => {
                _push2(`<div data-v-18c81dd7${_scopeId}><div class="date-divider" data-v-18c81dd7${_scopeId}><span data-v-18c81dd7${_scopeId}>${ssrInterpolate(date)}</span></div><!--[-->`);
                ssrRenderList(group, (msg) => {
                  var _a2;
                  _push2(`<div class="${ssrRenderClass([{ "is-admin": msg.is_admin }, "message-row"])}" data-v-18c81dd7${_scopeId}>`);
                  _push2(ssrRenderComponent(_component_el_avatar, {
                    size: 32,
                  ...
                  _push2(`<div class="message-content" data-v-18c81dd7${_scopeId}><div class="bubble" data-v-18c81dd7${_scopeId}>${ssrInterpolate(msg.content)}</div><div class="meta" data-v-18c81dd7${_scopeId}><span data-v-18c81dd7${_scopeId}>${ssrInterpolate(formatTime(msg.created_at))}</span></div>`);
                  if ((_a2 = msg.attachments) == null ? void 0 : _a2.length) {
                    _push2(`<div class="attachments" data-v-18c81dd7${_scopeId}><!--[-->`);
              ...
              _push2(`<!--]--></div><div class="chat-footer" data-v-18c81dd7${_scopeId}>`);
              if (((_l = ticket.value) == null ? void 0 : _l.status) !== "processing" && ((_m = ticket.value) == null ? void 0 : _m.status) !== "resolved") {
                _push2(`<div class="text-xs text-red-400 text-center mb-2" data-v-18c81dd7${_scopeId}> \u5F53\u524D\u72B6\u6001\u5F02\u5E38: ${ssrInterpolate((_n = ticket.value) == null ? void 0 : _n.status)}</div>`);
              } else {
                _push2(`<!---->`);
              }
              if (((_o = ticket.value) == null ? void 0 : _o.status) === "processing") {
                _push2(`<div class="action-area" data-v-18c81dd7${_scopeId}>`);
                if (pendingAttachments.value.length > 0) {
                  _push2(`<div class="preview-area" data-v-18c81dd7${_scopeId}><!--[-->`);
                  ssrRenderList(pendingAttachments.value, (url, index) => {
                    _push2(`<div class="preview-item" data-v-18c81dd7${_scopeId}>`);
                    _push2(ssrRenderComponent(_component_el_image, {
                      src: url,
                      class: "preview-img",
                      fit: "cover"
                    }, null, _parent2, _scopeId));
                    _push2(`<div class="remove-btn" data-v-18c81dd7${_scopeId}>`);
                ...
                _push2(`<div class="footer-buttons" data-v-18c81dd7${_scopeId}><input type="file" style="${ssrRenderStyle({ "display": "none" })}" accept="image/jpeg,image/png,image/gif" data-v-18c81dd7${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_button, {
                  type: "info",
                  plain: "",
                ...
                _push2(`<div class="flex-grow" data-v-18c81dd7${_scopeId}></div>`);
                _push2(ssrRenderComponent(_component_el_button, {
                  type: "success",
                  plain: "",
                ...
                _push2(`<div class="resolved-banner" data-v-18c81dd7${_scopeId}>`);
...
const TicketChatModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-18c81dd7"]]);

export { TicketChatModal as default };
//# sourceMappingURL=TicketChatModal-QPvzvpwS.mjs.map
