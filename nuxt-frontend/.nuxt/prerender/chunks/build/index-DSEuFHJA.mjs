...
import { L as search_default, S as user_default, r as refresh_default } from './index-CmsdIFY8.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "coupon-stats-page" }, _attrs))} data-v-800ec438>`);
      ...
      _push(ssrRenderComponent(AdminActionCard, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="filter-group" data-v-800ec438${_scopeId}>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="code-text" data-v-800ec438${_scopeId2}>${ssrInterpolate(row.code)}</span>`);
                } else {
                  return [
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row.display_uid || row.user_uid) {
                    _push3(`<div class="user-cell" data-v-800ec438${_scopeId2}>`);
                    ...
                    if (row.user_nickname) {
                      _push3(`<div class="user-nickname" data-v-800ec438${_scopeId2}>${ssrInterpolate(row.user_nickname)}</div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div>`);
                  } else {
                    _push3(`<span class="text-gray" data-v-800ec438${_scopeId2}>-</span>`);
                  }
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row.order_no) {
                    _push3(`<span class="order-no" data-v-800ec438${_scopeId2}>${ssrInterpolate(row.order_no)}</span>`);
                  } else if (row.order_id) {
                    _push3(`<span class="order-uuid" data-v-800ec438${_scopeId2}>${ssrInterpolate(row.order_id)}</span>`);
                  } else {
                    _push3(`<span class="text-gray" data-v-800ec438${_scopeId2}>-</span>`);
                  }
                } else {
      ...
      _push(`<div class="pagination-wrapper" data-v-800ec438>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-800ec438"]]);

export { index as default };
//# sourceMappingURL=index-DSEuFHJA.mjs.map
