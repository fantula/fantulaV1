...
import { defineComponent, ref, computed, reactive, mergeProps, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { c as arrow_left_default } from './index-CmsdIFY8.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "faq-post-page" }, _attrs))} data-v-c9e97e6a><div class="page-header" data-v-c9e97e6a><div class="header-left" data-v-c9e97e6a>`);
      ...
      _push(`<h2 class="page-title" data-v-c9e97e6a>${ssrInterpolate(isEdit.value ? "\u7F16\u8F91\u95EE\u9898" : "\u521B\u5EFA\u95EE\u9898")}</h2></div></div><div${ssrRenderAttrs(mergeProps({ class: "form-card" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-c9e97e6a>`);
            ...
            _push2(ssrRenderComponent(_component_el_form_item, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="form-tip" data-v-c9e97e6a${_scopeId2}>\u652F\u6301\u57FA\u672C\u7684\u6587\u672C\u5185\u5BB9\uFF0C\u5C06\u76F4\u63A5\u663E\u793A\u5728\u5BA2\u6237\u7AEF\u3002</div>`);
                } else {
                  return [
                    createVNode(_component_el_input, {
                      modelValue: form.answer,
            ...
            _push2(ssrRenderComponent(_component_el_form_item, { label: "\u5173\u8054\u5546\u54C1" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                        ...
                        ssrRenderList(productOptions.value, (item) => {
                          _push4(ssrRenderComponent(_component_el_option, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="product-option" data-v-c9e97e6a${_scopeId4}><span data-v-c9e97e6a${_scopeId4}>${ssrInterpolate(item.product_name)}</span><span class="product-id-sub" data-v-c9e97e6a${_scopeId4}>${ssrInterpolate(item.id)}</span></div>`);
                              } else {
                                return [
                  ...
                  _push3(`<div class="form-tip" data-v-c9e97e6a${_scopeId2}> \u7ED1\u5B9A\u540E\uFF0C\u8BE5\u95EE\u9898\u5C06\u4F18\u5148\u5C55\u793A\u5728\u5BF9\u5E94\u5546\u54C1\u7684\u8BE6\u60C5\u9875\u4E2D\u3002 </div>`);
                } else {
                  return [
                    createVNode(_component_el_select, {
                      modelValue: form.productId,
            ...
            _push2(ssrRenderComponent(_component_el_form_item, { label: "\u6392\u5E8F\u6743\u91CD" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="form-tip" data-v-c9e97e6a${_scopeId2}>\u6570\u503C\u8D8A\u5C0F\u8D8A\u9760\u524D</div>`);
                } else {
                  return [
...
const post = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c9e97e6a"]]);

export { post as default };
//# sourceMappingURL=post-gDP1K3LR.mjs.map
