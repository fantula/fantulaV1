...
import { defineComponent, ref, computed, reactive, mergeProps, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, Fragment, renderList, withDirectives, toDisplayString, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { L as picture_default, at as folder_remove_default, au as folder_default, av as setting_default, A as refresh_default, aw as upload_default, H as view_default, a2 as edit_default, B as delete_default, M as check_default } from './index-CRs4T-Jf.mjs';
import { d as adminImageCategoryApi, a as adminImageApi } from './media-BJaGHW2U.mjs';
import { c as confirmAction, a as confirmDelete } from './useAdminDialog-B2Mn_Lor.mjs';
...
import { u as useSupabaseSession } from './useSupabaseSession-2l1XDO7-.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AdminDataDialog, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="cat-manager" data-v-7187e39c${_scopeId}><div class="add-cat-row" data-v-7187e39c${_scopeId}>`);
            ...
            _push2(`<div${ssrRenderAttrs(mergeProps({ class: "cat-list" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-7187e39c${_scopeId}><!--[-->`);
            ssrRenderList(categories.value, (cat) => {
              _push2(`<div class="cat-item" data-v-7187e39c${_scopeId}><span data-v-7187e39c${_scopeId}>${ssrInterpolate(cat.name)}</span>`);
              _push2(ssrRenderComponent(_component_el_button, {
                link: "",
                type: "danger",
                size: "small",
...
const CategoryManagerModal = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-7187e39c"]]);
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_el_upload, {
                          ...
                          tip: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="el-upload__tip" data-v-1b9b4103${_scopeId4}>\u53EA\u80FD\u4E0A\u4F20 jpg/png \u6587\u4EF6\uFF0C\u4E14\u4E0D\u8D85\u8FC7 2MB</div>`);
                            } else {
                              return [
...
const ImageUploadModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1b9b4103"]]);
  ...
  setup(__props) {
    ...
    const handleDelete = async (img) => {
      await confirmDelete(
        ...
        async () => {
          const token = await getAuthToken();
          const res = await adminImageApi.deleteImage(img.id, token || void 0);
          if (res.success) {
            fetchImages();
          }
          return res;
    ...
    const handleBatchDelete = async () => {
      await confirmAction(
        ...
        async () => {
          const token = await getAuthToken();
          const res = await adminImageApi.deleteImages(selectedIds.value, token || void 0);
          if (res.success) {
            fetchImages();
          }
          return res;
    ...
    const syncFromR2 = async () => {
      ...
      try {
        ...
        const { getEdgeFunctionsUrl } = await import('./supabase-Ds8OQlZJ.mjs');
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _directive_loading = vLoading;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "media-layout" }, _attrs))} data-v-700faabb><div class="media-sidebar" data-v-700faabb><div class="sidebar-header" data-v-700faabb><h3 class="sidebar-title" data-v-700faabb>\u56FE\u7247\u5206\u7C7B</h3></div><div class="category-nav" data-v-700faabb><div class="${ssrRenderClass([{ active: currentCategoryId.value === "" }, "nav-item"])}" data-v-700faabb>`);
      ...
      _push(`<span class="nav-label" data-v-700faabb>\u5168\u90E8\u56FE\u7247</span>`);
      if (totalImages.value > 0 && currentCategoryId.value === "") {
        _push(`<span class="nav-count" data-v-700faabb>${ssrInterpolate(totalImages.value)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="nav-divider" data-v-700faabb></div><div${ssrRenderAttrs(mergeProps({ class: "nav-list" }, ssrGetDirectiveProps(_ctx, _directive_loading, catLoading.value)))} data-v-700faabb><!--[-->`);
      ssrRenderList(categories.value, (cat) => {
        _push(`<div class="${ssrRenderClass([{ active: currentCategoryId.value === cat.id, "is-uncategorized": cat.name === "\u672A\u5206\u7C7B" }, "nav-item"])}" data-v-700faabb>`);
        if (cat.name === "\u672A\u5206\u7C7B") {
          _push(ssrRenderComponent(_component_el_icon, null, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
        ...
        _push(`<span class="nav-label" data-v-700faabb>${ssrInterpolate(cat.name)}</span></div>`);
      });
      _push(`<!--]--></div></div><div class="sidebar-footer" data-v-700faabb>`);
      ...
      _push(`</div></div><div class="media-content" data-v-700faabb><div class="content-toolbar" data-v-700faabb><div class="toolbar-left" data-v-700faabb>`);
      ...
      _push(`</div><div class="toolbar-right" data-v-700faabb>`);
      if (selectedIds.value.length > 0) {
        _push(`<div class="batch-actions" data-v-700faabb><span class="selection-info" data-v-700faabb>\u5DF2\u9009 ${ssrInterpolate(selectedIds.value.length)} \u9879</span>`);
        _push(ssrRenderComponent(_component_el_button, {
          type: "danger",
          link: "",
      ...
      _push(`</div></div><div${ssrRenderAttrs(mergeProps({ class: "content-body" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-700faabb>`);
      if (images2.value.length === 0) {
        _push(`<div class="empty-state" data-v-700faabb>`);
        _push(ssrRenderComponent(_component_el_empty, { description: "\u6682\u65E0\u56FE\u7247" }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div class="image-grid-container" data-v-700faabb><!--[-->`);
        ssrRenderList(images2.value, (img) => {
          _push(`<div class="${ssrRenderClass([{ selected: selectedIds.value.includes(img.id) }, "grid-item"])}" data-v-700faabb><div class="img-preview" data-v-700faabb>`);
          ...
          _push(`<div class="img-overlay" data-v-700faabb><div class="overlay-actions" data-v-700faabb>`);
          _push(ssrRenderComponent(_component_el_button, {
            circle: "",
            size: "small",
          ...
          if (selectedIds.value.includes(img.id)) {
            _push(`<div class="selection-mark" data-v-700faabb>`);
            _push(ssrRenderComponent(_component_el_icon, null, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
          ...
          _push(`</div><div class="img-meta" data-v-700faabb><div class="img-name"${ssrRenderAttr("title", img.name)} data-v-700faabb>${ssrInterpolate(img.name)}</div><div class="img-info" data-v-700faabb>`);
          if (img.category) {
            _push(`<span class="cat-badge" data-v-700faabb>${ssrInterpolate(img.category.name)}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<span class="date" data-v-700faabb>${ssrInterpolate(formatDate(img.created_at))}</span></div></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div>`);
      if (images2.value.length > 0) {
        _push(`<div class="content-footer" data-v-700faabb>`);
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", previewUrl.value)} style="${ssrRenderStyle({ "max-width": "100%", "max-height": "600px", "display": "block", "margin": "0 auto" })}" data-v-700faabb${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
...
const images = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-700faabb"]]);

export { images as default };
//# sourceMappingURL=images-CqEfy2Wl.mjs.map
