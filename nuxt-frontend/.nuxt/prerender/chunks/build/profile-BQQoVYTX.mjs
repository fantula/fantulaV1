...
import { q as arrow_left_default, W as user_default, X as wallet_default, Y as list_default, Z as ticket_default, _ as star_default, s as service_default, $ as bell_default, a0 as switch_button_default } from './index-CRs4T-Jf.mjs';
...
const LogoutModal = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-725cd612"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "profile-sidebar" }, _attrs))} data-v-c12b69ee><div class="sidebar-header" data-v-c12b69ee><div class="back-home-btn" data-v-c12b69ee>`);
      ...
      _push(`<span data-v-c12b69ee>\u8FD4\u56DE\u9996\u9875</span></div><div class="user-hero-card" data-v-c12b69ee>`);
      if (unref(userStore).loading) {
        _push(`<div class="user-hero-loading" data-v-c12b69ee><div class="avatar-skeleton" data-v-c12b69ee></div><div class="info-skeleton" data-v-c12b69ee><div class="line-1" data-v-c12b69ee></div><div class="line-2" data-v-c12b69ee></div></div></div>`);
      } else {
        _push(`<div class="user-hero-content" data-v-c12b69ee><div class="avatar-wrapper" data-v-c12b69ee><img${ssrRenderAttr("src", ((_a = unref(userStore).user) == null ? void 0 : _a.avatar) || unref(DEFAULT_AVATAR))} class="user-avatar" data-v-c12b69ee><div class="status-dot" data-v-c12b69ee></div></div><div class="user-info" data-v-c12b69ee><h3 class="user-nickname" data-v-c12b69ee>${ssrInterpolate(((_b = unref(userStore).user) == null ? void 0 : _b.nickname) || "FANTULA User")}</h3><div class="user-id-badge" data-v-c12b69ee><span data-v-c12b69ee>UID: ${ssrInterpolate(((_c = unref(userStore).user) == null ? void 0 : _c.uid) || "---")}</span></div></div></div>`);
      }
      _push(`</div></div><nav class="sidebar-menu" data-v-c12b69ee><!--[-->`);
      ssrRenderList(menuGroups, (group) => {
        _push(`<div class="menu-group" data-v-c12b69ee>`);
        if (group.label) {
          _push(`<div class="menu-group-label" data-v-c12b69ee>${ssrInterpolate(group.label)}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--[-->`);
        ssrRenderList(group.items, (item) => {
          _push(`<div class="${ssrRenderClass([{ "active": isMenuItemActive(item) }, "menu-item"])}" data-v-c12b69ee><div class="icon-wrapper" data-v-c12b69ee>`);
          ...
          _push(`</div><span class="menu-text" data-v-c12b69ee>${ssrInterpolate(item == null ? void 0 : item.label)}</span>`);
          if (item.key === "messages" && unref(userStore).unreadMessageCount > 0) {
            _push(`<div class="unread-indicator" data-v-c12b69ee></div>`);
          } else {
            _push(`<!---->`);
          }
          if (isMenuItemActive(item)) {
            _push(`<div class="active-glow" data-v-c12b69ee></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
      ...
      _push(`<!--]--></nav><div class="sidebar-footer" data-v-c12b69ee><button class="logout-btn" data-v-c12b69ee>`);
...
const SideNavigation = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c12b69ee"]]);
...
//# sourceMappingURL=profile-BQQoVYTX.mjs.map
