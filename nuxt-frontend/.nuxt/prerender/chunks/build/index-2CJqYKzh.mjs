          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(`<span class="uid-text" data-v-75adb826${_scopeId2}>${ssrInterpolate(((_b = row._profile) == null ? void 0 : _b.uid) || "\u65E0UID")}</span></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(`<span data-v-75adb826${_scopeId2}>${ssrInterpolate(((_b = row.product_snapshot) == null ? void 0 : _b.product_name) || "\u672A\u77E5\u5546\u54C1")}</span></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<span class="spec-text" data-v-75adb826${_scopeId2}>${ssrInterpolate(unref(formatSpec)((_a = row.sku_snapshot) == null ? void 0 : _a.spec_combination))}</span>`);
                } else {
                  return [
...
//# sourceMappingURL=index-2CJqYKzh.mjs.map
