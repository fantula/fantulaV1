...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "coupon-product-list" }, _attrs))} data-v-1a21bb7a>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="code-info" data-v-1a21bb7a${_scopeId2}><div class="code-name" data-v-1a21bb7a${_scopeId2}>${ssrInterpolate(row.name)}</div></div>`);
                } else {
                  return [
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row.sku_ids && row.sku_ids.length) {
                    _push3(`<div class="product-tags" data-v-1a21bb7a${_scopeId2}><!--[-->`);
                    ...
                    _push3(`<span class="text-secondary" data-v-1a21bb7a${_scopeId2}>\u65E0\u5173\u8054\u5546\u54C1</span>`);
                  }
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="amount" data-v-1a21bb7a${_scopeId2}>${ssrInterpolate(unref(formatPrice)(row.value))}</span>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (!row.end_date) {
                    _push3(`<div class="validity-tag" data-v-1a21bb7a${_scopeId2}>\u6C38\u4E45\u6709\u6548</div>`);
                  } else {
                    _push3(`<div class="validity-range" data-v-1a21bb7a${_scopeId2}><div data-v-1a21bb7a${_scopeId2}>${ssrInterpolate(unref(formatDate)(row.end_date))} \u5230\u671F</div></div>`);
                  }
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/coupons/product/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1a21bb7a"]]);

export { index as default };
//# sourceMappingURL=index-DqQ102Um.mjs.map
