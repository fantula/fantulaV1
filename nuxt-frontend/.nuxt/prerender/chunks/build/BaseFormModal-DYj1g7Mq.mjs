import { defineComponent, mergeProps, createSlots, withCtx, openBlock, createBlock, toDisplayString, createCommentVNode, createVNode, renderSlot, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(__nuxt_component_0, mergeProps({
        ...
        "confirm-theme-id": __props.confirmThemeId,
        "cancel-theme-id": __props.cancelThemeId,
        onClose: handleClose,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.subtitle) {
              _push2(`<div class="form-subtitle" data-v-6a2aebfc${_scopeId}>${ssrInterpolate(__props.subtitle)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="form-body-wrapper" data-v-6a2aebfc${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/pc/modal/base/BaseFormModal.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const BaseFormModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6a2aebfc"]]);

export { BaseFormModal as B };
//# sourceMappingURL=BaseFormModal-DYj1g7Mq.mjs.map
