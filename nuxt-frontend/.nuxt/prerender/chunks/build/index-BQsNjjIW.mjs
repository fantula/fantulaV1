...
import { A as AdminModuleLayout } from './AdminModuleLayout-C9xtT9eb.mjs';
...
import { Y as delete_default } from './index-CbQ9NNm4.mjs';
import TicketChatModal from './TicketChatModal-CQNHf7zW.mjs';
...
import './index-B-YZCfIF.mjs';
import './index-CEmMQsAU.mjs';
import './index-COtmEGfB.mjs';
import './useAdminDialog-BSe9aawB.mjs';
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_el_table_column, {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      var _a, _b, _c, _d;
                      if (_push4) {
                        _push4(`<div class="font-medium truncate mb-1 cursor-pointer hover:text-blue-500" data-v-46e16d4a${_scopeId3}>${ssrInterpolate(row.title)}</div><div class="sub-text truncate" data-v-46e16d4a${_scopeId3}>${ssrInterpolate(((_b = (_a = row.ticket_messages) == null ? void 0 : _a[0]) == null ? void 0 : _b.content) || "\u6682\u65E0\u6D88\u606F")}</div>`);
                      } else {
                        return [
                          createVNode("div", {
                  ...
                  _push3(ssrRenderComponent(_component_el_table_column, {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      var _a, _b, _c, _d;
                      if (_push4) {
                        _push4(`<div class="user-cell" data-v-46e16d4a${_scopeId3}><div class="w-8 h-8 rounded bg-gray-100 flex items-center justify-center text-xs font-mono text-gray-500" data-v-46e16d4a${_scopeId3}>${ssrInterpolate(row.user_id.substring(0, 2).toUpperCase())}</div><div class="flex flex-col min-w-0" data-v-46e16d4a${_scopeId3}><span class="mono-text text-xs" data-v-46e16d4a${_scopeId3}>UID: ${ssrInterpolate(row.user_id.substring(0, 8).toUpperCase())}</span><span class="sub-text truncate"${ssrRenderAttr("title", (_a = row.profiles) == null ? void 0 : _a.email)} data-v-46e16d4a${_scopeId3}>${ssrInterpolate(((_b = row.profiles) == null ? void 0 : _b.email) || "\u672A\u77E5\u7528\u6237")}</span></div></div>`);
                      } else {
                        return [
...
//# sourceMappingURL=index-BQsNjjIW.mjs.map
