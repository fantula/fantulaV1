...
import { E as ElRadioGroup, a as ElRadioButton } from './index-tnznqLDe.mjs';
...
import { defineComponent, mergeProps, withCtx, unref, createTextVNode, createVNode, isRef, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { U as refresh_default, _ as delete_default } from './index-CCIZH4aC.mjs';
...
import { u as useAdminList } from './useAdminList-C0DHczxG.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "cdks-page" }, _attrs))} data-v-00d4909c><div class="page-tip-header" data-v-00d4909c>`);
      ...
      _push(ssrRenderComponent(AdminActionCard, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="filter-group" data-v-00d4909c${_scopeId}>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                var _a, _b, _c, _d;
                if (_push3) {
                  _push3(`<div class="product-cell" style="${ssrRenderStyle({ "display": "flex", "align-items": "center" })}" data-v-00d4909c${_scopeId2}>`);
                  ...
                  _push3(`<span class="product-name" data-v-00d4909c${_scopeId2}>${ssrInterpolate(((_b = row.product_snapshot) == null ? void 0 : _b.product_name) || "\u672A\u77E5\u5546\u54C1")}</span></div>`);
                } else {
                  return [
                    createVNode("div", {
                      class: "product-cell",
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row.sku_mappings && row.sku_mappings.length > 0) {
                    _push3(`<div class="linked-skus" data-v-00d4909c${_scopeId2}><!--[-->`);
                    ...
                    if (row.sku_mappings.length > 2) {
                      _push3(`<span class="more-tag" data-v-00d4909c${_scopeId2}>+${ssrInterpolate(row.sku_mappings.length - 2)}</span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div>`);
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="code-text" data-v-00d4909c${_scopeId2}>${ssrInterpolate(row.code || "-")}</span>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<span data-v-00d4909c${_scopeId2}>${ssrInterpolate((_a = row.stock) != null ? _a : 1)}</span>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="time-text" data-v-00d4909c${_scopeId2}>${ssrInterpolate(unref(formatDate)(row.created_at))}</span>`);
                } else {
                  return [
...
const cdks = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-00d4909c"]]);

export { cdks as default };
//# sourceMappingURL=cdks-DmkQ-ac1.mjs.map
