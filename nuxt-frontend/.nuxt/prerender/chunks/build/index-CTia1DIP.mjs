...
import { U as refresh_default, l as loading_default, L as copy_document_default, R as check_default } from './index-DNnPa_Q9.mjs';
...
import { P as ProductThumbCell } from './ProductThumbCell-DjG8-c-D.mjs';
          ...
          if (_push2) {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(AdminUserCell, {
                    user: row._profile,
                    uid: (_a = row._profile) == null ? void 0 : _a.uid
                  }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(AdminUserCell, {
                      user: row._profile,
                      uid: (_b = row._profile) == null ? void 0 : _b.uid
                    }, null, 8, ["user", "uid"])
                  ];
                }
              }),
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(ProductThumbCell, {
                    image: (_a = row.product_snapshot) == null ? void 0 : _a.image,
                    name: ((_b = row.product_snapshot) == null ? void 0 : _b.product_name) || "\u672A\u77E5\u5546\u54C1",
                    id: row.product_id,
                    "truncate-id": true
                  }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(ProductThumbCell, {
                      image: (_c = row.product_snapshot) == null ? void 0 : _c.image,
                      name: ((_d = row.product_snapshot) == null ? void 0 : _d.product_name) || "\u672A\u77E5\u5546\u54C1",
                      id: row.product_id,
                      "truncate-id": true
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<span class="spec-text" data-v-6222dfed${_scopeId2}>${ssrInterpolate(unref(formatSpec)((_a = row.sku_snapshot) == null ? void 0 : _a.spec_combination))}</span>`);
                } else {
                  return [
...
//# sourceMappingURL=index-CTia1DIP.mjs.map
