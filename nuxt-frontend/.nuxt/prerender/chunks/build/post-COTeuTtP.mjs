...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "coupon-post-page" }, _attrs))} data-v-08190367>`);
      ...
      _push(`<div class="form-content" data-v-08190367>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_card, {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card-header" data-v-08190367${_scopeId2}><span data-v-08190367${_scopeId2}>\u57FA\u7840\u4FE1\u606F</span></div>`);
                } else {
                  return [
                              ...
                              _push5(ssrRenderComponent(_component_el_form_item, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(`<div class="form-tip" data-v-08190367${_scopeId5}>\u7528\u6237\u9886\u5238\u540E\u76F4\u63A5\u589E\u52A0\u5230\u8D26\u6237\u4F59\u989D\u7684\u91D1\u989D</div>`);
                                  } else {
                                    return [
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_el_form_item, { label: "\u6709\u6548\u671F" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="date-picker-wrapper" data-v-08190367${_scopeId5}>`);
                                    if (!isUnlimitedDate.value) {
                                      _push6(`<div class="date-text" data-v-08190367${_scopeId5}><span class="label" data-v-08190367${_scopeId5}>\u5F00\u59CB\uFF1A</span><span class="value" data-v-08190367${_scopeId5}>${ssrInterpolate(formatDate(form.startDate))}</span></div>`);
                                    } else {
                                      _push6(`<!---->`);
                                    }
                                    if (!isUnlimitedDate.value) {
                                    ...
                                    _push6(`</div>`);
                                    if (!isUnlimitedDate.value) {
                                      _push6(`<div class="form-tip" data-v-08190367${_scopeId5}>\u9ED8\u8BA4\u4ECE\u4ECA\u65E5\u5F00\u59CB\u751F\u6548\uFF0C\u8BF7\u9009\u62E9\u622A\u6B62\u65E5\u671F</div>`);
                                    } else {
                                      _push6(`<!---->`);
                                    }
                                  } else {
            ...
            _push2(ssrRenderComponent(_component_el_card, {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card-header" data-v-08190367${_scopeId2}><span data-v-08190367${_scopeId2}>\u6548\u679C\u9884\u89C8</span></div>`);
                } else {
                  return [
                    createVNode("div", { class: "card-header" }, [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="preview-container" data-v-08190367${_scopeId2}><div class="coupon-ticket" data-v-08190367${_scopeId2}><div class="ticket-left" data-v-08190367${_scopeId2}><div class="ticket-amount" data-v-08190367${_scopeId2}>\xA5${ssrInterpolate(form.value || "0")}</div><div class="ticket-label" data-v-08190367${_scopeId2}>\u4F59\u989D\u7EA2\u5305</div></div><div class="ticket-right" data-v-08190367${_scopeId2}><div class="ticket-name" data-v-08190367${_scopeId2}>${ssrInterpolate(form.name || "\u4F18\u60E0\u5238\u540D\u79F0")}</div><div class="ticket-date" data-v-08190367${_scopeId2}>${ssrInterpolate(isUnlimitedDate.value ? "\u6C38\u4E45\u6709\u6548" : `${formatDate(form.startDate)} \u81F3 ${form.endDate || "?"}`)}</div></div></div></div>`);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/coupons/balance/post.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const post = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-08190367"]]);

export { post as default };
//# sourceMappingURL=post-COTeuTtP.mjs.map
