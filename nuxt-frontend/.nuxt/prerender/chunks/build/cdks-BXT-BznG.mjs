...
import { E as ElRadioGroup, a as ElRadioButton } from './index-_o7w7WVH.mjs';
...
import { defineComponent, mergeProps, withCtx, unref, createTextVNode, createVNode, isRef, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode, ref, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { U as refresh_default, _ as delete_default } from './index-DNnPa_Q9.mjs';
  ...
  const handleSingleCleanup = async (row) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        (_a = options == null ? void 0 : options.onDeleteSuccess) == null ? void 0 : _a.call(options, row.id);
      } else {
  ...
  const handleBulkCleanup = async (ids) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        (_a = options == null ? void 0 : options.onBulkDeleteSuccess) == null ? void 0 : _a.call(options, ids);
      } else {
        ElMessage.error(res.error || "\u5220\u9664\u5931\u8D25");
      }
    } catch {
          ...
          if (_push2) {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(ProductThumbCell, {
                    image: (_a = row.product_snapshot) == null ? void 0 : _a.product_image,
                  ...
                  return [
                    createVNode(ProductThumbCell, {
                      image: (_c = row.product_snapshot) == null ? void 0 : _c.product_image,
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<span data-v-4846a93f${_scopeId2}>${ssrInterpolate((_a = row.stock) != null ? _a : 1)}</span>`);
                } else {
                  return [
...
//# sourceMappingURL=cdks-BXT-BznG.mjs.map
