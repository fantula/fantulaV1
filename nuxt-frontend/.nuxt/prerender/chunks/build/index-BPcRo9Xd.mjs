import { defineComponent, getCurrentInstance, useSlots, inject, ref, computed, watch, reactive, withDirectives, openBlock, createElementBlock, normalizeClass, unref, renderSlot, vShow, createCommentVNode, nextTick, provide, createVNode, shallowRef, triggerRef, normalizeStyle } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { w as withInstall, q as withNoopInstall, p as plus_default, b as buildProps, c as definePropType, t as arrow_left_default, a as arrow_right_default, j as close_default } from './index-DuV_oMrC.mjs';
...
import { g as getEventCode, E as EVENT_CODE, i as isFirefox } from './event-D3FEo2C5.mjs';
import { m as mutable } from './typescript-D6L75muK.mjs';
import { c as capitalize } from './strings-D1uxkXhq.mjs';
import { y as throwError, g as useNamespace, w as isUndefined$1, i as isNumber$1 } from './server.mjs';
  ...
  setup(__props, { expose: __expose }) {
    ...
    const getBarStyle = () => {
      ...
      props.tabs.every((tab) => {
        if (isUndefined$1(tab.paneName)) return false;
...
const ElTabPane = withNoopInstall(_sfc_main);

export { AUTO_ALIGNMENT as A, BACKWARD as B, CENTERED_ALIGNMENT as C, DEFAULT_DYNAMIC_LIST_ITEM_SIZE as D, ElTabs as E, FORWARD as F, HORIZONTAL as H, ITEM_RENDER_EVT as I, LTR as L, RTL as R, SCROLL_EVT as S, VERTICAL as V, ElTabPane as a, ScrollbarDirKey as b, SCROLLBAR_MIN_SIZE as c, RTL_OFFSET_POS_ASC as d, RTL_OFFSET_NAG as e, RTL_OFFSET_POS_DESC as f, END_ALIGNMENT as g, START_ALIGNMENT as h, SMART_ALIGNMENT as i, tabNavEmits as j, tabNavProps as k, tabPaneProps as l, tabsEmits as m, tabsProps as n, tabsRootContextKey as o, tabBarProps as t, useWheel as u };
//# sourceMappingURL=index-BPcRo9Xd.mjs.map
