import { defineComponent, computed, mergeProps, reactive, unref, withCtx, createVNode, ref, watch, openBlock, createBlock, Fragment, renderList, createCommentVNode, withDirectives, withKeys, vModelText, createTextVNode, toDisplayString, vModelCheckbox, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { u as useUserStore, a as authApi } from './user-0iCypJz1.mjs';
import { a1 as camera_default, j as circle_check_default, a2 as edit_default, a3 as credit_card_default, a4 as copy_document_default, a5 as message_default, a6 as edit_pen_default, a7 as lock_default, a8 as key_default, m as arrow_right_default, a9 as connection_default, S as warning_default, V as user_filled_default, M as check_default, aa as chat_dot_round_default, ab as select_default, A as refresh_default } from './index-CRs4T-Jf.mjs';
...
import { w as wechatLoginApi } from './wechat-login-DYkcuR5o.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(BaseFormModal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!__props.email) {
              _push2(`<div class="alert-box" data-v-ed2a03dc${_scopeId}> \u8BF7\u5148\u7ED1\u5B9A\u90AE\u7BB1\uFF0C\u4FEE\u6539\u5BC6\u7801\u9700\u8981\u90AE\u7BB1\u9A8C\u8BC1\u3002 </div>`);
            } else {
              _push2(`<!--[--><div class="form-group" data-v-ed2a03dc${_scopeId}><label class="form-label" data-v-ed2a03dc${_scopeId}>\u9A8C\u8BC1\u7801</label><div class="input-with-action relative-input-group" data-v-ed2a03dc${_scopeId}><input${ssrRenderAttr("value", form.code)} class="form-input" placeholder="\u90AE\u7BB1\u9A8C\u8BC1\u7801" maxlength="6" data-v-ed2a03dc${_scopeId}>`);
              _push2(ssrRenderComponent(SendCodeButton, {
                loading: loading.value,
                countdown: unref(countdown),
                onClick: sendCode
              }, null, _parent2, _scopeId));
              _push2(`</div></div><div class="form-group" data-v-ed2a03dc${_scopeId}><label class="form-label" data-v-ed2a03dc${_scopeId}>\u65B0\u5BC6\u7801</label><input${ssrRenderAttr("value", form.newPassword)} class="form-input" type="password" placeholder="6-20\u4F4D\u5B57\u7B26" data-v-ed2a03dc${_scopeId}></div><div class="form-group" data-v-ed2a03dc${_scopeId}><label class="form-label" data-v-ed2a03dc${_scopeId}>\u786E\u8BA4\u5BC6\u7801</label><input${ssrRenderAttr("value", form.confirmPassword)} class="form-input" type="password" placeholder="\u518D\u6B21\u8F93\u5165\u65B0\u5BC6\u7801" data-v-ed2a03dc${_scopeId}></div><!--]-->`);
            }
          } else {
            return [
...
const ChangePasswordModal = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-ed2a03dc"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BaseModal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="warning-box" data-v-31029df9${_scopeId}><span class="warning-icon" data-v-31029df9${_scopeId}>\u26A0\uFE0F</span><div class="warning-content" data-v-31029df9${_scopeId}> \u8B66\u544A\uFF1A\u8D26\u53F7\u6CE8\u9500\u662F\u4E0D\u53EF\u6062\u590D\u7684\u64CD\u4F5C\u3002\u6240\u6709\u4E2A\u4EBA\u6570\u636E\u3001\u8BA2\u5355\u8BB0\u5F55\u548C\u8D44\u4EA7\u5C06\u88AB\u6C38\u4E45\u5220\u9664\u3002 </div></div><div class="form-group" data-v-31029df9${_scopeId}><label class="form-label" data-v-31029df9${_scopeId}>\u90AE\u7BB1\u9A8C\u8BC1</label><div class="captcha-row relative-input-group" data-v-31029df9${_scopeId}><input${ssrRenderAttr("value", otpCode.value)} type="text" class="form-input" placeholder="\u8BF7\u8F93\u5165\u9A8C\u8BC1\u7801" maxlength="6" inputmode="numeric" autocomplete="off" data-v-31029df9${_scopeId}>`);
            _push2(ssrRenderComponent(SendCodeButton, {
              loading: loading.value,
              countdown: unref(countdown),
              onClick: sendCode
            }, null, _parent2, _scopeId));
            _push2(`</div><p class="form-tip" data-v-31029df9${_scopeId}>\u4E3A\u4E86\u60A8\u7684\u8D44\u4EA7\u5B89\u5168\uFF0C\u8BF7\u9A8C\u8BC1\u90AE\u7BB1: ${ssrInterpolate(__props.email)}</p></div><div class="confirmation-area" data-v-31029df9${_scopeId}><label class="checkbox-label" data-v-31029df9${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(isConfirmed.value) ? ssrLooseContain(isConfirmed.value, null) : isConfirmed.value) ? " checked" : ""} data-v-31029df9${_scopeId}><span data-v-31029df9${_scopeId}>\u6211\u5DF2\u4E86\u89E3\u98CE\u9669\uFF0C\u786E\u8BA4\u6CE8\u9500\u5F53\u524D\u8D26\u53F7</span></label></div>`);
          } else {
            return [
...
const DeleteAccountModal = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-31029df9"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    const handleDeleteAccount = async () => {
      try {
        ...
        if (res.success) {
          const { ElMessageBox: ElMessageBox2 } = await import('./index-NWpSRgEH.mjs');
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_el_icon = ElIcon;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "personal-info-page" }, _attrs))} data-v-cf5b2b0a><div class="profile-banner" data-v-cf5b2b0a><div class="banner-glass" data-v-cf5b2b0a></div><div class="banner-content" data-v-cf5b2b0a><div class="hero-left" data-v-cf5b2b0a><div class="hero-avatar-wrapper" data-v-cf5b2b0a><img${ssrRenderAttr("src", __props.user.avatar || unref(DEFAULT_AVATAR))} class="hero-avatar" data-v-cf5b2b0a><div class="hero-avatar-overlay" data-v-cf5b2b0a>`);
      ...
      _push(`</div></div><div class="hero-text" data-v-cf5b2b0a><h1 class="hero-nickname" data-v-cf5b2b0a>${ssrInterpolate(__props.user.nickname)}</h1><div class="hero-tags" data-v-cf5b2b0a><span class="user-tag role-tag" data-v-cf5b2b0a>FANTULA Member</span><span class="user-tag security-tag" data-v-cf5b2b0a>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(` \u5B89\u5168\u7B49\u7EA7: \u9AD8 </span></div></div></div><div class="hero-actions" data-v-cf5b2b0a><button class="glass-pill-btn primary-glass-btn" data-v-cf5b2b0a>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(` \u7F16\u8F91\u8D44\u6599 </button></div></div></div><div class="workspace-scroll-area" data-v-cf5b2b0a><div class="workspace-content" data-v-cf5b2b0a><div class="info-grid section-gap" data-v-cf5b2b0a><div class="glass-tile info-tile" data-v-cf5b2b0a><div class="tile-icon-bg" data-v-cf5b2b0a>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</div><div class="tile-header" data-v-cf5b2b0a><div class="tile-label" data-v-cf5b2b0a>\u8D26\u6237 UID</div>`);
      ...
      _push(`</div><div class="tile-value-group" data-v-cf5b2b0a><span class="tile-value-mono" data-v-cf5b2b0a>${ssrInterpolate(__props.user.uid || __props.user.id || "---")}</span><button class="copy-btn-mini" data-v-cf5b2b0a>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</button></div></div><div class="glass-tile info-tile" data-v-cf5b2b0a><div class="tile-icon-bg" data-v-cf5b2b0a>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</div><div class="tile-header" data-v-cf5b2b0a><div class="tile-label" data-v-cf5b2b0a>\u7ED1\u5B9A\u90AE\u7BB1</div>`);
      if (__props.user.email) {
        _push(`<div class="status-badge success" data-v-cf5b2b0a>\u5DF2\u7ED1\u5B9A</div>`);
      } else {
        _push(`<div class="status-badge warning" data-v-cf5b2b0a>\u672A\u7ED1\u5B9A</div>`);
      }
      _push(`</div><div class="tile-value-group" data-v-cf5b2b0a><span class="tile-value" data-v-cf5b2b0a>${ssrInterpolate(__props.user.email || "\u672A\u7ED1\u5B9A\u90AE\u7BB1")}</span><button class="icon-action-btn" data-v-cf5b2b0a>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</div><div class="tile-header" data-v-cf5b2b0a><div class="tile-label" data-v-cf5b2b0a>\u8D26\u53F7\u5B89\u5168</div><div class="status-badge success" data-v-cf5b2b0a>\u4FDD\u62A4\u4E2D</div></div><div class="tile-value-group" data-v-cf5b2b0a><div class="security-level-bar" data-v-cf5b2b0a><div class="level-fill" style="${ssrRenderStyle({ "width": "100%" })}" data-v-cf5b2b0a></div></div><span class="tile-meta" data-v-cf5b2b0a>\u6781\u9AD8</span></div></div></div><div class="command-center section-gap" data-v-cf5b2b0a><h3 class="section-title" data-v-cf5b2b0a>\u8D26\u6237\u7BA1\u7406</h3><div class="command-grid" data-v-cf5b2b0a><div class="action-card-lg" data-v-cf5b2b0a><div class="card-bg-icon" data-v-cf5b2b0a>\u{1F511}</div><div class="card-content" data-v-cf5b2b0a><div class="card-icon-frame blue-frame" data-v-cf5b2b0a>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</div><div class="card-text" data-v-cf5b2b0a><span class="card-title" data-v-cf5b2b0a>\u4FEE\u6539\u5BC6\u7801</span><span class="card-desc" data-v-cf5b2b0a>\u5B9A\u671F\u66F4\u65B0\u5BC6\u7801\u4FDD\u62A4\u8D26\u53F7\u5B89\u5168</span></div></div><div class="card-arrow" data-v-cf5b2b0a>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</div></div><div class="action-card-lg" data-v-cf5b2b0a><div class="card-bg-icon" data-v-cf5b2b0a>\u{1F517}</div><div class="card-content" data-v-cf5b2b0a><div class="card-icon-frame purple-frame" data-v-cf5b2b0a>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</div><div class="card-text" data-v-cf5b2b0a><span class="card-title" data-v-cf5b2b0a>\u8C37\u6B4C\u7ED1\u5B9A</span><span class="card-desc" data-v-cf5b2b0a>\u7ED1\u5B9A Google \u8D26\u53F7\u5FEB\u6377\u767B\u5F55</span></div></div>`);
      if (!__props.user.isGoogleBound) {
        _push(`<div class="card-arrow" data-v-cf5b2b0a>`);
        _push(ssrRenderComponent(_component_el_icon, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(arrow_right_default), null, null, _parent2, _scopeId));
        ...
        _push(`<div class="status-text-mini" data-v-cf5b2b0a>\u5DF2\u7ED1\u5B9A</div>`);
      }
      _push(`</div><div class="action-card-lg" data-v-cf5b2b0a><div class="card-bg-icon" data-v-cf5b2b0a>\u{1F517}</div><div class="card-content" data-v-cf5b2b0a><div class="card-icon-frame green-frame" data-v-cf5b2b0a>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(connection_default), null, null, _parent2, _scopeId));
      ...
      _push(`</div><div class="card-text" data-v-cf5b2b0a><span class="card-title" data-v-cf5b2b0a>\u5FAE\u4FE1\u7ED1\u5B9A</span><span class="card-desc" data-v-cf5b2b0a>\u7ED1\u5B9A\u5FAE\u4FE1\u626B\u7801\u5FEB\u6377\u767B\u5F55</span></div></div>`);
      ...
      _push(`</div><div class="action-card-lg danger-card" data-v-cf5b2b0a><div class="card-bg-icon" data-v-cf5b2b0a>\u26A0\uFE0F</div><div class="card-content" data-v-cf5b2b0a><div class="card-icon-frame red-frame" data-v-cf5b2b0a>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</div><div class="card-text" data-v-cf5b2b0a><span class="card-title" data-v-cf5b2b0a>\u6CE8\u9500\u8D26\u53F7</span><span class="card-desc" data-v-cf5b2b0a>\u6C38\u4E45\u5220\u9664\u8D26\u53F7\u6570\u636E</span></div></div><div class="card-arrow" data-v-cf5b2b0a>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(arrow_right_default), null, null, _parent2, _scopeId));
...
const ProfilePersonalInfo = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-cf5b2b0a"]]);
...
//# sourceMappingURL=index-LHz8Jamn.mjs.map
