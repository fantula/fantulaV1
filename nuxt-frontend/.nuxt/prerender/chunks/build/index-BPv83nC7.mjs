...
import { defineComponent, mergeProps, withCtx, isRef, unref, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, ref, computed, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrGetDirectiveProps, ssrInterpolate, ssrRenderAttr } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { A as refresh_default } from './index-CRs4T-Jf.mjs';
...
import { B as BulkActionBar } from './BulkActionBar-DwWrKqhQ.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-container" }, _attrs))} data-v-9dd95359>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="mono-text" data-v-9dd95359${_scopeId2}>${ssrInterpolate(row.order_no)}</span>`);
                } else {
                  return [
                    createVNode("span", {
                      class: "mono-text",
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(`<div class="user-cell" data-v-9dd95359${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_el_avatar, {
                    size: 24,
                    src: ((_a = row._profile) == null ? void 0 : _a.avatar) || unref(DEFAULT_AVATAR2)
                  }, null, _parent3, _scopeId2));
                  _push3(`<span class="user-email" data-v-9dd95359${_scopeId2}>${ssrInterpolate(((_b = row._profile) == null ? void 0 : _b.nickname) || ((_c = row._profile) == null ? void 0 : _c.uid) || "\u672A\u77E5\u7528\u6237")}</span></div>`);
                } else {
                  return [
                    createVNode("div", { class: "user-cell" }, [
                      createVNode(_component_el_avatar, {
                        size: 24,
                        src: ((_d = row._profile) == null ? void 0 : _d.avatar) || unref(DEFAULT_AVATAR2)
                      }, null, 8, ["src"]),
                      createVNode("span", { class: "user-email" }, toDisplayString(((_e = row._profile) == null ? void 0 : _e.nickname) || ((_f = row._profile) == null ? void 0 : _f.uid) || "\u672A\u77E5\u7528\u6237"), 1)
                    ])
                  ];
                }
              }),
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                var _a, _b, _c, _d;
                if (_push3) {
                  _push3(`<div class="product-cell" data-v-9dd95359${_scopeId2}>`);
                  if ((_a = row.product_snapshot) == null ? void 0 : _a.image) {
                    _push3(`<img${ssrRenderAttr("src", row.product_snapshot.image)} class="product-thumb" data-v-9dd95359${_scopeId2}>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<span data-v-9dd95359${_scopeId2}>${ssrInterpolate(((_b = row.product_snapshot) == null ? void 0 : _b.product_name) || "\u672A\u77E5\u5546\u54C1")}</span></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="amount" data-v-9dd95359${_scopeId2}>\xA5${ssrInterpolate(row.total_amount)}</span>`);
                } else {
                  return [
                    createVNode("span", { class: "amount" }, "\xA5" + toDisplayString(row.total_amount), 1)
                  ];
                }
              }),
              _: 1
                ...
                default: withCtx(({ row }) => {
                  ...
                  return [
                    createVNode("div", { class: "user-cell" }, [
                      ...
                      createVNode("span", { class: "user-email" }, toDisplayString(((_b = row._profile) == null ? void 0 : _b.nickname) || ((_c = row._profile) == null ? void 0 : _c.uid) || "\u672A\u77E5\u7528\u6237"), 1)
                    ])
                  ];
                }),
                _: 1
      ...
      _push(`<div class="stats-row" data-v-9dd95359><div class="stat-card" data-v-9dd95359><div class="stat-value" data-v-9dd95359>${ssrInterpolate(unref(stats).converted)}</div><div class="stat-label" data-v-9dd95359>\u5DF2\u8F6C\u6362</div></div><div class="stat-card" data-v-9dd95359><div class="stat-value" data-v-9dd95359>${ssrInterpolate(unref(stats).expired)}</div><div class="stat-label" data-v-9dd95359>\u5DF2\u8FC7\u671F</div></div><div class="stat-card" data-v-9dd95359><div class="stat-value" data-v-9dd95359>${ssrInterpolate(unref(stats).deleted)}</div><div class="stat-label" data-v-9dd95359>\u5DF2\u5220\u9664</div></div><div class="stat-card total" data-v-9dd95359><div class="stat-value" data-v-9dd95359>${ssrInterpolate(unref(stats).total)}</div><div class="stat-label" data-v-9dd95359>\u603B\u8BA1</div></div></div></div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/orders/preorders/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9dd95359"]]);

export { index as default };
//# sourceMappingURL=index-BPv83nC7.mjs.map
