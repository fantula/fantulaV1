...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "notification-list-page" }, _attrs))} data-v-eb72b657><div class="page-header" data-v-eb72b657><h3 data-v-eb72b657>\u90AE\u4EF6\u901A\u77E5\u914D\u7F6E</h3>`);
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_button, {
                    type: "primary",
                    link: "",
                    onClick: ($event) => unref(router).push(`/manager_portal/backend-settings/notification/template/${row.id}`)
                  }, {
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(` \u7F16\u8F91\u6A21\u677F `);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-eb72b657"]]);

export { index as default };
//# sourceMappingURL=index-CT5kFVIc.mjs.map
