...
import { defineComponent, ref, mergeProps, withCtx, createTextVNode, unref, createVNode, createBlock, openBlock, Fragment, renderList, withKeys, toDisplayString, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrGetDirectiveProps, ssrInterpolate } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "faq-list-page" }, _attrs))} data-v-30f8d51a><div class="page-header" data-v-30f8d51a><div class="header-left" data-v-30f8d51a><h2 class="page-title" data-v-30f8d51a>\u5E38\u89C1\u95EE\u9898\u7BA1\u7406</h2><span class="page-desc" data-v-30f8d51a>\u7BA1\u7406\u5E2E\u52A9\u4E2D\u5FC3\u7684\u5E38\u89C1\u95EE\u9898\u53CA\u89E3\u7B54</span></div><div class="header-right" data-v-30f8d51a>`);
      _push(ssrRenderComponent(_component_el_button, {
        onClick: ($event) => _ctx.$router.push("/_mgmt_9Xfa3/faq/category")
      }, {
      ...
      _push(ssrRenderComponent(_component_el_button, {
        type: "primary",
        onClick: ($event) => _ctx.$router.push("/_mgmt_9Xfa3/faq/post")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</div></div><div class="toolbar-card" data-v-30f8d51a>`);
      ...
      _push(`</div><div${ssrRenderAttrs(mergeProps({ class: "table-card" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-30f8d51a>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="question-text" data-v-30f8d51a${_scopeId2}>${ssrInterpolate(row.question)}</span>`);
                } else {
                  return [
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row.category) {
                    ...
                    _push3(`<span class="text-gray-400" data-v-30f8d51a${_scopeId2}>\u672A\u5206\u7C7B</span>`);
                  }
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row.product) {
                    _push3(`<div class="bound-product" data-v-30f8d51a${_scopeId2}>`);
                    ...
                    _push3(`<span data-v-30f8d51a${_scopeId2}>${ssrInterpolate(row.product.product_name)}</span></div>`);
                  } else {
                    _push3(`<span class="text-gray-400" data-v-30f8d51a${_scopeId2}>-</span>`);
                  }
                } else {
                  return [
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_button, {
                    ...
                    link: "",
                    size: "small",
                    onClick: ($event) => _ctx.$router.push(`/_mgmt_9Xfa3/faq/post?id=${row.id}`)
                  }, {
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(` \u7F16\u8F91 `);
      ...
      _push(`<div class="pagination-row" data-v-30f8d51a>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/_mgmt_9Xfa3/faq/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-30f8d51a"]]);

export { index as default };
//# sourceMappingURL=index-BSQEsBJC.mjs.map
