...
import { defineComponent, mergeProps, withCtx, unref, createVNode, createTextVNode, withKeys, toDisplayString, openBlock, createBlock, createCommentVNode, ref, reactive, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { O as search_default, W as user_default, A as refresh_default } from './index-CRs4T-Jf.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "coupon-stats-page" }, _attrs))} data-v-975becaa>`);
      ...
      _push(ssrRenderComponent(AdminActionCard, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="filter-group" data-v-975becaa${_scopeId}>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="code-text" data-v-975becaa${_scopeId2}>${ssrInterpolate(row.code)}</span>`);
                } else {
                  return [
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row.display_uid || row.user_uid) {
                    _push3(`<div class="user-cell" data-v-975becaa${_scopeId2}>`);
                    ...
                    if (row.user_nickname) {
                      _push3(`<div class="user-nickname" data-v-975becaa${_scopeId2}>${ssrInterpolate(row.user_nickname)}</div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div>`);
                  } else {
                    _push3(`<span class="text-gray" data-v-975becaa${_scopeId2}>-</span>`);
                  }
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row.order_no) {
                    _push3(`<span class="order-no" data-v-975becaa${_scopeId2}>${ssrInterpolate(row.order_no)}</span>`);
                  } else if (row.order_id) {
                    _push3(`<span class="order-uuid" data-v-975becaa${_scopeId2}>${ssrInterpolate(row.order_id)}</span>`);
                  } else {
                    _push3(`<span class="text-gray" data-v-975becaa${_scopeId2}>-</span>`);
                  }
                } else {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/coupons/stats/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-975becaa"]]);

export { index as default };
//# sourceMappingURL=index-BUSxRgzj.mjs.map
