...
import { l as loading_default, f as arrow_right_default } from './index-DNnPa_Q9.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const AboutSection = defineAsyncComponent(() => import('./AboutSection-oKtvx_ra.mjs'));
    const LoginRegisterModal = defineAsyncComponent(() => import('./LoginRegisterModal-ClwExjfE.mjs'));
...
//# sourceMappingURL=index-BxMjKZTf.mjs.map
