...
import { ab as picture_default, at as folder_remove_default, au as folder_default, av as setting_default, U as refresh_default, aw as upload_default, ap as view_default, J as edit_default, Y as delete_default, R as check_default } from './index-CbQ9NNm4.mjs';
import { d as adminImageCategoryApi, a as adminImageApi } from './media-BJaGHW2U.mjs';
import { c as confirmAction, a as confirmDelete } from './useAdminDialog-BSe9aawB.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _directive_loading = vLoading;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "media-layout" }, _attrs))} data-v-a75f3457><div class="media-sidebar" data-v-a75f3457><div class="sidebar-header" data-v-a75f3457><h3 class="sidebar-title" data-v-a75f3457>\u56FE\u7247\u5206\u7C7B</h3></div><div class="category-nav" data-v-a75f3457><div class="${ssrRenderClass([{ active: currentCategoryId.value === "" }, "nav-item"])}" data-v-a75f3457>`);
      ...
      _push(`<span class="nav-label" data-v-a75f3457>\u5168\u90E8\u56FE\u7247</span>`);
      if (totalImages.value > 0 && currentCategoryId.value === "") {
        _push(`<span class="nav-count" data-v-a75f3457>${ssrInterpolate(totalImages.value)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="nav-divider" data-v-a75f3457></div><div${ssrRenderAttrs(mergeProps({ class: "nav-list" }, ssrGetDirectiveProps(_ctx, _directive_loading, catLoading.value)))} data-v-a75f3457><!--[-->`);
      ssrRenderList(categories.value, (cat) => {
        _push(`<div class="${ssrRenderClass([{ active: currentCategoryId.value === cat.id, "is-uncategorized": cat.name === "\u672A\u5206\u7C7B" }, "nav-item"])}" data-v-a75f3457>`);
        if (cat.name === "\u672A\u5206\u7C7B") {
          _push(ssrRenderComponent(_component_el_icon, null, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
        ...
        _push(`<span class="nav-label" data-v-a75f3457>${ssrInterpolate(cat.name)}</span></div>`);
      });
      _push(`<!--]--></div></div><div class="sidebar-footer" data-v-a75f3457>`);
      ...
      _push(`</div></div><div class="media-content" data-v-a75f3457><div class="content-toolbar" data-v-a75f3457><div class="toolbar-left" data-v-a75f3457>`);
      ...
      _push(`</div><div class="toolbar-right" data-v-a75f3457>`);
      if (selectedIds.value.length > 0) {
        _push(`<div class="batch-actions" data-v-a75f3457><span class="selection-info" data-v-a75f3457>\u5DF2\u9009 ${ssrInterpolate(selectedIds.value.length)} \u9879</span>`);
        _push(ssrRenderComponent(_component_el_button, {
          type: "danger",
          link: "",
      ...
      _push(`</div></div><div${ssrRenderAttrs(mergeProps({ class: "content-body" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-a75f3457>`);
      if (images2.value.length === 0) {
        _push(`<div class="empty-state" data-v-a75f3457>`);
        _push(ssrRenderComponent(_component_el_empty, { description: "\u6682\u65E0\u56FE\u7247" }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div class="image-grid-container" data-v-a75f3457><!--[-->`);
        ssrRenderList(images2.value, (img) => {
          _push(`<div class="${ssrRenderClass([{ selected: selectedIds.value.includes(img.id) }, "grid-item"])}" data-v-a75f3457><div class="img-preview" data-v-a75f3457>`);
          ...
          _push(`<div class="img-overlay" data-v-a75f3457><div class="overlay-actions" data-v-a75f3457>`);
          _push(ssrRenderComponent(_component_el_button, {
            circle: "",
            size: "small",
          ...
          if (selectedIds.value.includes(img.id)) {
            _push(`<div class="selection-mark" data-v-a75f3457>`);
            _push(ssrRenderComponent(_component_el_icon, null, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
          ...
          _push(`</div><div class="img-meta" data-v-a75f3457><div class="img-name"${ssrRenderAttr("title", img.name)} data-v-a75f3457>${ssrInterpolate(img.name)}</div><div class="img-info" data-v-a75f3457>`);
          if (img.category) {
            _push(`<span class="cat-badge" data-v-a75f3457>${ssrInterpolate(img.category.name)}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<span class="date" data-v-a75f3457>${ssrInterpolate(formatDate(img.created_at))}</span></div></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div>`);
      if (images2.value.length > 0) {
        _push(`<div class="content-footer" data-v-a75f3457>`);
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", previewUrl.value)} style="${ssrRenderStyle({ "max-width": "100%", "max-height": "600px", "display": "block", "margin": "0 auto" })}" data-v-a75f3457${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/media/images.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const images = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a75f3457"]]);

export { images as default };
//# sourceMappingURL=images-C5jvFIJv.mjs.map
