...
import { E as ElCheckbox } from './index-DWB_V3f7.mjs';
...
import { defineComponent, ref, computed, reactive, mergeProps, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, unref, createTextVNode, toDisplayString, withKeys, createCommentVNode, withModifiers, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrGetDirectiveProps, ssrRenderClass, ssrRenderAttr, ssrRenderStyle } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { ad as search_default, U as refresh_default, aw as upload_default } from './index-CbQ9NNm4.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "image-page" }, _attrs))} data-v-8e14de15><div class="page-header" data-v-8e14de15><h2 data-v-8e14de15>\u56FE\u7247\u7BA1\u7406</h2></div>`);
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="filter-container" data-v-8e14de15${_scopeId}><div class="filter-left" data-v-8e14de15${_scopeId}>`);
            ...
            _push2(`</div><div class="filter-right" data-v-8e14de15${_scopeId}>`);
            ...
            if (categories.value.length > 0) {
              _push2(`<div class="category-display" data-v-8e14de15${_scopeId}><span class="cat-label" data-v-8e14de15${_scopeId}>\u5DF2\u6709\u5206\u7C7B\uFF1A</span><div class="cat-tags" data-v-8e14de15${_scopeId}><!--[-->`);
              ssrRenderList(categories.value, (cat) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (filteredImages.value.length === 0) {
              _push2(`<div class="empty-state" data-v-8e14de15${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_empty, { description: "\u6682\u65E0\u56FE\u7247" }, null, _parent2, _scopeId));
              _push2(`</div>`);
            } else {
              _push2(`<div class="image-grid" data-v-8e14de15${_scopeId}><!--[-->`);
              ssrRenderList(filteredImages.value, (img) => {
                _push2(`<div class="${ssrRenderClass([{ "is-selected": selectedIds.value.includes(img.id) }, "image-card"])}" data-v-8e14de15${_scopeId}><div class="card-selection" data-v-8e14de15${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_checkbox, {
                  "model-value": selectedIds.value.includes(img.id),
                  size: "large",
                  style: { "pointer-events": "none" }
                }, null, _parent2, _scopeId));
                _push2(`</div><div class="image-wrapper" data-v-8e14de15${_scopeId}>`);
                ...
                _push2(`</div><div class="image-info" data-v-8e14de15${_scopeId}><div class="image-header" data-v-8e14de15${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_tag, {
                  size: "small",
                  type: "info",
                  effect: "plain",
                ...
                _push2(`</div><div class="image-name"${ssrRenderAttr("title", img.name)} data-v-8e14de15${_scopeId}>${ssrInterpolate(img.name)}</div><div class="image-actions" data-v-8e14de15${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_button, {
                  link: "",
                  type: "primary",
                  size: "small",
            ...
            _push2(`<div class="pagination-wrapper" style="${ssrRenderStyle({ "margin-top": "20px", "display": "flex", "justify-content": "flex-end" })}" data-v-8e14de15${_scopeId}>`);
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="cat-manager" data-v-8e14de15${_scopeId}><div class="add-cat-row" data-v-8e14de15${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_input, {
            ...
            _push2(`<div class="cat-list" data-v-8e14de15${_scopeId}><!--[-->`);
            ssrRenderList(categories.value, (cat) => {
              _push2(`<div class="cat-item" data-v-8e14de15${_scopeId}><span data-v-8e14de15${_scopeId}>${ssrInterpolate(cat.name)}</span>`);
              _push2(ssrRenderComponent(_component_el_button, {
                link: "",
                type: "danger",
                size: "small",
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="dialog-footer" data-v-8e14de15${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_button, {
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_el_upload, {
                          ...
                          tip: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="el-upload__tip" data-v-8e14de15${_scopeId4}>\u53EA\u80FD\u4E0A\u4F20 jpg/png \u6587\u4EF6\uFF0C\u4E14\u4E0D\u8D85\u8FC7 2MB</div>`);
                            } else {
                              return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/images/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8e14de15"]]);

export { index as default };
//# sourceMappingURL=index-C02jiZeL.mjs.map
