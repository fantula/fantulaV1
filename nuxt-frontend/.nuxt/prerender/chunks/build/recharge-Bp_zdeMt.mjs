...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const tabs = [
      { name: "tiers", label: "\u5145\u503C\u6863\u4F4D", route: "/manager_portal/recharge/tiers" },
      { name: "orders", label: "\u5145\u503C\u8BB0\u5F55", route: "/manager_portal/recharge/orders" }
    ];
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/recharge.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=recharge-Bp_zdeMt.mjs.map
