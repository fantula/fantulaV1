...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const tabs = [
      { name: "balance", label: "\u989D\u5EA6\u5238", route: "/manager_portal/coupons/balance" },
      { name: "flat", label: "\u7ACB\u51CF\u5238", route: "/manager_portal/coupons/flat" },
      { name: "product", label: "\u6307\u5B9A\u5546\u54C1", route: "/manager_portal/coupons/product" },
      { name: "stats", label: "\u4F18\u60E0\u5238\u7EDF\u8BA1", route: "/manager_portal/coupons/stats" }
    ];
...
//# sourceMappingURL=coupons-bqH-lldU.mjs.map
