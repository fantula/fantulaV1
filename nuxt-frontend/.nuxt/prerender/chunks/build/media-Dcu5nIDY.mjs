...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const tabs = [
      { name: "images", label: "\u56FE\u7247\u5E93", route: "/manager_portal/media/images" },
      { name: "banners", label: "\u8F6E\u64AD\u56FE", route: "/manager_portal/media/banners" }
    ];
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/media.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=media-Dcu5nIDY.mjs.map
