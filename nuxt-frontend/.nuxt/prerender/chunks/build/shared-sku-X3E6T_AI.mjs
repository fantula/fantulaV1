...
import { U as refresh_default, p as plus_default, ab as picture_default } from './index-CbQ9NNm4.mjs';
...
import { A as AdminSkuEditor } from './SkuEditor-DjECnKf3.mjs';
...
import './index-7iIj_WSU.mjs';
import './index-D3BlhKEk.mjs';
import './AdminImageSelector-Df4rVl5Q.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "shared-sku-page" }, _attrs))} data-v-1435a5d5>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (row.tag_name) {
                    _push3(`<div style="${ssrRenderStyle({ "font-size": "12px", "margin-top": "5px", "color": "#909399" })}" data-v-1435a5d5${_scopeId2}>${ssrInterpolate(row.tag_name)}</div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="spec-preview" data-v-1435a5d5${_scopeId2}><!--[-->`);
      ...
      _push(ssrRenderComponent(AdminDataDialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "margin-bottom": "20px" })}" data-v-1435a5d5${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/products/shared-sku.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const sharedSku = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1435a5d5"]]);

export { sharedSku as default };
//# sourceMappingURL=shared-sku-X3E6T_AI.mjs.map
