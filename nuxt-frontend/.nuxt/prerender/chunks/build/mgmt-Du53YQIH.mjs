import { E as ElContainer, a as ElAside, b as ElMenu, c as ElSubMenu, d as ElMenuItem, e as ElHeader, f as ElDropdown, g as ElDropdownMenu, h as ElDropdownItem, i as ElMain } from './index-D0PrYmPT.mjs';
...
import { u as useAdminStore } from './admin-jdz9G7O3.mjs';
import draggable from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vuedraggable/dist/vuedraggable.umd.min.js';
import { A as user_filled_default, x as monitor_default, a4 as timer_default, av as setting_default, M as message_default, aG as collection_default, q as document_default, al as question_filled_default, o as picture_filled_default, ad as picture_default, t as money_default, s as service_default, B as user_default, E as ticket_default, P as key_default, a7 as files_default, as as goods_default, r as refresh_left_default, D as list_default, aH as odometer_default, aI as expand_default, aJ as fold_default, aD as sunny_default, aK as moon_default, a9 as arrow_down_default, H as switch_button_default } from './index-CCIZH4aC.mjs';
import { A as ADMIN_MENU_ITEMS } from './admin-menu-CM94ZQny.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-46fa2f5e>`);
      if (isLoginPage.value) {
        ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      } else if (isLoading.value) {
        _push(`<div class="admin-loading-screen" data-v-46fa2f5e><div class="loading-content" data-v-46fa2f5e><div class="loading-logo" data-v-46fa2f5e>F</div><p class="loading-text" data-v-46fa2f5e>\u6B63\u5728\u9A8C\u8BC1\u8EAB\u4EFD...</p></div></div>`);
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_component_el_aside, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="${ssrRenderClass([{ "collapsed": isCollapse.value }, "logo"])}" data-v-46fa2f5e${_scopeId2}><div class="logo-icon" data-v-46fa2f5e${_scopeId2}>F</div><div class="logo-text" style="${ssrRenderStyle(!isCollapse.value ? null : { display: "none" })}" data-v-46fa2f5e${_scopeId2}><h2 data-v-46fa2f5e${_scopeId2}>FANTULA</h2><span class="logo-sub" data-v-46fa2f5e${_scopeId2}>ADMINISTRATOR</span></div></div>`);
                              ...
                              if (_push5) {
                                _push5(ssrRenderComponent(unref(draggable), {
                                  ...
                                  item: withCtx(({ element }, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="menu-wrapper" data-v-46fa2f5e${_scopeId5}>`);
                                        ...
                                        _push6(ssrRenderComponent(_component_el_sub_menu, {
                                          ...
                                          title: withCtx((_5, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              ...
                                              _push7(`<span data-v-46fa2f5e${_scopeId6}>${ssrInterpolate(element.title)}</span>`);
                                            } else {
                                              return [
                                              ...
                                              ssrRenderList(element.children, (child) => {
                                                _push7(ssrRenderComponent(_component_el_menu_item, {
                                                  ...
                                                  title: withCtx((_6, _push8, _parent8, _scopeId7) => {
                                                    if (_push8) {
                                                      _push8(`<span data-v-46fa2f5e${_scopeId7}>${ssrInterpolate(child.title)}</span>`);
                                                    } else {
                                                      return [
                    ...
                    _push3(`<div class="sidebar-toggle" data-v-46fa2f5e${_scopeId2}>`);
                    if (isCollapse.value) {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_el_header, { class: "admin-header" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="header-content" data-v-46fa2f5e${_scopeId3}><div id="header-portal" class="header-portal" data-v-46fa2f5e${_scopeId3}></div><div class="header-right-actions" data-v-46fa2f5e${_scopeId3}><button class="theme-toggle"${ssrRenderAttr("title", isDark.value ? "Switch to Light" : "Switch to Dark")} data-v-46fa2f5e${_scopeId3}>`);
                          if (isDark.value) {
                          ...
                          if (currentUser.value) {
                            _push4(`<div class="user-info" data-v-46fa2f5e${_scopeId3}>`);
                            _push4(ssrRenderComponent(_component_el_dropdown, { trigger: "click" }, {
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<div class="el-dropdown-link" data-v-46fa2f5e${_scopeId4}>`);
                                  _push5(ssrRenderComponent(_component_el_avatar, {
                                    size: 36,
                                    src: "https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png",
                                    class: "user-avatar"
                                  }, null, _parent5, _scopeId4));
                                  _push5(`<div class="user-details" data-v-46fa2f5e${_scopeId4}><span class="username" data-v-46fa2f5e${_scopeId4}>${ssrInterpolate(currentUser.value.name)}</span><span class="user-role" data-v-46fa2f5e${_scopeId4}>${ssrInterpolate(currentUser.value.email)}</span></div>`);
                    ...
                    _push3(ssrRenderComponent(_component_el_main, { class: "admin-main" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="main-content-wrapper" data-v-46fa2f5e${_scopeId3}>`);
...
const mgmt = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-46fa2f5e"]]);

export { mgmt as default };
//# sourceMappingURL=mgmt-Du53YQIH.mjs.map
