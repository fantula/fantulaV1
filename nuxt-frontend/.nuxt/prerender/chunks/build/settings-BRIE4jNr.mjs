...
import { E as ElForm } from './index-C-iEkQSR.mjs';
...
import { defineComponent, ref, reactive, mergeProps, withCtx, createVNode, openBlock, createBlock, createCommentVNode, withDirectives, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "settings-page" }, _attrs))} data-v-90fd999c>`);
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${ssrRenderAttrs(mergeProps({ class: "settings-list" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-90fd999c${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_form, { "label-position": "top" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-title" data-v-90fd999c${_scopeId2}>\u8BA2\u5355\u76F8\u5173</div><div class="setting-item" data-v-90fd999c${_scopeId2}><div class="setting-header" data-v-90fd999c${_scopeId2}><span class="label" data-v-90fd999c${_scopeId2}>\u4E0B\u5355\u901A\u77E5 (Order Created)</span>`);
                  ...
                  if (settings2.order_created.enable) {
                    _push3(`<div class="template-area" data-v-90fd999c${_scopeId2}><div class="field-row" data-v-90fd999c${_scopeId2}>`);
                    ...
                    _push3(`<div class="vars-tip" data-v-90fd999c${_scopeId2}>\u53EF\u7528\u53D8\u91CF: {order_no}</div></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div><div class="setting-item" data-v-90fd999c${_scopeId2}><div class="setting-header" data-v-90fd999c${_scopeId2}><span class="label" data-v-90fd999c${_scopeId2}>\u8BA2\u5355\u53D1\u8D27 (Order Shipped)</span>`);
                  _push3(ssrRenderComponent(_component_el_switch, {
                  ...
                  _push3(`</div><div class="setting-item" data-v-90fd999c${_scopeId2}><div class="setting-header" data-v-90fd999c${_scopeId2}><span class="label" data-v-90fd999c${_scopeId2}>\u865A\u62DF/API\u56DE\u6267 (Receipt)</span>`);
                  _push3(ssrRenderComponent(_component_el_switch, {
                  ...
                  _push3(`<div class="section-title" data-v-90fd999c${_scopeId2}>\u8D26\u6237\u4E0E\u6743\u76CA</div><div class="setting-item" data-v-90fd999c${_scopeId2}><div class="setting-header" data-v-90fd999c${_scopeId2}><span class="label" data-v-90fd999c${_scopeId2}>\u4F18\u60E0\u5238\u5151\u6362 (Redeemed)</span>`);
                  _push3(ssrRenderComponent(_component_el_switch, {
                  ...
                  _push3(`</div><div class="setting-item" data-v-90fd999c${_scopeId2}><div class="setting-header" data-v-90fd999c${_scopeId2}><span class="label" data-v-90fd999c${_scopeId2}>\u989D\u5EA6\u53D8\u52A8 (Quota Changed)</span>`);
                  _push3(ssrRenderComponent(_component_el_switch, {
                  ...
                  if (settings2.quota_changed.enable) {
                    ...
                    _push3(`<div class="vars-tip" data-v-90fd999c${_scopeId2}>\u53EF\u7528\u53D8\u91CF: {balance}, {amount}</div></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div>`);
                  _push3(ssrRenderComponent(_component_el_divider, null, null, _parent3, _scopeId2));
                  _push3(`<div class="section-title" data-v-90fd999c${_scopeId2}>\u670D\u52A1\u652F\u6301</div><div class="setting-item" data-v-90fd999c${_scopeId2}><div class="setting-header" data-v-90fd999c${_scopeId2}><span class="label" data-v-90fd999c${_scopeId2}>\u5DE5\u5355\u56DE\u590D (Ticket Replied)</span>`);
                  _push3(ssrRenderComponent(_component_el_switch, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/messages/settings.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const settings = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-90fd999c"]]);

export { settings as default };
//# sourceMappingURL=settings-BRIE4jNr.mjs.map
