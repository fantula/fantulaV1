...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const tabs = [
      { name: "tiers", label: "\u5145\u503C\u6863\u4F4D", route: adminRoute("recharge/tiers") },
      { name: "orders", label: "\u5145\u503C\u8BB0\u5F55", route: adminRoute("recharge/orders") }
    ];
...
//# sourceMappingURL=recharge-D1uS_ved.mjs.map
