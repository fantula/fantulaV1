...
const categoryStyles_CeRSGDpd = [
  category_vue_vue_type_style_index_0_scoped_bc6e31f1_lang
];

export { categoryStyles_CeRSGDpd as default };
//# sourceMappingURL=category-styles.CeRSGDpd.mjs.map
