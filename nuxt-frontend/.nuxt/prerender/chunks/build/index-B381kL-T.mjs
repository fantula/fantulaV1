...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "redirect-loading" }, _attrs))} data-v-b83ae94c>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b83ae94c"]]);

export { index as default };
//# sourceMappingURL=index-B381kL-T.mjs.map
