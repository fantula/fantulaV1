...
import { defineComponent, ref, computed, mergeProps, withCtx, unref, createTextVNode, createVNode, toDisplayString, withDirectives, openBlock, createBlock, Fragment, renderList, withKeys, createCommentVNode, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrGetDirectiveProps, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderClass } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { p as plus_default, O as search_default, M as check_default } from './index-CRs4T-Jf.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "banner-page" }, _attrs))} data-v-04e56c21><div class="page-header" data-v-04e56c21><h2 data-v-04e56c21>\u8F6E\u64AD\u56FE\u7BA1\u7406</h2></div>`);
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="action-container" data-v-04e56c21${_scopeId}>`);
                ...
                if (_push3) {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_el_image, {
                          src: ((_a = row.image) == null ? void 0 : _a.url) || row.url,
                          fit: "cover",
                          style: { "width": "140px", "height": "70px", "border-radius": "4px" },
                          "preview-src-list": [((_b = row.image) == null ? void 0 : _b.url) || row.url]
                        }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(_component_el_image, {
                            src: ((_c = row.image) == null ? void 0 : _c.url) || row.url,
                            fit: "cover",
                            style: { "width": "140px", "height": "70px", "border-radius": "4px" },
                            "preview-src-list": [((_d = row.image) == null ? void 0 : _d.url) || row.url]
                  ...
                  _push3(ssrRenderComponent(_component_el_table_column, {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      var _a, _b;
                      if (_push4) {
                        _push4(`${ssrInterpolate(((_a = row.image) == null ? void 0 : _a.name) || row.title || "\u672A\u547D\u540D")}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(((_b = row.image) == null ? void 0 : _b.name) || row.title || "\u672A\u547D\u540D"), 1)
                        ];
                      }
                    }),
                    _: 1
                  ...
                  return [
                    ...
                    createVNode(_component_el_table_column, {
                      ...
                      default: withCtx(({ row }) => {
                        var _a;
                        return [
                          createTextVNode(toDisplayString(((_a = row.image) == null ? void 0 : _a.name) || row.title || "\u672A\u547D\u540D"), 1)
                        ];
                      }),
                      _: 1
                    }),
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="dialog-footer" data-v-04e56c21${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_button, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "margin-bottom": "15px", "display": "flex" })}" data-v-04e56c21${_scopeId}>`);
            ...
            _push2(`</div><div class="selector-grid" data-v-04e56c21${_scopeId}><!--[-->`);
            ssrRenderList(libraryImages.value, (img) => {
              _push2(`<div class="${ssrRenderClass([{ "is-selected": selectedImageId.value === img.id }, "selector-item"])}" data-v-04e56c21${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_image, {
                src: img.url,
                fit: "cover",
                class: "selector-thumb"
              }, null, _parent2, _scopeId));
              _push2(`<div class="selector-name" data-v-04e56c21${_scopeId}>${ssrInterpolate(img.name)}</div>`);
              if (selectedImageId.value === img.id) {
                _push2(`<div class="selector-mask" data-v-04e56c21${_scopeId}>`);
            ...
            _push2(`<!--]--></div><div class="pagination-wrapper" style="${ssrRenderStyle({ "margin-top": "15px", "display": "flex", "justify-content": "flex-end" })}" data-v-04e56c21${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/banners/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-04e56c21"]]);

export { index as default };
//# sourceMappingURL=index-vIw9TO6F.mjs.map
