import { _ as _export_sfc, E as ElIcon, z as arrow_left_default, b6 as timer_default, a3 as info_filled_default, f as arrow_right_default, a5 as wallet_default, aA as select_default, d as useUserStore, ah as ElMessage, o as getSupabaseClient, ak as setInterval } from './server.mjs';
import { E as ElTag } from './index-BOQJCp53.mjs';
import { defineComponent, ref, computed, mergeProps, withCtx, unref, createVNode, createTextVNode, toDisplayString, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderClass } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
...
function useCheckout() {
  ...
  const handlePay = async () => {
    ...
    try {
      ...
      if (!res.success) {
        if ((_b = res.error) == null ? void 0 : _b.includes("\u4F59\u989D\u4E0D\u8DB3")) {
          showBalanceModal.value = true;
        } else {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const currentBalance = computed(() => {
      var _a, _b;
      return (_b = (_a = userStore.user) == null ? void 0 : _a.balance) != null ? _b : props.balance;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(preOrders), (order) => {
          var _a2, _b, _c;
          _push(`<div class="order-card glass-card" data-v-5a37d362><div class="order-header-row" data-v-5a37d362><span class="order-no" data-v-5a37d362>\u8BA2\u5355\u53F7: ${ssrInterpolate(order.order_no)}</span><span class="order-status" data-v-5a37d362>\u5F85\u652F\u4ED8</span></div><div class="order-body" data-v-5a37d362><div class="product-thumb" data-v-5a37d362><div class="sq-cover-img-container" data-v-5a37d362><img${ssrRenderAttr("src", ((_a2 = order.product_snapshot) == null ? void 0 : _a2.image) || "/images/shared/logo.png")} class="sq-cover-img" data-v-5a37d362></div></div><div class="product-info" data-v-5a37d362><div class="product-name" data-v-5a37d362>${ssrInterpolate((_b = order.product_snapshot) == null ? void 0 : _b.product_name)}</div><div class="product-spec" data-v-5a37d362>${ssrInterpolate(unref(formatSpec)((_c = order.sku_snapshot) == null ? void 0 : _c.spec_combination))}</div></div><div class="product-price" data-v-5a37d362><div class="price-val" data-v-5a37d362>\xA5${ssrInterpolate(order.unit_price.toFixed(2))}</div><div class="qty" data-v-5a37d362>x${ssrInterpolate(order.quantity)}</div></div></div></div>`);
        });
        ...
        if (unref(selectedCoupon)) {
          _push(ssrRenderComponent(_component_el_tag, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(` \u5DF2\u62B5\u6263 \xA5${ssrInterpolate(unref(couponDiscount).toFixed(2))}`);
              } else {
                return [
                  createTextVNode(" \u5DF2\u62B5\u6263 \xA5" + toDisplayString(unref(couponDiscount).toFixed(2)), 1)
                ];
              }
            }),
            _: 1
        ...
        if (unref(selectedCoupon)) {
          _push(`<span class="val discount" data-v-5a37d362>-\xA5${ssrInterpolate(unref(couponDiscount).toFixed(2))}</span>`);
        } else {
        ...
        _push(`</div><div class="balance-info" data-v-5a37d362><div class="method-name" data-v-5a37d362>\u4F59\u989D\u652F\u4ED8</div><div class="user-balance" data-v-5a37d362>\u53EF\u7528\u4F59\u989D: \xA5${ssrInterpolate(unref(userBalance).toFixed(2))}</div></div><div class="check-mark" data-v-5a37d362>`);
        _push(ssrRenderComponent(_component_el_icon, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        if (unref(paying)) {
          ...
          _push(`<span data-v-5a37d362>\u7ACB\u5373\u652F\u4ED8 \xA5${ssrInterpolate(unref(finalPayAmount).toFixed(2))}</span>`);
        }
...
//# sourceMappingURL=_id_-DLoHkiHq.mjs.map
