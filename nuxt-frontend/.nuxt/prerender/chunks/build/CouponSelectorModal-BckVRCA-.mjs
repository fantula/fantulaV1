...
import { defineComponent, computed, ref, watch, mergeProps, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { B as BaseCouponTicket } from './BaseCouponTicket-BGNJ4D7F.mjs';
import { c as couponApi } from './coupon-D1so52Ot.mjs';
import { i as info_filled_default, r as refresh_default, o as circle_close_default } from './index-CmsdIFY8.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(BaseBusinessModal, mergeProps({
        ...
        "footer-left": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (tempSelected.value) {
              _push2(`<div class="selected-info" data-v-b63d824f${_scopeId}> \u5DF2\u9009\u62E9: <span class="highlight" data-v-b63d824f${_scopeId}>${ssrInterpolate(tempSelected.value.coupon.name)}</span><span class="discount-preview" data-v-b63d824f${_scopeId}>-\xA5${ssrInterpolate(tempSelected.value.coupon.value)}</span></div>`);
            } else {
              _push2(`<div class="selected-info" data-v-b63d824f${_scopeId}> \u672A\u9009\u62E9\u4F18\u60E0\u5238 </div>`);
            }
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="coupon-selector-content" data-v-b63d824f${_scopeId}><div class="action-header" data-v-b63d824f${_scopeId}><div class="header-tip" data-v-b63d824f${_scopeId}>`);
            ...
            _push2(`</div><div class="coupon-list-container" data-v-b63d824f${_scopeId}>`);
            if (listLoading.value) {
              _push2(`<div class="loading-state" data-v-b63d824f${_scopeId}><div class="spinner" data-v-b63d824f${_scopeId}></div> \u6B63\u5728\u83B7\u53D6\u4F18\u60E0\u5238... </div>`);
            } else if (coupons.value.length === 0) {
              _push2(`<div class="empty-state" data-v-b63d824f${_scopeId}>`);
              ...
              _push2(`<div class="coupon-list" data-v-b63d824f${_scopeId}><div class="${ssrRenderClass([{ active: tempSelected.value === null }, "coupon-item no-coupon glass-card"])}" data-v-b63d824f${_scopeId}><div class="coupon-left" data-v-b63d824f${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_icon, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
              ...
              _push2(`</div><div class="coupon-center" data-v-b63d824f${_scopeId}><div class="coupon-title" data-v-b63d824f${_scopeId}>\u4E0D\u4F7F\u7528\u4F18\u60E0\u5238</div><div class="coupon-desc" data-v-b63d824f${_scopeId}>\u653E\u5F03\u5F53\u524D\u4F18\u60E0</div></div><div class="coupon-right" data-v-b63d824f${_scopeId}><div class="radio-check" data-v-b63d824f${_scopeId}></div></div></div><!--[-->`);
              ssrRenderList(sortedCoupons.value, (coupon) => {
                ...
                }, "ticket-wrapper"])}" data-v-b63d824f${_scopeId}>`);
                _push2(ssrRenderComponent(BaseCouponTicket, {
                  ...
                  action: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    var _a2, _b;
                    if (_push3) {
                      _push3(`<div class="${ssrRenderClass([{ checked: ((_a2 = tempSelected.value) == null ? void 0 : _a2.id) === coupon.id }, "radio-check"])}" data-v-b63d824f${_scopeId2}></div>`);
                    } else {
                      return [
                        createVNode("div", {
                ...
                if (!isApplicable(coupon)) {
                  _push2(`<div class="inapplicable-reason" data-v-b63d824f${_scopeId}>${ssrInterpolate(getInapplicableReason(coupon))}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
...
const CouponSelectorModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b63d824f"]]);

export { CouponSelectorModal as C };
//# sourceMappingURL=CouponSelectorModal-BckVRCA-.mjs.map
