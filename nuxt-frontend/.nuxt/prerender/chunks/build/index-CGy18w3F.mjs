import { defineComponent, computed, mergeProps, reactive, withCtx, unref, createVNode, ref, watch, openBlock, createBlock, createTextVNode, Fragment, renderList, createCommentVNode, withDirectives, withKeys, vModelText, toDisplayString, vModelCheckbox, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { Z as camera_default, q as circle_check_default, _ as edit_default, $ as credit_card_default, a0 as copy_document_default, a1 as message_default, a2 as edit_pen_default, a3 as lock_default, a4 as key_default, a as arrow_right_default, a5 as connection_default, P as warning_default, R as user_filled_default, a6 as upload_default, J as check_default, a7 as chat_dot_round_default, a8 as select_default, r as refresh_default } from './index-CmsdIFY8.mjs';
import getSupabaseClient from './supabase-jxF0-7J3.mjs';
import { B as BaseFormModal } from './BaseFormModal-BT6-Hc0e.mjs';
  ...
  async getLoginQrCode() {
    ...
    try {
      ...
      return {
        code: 500,
        success: false,
        msg: ((_a = err.data) == null ? void 0 : _a.message) || err.message || "\u83B7\u53D6\u4E8C\u7EF4\u7801\u5931\u8D25",
        data: void 0
      };
    }
  },
  ...
  setup(__props, { emit: __emit }) {
    ...
    const handleDeleteAccount = async () => {
      try {
        ...
        if (res.success) {
          const { ElMessageBox: ElMessageBox2 } = await import('./index-BxfJN5os.mjs');
...
//# sourceMappingURL=index-CGy18w3F.mjs.map
