...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-page" }, _attrs))} data-v-11e98049><div class="page-header" data-v-11e98049><h2 class="page-title" data-v-11e98049>\u793E\u533A\u6587\u7AE0\u7BA1\u7406</h2>`);
      _push(ssrRenderComponent(_component_el_button, {
        type: "primary",
        onClick: ($event) => unref(router).push(unref(adminRoute)("article/post"))
      }, {
      ...
      _push(`</div><div class="filter-section" data-v-11e98049></div><div${ssrRenderAttrs(mergeProps({ class: "table-container" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-11e98049>`);
      ...
      _push(`<div class="pagination-container" data-v-11e98049>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-11e98049"]]);

export { index as default };
//# sourceMappingURL=index-CyK-eShi.mjs.map
