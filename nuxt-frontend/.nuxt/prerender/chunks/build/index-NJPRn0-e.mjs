...
import { E as ElTableColumn } from './index-DnlpAwTZ.mjs';
...
import { defineComponent, ref, watch, mergeProps, withCtx, createVNode, unref, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { A as refresh_default, l as loading_default, M as check_default } from './index-CRs4T-Jf.mjs';
import { P as PageTipHeader } from './PageTipHeader-CYVW2ELG.mjs';
import { A as AdminActionCard } from './AdminActionCard-Br1XkmCK.mjs';
import { A as AdminDataTable } from './AdminDataTable-adUoqR6P.mjs';
import { g as getAdminSupabaseClient } from './supabase-admin-BRqZY69D.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-container" }, _attrs))} data-v-476cf353>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="mono-text" data-v-476cf353${_scopeId2}>${ssrInterpolate(row.order_no)}</span>`);
                } else {
                  return [
                    createVNode("span", {
                      class: "mono-text",
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                var _a, _b, _c, _d;
                if (_push3) {
                  _push3(`<div class="user-cell" data-v-476cf353${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_el_avatar, {
                    size: 28,
                    src: ((_a = row._profile) == null ? void 0 : _a.avatar) || unref(DEFAULT_AVATAR)
                  }, null, _parent3, _scopeId2));
                  _push3(`<span class="uid-text" data-v-476cf353${_scopeId2}>${ssrInterpolate(((_b = row._profile) == null ? void 0 : _b.uid) || "\u65E0UID")}</span></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                var _a, _b, _c, _d;
                if (_push3) {
                  _push3(`<div class="product-cell" data-v-476cf353${_scopeId2}>`);
                  if ((_a = row.product_snapshot) == null ? void 0 : _a.image) {
                    _push3(`<img${ssrRenderAttr("src", row.product_snapshot.image)} class="product-thumb" data-v-476cf353${_scopeId2}>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<span data-v-476cf353${_scopeId2}>${ssrInterpolate(((_b = row.product_snapshot) == null ? void 0 : _b.product_name) || "\u672A\u77E5\u5546\u54C1")}</span></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<span class="spec-text" data-v-476cf353${_scopeId2}>${ssrInterpolate(formatSpec((_a = row.sku_snapshot) == null ? void 0 : _a.spec_combination))}</span>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span data-v-476cf353${_scopeId2}>${ssrInterpolate(row.quantity || 1)}</span>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="amount" data-v-476cf353${_scopeId2}>${ssrInterpolate(unref(formatPrice)(row.total_amount))}</span>`);
                } else {
                  return [
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  if ((_a = row.coupon_snapshot) == null ? void 0 : _a.discount_amount) {
                    _push3(`<span class="discount" data-v-476cf353${_scopeId2}> -${ssrInterpolate(unref(formatPrice)(row.coupon_snapshot.discount_amount))}</span>`);
                  } else {
                    _push3(`<span class="no-discount" data-v-476cf353${_scopeId2}>-</span>`);
                  }
                } else {
                  return [
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (((_a = currentRequest.value) == null ? void 0 : _a.status) === "pending") {
              _push2(`<div class="dialog-footer-actions" data-v-476cf353${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_button, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (refundLoading.value) {
              _push2(`<div class="loading-state" data-v-476cf353${_scopeId}>`);
                  ...
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_el_descriptions_item, { label: "\u8BA2\u5355\u91D1\u989D" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        var _a2, _b2;
                        if (_push4) {
                          _push4(`<span class="amount" data-v-476cf353${_scopeId3}>\xA5${ssrInterpolate((_a2 = currentOrder.value) == null ? void 0 : _a2.total_amount)}</span>`);
                        } else {
                          return [
                    ...
                    if (_push3) {
                      if (currentRequest.value.refund_amount) {
                        _push3(ssrRenderComponent(_component_el_descriptions_item, { label: "\u9000\u6B3E\u91D1\u989D" }, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`<span class="amount" data-v-476cf353${_scopeId3}>\xA5${ssrInterpolate(currentRequest.value.refund_amount)}</span>`);
                            } else {
                              return [
              ...
              if (currentRequest.value.status === "pending") {
                _push2(`<div class="review-form mt-4" data-v-476cf353${_scopeId}><div class="form-row" data-v-476cf353${_scopeId}><label data-v-476cf353${_scopeId}>\u9000\u6B3E\u91D1\u989D\uFF1A</label>`);
                ...
                _push2(`<span class="hint" data-v-476cf353${_scopeId}>\uFF08\u8BA2\u5355\u91D1\u989D: \xA5${ssrInterpolate((_b = currentOrder.value) == null ? void 0 : _b.total_amount)}\uFF09</span></div><div class="form-row" data-v-476cf353${_scopeId}><label data-v-476cf353${_scopeId}>\u7BA1\u7406\u5458\u5907\u6CE8\uFF1A</label>`);
              ...
              _push2(`<div class="empty-receipt" data-v-476cf353${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/orders/refund/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-476cf353"]]);

export { index as default };
//# sourceMappingURL=index-NJPRn0-e.mjs.map
