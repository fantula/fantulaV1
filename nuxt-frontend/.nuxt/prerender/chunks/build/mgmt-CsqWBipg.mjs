import { E as ElContainer, a as ElAside, b as ElMenu, c as ElSubMenu, d as ElMenuItem, e as ElHeader, f as ElDropdown, g as ElDropdownMenu, h as ElDropdownItem, i as ElMain } from './index-DJdCcii6.mjs';
...
import { defineComponent, computed, ref, withCtx, unref, createVNode, resolveDynamicComponent, openBlock, createBlock, createCommentVNode, toDisplayString, Fragment, renderList, withDirectives, vShow, createTextVNode, renderSlot, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { u as useAdminStore } from './admin-iJOBhx41.mjs';
import draggable from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vuedraggable/dist/vuedraggable.umd.min.js';
import { V as user_filled_default, T as monitor_default, ak as timer_default, av as setting_default, a5 as message_default, aM as collection_default, N as document_default, P as question_filled_default, y as picture_filled_default, L as picture_default, Q as money_default, s as service_default, W as user_default, Z as ticket_default, a8 as key_default, an as files_default, as as goods_default, v as refresh_left_default, Y as list_default, aN as odometer_default, aO as expand_default, aP as fold_default, aJ as sunny_default, aQ as moon_default, D as arrow_down_default, a0 as switch_button_default } from './index-CRs4T-Jf.mjs';
import { A as ADMIN_MENU_ITEMS } from './admin-menu-K1BTJm27.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-ae963a29>`);
      if (isLoginPage.value) {
        ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      } else if (isLoading.value) {
        _push(`<div class="admin-loading-screen" data-v-ae963a29><div class="loading-content" data-v-ae963a29><div class="loading-logo" data-v-ae963a29>F</div><p class="loading-text" data-v-ae963a29>\u6B63\u5728\u9A8C\u8BC1\u8EAB\u4EFD...</p></div></div>`);
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_component_el_aside, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="${ssrRenderClass([{ "collapsed": isCollapse.value }, "logo"])}" data-v-ae963a29${_scopeId2}><div class="logo-icon" data-v-ae963a29${_scopeId2}>F</div><div class="logo-text" style="${ssrRenderStyle(!isCollapse.value ? null : { display: "none" })}" data-v-ae963a29${_scopeId2}><h2 data-v-ae963a29${_scopeId2}>FANTULA</h2><span class="logo-sub" data-v-ae963a29${_scopeId2}>ADMINISTRATOR</span></div></div>`);
                              ...
                              if (_push5) {
                                _push5(ssrRenderComponent(unref(draggable), {
                                  ...
                                  item: withCtx(({ element }, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="menu-wrapper" data-v-ae963a29${_scopeId5}>`);
                                        ...
                                        _push6(ssrRenderComponent(_component_el_sub_menu, {
                                          ...
                                          title: withCtx((_5, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              ...
                                              _push7(`<span data-v-ae963a29${_scopeId6}>${ssrInterpolate(element.title)}</span>`);
                                            } else {
                                              return [
                                              ...
                                              ssrRenderList(element.children, (child) => {
                                                _push7(ssrRenderComponent(_component_el_menu_item, {
                                                  ...
                                                  title: withCtx((_6, _push8, _parent8, _scopeId7) => {
                                                    if (_push8) {
                                                      _push8(`<span data-v-ae963a29${_scopeId7}>${ssrInterpolate(child.title)}</span>`);
                                                    } else {
                                                      return [
                    ...
                    _push3(`<div class="sidebar-toggle" data-v-ae963a29${_scopeId2}>`);
                    if (isCollapse.value) {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_el_header, { class: "admin-header" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="header-content" data-v-ae963a29${_scopeId3}><div id="header-portal" class="header-portal" data-v-ae963a29${_scopeId3}></div><div class="header-right-actions" data-v-ae963a29${_scopeId3}><button class="theme-toggle"${ssrRenderAttr("title", isDark.value ? "Switch to Light" : "Switch to Dark")} data-v-ae963a29${_scopeId3}>`);
                          if (isDark.value) {
                          ...
                          if (currentUser.value) {
                            _push4(`<div class="user-info" data-v-ae963a29${_scopeId3}>`);
                            _push4(ssrRenderComponent(_component_el_dropdown, { trigger: "click" }, {
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<div class="el-dropdown-link" data-v-ae963a29${_scopeId4}>`);
                                  _push5(ssrRenderComponent(_component_el_avatar, {
                                    size: 36,
                                    src: "https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png",
                                    class: "user-avatar"
                                  }, null, _parent5, _scopeId4));
                                  _push5(`<div class="user-details" data-v-ae963a29${_scopeId4}><span class="username" data-v-ae963a29${_scopeId4}>${ssrInterpolate(currentUser.value.name)}</span><span class="user-role" data-v-ae963a29${_scopeId4}>${ssrInterpolate(currentUser.value.email)}</span></div>`);
                    ...
                    _push3(ssrRenderComponent(_component_el_main, { class: "admin-main" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="main-content-wrapper" data-v-ae963a29${_scopeId3}>`);
...
const mgmt = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ae963a29"]]);

export { mgmt as default };
//# sourceMappingURL=mgmt-CsqWBipg.mjs.map
