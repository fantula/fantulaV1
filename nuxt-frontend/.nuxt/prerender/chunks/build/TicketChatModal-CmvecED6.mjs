        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (error.value) {
              ...
              _push2(`<div class="user-details" data-v-22900e30${_scopeId}><div class="uid" data-v-22900e30${_scopeId}>UID: ${ssrInterpolate((_c = (_b = ticket.value) == null ? void 0 : _b.user_id) == null ? void 0 : _c.substring(0, 8).toUpperCase())}</div>`);
              ...
              if ((_f = ticket.value) == null ? void 0 : _f.orders) {
                _push2(`<div class="info-block" data-v-22900e30${_scopeId}><div class="label" data-v-22900e30${_scopeId}>\u5173\u8054\u8BA2\u5355\u5FEB\u7167</div><div class="order-card-large" data-v-22900e30${_scopeId}><img${ssrRenderAttr("src", (_g = ticket.value.orders.product_snapshot) == null ? void 0 : _g.image)} class="order-img-large" data-v-22900e30${_scopeId}><div class="order-details-rows" data-v-22900e30${_scopeId}><div class="detail-row" data-v-22900e30${_scopeId}><span class="row-label" data-v-22900e30${_scopeId}>\u8BA2\u5355\u53F7</span><span class="row-value font-mono copyable" data-v-22900e30${_scopeId}>${ssrInterpolate(ticket.value.orders.order_no)}</span></div><div class="detail-row" data-v-22900e30${_scopeId}><span class="row-label" data-v-22900e30${_scopeId}>\u5546\u54C1</span><span class="row-value"${ssrRenderAttr("title", (_h = ticket.value.orders.product_snapshot) == null ? void 0 : _h.product_name)} data-v-22900e30${_scopeId}>${ssrInterpolate((_i = ticket.value.orders.product_snapshot) == null ? void 0 : _i.product_name)}</span></div>`);
                ...
                _push2(`<div class="detail-row" data-v-22900e30${_scopeId}><span class="row-label" data-v-22900e30${_scopeId}>\u91D1\u989D</span><span class="row-value price" data-v-22900e30${_scopeId}>\xA5${ssrInterpolate((_k = ticket.value.orders.total_amount) == null ? void 0 : _k.toFixed(2))}</span></div>`);
                if (timeLeft.value) {
              ...
              if (((_l = ticket.value) == null ? void 0 : _l.status) !== "processing" && ((_m = ticket.value) == null ? void 0 : _m.status) !== "resolved") {
                _push2(`<div class="text-xs text-red-400 text-center mb-2" data-v-22900e30${_scopeId}> \u5F53\u524D\u72B6\u6001\u5F02\u5E38: ${ssrInterpolate((_n = ticket.value) == null ? void 0 : _n.status)}</div>`);
              } else {
                _push2(`<!---->`);
              }
...
//# sourceMappingURL=TicketChatModal-CmvecED6.mjs.map
