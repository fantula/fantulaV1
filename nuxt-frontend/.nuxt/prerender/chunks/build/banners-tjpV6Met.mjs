...
import { defineComponent, ref, reactive, mergeProps, withCtx, unref, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, withDirectives, Fragment, renderList, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrGetDirectiveProps, ssrInterpolate, ssrRenderList, ssrRenderClass } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { p as plus_default, r as refresh_default, L as search_default } from './index-4qszPKX4.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "banner-page" }, _attrs))} data-v-d711c9a8>`);
      _push(ssrRenderComponent(AdminActionCard, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="action-bar" data-v-d711c9a8${_scopeId}>`);
            ...
            _push2(`</div><div class="mt-2 text-gray-500 text-sm" data-v-d711c9a8${_scopeId}> \u63D0\u793A\uFF1A\u8F6E\u64AD\u56FE\u56FE\u7247\u9700\u4ECE\u56FE\u7247\u7BA1\u7406\u4E2D\u9009\u62E9\uFF0C\u524D\u7AEF\u5C55\u793A\u987A\u5E8F\u7531\u6392\u5E8F\u503C\u51B3\u5B9A\uFF08\u8D8A\u5C0F\u8D8A\u9760\u524D\uFF09\u3002 </div>`);
          } else {
            return [
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (row.image) {
                          ...
                          _push4(`<span class="text-gray-400" data-v-d711c9a8${_scopeId3}>\u65E0\u56FE\u7247</span>`);
                        }
                      } else {
                        return [
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="dialog-footer" data-v-d711c9a8${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_button, {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_form_item, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="image-selector" data-v-d711c9a8${_scopeId3}>`);
                        if (selectedImage.value) {
                          ...
                          _push4(`<div class="placeholder" data-v-d711c9a8${_scopeId3}>`);
                          ...
                          _push4(`<span data-v-d711c9a8${_scopeId3}>\u70B9\u51FB\u9009\u62E9\u56FE\u7247</span></div>`);
                        }
                        _push4(`</div>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_el_form_item, { label: "\u6392\u5E8F\u503C" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="tips" data-v-d711c9a8${_scopeId3}>\u503C\u8D8A\u5C0F\u8D8A\u9760\u524D</div>`);
                      } else {
                        return [
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="selector-header" data-v-d711c9a8${_scopeId}>`);
            ...
            _push2(`</div><div${ssrRenderAttrs(mergeProps({ class: "selector-grid" }, ssrGetDirectiveProps(_ctx, _directive_loading, selectorLoading.value)))} data-v-d711c9a8${_scopeId}><!--[-->`);
            ssrRenderList(imageList.value, (img) => {
              _push2(`<div class="${ssrRenderClass([{ active: tempSelectedImageId.value === img.id }, "selector-item"])}" data-v-d711c9a8${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_image, {
                src: img.url,
                fit: "cover",
                class: "selector-img"
              }, null, _parent2, _scopeId));
              _push2(`<div class="selector-name" data-v-d711c9a8${_scopeId}>${ssrInterpolate(img.name)}</div></div>`);
            });
            _push2(`<!--]--></div><div class="selector-pagination" data-v-d711c9a8${_scopeId}></div>`);
          } else {
            return [
...
const banners = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d711c9a8"]]);

export { banners as default };
//# sourceMappingURL=banners-tjpV6Met.mjs.map
