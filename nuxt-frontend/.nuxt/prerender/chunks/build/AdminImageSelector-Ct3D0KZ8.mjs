...
import { defineComponent, computed, ref, watch, mergeProps, withCtx, unref, createTextVNode, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, withDirectives, createCommentVNode, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { O as search_default, aw as upload_default, M as check_default } from './index-CRs4T-Jf.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AdminDataDialog, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="selector-body" data-v-cf34855c${_scopeId}><div class="category-sidebar" data-v-cf34855c${_scopeId}><div class="${ssrRenderClass([{ active: !currentCategory.value }, "cat-item"])}" data-v-cf34855c${_scopeId}> \u5168\u90E8\u56FE\u7247 </div><!--[-->`);
            ssrRenderList(categories.value, (cat) => {
              _push2(`<div class="${ssrRenderClass([{ active: currentCategory.value === cat.id }, "cat-item"])}" data-v-cf34855c${_scopeId}>${ssrInterpolate(cat.name)}</div>`);
            });
            _push2(`<!--]--></div><div class="main-content" data-v-cf34855c${_scopeId}><div class="toolbar" data-v-cf34855c${_scopeId}>`);
            ...
            _push2(`</div><div${ssrRenderAttrs(mergeProps({ class: "image-grid" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-cf34855c${_scopeId}><!--[-->`);
            ssrRenderList(images.value, (img) => {
              _push2(`<div class="${ssrRenderClass([{ selected: isSelected(img) }, "image-item"])}" data-v-cf34855c${_scopeId}>`);
              ...
              _push2(`<div class="image-name" data-v-cf34855c${_scopeId}>${ssrInterpolate(img.name)}</div>`);
              if (isSelected(img)) {
                _push2(`<div class="check-mark" data-v-cf34855c${_scopeId}>`);
...
const AdminImageSelector = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cf34855c"]]);

export { AdminImageSelector as A };
//# sourceMappingURL=AdminImageSelector-Ct3D0KZ8.mjs.map
