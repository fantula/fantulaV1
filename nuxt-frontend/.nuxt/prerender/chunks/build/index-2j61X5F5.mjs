import { w as withInstall, e as withNoopInstall, b as buildProps } from './base-CEWXqFm3.mjs';
import { i as isNumber$1, b as useNamespace, d as debugWarn, B as isUndefined$1 } from './server.mjs';
import { defineComponent, computed, unref, withDirectives, openBlock, createElementBlock, normalizeStyle, normalizeClass, vShow, createCommentVNode, renderSlot, withModifiers, createBlock, Transition, withCtx, createElementVNode, createVNode, Fragment, renderList, toDisplayString, resolveDynamicComponent, inject, getCurrentInstance, ref, reactive, useSlots, watch, shallowRef, provide, isVNode } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { E as ElIcon } from './index-_zadwVDN.mjs';
import { i as info_filled_default, c as circle_close_filled_default, w as warning_filled_default, g as circle_check_filled_default, h as arrow_left_default, f as arrow_right_default } from './index-DNnPa_Q9.mjs';
import { throttle } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/lodash-unified/import.js';
...
const ElCarousel = withInstall(_sfc_main$2, {
  CarouselItem: _sfc_main$1
});
const ElCarouselItem = withNoopInstall(_sfc_main$1);
const IconMap = {
...
const ElResult = withInstall(_sfc_main);

export { CAROUSEL_ITEM_NAME as C, ElCarousel as E, IconComponentMap as I, ElCarouselItem as a, ElResult as b, IconMap as c, carouselContextKey as d, carouselEmits as e, carouselItemProps as f, carouselProps as g, resultProps as r };
//# sourceMappingURL=index-2j61X5F5.mjs.map
