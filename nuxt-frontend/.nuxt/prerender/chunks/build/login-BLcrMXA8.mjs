...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "login-container" }, _attrs))} data-v-07d55e75>`);
      _push(ssrRenderComponent(_component_el_card, { class: "login-card" }, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card-header" data-v-07d55e75${_scopeId}><span data-v-07d55e75${_scopeId}>\u540E\u53F0\u7BA1\u7406\u7CFB\u7EDF\u767B\u5F55</span></div>`);
          } else {
            return [
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(_component_el_form_item, { prop: "code" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="code-input-group" data-v-07d55e75${_scopeId5}>`);
                                    _push6(ssrRenderComponent(_component_el_input, {
...
const login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-07d55e75"]]);

export { login as default };
//# sourceMappingURL=login-BLcrMXA8.mjs.map
