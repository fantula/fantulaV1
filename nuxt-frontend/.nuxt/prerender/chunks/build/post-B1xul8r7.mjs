...
import { E as ElDatePicker } from './index-D2bgwknz.mjs';
import { E as ElCheckbox } from './index-RDuG-1hQ.mjs';
...
import { defineComponent, ref, computed, reactive, watch, mergeProps, unref, withCtx, createVNode, createTextVNode, openBlock, createBlock, toDisplayString, createCommentVNode, Fragment, renderList, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { S as StickyFormHeader } from './StickyFormHeader-BEb9UJKB.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-sku-selector" }, _attrs))} data-v-c32c05a9><div class="selector-controls" data-v-c32c05a9>`);
...
const AdminSkuSelector = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-c32c05a9"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "coupon-post-page" }, _attrs))} data-v-4eae4a44>`);
      ...
      _push(`<div class="form-content" data-v-4eae4a44>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_card, {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card-header" data-v-4eae4a44${_scopeId2}><span data-v-4eae4a44${_scopeId2}>\u57FA\u7840\u4FE1\u606F</span></div>`);
                } else {
                  return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_el_form_item, { label: "\u6709\u6548\u671F" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="date-picker-wrapper" data-v-4eae4a44${_scopeId3}>`);
                        if (!isUnlimitedDate.value) {
                          _push4(`<div class="date-text" data-v-4eae4a44${_scopeId3}><span class="label" data-v-4eae4a44${_scopeId3}>\u5F00\u59CB\uFF1A</span><span class="value" data-v-4eae4a44${_scopeId3}>${ssrInterpolate(formatDate(form.startDate))}</span></div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        if (!isUnlimitedDate.value) {
                        ...
                        _push4(`</div>`);
                        if (!isUnlimitedDate.value) {
                          _push4(`<div class="form-tip" data-v-4eae4a44${_scopeId3}>\u9ED8\u8BA4\u4ECE\u4ECA\u65E5\u5F00\u59CB\u751F\u6548\uFF0C\u8BF7\u9009\u62E9\u622A\u6B62\u65E5\u671F</div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
            ...
            _push2(ssrRenderComponent(_component_el_card, {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card-header" data-v-4eae4a44${_scopeId2}><span data-v-4eae4a44${_scopeId2}>\u5173\u8054\u5546\u54C1 SKU</span>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="product-selector" data-v-4eae4a44${_scopeId2}>`);
            ...
            _push2(ssrRenderComponent(_component_el_card, {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card-header" data-v-4eae4a44${_scopeId2}><span data-v-4eae4a44${_scopeId2}>\u6548\u679C\u9884\u89C8</span></div>`);
                } else {
                  return [
                    createVNode("div", { class: "card-header" }, [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="preview-container" data-v-4eae4a44${_scopeId2}><div class="coupon-ticket product-ticket" data-v-4eae4a44${_scopeId2}><div class="ticket-left" data-v-4eae4a44${_scopeId2}><div class="ticket-amount" data-v-4eae4a44${_scopeId2}><small data-v-4eae4a44${_scopeId2}>\xA5</small>${ssrInterpolate(form.value || "0")}</div><div class="ticket-cond" data-v-4eae4a44${_scopeId2}>\u6307\u5B9A\u5546\u54C1</div></div><div class="ticket-right" data-v-4eae4a44${_scopeId2}><div class="ticket-name" data-v-4eae4a44${_scopeId2}>${ssrInterpolate(form.name || "\u4F18\u60E0\u5238\u540D\u79F0")}</div><div class="ticket-date" data-v-4eae4a44${_scopeId2}>${ssrInterpolate(isUnlimitedDate.value ? "\u6C38\u4E45\u6709\u6548" : `${formatDate(form.startDate)} \u81F3 ${form.endDate || "?"}`)}</div><div class="ticket-btn" data-v-4eae4a44${_scopeId2}>\u53BB\u8D2D\u4E70</div></div></div></div>`);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/coupons/product/post.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const post = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4eae4a44"]]);

export { post as default };
//# sourceMappingURL=post-B1xul8r7.mjs.map
