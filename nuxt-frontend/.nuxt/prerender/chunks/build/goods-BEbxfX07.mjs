import { h as http } from './common-Bgv_wRgd.mjs';
import getSupabaseClient, { callEdgeFunction } from './supabase-F2pQZHm6.mjs';
...
const goodsApi = {
   ...
   */
  async getGoodsList(params, supabaseClient) {
    ...
    const sortField = params.sortBy === "price" ? "display_price" : params.sortBy === "sales" ? "initial_sales" : "created_at";
...
//# sourceMappingURL=goods-BEbxfX07.mjs.map
