...
import { defineComponent, defineAsyncComponent, ref, computed, mergeProps, unref, withCtx, createVNode, watch, nextTick, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { useRouter, useRoute } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue-router/vue-router.node.mjs';
import { ax as arrow_up_bold_default, ag as shopping_cart_default, _ as star_default, W as user_default, d as delete_default } from './index-DuV_oMrC.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.visible) {
        ...
        if (cartItem.value) {
          ...
          _push(`<div class="mc-empty" data-v-04f9d09d><div class="empty-icon" data-v-04f9d09d>\u{1F6D2}</div><p data-v-04f9d09d>\u7A7A\u7A7A\u5982\u4E5F</p></div>`);
        }
        _push(`</div>`);
        if (hasItems.value) {
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-34d495b9><div class="header-top" data-v-34d495b9><div class="logo-area" data-v-34d495b9><img${ssrRenderAttr("src", _imports_0)} class="logo-img" alt="FANTULA" data-v-34d495b9><span class="site-name" data-v-34d495b9>\u51E1\u56FE\u62C9</span></div><div class="header-actions" data-v-34d495b9><div class="cart-wrapper-rel" data-v-34d495b9><button class="icon-btn" data-v-34d495b9>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      if (unref(cartStore).totalCount > 0) {
        _push(`<div class="badge-dot-header" data-v-34d495b9></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</button>`);
      ...
      _push(`</div><button class="icon-btn" data-v-34d495b9>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      if (!unref(userStore).isLoggedIn) {
        _push(`<button class="icon-btn" data-v-34d495b9>`);
        _push(ssrRenderComponent(_component_el_icon, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`<div class="header-avatar" data-v-34d495b9>`);
        if (unref(userStore).loading) {
          _push(`<div class="avatar-skeleton" data-v-34d495b9></div>`);
        } else {
          _push(`<!--[--><img${ssrRenderAttr("src", ((_a = unref(userStore).user) == null ? void 0 : _a.avatar) || "/images/client/pc/avatars/avatar-cat.png")} data-v-34d495b9><div class="avatar-ring" data-v-34d495b9></div><!--]-->`);
        }
        _push(`</div>`);
      }
...
const HomeHeader = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-34d495b9"]]);
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "banner-section" }, _attrs))} data-v-6f096618><div class="banner-container-premium" data-v-6f096618>`);
      if (!__props.loading) {
        _push(`<div class="glow-border-effect" data-v-6f096618></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.loading) {
        _push(`<div class="banner-skeleton" data-v-6f096618><div class="skeleton-shimmer" data-v-6f096618></div></div>`);
      } else {
        _push(`<div class="banner-content-inner" data-v-6f096618><div class="expanded-view" data-v-6f096618>`);
        if (__props.banners.length > 0) {
          _push(`<div class="banner-carousel" data-v-6f096618><!--[-->`);
          ssrRenderList(__props.banners, (banner) => {
            _push(`<div class="banner-item" data-v-6f096618><img${ssrRenderAttr("src", banner.image)} class="banner-img" data-v-6f096618><div class="banner-overlay" data-v-6f096618></div></div>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<!---->`);
...
const HomeBanner = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-6f096618"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "goods-card-row card-glass" }, _attrs))} data-v-58a721f5><div class="goods-thumb" data-v-58a721f5><img${ssrRenderAttr("src", __props.goods.image || __props.goods.coverImage)} loading="lazy" decoding="async" data-v-58a721f5>`);
      if (__props.goods.badge_label && __props.goods.badge_label !== "\u4E0D\u5C55\u793A") {
        _push(`<div class="${ssrRenderClass([getBadgeClass(__props.goods.badge_label), "card-badge"])}" data-v-58a721f5>${ssrInterpolate(__props.goods.badge_label)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="goods-info" data-v-58a721f5><h3 class="goods-title" data-v-58a721f5>${ssrInterpolate(__props.goods.product_name || __props.goods.name || __props.goods.title)}</h3>`);
      if (tags.value.length) {
        _push(`<div class="goods-tags-row" data-v-58a721f5><!--[-->`);
        ssrRenderList(tags.value.slice(0, 2), (tag, idx) => {
          _push(`<span class="aurora-tag" data-v-58a721f5>${ssrInterpolate(tag)}</span>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="goods-meta-row" data-v-58a721f5><span class="stat-text" data-v-58a721f5>\u5DF2\u552E ${ssrInterpolate(formatSales(__props.goods.initial_sales || __props.goods.sales || 0))}</span></div><div class="goods-bottom" data-v-58a721f5><div class="goods-price-row" data-v-58a721f5><span class="price-val text-price" data-v-58a721f5>${ssrInterpolate(formatPrice(__props.goods.display_price || __props.goods.price))}</span></div><button class="buy-btn btn-marketing-buy" data-v-58a721f5> \u67E5\u770B\u8BE6\u60C5 </button></div></div></div>`);
    };
  }
});
...
const ProductCard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-58a721f5"]]);
const _sfc_main$1 = {};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ProductDetailSheet = defineAsyncComponent(() => import('./ProductDetailSheet-eRLQDIjq.mjs'));
    const MobileLoginSheet = defineAsyncComponent(() => import('./MobileLoginSheet-DPgXXBiL.mjs'));
    useRouter();
    useRoute();
    useUserStore();
    usePageLoading();
    const {
      ...
      // Rename to avoid conflict if we need wrapper
      loadMore
    } = useHomeData();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_el_icon = ElIcon;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mobile-home-page" }, _attrs))} data-v-2a1d1f33>`);
      _push(ssrRenderComponent(HomeHeader, {
        "is-scrolled": isScrolled.value,
        onOpenLogin: ($event) => showLoginSheet.value = true
      }, null, _parent));
      _push(`<div class="content-scroll no-scrollbar" data-v-2a1d1f33>`);
      ...
      _push(`<div class="pull-refresh-indicator" style="${ssrRenderStyle({ height: `${pullDistance.value}px`, opacity: pullDistance.value > 0 ? 1 : 0 })}" data-v-2a1d1f33>`);
      if (isRefreshing.value) {
        _push(`<div class="spinner-mini" data-v-2a1d1f33></div>`);
      } else {
        _push(`<span class="text-xs text-muted" data-v-2a1d1f33>${ssrInterpolate(unref(pullText))}</span>`);
      }
      _push(`</div><div class="goods-list-section" data-v-2a1d1f33>`);
      if (unref(goodsLoading) && unref(currentGoods).length === 0) {
        _push(`<div class="loading-state" data-v-2a1d1f33><!--[-->`);
        ssrRenderList(6, (i) => {
          _push(ssrRenderComponent(ProductCardSkeleton, { key: i }, null, _parent));
        });
        _push(`<!--]--></div>`);
      } else if (unref(currentGoods).length === 0) {
        _push(`<div class="empty-state bg-glass-card" data-v-2a1d1f33><div class="empty-icon" data-v-2a1d1f33>\u{1F4E6}</div><p class="text-muted text-sm" data-v-2a1d1f33>\u6682\u65E0\u76F8\u5173\u5546\u54C1</p></div>`);
      } else {
        _push(`<div class="goods-list" data-v-2a1d1f33><!--[-->`);
        ssrRenderList(unref(currentGoods), (item, index2) => {
      ...
      if (unref(hasMore) && unref(currentGoods).length > 0) {
        _push(`<div class="load-more-trigger" data-v-2a1d1f33>`);
        if (unref(isLoadingMore)) {
          _push(`<div class="loading-more" data-v-2a1d1f33><div class="spinner-mini" data-v-2a1d1f33></div> \u52A0\u8F7D\u66F4\u591A... </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (!unref(hasMore) && unref(currentGoods).length > 0) {
        _push(`<div class="no-more-data" data-v-2a1d1f33> - \u5230\u5E95\u4E86 - </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="tab-bar-spacer" data-v-2a1d1f33></div></div><button class="back-to-top-btn" style="${ssrRenderStyle(showBackToTop.value ? null : { display: "none" })}" data-v-2a1d1f33>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2a1d1f33"]]);

export { index as default };
//# sourceMappingURL=index-DgI_EDiX.mjs.map
