...
import { E as ElColorPicker } from './index-Bx_0lqEk.mjs';
...
import { p as plus_default } from './index-CbQ9NNm4.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-page" }, _attrs))} data-v-7d5356ae><div class="page-header" data-v-7d5356ae><h2 class="page-title" data-v-7d5356ae>\u6587\u7AE0\u5206\u7C7B\u7BA1\u7406</h2>`);
      ...
      _push(`</div><div${ssrRenderAttrs(mergeProps({ class: "table-container" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-7d5356ae>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span style="${ssrRenderStyle({ "font-size": "20px" })}" data-v-7d5356ae${_scopeId2}>${ssrInterpolate(row.icon)}</span>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span style="${ssrRenderStyle({ color: row.color, fontWeight: "bold" })}" data-v-7d5356ae${_scopeId2}>${ssrInterpolate(row.name)}</span>`);
                } else {
                  return [
                    createVNode("span", {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center" data-v-7d5356ae${_scopeId2}><div style="${ssrRenderStyle({ background: row.color, width: "16px", height: "16px", borderRadius: "4px", marginRight: "8px", border: "1px solid #ddd" })}" data-v-7d5356ae${_scopeId2}></div><span data-v-7d5356ae${_scopeId2}>${ssrInterpolate(row.color)}</span></div>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="dialog-footer" data-v-7d5356ae${_scopeId}>`);
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_el_input, {
                          ...
                          append: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              if (form.icon) {
                                _push5(`<span data-v-7d5356ae${_scopeId4}>${ssrInterpolate(form.icon)}</span>`);
                              } else {
                                _push5(`<!---->`);
                              }
                            } else {
                        ...
                        _push4(`<span class="text-gray-400 text-xs ml-2" data-v-7d5356ae${_scopeId3}>\u63A8\u8350\u4F7F\u7528 Emoji\uFF0C\u5982 \u{1F4DD}</span>`);
                      } else {
                        return [
                          createVNode(_component_el_input, {
                            modelValue: form.icon,
                  ...
                  _push3(ssrRenderComponent(_component_el_form_item, { label: "\u6392\u5E8F" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span class="text-gray-400 text-xs ml-2" data-v-7d5356ae${_scopeId3}>\u6570\u5B57\u8D8A\u5C0F\u8D8A\u9760\u524D</span>`);
                      } else {
                        return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/article/categories.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const categories = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7d5356ae"]]);

export { categories as default };
//# sourceMappingURL=categories-vOZRuLpd.mjs.map
