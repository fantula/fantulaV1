...
import { U as refresh_default, p as plus_default } from './index-CCIZH4aC.mjs';
import { _ as _export_sfc } from './server.mjs';
import { u as useBizFormat } from './useBizFormat-CLwhy_Ih.mjs';
import { u as useAdminCouponList } from './useAdminCouponList-drHHhP5J.mjs';
import { P as PageTipHeader } from './PageTipHeader-CeUy9d_M.mjs';
import { A as AdminActionCard } from './AdminActionCard-l7l1Gr-n.mjs';
import { B as BulkActionBar } from './BulkActionBar-BQbCkZjD.mjs';
import { A as AdminDataTable } from './AdminDataTable-D1_qu9TL.mjs';
import { C as CouponCodeGenerator, a as CouponCodeDrawer, _ as _sfc_main$1 } from './CouponCodeEditor-BBAcCDg7.mjs';
...
import './useAdminList-C0DHczxG.mjs';
...
import './index-iMlxBalC.mjs';
import './index-DGk0tJv4.mjs';
import './index-C-iEkQSR.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleCreate = () => {
      router.push("/manager_portal/coupons/flat/post");
    };
    const handleEdit = (row) => {
      router.push({
        path: "/manager_portal/coupons/flat/post",
        query: { id: row.id }
      });
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "coupon-flat-list" }, _attrs))} data-v-fc8f8d7e>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="code-info" data-v-fc8f8d7e${_scopeId2}><div class="code-name" data-v-fc8f8d7e${_scopeId2}>${ssrInterpolate(row.name)}</div></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="benefit-tag" data-v-fc8f8d7e${_scopeId2}><span data-v-fc8f8d7e${_scopeId2}>\u6EE1 ${ssrInterpolate(row.min_usage)} \u51CF</span><span class="benefit-value" data-v-fc8f8d7e${_scopeId2}>${ssrInterpolate(unref(formatPrice)(row.value))}</span></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (!row.end_date) {
                    _push3(`<div class="validity-tag" data-v-fc8f8d7e${_scopeId2}>\u6C38\u4E45\u6709\u6548</div>`);
                  } else {
                    _push3(`<div class="validity-range" data-v-fc8f8d7e${_scopeId2}><div data-v-fc8f8d7e${_scopeId2}>${ssrInterpolate(unref(formatDate)(row.start_date))}</div><div class="date-sep" data-v-fc8f8d7e${_scopeId2}>\u81F3</div><div data-v-fc8f8d7e${_scopeId2}>${ssrInterpolate(unref(formatDate)(row.end_date))}</div></div>`);
                  }
                } else {
                  return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fc8f8d7e"]]);

export { index as default };
//# sourceMappingURL=index-CHrhlcrV.mjs.map
