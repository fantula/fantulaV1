...
import { a as ElCheckboxGroup, E as ElCheckbox } from './index-7dcjom-z.mjs';
...
import { g as getPermissionMenuItems } from './admin-menu-CM94ZQny.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-container" }, _attrs))} data-v-c38f3d54>`);
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dept-manager" data-v-c38f3d54${_scopeId}><div class="dept-list-pane" data-v-c38f3d54${_scopeId}><div class="pane-header" data-v-c38f3d54${_scopeId}><span data-v-c38f3d54${_scopeId}>\u90E8\u95E8\u5217\u8868</span></div><div class="dept-list" data-v-c38f3d54${_scopeId}><!--[-->`);
            ssrRenderList(departments.value, (dept) => {
              _push2(`<div class="${ssrRenderClass([{ active: currentEditDeptId.value === dept.id }, "dept-item"])}" data-v-c38f3d54${_scopeId}><span class="dept-name" data-v-c38f3d54${_scopeId}>${ssrInterpolate(dept.name)}</span>`);
            ...
            if (departments.value.length === 0) {
              _push2(`<div class="empty-list" data-v-c38f3d54${_scopeId}>`);
            ...
            _push2(`</div></div><div class="dept-config-pane" data-v-c38f3d54${_scopeId}>`);
            if (currentEditDeptObj.value) {
              _push2(`<div class="config-form" data-v-c38f3d54${_scopeId}>`);
              ...
              _push2(`<div class="empty-selection" data-v-c38f3d54${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_empty, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/users/departments/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c38f3d54"]]);

export { index as default };
//# sourceMappingURL=index-Dptq2W_6.mjs.map
