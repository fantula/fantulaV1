...
import { defineComponent, ref, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleEdit = (row) => {
      router.push({
        path: "/_mgmt_9Xfa3/help-center/articles/post",
        query: { id: row.id }
      });
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-page" }, _attrs))} data-v-e699d3ba><div class="page-actions" data-v-e699d3ba>`);
      _push(ssrRenderComponent(_component_el_button, {
        type: "primary",
        onClick: ($event) => unref(router).push("/_mgmt_9Xfa3/help-center/articles/post")
      }, {
      ...
      _push(`</div><div class="filter-section" data-v-e699d3ba></div><div${ssrRenderAttrs(mergeProps({ class: "table-container" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-e699d3ba>`);
      ...
      _push(`<div class="pagination-container" data-v-e699d3ba>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/_mgmt_9Xfa3/help-center/articles.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const articles = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e699d3ba"]]);

export { articles as default };
//# sourceMappingURL=articles-CWWiLr39.mjs.map
