...
import { a9 as connection_default, M as check_default } from './index-CRs4T-Jf.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "r2-settings-page" }, _attrs))} data-v-4d917f60>`);
      _push(ssrRenderComponent(AdminActionCard, { title: "R2 \u5B58\u50A8\u914D\u7F6E (\u73AF\u5883\u53D8\u91CF)" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<div class="config-status" data-v-4d917f60${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_alert, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="status-content" data-v-4d917f60${_scopeId2}><p data-v-4d917f60${_scopeId2}>\u5F53\u524D R2 \u914D\u7F6E\u5DF2\u8FC1\u79FB\u81F3 <strong data-v-4d917f60${_scopeId2}>Supabase Edge Function \u73AF\u5883\u53D8\u91CF</strong>\uFF0C\u4E0D\u518D\u4ECE\u6570\u636E\u5E93\u8BFB\u53D6\u3002</p><p data-v-4d917f60${_scopeId2}>\u5982\u9700\u4FEE\u6539\u5BC6\u94A5\u6216\u5B58\u50A8\u6876\uFF0C\u8BF7\u5728 Supabase Dashboard &gt; Edge Functions &gt; Secrets \u4E2D\u8BBE\u7F6E\u3002</p></div>`);
                } else {
                  return [
            ...
            _push2(`<div class="env-list" data-v-4d917f60${_scopeId}><h3 data-v-4d917f60${_scopeId}>\u5F53\u524D\u73AF\u5883\u72B6\u6001</h3><div class="env-item" data-v-4d917f60${_scopeId}><span class="label" data-v-4d917f60${_scopeId}>Config Source:</span><span class="value" data-v-4d917f60${_scopeId}>`);
            ...
            _push2(`</span></div><div class="env-item" data-v-4d917f60${_scopeId}><span class="label" data-v-4d917f60${_scopeId}>R2 Connection:</span><span class="value" data-v-4d917f60${_scopeId}>`);
            ...
            _push2(`</span></div></div><div class="action-area" data-v-4d917f60${_scopeId}>`);
            ...
            if (testResult.value && testResult.value.success) {
              _push2(`<span class="text-green-600 text-sm ml-4" data-v-4d917f60${_scopeId}>`);
            ...
            if (testResult.value && !testResult.value.success) {
              _push2(`<span class="text-red-500 text-sm ml-4" data-v-4d917f60${_scopeId}>${ssrInterpolate(testResult.value.message)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div>`);
...
const storage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4d917f60"]]);

export { storage as default };
//# sourceMappingURL=storage-BdcfOyNl.mjs.map
