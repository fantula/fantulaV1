...
import { defineComponent, ref, computed, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createTextVNode, createCommentVNode, withDirectives, vModelText, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { getAuthToken } from './supabase-jxF0-7J3.mjs';
import { ac as present_default, a8 as select_default, a as arrow_right_default, a3 as lock_default, q as circle_check_default } from './index-CmsdIFY8.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BaseModal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="recharge-content" data-v-0f06b8d3${_scopeId}>`);
            if (!showQrCode.value) {
              _push2(`<!--[--><div class="modal-subtitle" data-v-0f06b8d3${_scopeId}>Purchase Quota</div><div class="split-layout" data-v-0f06b8d3${_scopeId}><div class="left-panel" data-v-0f06b8d3${_scopeId}><div class="section-container" data-v-0f06b8d3${_scopeId}><div class="section-label" data-v-0f06b8d3${_scopeId}>\u9009\u62E9\u989D\u5EA6</div><div class="amount-grid" data-v-0f06b8d3${_scopeId}><!--[-->`);
              ssrRenderList(options.value, (item, idx) => {
                _push2(`<div class="${ssrRenderClass(["amount-option", { active: selectedIdx.value === idx }])}" data-v-0f06b8d3${_scopeId}><div class="option-content" data-v-0f06b8d3${_scopeId}><div class="amount-row" data-v-0f06b8d3${_scopeId}><span class="amount-main" data-v-0f06b8d3${_scopeId}>${ssrInterpolate(item.value)}</span><span class="unit" data-v-0f06b8d3${_scopeId}>\u70B9</span></div>`);
                if (item.bonus > 0) {
                  _push2(`<div class="bonus-tag" data-v-0f06b8d3${_scopeId}>`);
              ...
              _push2(`<!--]--><div class="${ssrRenderClass(["amount-option", "custom-option", { active: selectedIdx.value === -1 }])}" data-v-0f06b8d3${_scopeId}><span class="custom-label" data-v-0f06b8d3${_scopeId}>\u81EA\u5B9A\u4E49</span></div></div><div class="${ssrRenderClass([{ visible: selectedIdx.value === -1 }, "custom-input-wrapper"])}" data-v-0f06b8d3${_scopeId}><input${ssrRenderAttr("value", inputValue.value)} type="number" min="1" placeholder="\u8BF7\u8F93\u5165\u5145\u503C\u91D1\u989D"${ssrIncludeBooleanAttr(selectedIdx.value !== -1) ? " disabled" : ""} data-v-0f06b8d3${_scopeId}><span class="input-suffix" data-v-0f06b8d3${_scopeId}>\u70B9</span></div></div><div class="section-container" data-v-0f06b8d3${_scopeId}><div class="section-label" data-v-0f06b8d3${_scopeId}>\u652F\u4ED8\u65B9\u5F0F</div><div class="pay-methods" data-v-0f06b8d3${_scopeId}><div class="${ssrRenderClass(["pay-method", "disabled"])}" title="\u652F\u4ED8\u5B9D\u6682\u672A\u5F00\u901A" data-v-0f06b8d3${_scopeId}><div class="icon-container alipay" data-v-0f06b8d3${_scopeId}><img class="pay-icon"${ssrRenderAttr("src", _imports_0)} alt="\u652F\u4ED8\u5B9D" data-v-0f06b8d3${_scopeId}></div><span data-v-0f06b8d3${_scopeId}>\u652F\u4ED8\u5B9D</span><span class="coming-soon" data-v-0f06b8d3${_scopeId}>\u5373\u5C06\u5F00\u901A</span></div><div class="${ssrRenderClass(["pay-method", payType.value === "wechat" ? "active" : ""])}" data-v-0f06b8d3${_scopeId}><div class="icon-container wechat" data-v-0f06b8d3${_scopeId}><img class="pay-icon"${ssrRenderAttr("src", _imports_1)} alt="\u5FAE\u4FE1" data-v-0f06b8d3${_scopeId}></div><span data-v-0f06b8d3${_scopeId}>\u5FAE\u4FE1</span>`);
              if (payType.value === "wechat") {
                _push2(`<div class="pay-check" data-v-0f06b8d3${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_icon, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
              ...
              _push2(`</div></div></div><div class="modal-footer" data-v-0f06b8d3${_scopeId}>`);
              if (isValidAmount.value) {
                _push2(`<div class="actual-arrival-info" data-v-0f06b8d3${_scopeId}><span class="label" data-v-0f06b8d3${_scopeId}>\u5B9E\u9645\u5230\u8D26:</span><span class="value" data-v-0f06b8d3${_scopeId}>${ssrInterpolate(totalPoints.value)} \u70B9</span>`);
                if (currentBonus.value > 0) {
                  _push2(`<span class="bonus-hint" data-v-0f06b8d3${_scopeId}>(\u542B\u8D60\u9001 ${ssrInterpolate(currentBonus.value)} \u70B9)</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
              ...
              _push2(`<div class="action-row" data-v-0f06b8d3${_scopeId}><button class="btn-confirm"${ssrIncludeBooleanAttr(!isValidAmount.value || loading.value) ? " disabled" : ""} data-v-0f06b8d3${_scopeId}>`);
              if (loading.value) {
                _push2(`<span class="btn-loading" data-v-0f06b8d3${_scopeId}></span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<span class="btn-text" data-v-0f06b8d3${_scopeId}>${ssrInterpolate(loading.value ? "\u6B63\u5728\u53D1\u8D77\u652F\u4ED8..." : `\u7ACB\u5373\u652F\u4ED8 \xA5${payAmount.value.toFixed(2)}`)}</span>`);
              if (!loading.value) {
              ...
              _push2(`</button></div><div class="security-tip" data-v-0f06b8d3${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_icon, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
              ...
              _push2(` \u5B89\u5168\u52A0\u5BC6\u652F\u4ED8 </div></div></div><div class="right-spacer" data-v-0f06b8d3${_scopeId}></div></div><!--]-->`);
            } else {
              _push2(`<div class="qrcode-container" data-v-0f06b8d3${_scopeId}><div class="qrcode-header" data-v-0f06b8d3${_scopeId}><img${ssrRenderAttr("src", _imports_1)} alt="\u5FAE\u4FE1" class="wechat-icon" data-v-0f06b8d3${_scopeId}><span data-v-0f06b8d3${_scopeId}>\u5FAE\u4FE1\u626B\u7801\u652F\u4ED8</span></div><div class="qrcode-wrapper" data-v-0f06b8d3${_scopeId}>`);
              if (qrcodeDataUrl.value) {
                _push2(`<img${ssrRenderAttr("src", qrcodeDataUrl.value)} alt="Payment QR Code" class="qrcode-img" data-v-0f06b8d3${_scopeId}>`);
              } else {
                _push2(`<!---->`);
              }
              if (paymentStatus.value === "checking") {
                _push2(`<div class="qrcode-overlay" data-v-0f06b8d3${_scopeId}><div class="checking-spinner" data-v-0f06b8d3${_scopeId}></div><span data-v-0f06b8d3${_scopeId}>\u6B63\u5728\u68C0\u67E5\u652F\u4ED8\u72B6\u6001...</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (paymentStatus.value === "success") {
                _push2(`<div class="qrcode-overlay success" data-v-0f06b8d3${_scopeId}>`);
                ...
                _push2(`<span data-v-0f06b8d3${_scopeId}>\u652F\u4ED8\u6210\u529F!</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="qrcode-info" data-v-0f06b8d3${_scopeId}><div class="amount-display" data-v-0f06b8d3${_scopeId}><span class="label" data-v-0f06b8d3${_scopeId}>\u652F\u4ED8\u91D1\u989D</span><span class="amount" data-v-0f06b8d3${_scopeId}>\xA5${ssrInterpolate(payAmount.value.toFixed(2))}</span></div><div class="order-no" data-v-0f06b8d3${_scopeId}> \u8BA2\u5355\u53F7: ${ssrInterpolate(currentOrderNo.value)}</div></div><div class="qrcode-tips" data-v-0f06b8d3${_scopeId}><p data-v-0f06b8d3${_scopeId}>\u8BF7\u4F7F\u7528\u5FAE\u4FE1\u626B\u4E00\u626B</p><p data-v-0f06b8d3${_scopeId}>\u626B\u63CF\u4E8C\u7EF4\u7801\u5B8C\u6210\u652F\u4ED8</p></div><div class="qrcode-actions" data-v-0f06b8d3${_scopeId}><button class="btn-back"${ssrIncludeBooleanAttr(paymentStatus.value === "checking") ? " disabled" : ""} data-v-0f06b8d3${_scopeId}> \u8FD4\u56DE\u91CD\u65B0\u9009\u62E9 </button></div></div>`);
            }
            _push2(`</div>`);
          } else {
            return [
                      ...
                      createVNode("div", { class: "modal-footer" }, [
                        ...
                        createVNode("div", { class: "action-row" }, [
                          createVNode("button", {
                            ...
                            createVNode("span", { class: "btn-text" }, toDisplayString(loading.value ? "\u6B63\u5728\u53D1\u8D77\u652F\u4ED8..." : `\u7ACB\u5373\u652F\u4ED8 \xA5${payAmount.value.toFixed(2)}`), 1),
...
const WalletRechargeModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0f06b8d3"]]);

export { WalletRechargeModal as W };
//# sourceMappingURL=WalletRechargeModal-ClHnmzJa.mjs.map
