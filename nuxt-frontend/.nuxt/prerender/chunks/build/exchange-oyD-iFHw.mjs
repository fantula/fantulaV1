...
import { E as ticket_default } from './index-CCIZH4aC.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const RedemptionCard = defineAsyncComponent(() => import('./RedemptionCard-B7aga8Tx.mjs'));
    const CouponBalance = defineAsyncComponent(() => import('./CouponBalance-DPUFrsbq.mjs'));
    const CouponFlat = defineAsyncComponent(() => import('./CouponFlat-DNm5An2g.mjs'));
    const CouponProduct = defineAsyncComponent(() => import('./CouponProduct-aX50aOkI.mjs'));
...
//# sourceMappingURL=exchange-oyD-iFHw.mjs.map
