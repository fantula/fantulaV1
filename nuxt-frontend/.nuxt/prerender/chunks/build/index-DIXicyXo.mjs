...
import { defineComponent, ref, watch, mergeProps, withCtx, unref, createTextVNode, createVNode, isRef, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { u as useAdminOrderList } from './useAdminOrderList-D9ONFxnc.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-container" }, _attrs))} data-v-3b0ed2de>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="mono-text" data-v-3b0ed2de${_scopeId2}>${ssrInterpolate(row.order_no)}</span>`);
                } else {
                  return [
                    createVNode("span", {
                      class: "mono-text",
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                var _a, _b, _c, _d;
                if (_push3) {
                  _push3(`<div class="user-cell" data-v-3b0ed2de${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_el_avatar, {
                    size: 28,
                    src: ((_a = row._profile) == null ? void 0 : _a.avatar) || unref(DEFAULT_AVATAR)
                  }, null, _parent3, _scopeId2));
                  _push3(`<span class="uid-text" data-v-3b0ed2de${_scopeId2}>${ssrInterpolate(((_b = row._profile) == null ? void 0 : _b.uid) || "\u65E0UID")}</span></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                var _a, _b, _c, _d;
                if (_push3) {
                  _push3(`<div class="product-cell" data-v-3b0ed2de${_scopeId2}>`);
                  if ((_a = row.product_snapshot) == null ? void 0 : _a.image) {
                    _push3(`<img${ssrRenderAttr("src", row.product_snapshot.image)} class="product-thumb" data-v-3b0ed2de${_scopeId2}>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<span data-v-3b0ed2de${_scopeId2}>${ssrInterpolate(((_b = row.product_snapshot) == null ? void 0 : _b.product_name) || "\u672A\u77E5\u5546\u54C1")}</span></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<span class="spec-text" data-v-3b0ed2de${_scopeId2}>${ssrInterpolate(unref(formatSpec)((_a = row.sku_snapshot) == null ? void 0 : _a.spec_combination))}</span>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span data-v-3b0ed2de${_scopeId2}>${ssrInterpolate(row.quantity || 1)}</span>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="amount" data-v-3b0ed2de${_scopeId2}>${ssrInterpolate(unref(formatPrice)(row.total_amount))}</span>`);
                } else {
                  return [
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  if ((_a = row.coupon_snapshot) == null ? void 0 : _a.discount_amount) {
                    _push3(`<span class="discount" data-v-3b0ed2de${_scopeId2}> -${ssrInterpolate(unref(formatPrice)(row.coupon_snapshot.discount_amount))}</span>`);
                  } else {
                    _push3(`<span class="no-discount" data-v-3b0ed2de${_scopeId2}>-</span>`);
                  }
                } else {
                  return [
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (((_a = currentReceipt.value) == null ? void 0 : _a.status) === "submitted") {
              _push2(`<div class="dialog-footer-actions" data-v-3b0ed2de${_scopeId}>`);
              if (!rejectMode.value) {
                _push2(`<!--[-->`);
                _push2(ssrRenderComponent(_component_el_button, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (receiptLoading.value) {
              _push2(`<div class="loading-state" data-v-3b0ed2de${_scopeId}>`);
                  ...
                  if (_push3) {
                    ...
                    ssrRenderList(currentReceipt.value.payload, (value, key) => {
                      _push3(ssrRenderComponent(_component_el_descriptions_item, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<span class="payload-value" data-v-3b0ed2de${_scopeId3}>${ssrInterpolate(value)}</span>`);
                          } else {
                            return [
              ...
              if (currentReceipt.value.status === "rejected") {
                _push2(`<div class="reject-reason-box" data-v-3b0ed2de${_scopeId}><p class="label" data-v-3b0ed2de${_scopeId}>\u9A73\u56DE\u539F\u56E0\uFF1A</p><p class="content" data-v-3b0ed2de${_scopeId}>${ssrInterpolate(currentReceipt.value.reject_reason)}</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (rejectMode.value) {
                _push2(`<div class="reject-input-area" data-v-3b0ed2de${_scopeId}><p class="input-label" data-v-3b0ed2de${_scopeId}>\u8BF7\u8F93\u5165\u9A73\u56DE\u539F\u56E0\u901A\u77E5\u7528\u6237\uFF1A</p>`);
              ...
              _push2(`<div class="empty-receipt" data-v-3b0ed2de${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/orders/recharge/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3b0ed2de"]]);

export { index as default };
//# sourceMappingURL=index-DIXicyXo.mjs.map
