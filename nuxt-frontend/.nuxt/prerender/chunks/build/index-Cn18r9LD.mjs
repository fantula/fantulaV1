...
import { a as ElCheckboxGroup, E as ElCheckbox } from './index-RDuG-1hQ.mjs';
import { defineComponent, ref, mergeProps, withCtx, unref, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { g as getPermissionMenuItems } from './admin-menu-K1BTJm27.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-container" }, _attrs))} data-v-89b3d97c>`);
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dept-manager" data-v-89b3d97c${_scopeId}><div class="dept-list-pane" data-v-89b3d97c${_scopeId}><div class="pane-header" data-v-89b3d97c${_scopeId}><span data-v-89b3d97c${_scopeId}>\u90E8\u95E8\u5217\u8868</span></div><div class="dept-list" data-v-89b3d97c${_scopeId}><!--[-->`);
            ssrRenderList(departments.value, (dept) => {
              _push2(`<div class="${ssrRenderClass([{ active: currentEditDeptId.value === dept.id }, "dept-item"])}" data-v-89b3d97c${_scopeId}><span class="dept-name" data-v-89b3d97c${_scopeId}>${ssrInterpolate(dept.name)}</span>`);
            ...
            if (departments.value.length === 0) {
              _push2(`<div class="empty-list" data-v-89b3d97c${_scopeId}>`);
            ...
            _push2(`</div></div><div class="dept-config-pane" data-v-89b3d97c${_scopeId}>`);
            if (currentEditDeptObj.value) {
              _push2(`<div class="config-form" data-v-89b3d97c${_scopeId}>`);
              ...
              _push2(`<div class="empty-selection" data-v-89b3d97c${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_empty, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/users/departments/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-89b3d97c"]]);

export { index as default };
//# sourceMappingURL=index-Cn18r9LD.mjs.map
