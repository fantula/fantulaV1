...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-page" }, _attrs))} data-v-e84dc4a0>`);
...
const articles = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e84dc4a0"]]);

export { articles as default };
//# sourceMappingURL=articles-DqUc9NSV.mjs.map
