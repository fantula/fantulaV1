...
import { ssrRenderAttrs, ssrRenderClass, ssrRenderSlot } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-08b0d9ce>`);
      if (__props.loading) {
        _push(`<span class="btn-spinner" data-v-08b0d9ce><svg viewBox="0 0 24 24" fill="none" class="spinner-icon" data-v-08b0d9ce><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" stroke-opacity="0.25" data-v-08b0d9ce></circle><path fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-08b0d9ce></path></svg></span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<span class="${ssrRenderClass([{ "is-hidden": __props.loading }, "btn-content"])}" data-v-08b0d9ce>`);
      ssrRenderSlot(_ctx.$slots, "icon", {}, null, _push, _parent);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</span><div class="hover-effect" data-v-08b0d9ce></div></button>`);
    };
  }
});
...
const BaseButton = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-08b0d9ce"]]);

export { BaseButton as B };
//# sourceMappingURL=BaseButton-BnWAaIRO.mjs.map
