...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function openEdit() {
      router.push(`/_mgmt_9Xfa3/orders/cdkey/post?id=${order.value.id}`);
    }
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="detail-wrapper" data-v-3450bd94>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/_mgmt_9Xfa3/orders/cdkey/detail.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const detail = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3450bd94"]]);

export { detail as default };
//# sourceMappingURL=detail-eWJCKUr7.mjs.map
