...
import { aT as present_default, a6 as select_default, a as arrow_right_default, a1 as lock_default, n as circle_check_default } from './index-DlETah8a.mjs';
            ...
            if (!showQrCode.value) {
              ...
              _push2(ssrRenderComponent(BaseButton, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (!loading.value) {
                      _push3(`<!--[--><span class="btn-text" data-v-e36e7571${_scopeId2}>\u7ACB\u5373\u652F\u4ED8 \xA5${ssrInterpolate(payAmount.value.toFixed(2))}</span>`);
              ...
              _push2(`</div><div class="qrcode-info" data-v-e36e7571${_scopeId}><div class="amount-display" data-v-e36e7571${_scopeId}><span class="label" data-v-e36e7571${_scopeId}>\u652F\u4ED8\u91D1\u989D</span><span class="amount" data-v-e36e7571${_scopeId}>\xA5${ssrInterpolate(payAmount.value.toFixed(2))}</span></div><div class="order-no" data-v-e36e7571${_scopeId}> \u8BA2\u5355\u53F7: ${ssrInterpolate(currentOrderNo.value)}</div></div><div class="qrcode-tips" data-v-e36e7571${_scopeId}><p data-v-e36e7571${_scopeId}>\u8BF7\u4F7F\u7528\u5FAE\u4FE1\u626B\u4E00\u626B</p><p data-v-e36e7571${_scopeId}>\u626B\u63CF\u4E8C\u7EF4\u7801\u5B8C\u6210\u652F\u4ED8</p></div><div class="qrcode-actions" data-v-e36e7571${_scopeId}>`);
              _push2(ssrRenderComponent(BaseButton, {
                themeId: "secondary",
...
//# sourceMappingURL=WalletRechargeModal-BrWMEznN.mjs.map
