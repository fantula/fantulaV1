...
import { defineComponent, ref, reactive, mergeProps, withCtx, unref, createVNode, createTextVNode, toDisplayString, withKeys, withDirectives, openBlock, createBlock, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrGetDirectiveProps, ssrRenderStyle } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { af as search_default, B as user_default, U as refresh_default } from './index-CCIZH4aC.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "refund-stats-page" }, _attrs))} data-v-dd63bc87><div class="page-header" data-v-dd63bc87><h2 data-v-dd63bc87>\u9000\u6B3E\u7EDF\u8BA1</h2><p class="sub-desc" data-v-dd63bc87>\u5DF2\u53D6\u6D88\u7684\u9000\u6B3E\u7533\u8BF7\u8BB0\u5F55</p></div>`);
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="filter-container" data-v-dd63bc87${_scopeId}><div class="filter-left" data-v-dd63bc87${_scopeId}>`);
            ...
            _push2(`</div><div class="filter-right" data-v-dd63bc87${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_statistic, { title: "\u603B\u53D6\u6D88\u6B21\u6570" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="stat-number" data-v-dd63bc87${_scopeId2}>${ssrInterpolate(totalCount.value)}</span>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_el_table_column, {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      var _a, _b;
                      if (_push4) {
                        _push4(`<span data-v-dd63bc87${_scopeId3}>${ssrInterpolate(row.user_nickname || ((_a = row.user_id) == null ? void 0 : _a.slice(0, 8)))}</span>`);
                      } else {
                        return [
            ...
            _push2(`<div class="pagination-wrapper" style="${ssrRenderStyle({ "margin-top": "20px", "display": "flex", "justify-content": "flex-end" })}" data-v-dd63bc87${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manager_portal/orders/cancelled-refunds/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dd63bc87"]]);

export { index as default };
//# sourceMappingURL=index-cF3I89PT.mjs.map
