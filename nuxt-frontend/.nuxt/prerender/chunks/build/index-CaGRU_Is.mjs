...
import { ag as arrow_up_bold_default, $ as shopping_cart_default, F as star_default, B as user_default, _ as delete_default } from './index-CCIZH4aC.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const MobileLoginSheet = defineAsyncComponent(() => import('./MobileLoginSheet-BiEg_riN.mjs'));
    useRouter();
    useRoute();
    useUserStore();
    const {
...
//# sourceMappingURL=index-CaGRU_Is.mjs.map
