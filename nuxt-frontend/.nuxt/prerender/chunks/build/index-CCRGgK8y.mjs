...
import { defineComponent, ref, computed, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
...
import { c as arrow_left_default, ak as headset_default } from './index-4qszPKX4.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mobile-page" }, _attrs))} data-v-0601c69c><div class="page-header" data-v-0601c69c><div class="back-btn" data-v-0601c69c>`);
      ...
      _push(`</div><h1 class="page-title" data-v-0601c69c>\u6211\u7684\u5DE5\u5355</h1><div class="header-right" data-v-0601c69c></div></div><div class="tabs-header" data-v-0601c69c><!--[-->`);
      ssrRenderList(tabs, (tab) => {
        _push(`<div class="${ssrRenderClass([{ active: activeTab.value === tab.key }, "tab-item"])}" data-v-0601c69c>${ssrInterpolate(tab.label)}</div>`);
      });
      _push(`<!--]--></div><div class="content-body" data-v-0601c69c>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(displayList).length === 0 && !unref(loading)) {
              _push2(`<div class="empty-state" data-v-0601c69c${_scopeId}>`);
              ...
              _push2(`<p data-v-0601c69c${_scopeId}>\u6682\u65E0\u5DE5\u5355\u8BB0\u5F55</p></div>`);
            } else {
              _push2(`<div class="ticket-list" data-v-0601c69c${_scopeId}><!--[-->`);
              ssrRenderList(unref(displayList), (ticket) => {
                _push2(`<div class="ticket-card" data-v-0601c69c${_scopeId}><div class="ticket-header" data-v-0601c69c${_scopeId}><span class="ticket-id" data-v-0601c69c${_scopeId}>${ssrInterpolate(ticket.shortId)}</span><span class="${ssrRenderClass([ticket.statusClass, "ticket-status"])}" data-v-0601c69c${_scopeId}>${ssrInterpolate(ticket.statusText)}</span></div><div class="ticket-title" data-v-0601c69c${_scopeId}>${ssrInterpolate(ticket.content)}</div><div class="ticket-footer" data-v-0601c69c${_scopeId}><div class="ticket-meta" data-v-0601c69c${_scopeId}>`);
                if (ticket.productName) {
                  _push2(`<span data-v-0601c69c${_scopeId}>\u5173\u8054: ${ssrInterpolate(ticket.productName)}</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><div class="ticket-time" data-v-0601c69c${_scopeId}>${ssrInterpolate(ticket.time)}</div></div></div>`);
              });
              _push2(`<!--]--></div>`);
            }
          } else {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0601c69c"]]);

export { index as default };
//# sourceMappingURL=index-CCRGgK8y.mjs.map
