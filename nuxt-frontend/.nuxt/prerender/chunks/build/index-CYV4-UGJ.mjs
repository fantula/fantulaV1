...
import { Y as top_default, t as money_default, as as goods_default, B as user_default } from './index-CCIZH4aC.mjs';
import { _ as __nuxt_component_3 } from './AdminPageSkeleton-DaUkIwpw.mjs';
                    ...
                    _push3(ssrRenderComponent(_component_el_card, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(`<div class="metric-sub" data-v-13499724${_scopeId3}>\u6628\u65E5: \xA5${ssrInterpolate(Number(stats.value.yesterday_sales).toFixed(2))}</div></div>`);
                        } else {
                          return [
                            createVNode("div", { class: "metric-content" }, [
                              createVNode(_component_el_statistic, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          ssrRenderList(stats.value.sales_trend, (item, index2) => {
                            _push4(`<div class="bar-group" data-v-13499724${_scopeId3}><div class="bar-col" data-v-13499724${_scopeId3}><div class="bar-val" data-v-13499724${_scopeId3}>\xA5${ssrInterpolate(item.amount)}</div><div class="bar-fill" style="${ssrRenderStyle({ height: `${calculatePercent(item.amount, maxSalesAmount.value)}%` })}" data-v-13499724${_scopeId3}></div></div><div class="bar-label" data-v-13499724${_scopeId3}>${ssrInterpolate(formatDate(item.date))}</div></div>`);
                          });
                          _push4(`<!--]--></div></div></div>`);
                        } else {
                          return [
...
//# sourceMappingURL=index-CYV4-UGJ.mjs.map
