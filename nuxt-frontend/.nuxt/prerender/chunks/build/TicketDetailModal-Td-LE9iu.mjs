...
import { defineComponent, computed, ref, watch, mergeProps, withCtx, unref, withDirectives, openBlock, createBlock, createVNode, createTextVNode, toDisplayString, createCommentVNode, Fragment, renderList, withKeys, withModifiers, vModelText, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderAttrs, ssrGetDirectiveProps, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrIncludeBooleanAttr } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { t as ticketApi } from './ticket-BRmvCekE.mjs';
import { c as clientOrderApi } from './order-2EzuG-pd.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BaseModal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<div${ssrRenderAttrs(mergeProps({ class: "modal-body" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-89a9a6e2${_scopeId}>`);
            _push2(ssrRenderComponent(OrderInfoCard, {
              order: orderDetail.value,
              loading: loadingOrder.value
            }, null, _parent2, _scopeId));
            if (ticketDetail.value) {
              _push2(`<div class="ticket-meta-glass" data-v-89a9a6e2${_scopeId}><div class="meta-row" data-v-89a9a6e2${_scopeId}><span class="label" data-v-89a9a6e2${_scopeId}>\u63D0\u4EA4\u65F6\u95F4:</span> <span class="val" data-v-89a9a6e2${_scopeId}>${ssrInterpolate(unref(formatDate)(ticketDetail.value.created_at))}</span></div><div class="meta-row" data-v-89a9a6e2${_scopeId}><span class="label" data-v-89a9a6e2${_scopeId}>\u5F53\u524D\u72B6\u6001:</span><span class="${ssrRenderClass(["status-text", ticketDetail.value.status])}" data-v-89a9a6e2${_scopeId}>${ssrInterpolate(ticketDetail.value.status === "processing" ? "\u5904\u7406\u4E2D" : "\u5DF2\u89E3\u51B3")}</span></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="chat-container" data-v-89a9a6e2${_scopeId}><!--[-->`);
            ssrRenderList(replies.value, (reply, idx) => {
              _push2(`<div class="${ssrRenderClass([reply.sender, "chat-message"])}" data-v-89a9a6e2${_scopeId}>`);
              if (reply.sender === "admin") {
                _push2(`<div class="avatar admin" data-v-89a9a6e2${_scopeId}>\u670D</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="message-content-wrapper" data-v-89a9a6e2${_scopeId}><div class="message-bubble" data-v-89a9a6e2${_scopeId}><div class="msg-text" data-v-89a9a6e2${_scopeId}>${ssrInterpolate(reply.content)}</div>`);
              if (reply.attachments && reply.attachments.length) {
                _push2(`<div class="msg-attachments" data-v-89a9a6e2${_scopeId}><!--[-->`);
              ...
              _push2(`</div><div class="message-time" data-v-89a9a6e2${_scopeId}>${ssrInterpolate(unref(formatDate)(reply.time))}</div></div>`);
              if (reply.sender === "user") {
                _push2(`<div class="avatar user" data-v-89a9a6e2${_scopeId}>\u6211</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            if (((_a = ticketDetail.value) == null ? void 0 : _a.status) === "processing") {
              _push2(`<div class="reply-area" data-v-89a9a6e2${_scopeId}><textarea class="reply-textarea" placeholder="\u8BF7\u8F93\u5165\u60A8\u7684\u56DE\u590D... (Enter \u53D1\u9001)"${ssrIncludeBooleanAttr(replying.value) ? " disabled" : ""} data-v-89a9a6e2${_scopeId}>${ssrInterpolate(replyContent.value)}</textarea><div class="reply-actions" data-v-89a9a6e2${_scopeId}><button class="btn-send"${ssrIncludeBooleanAttr(!replyContent.value.trim() || replying.value) ? " disabled" : ""} data-v-89a9a6e2${_scopeId}>${ssrInterpolate(replying.value ? "\u53D1\u9001\u4E2D..." : "\u53D1\u9001\u56DE\u590D")}</button></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
...
const TicketDetailModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-89a9a6e2"]]);

export { TicketDetailModal as default };
//# sourceMappingURL=TicketDetailModal-Td-LE9iu.mjs.map
