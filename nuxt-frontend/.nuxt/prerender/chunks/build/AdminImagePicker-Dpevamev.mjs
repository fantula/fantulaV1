...
import { defineComponent, ref, watch, mergeProps, withCtx, createTextVNode, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, withDirectives, createCommentVNode, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_dialog, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="picker-container" data-v-9bf0d913${_scopeId}><div class="picker-sidebar" data-v-9bf0d913${_scopeId}><div class="${ssrRenderClass([{ active: activeCategoryId.value === "" }, "picker-cat-item"])}" data-v-9bf0d913${_scopeId}>\u5168\u90E8\u56FE\u7247</div><!--[-->`);
            ssrRenderList(categories.value, (cat) => {
              _push2(`<div class="${ssrRenderClass([{ active: activeCategoryId.value === cat.id }, "picker-cat-item"])}" data-v-9bf0d913${_scopeId}>${ssrInterpolate(cat.name)}</div>`);
            });
            _push2(`<!--]--></div><div${ssrRenderAttrs(mergeProps({ class: "picker-main" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-9bf0d913${_scopeId}><div class="picker-toolbar" data-v-9bf0d913${_scopeId}>`);
            ...
            _push2(`</div><div class="picker-grid" data-v-9bf0d913${_scopeId}><!--[-->`);
            ssrRenderList(images.value, (img) => {
              _push2(`<div class="picker-img-card" data-v-9bf0d913${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_image, {
                src: img.url,
                fit: "cover"
              }, null, _parent2, _scopeId));
              _push2(`<div class="picker-img-name" data-v-9bf0d913${_scopeId}>${ssrInterpolate(img.name)}</div></div>`);
            });
            _push2(`<!--]--></div>`);
...
const AdminImagePicker = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9bf0d913"]]);

export { AdminImagePicker as A };
//# sourceMappingURL=AdminImagePicker-Dpevamev.mjs.map
