...
import { supabaseProductApi, supabaseFaqApi } from './supabase-DLV6up8l.mjs';
...
const useProductDetail = (overrideId) => {
  ...
  const checkFavoriteStatus = async () => {
    ...
    const { favoriteApi } = await import('./common-Bgv_wRgd.mjs').then((n) => n.b);
  ...
  const buyNow = async () => {
    ...
    try {
      const { supabasePreOrderApi } = await import('./supabase-DLV6up8l.mjs');
...
//# sourceMappingURL=useProductDetail-DLP8HdIq.mjs.map
