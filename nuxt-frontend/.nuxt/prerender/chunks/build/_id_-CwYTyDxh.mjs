...
import { defineComponent, defineAsyncComponent, ref, computed, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderStyle, ssrRenderAttr } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { useRoute, useRouter } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue-router/vue-router.node.mjs';
import { q as arrow_left_default, ak as timer_default, P as question_filled_default, D as arrow_down_default, i as info_filled_default, m as arrow_right_default, X as wallet_default, A as refresh_default, ab as select_default } from './index-CRs4T-Jf.mjs';
import { u as useCheckout } from './useCheckout-CT4eawny.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.orders, (order) => {
        var _a, _b;
        _push(`<div class="order-card glass-card" data-v-9aa3c754><div class="order-header-row" data-v-9aa3c754><span class="order-no" data-v-9aa3c754>\u8BA2\u5355\u53F7: ${ssrInterpolate(order.order_no)}</span><span class="order-status" data-v-9aa3c754>\u5F85\u652F\u4ED8</span></div><div class="order-body" data-v-9aa3c754><div class="product-thumb" data-v-9aa3c754><div class="sq-cover-img-container" data-v-9aa3c754><img${ssrRenderAttr("src", ((_a = order.product_snapshot) == null ? void 0 : _a.image) || "/images/shared/logo.png")} class="sq-cover-img" data-v-9aa3c754></div></div><div class="product-info" data-v-9aa3c754><div class="product-name" data-v-9aa3c754>${ssrInterpolate((_b = order.product_snapshot) == null ? void 0 : _b.product_name)}</div><div class="product-meta-row" data-v-9aa3c754>`);
        _push(ssrRenderComponent(_component_el_tag, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a2, _b2;
            if (_push2) {
              _push2(`${ssrInterpolate(formatSpec((_a2 = order.sku_snapshot) == null ? void 0 : _a2.spec_combination))}`);
            } else {
              return [
                createTextVNode(toDisplayString(formatSpec((_b2 = order.sku_snapshot) == null ? void 0 : _b2.spec_combination)), 1)
              ];
            }
          }),
          _: 2
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const PaySuccessModal = defineAsyncComponent(() => import('./PaySuccessModal-CnE_GCIQ.mjs'));
    const CouponSelectorModal = defineAsyncComponent(() => import('./CouponSelectorModal-BDyynFo8.mjs'));
    const WalletRechargeModal = defineAsyncComponent(() => import('./WalletRechargeModal-j2cuL1iq.mjs'));
...
//# sourceMappingURL=_id_-CwYTyDxh.mjs.map
