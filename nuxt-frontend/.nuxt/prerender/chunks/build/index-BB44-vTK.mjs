import { defineComponent, Fragment, h, getCurrentInstance, ref, computed, watchEffect, resolveComponent, resolveDirective, createElementBlock, openBlock, normalizeStyle, normalizeClass, createElementVNode, withDirectives, createCommentVNode, renderSlot, createVNode, withCtx, createBlock, createTextVNode, toDisplayString, vShow, provide, watch, Comment, unref, inject, reactive, isRef, nextTick, isVNode, renderList, toRefs, render } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { debounce, isNull, merge, castArray, flatMap, get } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/lodash-unified/import.js';
import { E as ElScrollbar } from './index-D_b573Qt.mjs';
import { u as useTooltipContentProps, E as ElTooltip } from './index-CIoWkt90.mjs';
import { isArray, isString, hasOwn, isFunction, isObject } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/@vue/shared/dist/shared.cjs.prod.js';
import { C as withNoopInstall, B as withInstall, w as _export_sfc$1, x as useNamespace, ax as useSizeProp, y as useLocale, A as isUndefined$1, v as debugWarn, Z as addClass, aM as removeClass, r as isNumber$1, bw as getProp, aD as isBoolean$1, E as ElIcon, f as arrow_right_default, bx as arrow_up_default, aZ as arrow_down_default, bs as isPropAbsent, Y as hasClass, P as isElement, V as getEventCode, W as EVENT_CODE, X as throwError, l as loading_default } from './server.mjs';
import { isClient } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/@vueuse/core/index.mjs';
import { E as ElCheckbox, a as ElCheckboxGroup } from './index-BlpH41lu.mjs';
import { r as rAF } from './raf-CQRaPAjg.mjs';
import { b as useFormSize } from './use-form-common-props-DlCG9pC5.mjs';
import normalizeWheel from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/normalize-wheel-es/dist/index.js';
...
class TableLayout {
  ...
  updateColumnsWidth() {
    ...
    const flexColumns = flattenColumns.filter(
      (column) => !isNumber$1(column.width)
    );
...
var FilterPanel = /* @__PURE__ */ _export_sfc$1(_sfc_main$2, [["render", _sfc_render$1], ["__file", "/home/runner/work/element-plus/element-plus/packages/components/table/src/filter-panel.vue"]]);
...
var TdWrapper = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/table/src/table-body/td-wrapper.vue"]]);
    ...
    if (hasExpandColumn) {
      ...
      if (cur) {
        ...
        if (isBoolean$1(cur.lazy)) {
          if (treeRowData && isBoolean$1(cur.loaded) && cur.loaded) {
...
var Table = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["render", _sfc_render], ["__file", "/home/runner/work/element-plus/element-plus/packages/components/table/src/table.vue"]]);
    ...
    parentProps.forEach((key) => {
      if (hasOwn(owner.value.props, key)) {
        watch(
          ...
          (newVal) => {
            if (instance.columnConfig.value.type === "selection")
              return;
            if (!isUndefined$1(props_[key]))
              return;
            instance.columnConfig.value[key] = newVal;
          }
        );
...
function useRender(props, slots, owner) {
  ...
  const setColumnWidth = (column) => {
    ...
    column.realWidth = Number(
      isUndefined$1(column.width) ? column.minWidth : column.width
    );
    return column;
  };
...
export { ElTableColumn as E, Mousewheel as M, ElTable as a };
//# sourceMappingURL=index-BB44-vTK.mjs.map
