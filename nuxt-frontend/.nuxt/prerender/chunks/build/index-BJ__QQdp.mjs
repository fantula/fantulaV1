...
import { l as loading_default, f as arrow_right_default } from './index-CbQ9NNm4.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const AboutSection = defineAsyncComponent(() => import('./AboutSection-ChwIMwzr.mjs'));
    const LoginRegisterModal = defineAsyncComponent(() => import('./LoginRegisterModal-DkTPTyiu.mjs'));
...
//# sourceMappingURL=index-BJ__QQdp.mjs.map
