...
import { ssrRenderTeleport, ssrRenderStyle, ssrInterpolate, ssrRenderSlot, ssrRenderComponent, ssrRenderAttr, ssrRenderClass } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (__props.visible) {
          ...
          if (__props.showClose) {
            _push2(`<button class="base-modal-close" data-v-084e2e9c>\xD7</button>`);
          } else {
            _push2(`<!---->`);
          }
...
export { BaseModal as B };
//# sourceMappingURL=BaseModal-HTOTXfQj.mjs.map
