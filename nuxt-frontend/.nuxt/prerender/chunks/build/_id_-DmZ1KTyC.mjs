...
import { defineComponent, computed, withAsyncContext, ref, mergeProps, withCtx, createVNode, unref, createBlock, openBlock, toValue, getCurrentInstance, onServerPrefetch, shallowRef, toRef, nextTick, useSSRContext } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrInterpolate, ssrIncludeBooleanAttr } from 'file:///Users/dalin/fantula/nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "goods-detail-page" }, _attrs))} data-v-7e779d38><div style="${ssrRenderStyle({ "height": "20px" })}" data-v-7e779d38></div>`);
      if (goodsError.value) {
        _push(`<div class="api-warning-bar" data-v-7e779d38> \u26A0\uFE0F \u7F51\u7EDC\u8FDE\u63A5\u5F02\u5E38\uFF0C\u6B63\u5728\u9884\u89C8\u6F14\u793A\u6570\u636E </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="goods-content" data-v-7e779d38><div class="back-btn-row" data-v-7e779d38><button class="back-btn" data-v-7e779d38><span class="back-btn-icon" data-v-7e779d38><svg width="20" height="20" viewBox="0 0 32 32" fill="none" style="${ssrRenderStyle({ "display": "block" })}" data-v-7e779d38><path d="M18.5 10L13 16L18.5 22" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" data-v-7e779d38></path></svg></span><span class="back-btn-text" data-v-7e779d38>\u8FD4\u56DE\u4E0A\u4E00\u9875</span></button></div><div class="goods-detail-content" data-v-7e779d38><div class="goods-main-section" data-v-7e779d38><div class="goods-left-panel" data-v-7e779d38><div class="main-image-wrapper" data-v-7e779d38><div class="main-image" data-v-7e779d38>`);
      _push(ssrRenderComponent(_component_el_image, {
        ...
        placeholder: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="img-loading-placeholder" data-v-7e779d38${_scopeId}>\u52A0\u8F7D\u4E2D...</div>`);
          } else {
            return [
      ...
      if (skuImages.value && skuImages.value.length > 0) {
        _push(`<div class="sku-thumb-scroll" data-v-7e779d38><!--[-->`);
        ssrRenderList(skuImages.value, (img, idx) => {
          _push(`<div class="${ssrRenderClass(["sku-thumb-item", { active: selectedSkuImage.value === img }])}" data-v-7e779d38><img${ssrRenderAttr("src", img)} alt="SKU\u56FE\u7247" data-v-7e779d38></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="premium-service-card" data-v-7e779d38><div class="premium-service-title" data-v-7e779d38>\u670D\u52A1\u4FDD\u969C</div><div class="premium-service-grid" data-v-7e779d38><!--[-->`);
      ssrRenderList(serviceTags, (tag) => {
        _push(`<div class="p-service-item" data-v-7e779d38>`);
        ...
        _push(`<span data-v-7e779d38>${ssrInterpolate(tag)}</span></div>`);
      });
      _push(`<!--]--></div></div></div><div class="goods-info-panel" data-v-7e779d38><div class="info-header" data-v-7e779d38><h1 class="product-name" data-v-7e779d38>${ssrInterpolate(goodsInfo.value.name)}</h1><div class="product-sales-badge" data-v-7e779d38> \u7D2F\u8BA1\u9500\u91CF <span data-v-7e779d38>${ssrInterpolate(goodsInfo.value.sales)}</span></div></div>`);
      if (faqs.value.length > 0) {
        _push(`<div class="faq-ticker-bar" data-v-7e779d38><div class="faq-ticker-container" data-v-7e779d38><div class="faq-ticker-track" style="${ssrRenderStyle(tickerStyle.value)}" data-v-7e779d38><!--[-->`);
        ssrRenderList(displayFaqs.value, (faq, idx) => {
          _push(`<div class="faq-ticker-item" data-v-7e779d38>${ssrInterpolate(faq.question)}</div>`);
        });
        _push(`<!--]--></div></div><div class="faq-arrow-wrap" data-v-7e779d38>`);
      ...
      if (hasSkus.value) {
        _push(`<div class="spec-selection-area" data-v-7e779d38><!--[-->`);
        ssrRenderList(specGroups.value, (specGroup) => {
          _push(`<div class="spec-group" data-v-7e779d38><div class="spec-label" data-v-7e779d38>${ssrInterpolate(specGroup.name)}</div><div class="spec-values" data-v-7e779d38><!--[-->`);
          ssrRenderList(specGroup.values, (val) => {
            _push(`<div class="${ssrRenderClass(["spec-val-btn", { active: selectedSpecs.value[specGroup.name] === val }])}" data-v-7e779d38>${ssrInterpolate(val)}</div>`);
          });
          _push(`<!--]--></div></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<div class="no-sku-notice" data-v-7e779d38><div class="notice-emoji" data-v-7e779d38>\u{1F4E6}\u2728</div><h3 data-v-7e779d38>\u6211\u6B63\u5728\u7591\u72C2\u8865\u8D27\u4E2D\uFF01</h3><p data-v-7e779d38>\u5546\u54C1\u6B63\u5728\u51C6\u5907\u4E2D\uFF0C\u8BF7\u7A0D\u540E\u518D\u6765\u6216\u8054\u7CFB\u5BA2\u670D\u4E86\u89E3\u66F4\u591A~</p></div>`);
      }
      if ((_a = matchedSku.value) == null ? void 0 : _a.intro) {
        _push(`<div class="sku-intro-section" data-v-7e779d38><span class="sku-intro-text" data-v-7e779d38>${ssrInterpolate(matchedSku.value.intro)}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="price-display-section compact-price-area" data-v-7e779d38>`);
      if (hasSkus.value) {
        _push(`<!--[--><div class="price-stock-row" data-v-7e779d38><div class="current-price-box" data-v-7e779d38><span class="p-amount" data-v-7e779d38>${ssrInterpolate(formatPrice(currentPrice.value))}</span></div><div class="stock-info" data-v-7e779d38>`);
        if (stockLoading.value) {
          _push(`<span class="stock-badge loading" data-v-7e779d38>\u67E5\u8BE2\u4E2D...</span>`);
        } else if (hasStock.value) {
          _push(`<span class="stock-badge" data-v-7e779d38>\u5E93\u5B58: ${ssrInterpolate(stock.value)}</span>`);
        } else {
          _push(`<span class="stock-badge out-of-stock" data-v-7e779d38>\u6682\u65F6\u7F3A\u8D27</span>`);
        }
        _push(`</div></div>`);
        if (allowAddon.value && hasStock.value) {
          _push(`<div class="qty-control" data-v-7e779d38><div class="q-actions" data-v-7e779d38><button${ssrIncludeBooleanAttr(!hasStock.value) ? " disabled" : ""} data-v-7e779d38>-</button><input type="number"${ssrRenderAttr("value", qty.value)} min="1"${ssrIncludeBooleanAttr(!hasStock.value) ? " disabled" : ""} data-v-7e779d38><button${ssrIncludeBooleanAttr(!hasStock.value || qty.value >= stock.value) ? " disabled" : ""} data-v-7e779d38>+</button></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
      } else {
        _push(`<div class="no-price-notice" data-v-7e779d38><span class="out-of-stock-large" data-v-7e779d38>\u6682\u65F6\u7F3A\u8D27</span></div>`);
      }
      _push(`</div><div class="main-actions" data-v-7e779d38><button class="primary-buy-btn"${ssrIncludeBooleanAttr(stockLoading.value || !hasStock.value || !hasSkus.value || submitting.value) ? " disabled" : ""} data-v-7e779d38>${ssrInterpolate(stockLoading.value ? "\u52A0\u8F7D\u4E2D..." : hasSkus.value && hasStock.value ? "\u7ACB\u5373\u6781\u901F\u8D2D\u4E70" : "\u6682\u65F6\u7F3A\u8D27")} `);
      if (!stockLoading.value && hasStock.value && hasSkus.value) {
        _push(`<span class="btn-subtext" data-v-7e779d38>\u5B89\u5168\u5408\u89C4\xB7\u79D2\u901F\u53D1\u8D27</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</button><div class="secondary-btns" data-v-7e779d38><button class="add-cart-btn"${ssrIncludeBooleanAttr(stockLoading.value || !hasStock.value || !hasSkus.value || submitting.value) ? " disabled" : ""} data-v-7e779d38>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(` \u52A0\u5165\u8D2D\u7269\u8F66 </button><button class="${ssrRenderClass(["favorite-btn", { favorited: isFavorited.value }])}"${ssrIncludeBooleanAttr(stockLoading.value || !hasStock.value || !hasSkus.value) ? " disabled" : ""} data-v-7e779d38>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(` ${ssrInterpolate(isFavorited.value ? "\u5DF2\u6536\u85CF" : "\u6536\u85CF\u5546\u54C1")}</button></div></div><div class="safe-disclaimer" data-v-7e779d38>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(` \u7248\u6743\u58F0\u660E\uFF1A\u672C\u7AD9\u5C55\u793A\u7684\u5FBD\u6807\u3001\u5546\u6807\u53CA\u76F8\u5173\u6807\u5FD7\u5F52\u5404\u6743\u5229\u4EBA\u6240\u6709\u3002 </div></div></div></div><div class="product-detail-rich" data-v-7e779d38><div class="detail-divider" data-v-7e779d38><span data-v-7e779d38>\u5546\u54C1\u8BE6\u60C5\u4ECB\u7ECD</span></div><div class="detail-content-wrap" data-v-7e779d38><!--[-->`);
      ssrRenderList(detailModules.value, (mod, idx) => {
        _push(`<div class="detail-module" data-v-7e779d38>`);
        if (mod.type === "text") {
          _push(`<div class="detail-text-box" data-v-7e779d38>${ssrInterpolate(mod.content)}</div>`);
        } else if (mod.type === "image") {
          _push(`<img${ssrRenderAttr("src", mod.content)} class="detail-full-img" loading="lazy" data-v-7e779d38>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7e779d38"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-DmZ1KTyC.mjs.map
