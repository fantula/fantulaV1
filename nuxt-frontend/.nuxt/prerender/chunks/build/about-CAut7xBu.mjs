...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-placeholder" }, _attrs))} data-v-15c30951>\u5173\u4E8E\u6211\u4EEC\u9875\u9762\u5EFA\u8BBE\u4E2D\u2026</div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/pc/about.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const about = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-15c30951"]]);

export { about as default };
//# sourceMappingURL=about-CAut7xBu.mjs.map
