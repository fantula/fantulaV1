      ...
      <div v-if="visible" class="sheet-panel aurora-sheet-panel" @click.stop>
         ...
         <div class="sheet-body">
            ...
            <div class="social-login">
               <button class="wechat-btn" @click="onWechatLogin" :disabled="wechatLoading || !isAgree">
                  ...
                  <span>{{ wechatLoading ? '跳转中...' : '微信' }}</span>
               </button>
            </div>
         </div>
      </div>
...
const isAgree = computed(() => {
    return mode.value === 'login' 
        ? (loginType.value === 'password' ? loginForm.value.agree : loginCodeForm.value.agree)
...
const onWechatLogin = () => {
    ...
    // wechatLoading remains true until page navigates away
}
</script>
