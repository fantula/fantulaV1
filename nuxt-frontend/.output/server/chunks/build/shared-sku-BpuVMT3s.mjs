...
import { E as ElTableColumn, a as ElTable } from './index-BDPO3Is8.mjs';
import { E as ElTag } from './index-BZB4XnD2.mjs';
import { E as ElInput } from './index-CcE-rjwX.mjs';
import { defineComponent, ref, mergeProps, withCtx, unref, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, watch, withDirectives, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrGetDirectiveProps } from 'vue/server-renderer';
import { r as refresh_default, p as plus_default, g as picture_default } from './index-CmsdIFY8.mjs';
import { h as adminSharedSkuApi } from './index-DjW7A1G4.mjs';
import { A as AdminActionCard } from './AdminActionCard-BOXSA_sB.mjs';
import { A as AdminDataTable } from './AdminDataTable-DXAYh9aE.mjs';
import { A as AdminDataDialog } from './AdminDataDialog-BgT10VRF.mjs';
import { P as PageTipHeader } from './PageTipHeader-DNW76KgA.mjs';
import { A as AdminSkuEditor } from './SkuEditor-Bxnp8Gei.mjs';
...
import './index-DsxUj3pO.mjs';
import './index-D3BlhKEk.mjs';
import './AdminImageSelector-nSqRE3QU.mjs';
import './index-BMCTPr7n.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_drawer, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="drawer-container" data-v-81cc2b52${_scopeId}><div class="toolbar" data-v-81cc2b52${_scopeId}>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_table_column, {
                    ...
                    default: withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="product-cell" data-v-81cc2b52${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_el_image, {
                          ...
                          error: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="image-slot" data-v-81cc2b52${_scopeId4}>`);
                        ...
                        _push4(`<div class="p-info" data-v-81cc2b52${_scopeId3}><div class="p-name" data-v-81cc2b52${_scopeId3}>${ssrInterpolate(row.product_name)}</div><div class="p-id" data-v-81cc2b52${_scopeId3}>ID: ${ssrInterpolate(row.id.substring(0, 8))}...</div></div></div>`);
                      } else {
                        return [
...
const LinkedProductDrawer = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-81cc2b52"]]);
...
//# sourceMappingURL=shared-sku-BpuVMT3s.mjs.map
