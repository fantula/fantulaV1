import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, createElementBlock, openBlock, createElementVNode, getCurrentInstance, inject, computed, unref, ref, shallowRef, h, resolveComponent, Suspense, hasInjectionContext, provide, cloneVNode, isRef, warn, shallowReactive, Fragment, mergeProps, watch, withCtx, createTextVNode, renderSlot, normalizeClass, createVNode, Transition, withDirectives, normalizeStyle, toDisplayString, vShow, reactive, effectScope, isReactive, toRaw, nextTick, getCurrentScope, onScopeDispose, toRefs, markRaw, readonly, useSSRContext, createBlock, createCommentVNode, resolveDynamicComponent, withModifiers, createApp, isVNode, toRef, onErrorCaptured, onServerPrefetch, isReadonly, isShallow, render, defineAsyncComponent } from 'vue';
import { p as parseQuery, c as createError$1, h as hasProtocol, i as isScriptProtocol, k as joinURL, w as withQuery, s as sanitizeStatusCode, l as getContext, m as withTrailingSlash, n as withoutTrailingSlash, $ as $fetch, o as destr, q as klona, r as createHooks, t as executeAsync, v as parse, x as getRequestHeader, y as isEqual$1, z as toRouteMatcher, A as createRouter$1, B as defu, C as setCookie, D as getCookie, E as deleteCookie } from '../nitro/nitro.mjs';
...
import { isArray as isArray$1, isObject as isObject$1, NOOP, isString as isString$1, camelize, hasOwn, isFunction as isFunction$2 } from '@vue/shared';
import { fromPairs, isNil, get, set, isEqual } from 'lodash-unified';
...
import { ssrRenderTeleport, ssrRenderStyle, ssrInterpolate, ssrRenderSlot, ssrIncludeBooleanAttr, ssrRenderAttr, ssrRenderClass, ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrLooseContain, ssrRenderVNode, ssrRenderSuspense } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const URLSearchParams$1 = require$$7.URLSearchParams;
