import { defineComponent, reactive, computed, toRefs, provide, createElementBlock, openBlock, normalizeClass, unref, createElementVNode, createBlock, createCommentVNode, normalizeStyle, createVNode, Fragment, renderList, withModifiers, shallowRef, ref, watch, h, nextTick, withCtx, toDisplayString, inject } from 'vue';
import { useEventListener } from '@vueuse/core';
import { E as ElInputNumber } from './index-iY4Ojb3q.mjs';
import { placements } from '@popperjs/core';
import { B as withInstall, w as _export_sfc$1, r as isNumber$1, q as buildProps, x as useNamespace, y as useLocale, D as definePropType, ax as useSizeProp, X as throwError, v as debugWarn, V as getEventCode, W as EVENT_CODE } from './server.mjs';
