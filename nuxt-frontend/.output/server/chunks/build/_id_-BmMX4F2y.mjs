import { _ as _export_sfc, E as ElIcon, z as arrow_left_default, ap as copy_document_default, am as circle_check_default, b5 as box_default, M as refresh_left_default, a3 as info_filled_default, b6 as timer_default, b7 as headset_default, b8 as tickets_default, b9 as refresh_default, a_ as circle_close_default, a0 as money_default, a1 as guide_default, L as zoom_in_default, ah as ElMessage, a4 as user_default, p as plus_default, b3 as files_default, l as loading_default, ar as edit_pen_default, an as edit_default, N as refresh_right_default, b4 as document_add_default, aZ as arrow_down_default, a2 as warning_default, d as useUserStore, ad as BaseModal, f as arrow_right_default, o as getSupabaseClient } from './server.mjs';
import { defineComponent, ref, computed, mergeProps, withCtx, unref, createVNode, watch, reactive, createBlock, openBlock, toDisplayString, createCommentVNode, Fragment, renderList, createTextVNode, withDirectives, vModelText, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderStyle } from 'vue/server-renderer';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(allSlots.value, (slot) => {
        ...
        _push(`</div><span class="profile-name" data-v-d65e0ff6>${ssrInterpolate(slot.isMe ? "\u6211" : ((_a = slot.user) == null ? void 0 : _a.nickname) || "\u5F85\u52A0\u5165")}</span><span class="slot-number-tag" data-v-d65e0ff6>${ssrInterpolate(slot.index)}\u53F7</span></div>`);
      });
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (records.value.length > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fulfillment-history glass-panel" }, _attrs))} data-v-6aef509b><div class="history-header" data-v-6aef509b><div class="header-left" data-v-6aef509b><span class="icon" data-v-6aef509b>\u{1F4CB}</span><span class="title" data-v-6aef509b>\u56DE\u6267\u8BB0\u5F55</span><span class="count-badge flex-center" data-v-6aef509b>${ssrInterpolate(records.value.length)}</span></div>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (loading.value) {
              ...
              if (selectedCoupon.value) {
                _push2(`<span class="coupon-selected" data-v-bc6c6b56${_scopeId}>-\xA5${ssrInterpolate(discountAmount.value.toFixed(2))}</span>`);
              } else {
              ...
              _push2(`</div></div></div><div class="refresh-right-col" data-v-bc6c6b56${_scopeId}><div class="summary-card" data-v-bc6c6b56${_scopeId}><div class="summary-title" data-v-bc6c6b56${_scopeId}>\u8BA2\u5355\u6458\u8981</div><div class="summary-row" data-v-bc6c6b56${_scopeId}><span data-v-bc6c6b56${_scopeId}>\u5546\u54C1\u91D1\u989D</span><span data-v-bc6c6b56${_scopeId}>\xA5${ssrInterpolate(originalAmount.value.toFixed(2))}</span></div>`);
              if (discountAmount.value > 0) {
                _push2(`<div class="summary-row" data-v-bc6c6b56${_scopeId}><span data-v-bc6c6b56${_scopeId}>\u4F18\u60E0\u62B5\u6263</span><span class="text-danger" data-v-bc6c6b56${_scopeId}>-\xA5${ssrInterpolate(discountAmount.value.toFixed(2))}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="divider" data-v-bc6c6b56${_scopeId}></div><div class="total-row" data-v-bc6c6b56${_scopeId}><div class="total-label" data-v-bc6c6b56${_scopeId}>\u5E94\u4ED8\u91D1\u989D</div><div class="total-price" data-v-bc6c6b56${_scopeId}><span class="unit" data-v-bc6c6b56${_scopeId}>\xA5</span>${ssrInterpolate(finalAmount.value.toFixed(2))}</div></div>`);
              if (newEndTime.value) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (orderDetail.value) {
              ...
              _push2(`<div class="price-row" data-v-23f72434${_scopeId}><span class="price" data-v-23f72434${_scopeId}>\xA5${ssrInterpolate((_c = orderDetail.value.total_amount) == null ? void 0 : _c.toFixed(2))}</span><span class="quantity" data-v-23f72434${_scopeId}>x${ssrInterpolate(orderDetail.value.quantity)}</span></div></div></div>`);
            ...
            ssrRenderList(form.attachments, (url, idx) => {
              _push2(`<div class="img-preview" data-v-23f72434${_scopeId}><img${ssrRenderAttr("src", url)} data-v-23f72434${_scopeId}><div class="remove-btn" data-v-23f72434${_scopeId}>\xD7</div></div>`);
            });
            _push2(`<!--]-->`);
              ...
              createVNode("div", { class: "modal-body" }, [
                orderDetail.value ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("div", { class: "card-image" }, [
                    createVNode("img", {
                      src: (_d = orderDetail.value.product_snapshot) == null ? void 0 : _d.image,
                      alt: "Product"
                    }, null, 8, ["src"])
                  ]),
                  createVNode("div", { class: "card-info" }, [
                    ...
                    createVNode("div", { class: "product-name" }, toDisplayString((_e = orderDetail.value.product_snapshot) == null ? void 0 : _e.product_name), 1),
                    ...
                    createVNode("div", { class: "price-row" }, [
                      createVNode("span", { class: "price" }, "\xA5" + toDisplayString((_f = orderDetail.value.total_amount) == null ? void 0 : _f.toFixed(2)), 1),
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (productImage.value) {
        ...
        _push(`<div class="placeholder" data-v-282d55f7>\u{1F4E6}</div>`);
      }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (showTicketModal.value && order.value.id) {
        _push(ssrRenderComponent(TicketApplyModal, {
          "order-id": order.value.id,
          "order-info": { order_no: order.value.order_no || "", product_name: ((_a = order.value.product_snapshot) == null ? void 0 : _a.product_name) || "" },
...
//# sourceMappingURL=_id_-BmMX4F2y.mjs.map
