...
import { defineComponent, defineAsyncComponent, mergeProps, unref, withCtx, createVNode, createTextVNode, isRef, toDisplayString, openBlock, createBlock, computed, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderAttr } from 'vue/server-renderer';
import { t as arrow_left_default, ag as shopping_cart_default, _ as star_default, ah as star_filled_default, i as info_filled_default, m as circle_check_default } from './index-DuV_oMrC.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const FaqTicker = defineAsyncComponent(() => import('./FaqTicker-BQArIEhZ.mjs'));
    ...
    const handleAddToCartWrapper = async (event) => {
      const { useCartStore: useCartStore2 } = await import('./cart-B8xez9id.mjs');
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        if (unref(hasSkus)) {
          ...
          _push(`<div class="no-sku-notice" data-v-4587110e><div class="notice-emoji" data-v-4587110e>\u{1F4E6}\u2728</div><h3 data-v-4587110e>\u6211\u6B63\u5728\u7591\u72C2\u8865\u8D27\u4E2D\uFF01</h3><p data-v-4587110e>\u5546\u54C1\u6B63\u5728\u51C6\u5907\u4E2D\uFF0C\u8BF7\u7A0D\u540E\u518D\u6765\u6216\u8054\u7CFB\u5BA2\u670D\u4E86\u89E3\u66F4\u591A~</p></div>`);
        }
...
//# sourceMappingURL=_id_-CmXyKxr_.mjs.map
