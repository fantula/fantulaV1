...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const RedemptionCard = defineAsyncComponent(() => import('./RedemptionCard-xxR8auVA.mjs'));
    const CouponBalance = defineAsyncComponent(() => import('./CouponBalance-CjupjqTe.mjs'));
    const CouponFlat = defineAsyncComponent(() => import('./CouponFlat-CqZQG8OA.mjs'));
    const CouponProduct = defineAsyncComponent(() => import('./CouponProduct-BLzdtCDF.mjs'));
...
//# sourceMappingURL=exchange-jFDJhYXe.mjs.map
