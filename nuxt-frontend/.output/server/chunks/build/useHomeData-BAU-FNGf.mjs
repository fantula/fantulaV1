import { ref } from 'vue';
import { a as commonApi } from './common-D9iMPQj0.mjs';
import { g as goodsApi } from './goods-Q8QuJnLu.mjs';
...
const useHomeData = () => {
  ...
  const fetchCategories = async () => {
    ...
    try {
      ...
      if ((res == null ? void 0 : res.success) && res.data && res.data.length > 0) {
...
//# sourceMappingURL=useHomeData-BAU-FNGf.mjs.map
