...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "faq-category-page" }, _attrs))} data-v-fdf4cebb><div class="page-actions" data-v-fdf4cebb>`);
      ...
      _push(`</div><div${ssrRenderAttrs(mergeProps({ class: "content-card" }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-fdf4cebb>`);
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dialog-footer" data-v-fdf4cebb${_scopeId}>`);
                  ...
                  _push3(ssrRenderComponent(_component_el_form_item, { label: "\u7ED3\u7B97\u9875\u663E\u793A" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="form-tip" data-v-fdf4cebb${_scopeId3}>\u5F00\u542F\u540E\uFF0C\u8BE5\u5206\u7C7B\u4E0B\u7684\u95EE\u9898\u5C06\u663E\u793A\u5728\u7ED3\u7B97\u754C\u9762\u3002</div>`);
                      } else {
                        return [
                          createVNode(_component_el_switch, {
                            modelValue: form.value.is_checkout_visible,
...
const faqCategories = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fdf4cebb"]]);

export { faqCategories as default };
//# sourceMappingURL=faq-categories-BydvFbIh.mjs.map
