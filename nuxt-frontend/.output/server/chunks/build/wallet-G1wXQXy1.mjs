import { defineComponent, defineAsyncComponent, ref, computed, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, toDisplayString, TransitionGroup, Fragment, renderList, createTextVNode, useSSRContext } from 'vue';
...
import { E as ElTooltip } from './index-BgvvVJ20.mjs';
import { R as wallet_default, M as warning_default, a7 as lightning_default, H as document_default, a8 as top_default, a9 as bottom_default } from './index-DlETah8a.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "asset-hero-card" }, _attrs))} data-v-9ca067a6><div class="hero-aurora-bg" data-v-9ca067a6></div><div class="hero-content" data-v-9ca067a6><div class="hero-header" data-v-9ca067a6><div class="header-main" data-v-9ca067a6><div class="card-icon-wrapper" data-v-9ca067a6>`);
      ...
      _push(`</div><div class="header-text" data-v-9ca067a6><span class="card-label" data-v-9ca067a6>\u6211\u7684\u989D\u5EA6</span><div class="card-tag" data-v-9ca067a6>My Quota</div></div></div>`);
      _push(ssrRenderComponent(_component_el_tooltip, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="info-btn" data-v-9ca067a6${_scopeId}>`);
      ...
      _push(`</div><div class="balance-display" data-v-9ca067a6><div class="balance-number" data-v-9ca067a6><span class="amount-integer" data-v-9ca067a6>${ssrInterpolate(balanceInteger.value)}</span><span class="amount-decimal" data-v-9ca067a6>.${ssrInterpolate(balanceDecimal.value)}</span></div><div class="balance-unit" data-v-9ca067a6>\u70B9</div></div><div class="hero-footer" data-v-9ca067a6><button class="neon-action-btn" data-v-9ca067a6>`);
      _push(ssrRenderComponent(_component_el_icon, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`<span data-v-9ca067a6>\u7ACB\u5373\u5145\u503C</span><div class="btn-glow" data-v-9ca067a6></div></button></div></div>`);
...
const AssetHeroCard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-9ca067a6"]]);
...
//# sourceMappingURL=wallet-G1wXQXy1.mjs.map
