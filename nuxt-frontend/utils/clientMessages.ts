export const CLIENT_MESSAGES = {
    ...
    EMAIL_MODAL: {
        ...
        SAME_EMAIL: '这个邮箱已经在用了哦', // Same as current user
    ...
    // 共享逻辑 (Shared)
    SHARE: {
        COPY_WX_SUCCESS: '微信号已复制到剪贴板', // Keep standard or update? User didn't specify JoinUsModal in 2nd request but listed in inventory. Let's keep specific ones or default. 
