...
COMMENT ON FUNCTION "public"."admin_review_refund"("p_request_id" "uuid", "p_approved" boolean, "p_refund_amount" numeric, "p_admin_note" "text") IS '管理员审核退款申请';
...
ALTER FUNCTION "public"."cancel_user_refund_request"("p_order_id" "uuid") OWNER TO "supabase_admin";
...
COMMENT ON FUNCTION "public"."confirm_pre_order"("p_pre_order_id" "uuid", "p_pay_method" "text", "p_coupon_id" "uuid") IS '确认预订单（支持续费逻辑）';
...
COMMENT ON FUNCTION "public"."create_refund_request"("p_order_id" "uuid", "p_reason" "text", "p_reason_detail" "text") IS '创建退款申请';
...
COMMENT ON FUNCTION "public"."create_renewal_pre_order"("p_sku_id" "uuid", "p_old_order_id" "uuid") IS '创建续费预订单（复用原订单资源，修复JSONB转换）';
...
CREATE OR REPLACE FUNCTION "public"."get_notification_field"("config_key" "text", "field_name" "text") RETURNS "text"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    config jsonb;
...
ALTER FUNCTION "public"."get_notification_field"("config_key" "text", "field_name" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."get_notification_template"("config_key" "text") RETURNS "text"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    config jsonb;
...
ALTER FUNCTION "public"."get_notification_template"("config_key" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_order_refund_info"("p_order_id" "uuid") OWNER TO "supabase_admin";
...
COMMENT ON FUNCTION "public"."get_refund_request"("p_order_id" "uuid") IS '获取订单的退款申请信息';
...
COMMENT ON FUNCTION "public"."get_renewal_skus"("p_order_id" "uuid") IS '获取订单可续费的SKU列表(含商品信息)';
...
ALTER FUNCTION "public"."is_notification_enabled"("config_key" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."resolve_channel_key"("p_channel_key" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."send_auto_message"("p_user_id" "uuid", "p_title" "text", "p_content" "text", "p_type" "text", "p_link" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."set_ticket_no"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."trigger_notify_balance_change"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."trigger_notify_coupon_insert"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."trigger_notify_coupon_redeemed"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."trigger_notify_coupon_redeemed"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."trigger_notify_fulfillment_update"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."trigger_notify_order_created"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."trigger_notify_order_status"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."trigger_notify_ticket_reply"() OWNER TO "supabase_admin";
...
ALTER TABLE "public"."channel_recognitions" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."recharge_orders" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."wechat_login_sessions" OWNER TO "supabase_admin";
...
CREATE POLICY "Authenticated users can create orders" ON "public"."recharge_orders" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can send messages to own tickets" ON "public"."ticket_messages" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."tickets"
...
CREATE POLICY "Users can view messages of own tickets" ON "public"."ticket_messages" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."tickets"
  WHERE (("tickets"."id" = "ticket_messages"."ticket_id") AND ("tickets"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can view own recharge orders" ON "public"."recharge_orders" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
GRANT ALL ON FUNCTION "public"."cancel_user_refund_request"("p_order_id" "uuid") TO "postgres";
...
GRANT ALL ON FUNCTION "public"."get_notification_field"("config_key" "text", "field_name" "text") TO "postgres";
GRANT ALL ON FUNCTION "public"."get_notification_field"("config_key" "text", "field_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_notification_field"("config_key" "text", "field_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_notification_field"("config_key" "text", "field_name" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_notification_template"("config_key" "text") TO "postgres";
GRANT ALL ON FUNCTION "public"."get_notification_template"("config_key" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_notification_template"("config_key" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_notification_template"("config_key" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_order_refund_info"("p_order_id" "uuid") TO "postgres";
...
GRANT ALL ON FUNCTION "public"."is_notification_enabled"("config_key" "text") TO "postgres";
...
GRANT ALL ON FUNCTION "public"."resolve_channel_key"("p_channel_key" "text") TO "postgres";
...
GRANT ALL ON FUNCTION "public"."send_auto_message"("p_user_id" "uuid", "p_title" "text", "p_content" "text", "p_type" "text", "p_link" "text") TO "postgres";
...
GRANT ALL ON FUNCTION "public"."set_ticket_no"() TO "postgres";
...
GRANT ALL ON FUNCTION "public"."trigger_notify_balance_change"() TO "postgres";
...
GRANT ALL ON FUNCTION "public"."trigger_notify_coupon_insert"() TO "postgres";
...
GRANT ALL ON FUNCTION "public"."trigger_notify_coupon_redeemed"() TO "postgres";
GRANT ALL ON FUNCTION "public"."trigger_notify_coupon_redeemed"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_notify_coupon_redeemed"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trigger_notify_coupon_redeemed"() TO "service_role";



GRANT ALL ON FUNCTION "public"."trigger_notify_fulfillment_update"() TO "postgres";
...
GRANT ALL ON FUNCTION "public"."trigger_notify_order_created"() TO "postgres";
...
GRANT ALL ON FUNCTION "public"."trigger_notify_order_status"() TO "postgres";
...
GRANT ALL ON FUNCTION "public"."trigger_notify_ticket_reply"() TO "postgres";
...
GRANT ALL ON TABLE "public"."channel_recognitions" TO "postgres";
...
GRANT ALL ON TABLE "public"."recharge_orders" TO "postgres";
...
GRANT ALL ON TABLE "public"."wechat_login_sessions" TO "postgres";
